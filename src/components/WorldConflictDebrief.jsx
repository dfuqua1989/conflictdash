...
const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,413,510",todayChange:"+1,260",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
  {id:2,category:"Tanks",total:"12,100",todayChange:"+3",color:"#f97316",icon:"🪖",description:"Main battle tanks"},
  {id:3,category:"Armoured Vehs",total:"24,903",todayChange:"+4",color:"#eab308",icon:"🚧",description:"APCs, IFVs, MRAPs"},
  {id:4,category:"Artillery",total:"45,569",todayChange:"+61",color:"#84cc16",icon:"💥",description:"Guns, howitzers, mortars"},
  {id:5,category:"MLRS",total:"1,918",todayChange:"+1",color:"#22c55e",icon:"🚀",description:"Multiple launch rockets"},
  {id:6,category:"Air Defence",total:"1,478",todayChange:"—",color:"#06b6d4",icon:"🛡️",description:"SAM & SHORAD systems"},
  {id:7,category:"UAVs",total:"396,920",todayChange:"+2,074",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
  ...
  {id:12,category:"Vehicles",total:"117,547",todayChange:"+462",color:"#a78bfa",icon:"🚛",description:"Trucks & logistics"},
  {id:13,category:"Ground Robots",total:"1,853",todayChange:"+5",color:"#f43f5e",icon:"🤖",description:"UGV platforms"},
  {id:14,category:"Special Equip",total:"4,398",todayChange:"+4",color:"#fb923c",icon:"🔧",description:"Engineering & EW"},
],gaza:[
...
const BRIEFING={summary:"Ukraine pushed total Russian losses to 1,413,510 (Jul 8 MoD report, +1,260 on the day) while sustaining its deep-strike campaign — Russian refining is at 42.47% of design capacity after the St. Petersburg Oil Terminal and Kronstadt raids. Russia answered with two Kyiv mass strikes in five days: roughly 570 missiles and drones on Jul 1-2 (30 killed), then 68 missiles and 351 drones on Jul 5-6 (21 killed) with zero ballistic intercepts — Patriot stocks exhausted. NATO Ankara opens today, with air defense the forced centerpiece after two Kyiv mass strikes in five days: the draft commits €70B/year through 2027 (€140B total), brands Russia a 'long-term threat,' and reaffirms Article 5 — ratification is the day's question. The US-Iran exchange has spiraled into a full retaliatory cycle: Iran struck three tankers, the US hit 80+ targets and revoked the GL X oil license, the IRGC claims 85 US military sites struck in Bahrain and Kuwait, and a second US wave followed — with Trump declaring the MoU 'over' from the NATO summit stage while his administration insists it technically survives. Brent is at $78 (+6%). Khamenei's successor Mojtaba remains unseen ahead of the Jul 9 burial; Pezeshkian cut short the Najaf procession. The UN Human Rights Council held an urgent debate Jul 3 on El-Obeid, drafting a resolution condemning starvation as a method of warfare, as Venezuela's earthquake recovery collides with acting President Rodríguez's expired interim mandate and Machado's bid to return.",signals:[{theater:"Ukraine",text:"2nd Kyiv mass strike in 5 days kills 21; zero ballistic intercepts; 1.41M RU losses"},{theater:"NATO",text:"Ankara Day 2 (final) — Trump-Zelensky bilateral 14:30; €140B/2yr ratification watch"},{theater:"Iran",text:"Full retaliatory cycle: IRGC hits Bahrain/Kuwait bases; 2nd US wave; Trump: MoU 'over'"},{theater:"Sudan",text:"UN urgent debate on El-Obeid — draft resolution on starvation as warfare"}],watch:"Next 48hrs: whether the US-Iran cycle continues past two rounds — Trump: 'if it happens again, it will get much worse'; whether Jul 11 talks survive Trump's 'MoU is over' declaration (the single clearest signal); Ankara outcomes — Trump-Zelensky bilateral, €140B ratification, Patriot deliverable; Khamenei burial Jul 9 with Mojtaba still unseen.",generatedAt:new Date().toISOString()};
const UKRAINE_BRIEFING={summary:"Russia's attrition math has become unsustainable even as its ground offensive grinds on. CSIS's July 1 assessment puts the Russia:Ukraine battlefield loss ratio at nearly 8:1 in H1 2026 — up from 2:1-3:1 for most of the war — credited largely to Ukraine's AI-enabled drone interdiction campaign. The MoD's Jul 8 report puts cumulative Russian losses at 1,413,510 (+1,260 on the day), with daily losses still running above 1,000 most days. That said, the war is not simply going well for Ukraine: Russia's stalled offensive still holds Pokrovsk at genuine encirclement risk, and the Patriot/PAC-3 shortage — worsened by the 2026 Iran war draining US stocks — remains the one gap Ukraine cannot close on its own.",assessment:[{cat:"Attrition",text:"~8:1 RU:UA loss ratio in H1 2026 (CSIS). Cumulative Russian losses reached 1,413,510 as of the Jul 8 MoD report, with artillery losses (45,569 total) still climbing after June's record monthly pace."},{cat:"Territory",text:"Russian advance has slowed to 50-90m/day around Pokrovsk, Kostiantynivka and Sloviansk — among the slowest rates of any war in the past century. Russia had a net territorial LOSS in Apr-May 2026 (~400 km²), its first monthly net loss since Aug 2024."},{cat:"Deep Strikes",text:"Crimea airpower now a sustained target — Saky airbase struck twice in a week (7 aircraft hit Jul 3), alongside the Jul 1-2 Ufa/Penza refinery-and-missile-component wave."},{cat:"Air Defense",text:"The gap is now total: in the Jul 5-6 mass strike (68 missiles, 351 drones, 21 killed) Ukraine intercepted zero ballistic missiles — Zelensky says interceptor stocks are exhausted, five days after the Jul 1-2 attack killed 30. Drone-side economics still favor Ukraine ($7.5k interceptor vs $35k Shahed), but Patriot/PAC-3 supply has become the war's single decisive materiel question, and the forced centerpiece of the Ankara summit."},{cat:"Diplomacy",text:"NATO Ankara Summit Day 2 (final); Russia has already rejected the Turkish ceasefire push heading into it. Track remains blocked."}],watch:"Whether Pokrovsk holds — that single sector is the most consequential near-term variable, sitting against an otherwise favorable attrition and territorial picture.",generatedAt:new Date().toISOString()};
...
const REPORT_NOW=new Date("2026-07-08T12:00:00Z");
...
<Hero t={t}><div style={{display:"flex",alignItems:"center",gap:6,marginBottom:10}}><span style={{width:8,height:8,borderRadius:"50%",background:"#ef4444",display:"inline-block",animation:"blink 1.4s ease-in-out infinite",flexShrink:0}}/><span style={{fontSize:11,color:"rgba(255,255,255,.45)",letterSpacing:".08em",textTransform:"uppercase"}}>War Day {UA_WAR_DAY} · Live</span><span style={{marginLeft:"auto",fontSize:11,color:"rgba(255,255,255,.35)"}}>{REPORT_NOW.toLocaleDateString("en-GB",{day:"numeric",month:"long",year:"numeric"})}</span></div><div style={{fontSize:11,color:"rgba(255,255,255,.4)",textTransform:"uppercase",letterSpacing:".05em"}}>🇷🇺 Total Russian Personnel Losses</div><div style={{fontSize:42,fontWeight:800,letterSpacing:-2,lineHeight:1,fontVariantNumeric:"tabular-nums"}}>{LOSSES.ukraine[0].total}</div><div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",marginTop:14,paddingTop:12,borderTop:"1px solid rgba(255,255,255,.08)"}}><div><div style={{fontSize:11,color:"rgba(255,255,255,.4)"}}>Today</div><div style={{fontSize:22,fontWeight:800,color:"#ff9500",fontVariantNumeric:"tabular-nums"}}>+1,190</div></div><div><div style={{fontSize:11,color:"rgba(255,255,255,.4)"}}>7-Day Avg</div><div style={{fontSize:20,fontWeight:700,color:"#fbbf24",fontVariantNumeric:"tabular-nums"}}>~1,231</div></div><div><div style={{fontSize:11,color:"rgba(255,255,255,.4)"}}>Since Feb 22</div><div style={{fontSize:15,fontWeight:700,color:"rgba(255,255,255,.6)",marginTop:3}}>Day {UA_WAR_DAY}</div></div></div></Hero><Grid2 t={t} items={[{icon:"🛸",label:"UAVs Destroyed Today",val:"+1,768",sub:"cumulative 389,110",color:"#5b8ec8"},{icon:"⚔️",label:"Combat Clashes",val:"197",sub:"Jun 28 engagement count",color:"#8b5cf6"},{icon:"🪖",label:"Tanks Today",val:"+1",sub:"cumulative 12,074",color:"#f97316"},{icon:"💥",label:"Artillery Today",val:"+100",sub:"cumulative 45,325",color:"#ef4444"}]}/><ST t={t}>📋 This Week in the War</ST><Card t={t}>{WEEK_UPDATES.map((u,i)=><Row key={i} t={t} last={i===WEEK_UPDATES.length-1}><div style={{fontSize:12.5,color:t.text,lineHeight:1.55}}>{u}</div></Row>)}</Card><div style={{background:t.isDark?"linear-gradient(135deg,#091321,#0d1f38)":"linear-gradient(135deg,#eef3fc,#e6edf9)",border:"1px solid rgba(59,130,246,0.25)",borderLeft:"4px solid #5b8ec8",borderRadius:14,padding:"14px 16px",marginBottom:16}}>
  ...
  <div style={{fontSize:11,color:t.sub,fontStyle:"italic",paddingTop:10,borderTop:`1px solid ${t.isDark?"rgba(255,255,255,.08)":"rgba(0,0,0,.08)"}`}}>
    👁 <strong style={{color:t.text,fontStyle:"normal"}}>Watch: </strong>{UKRAINE_BRIEFING.watch}
      ...
      <Hero t={t} color="#06b6d4"><div style={{fontSize:11,fontWeight:800,letterSpacing:".12em",color:"#67e8f9",marginBottom:6}}>🛡️ AIR DEFENSE — THE INTERCEPT WAR</div><div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>Ukraine wins the drone fight on economics and loses the ballistic fight on inventory. The Jul 1-2 Kyiv mass strike drew the line precisely: ~90% of 570 projectiles downed, yet 24-28 ballistic missiles and jet-powered Geran-4s still killed 30 — the gap is not skill, it is Patriot/PAC-3 stock.</div></Hero>
      <Grid2 t={t} items={[
        ...
        {icon:"🚀",label:"Ballistic gap",val:"0 downed",sub:"Jul 5-6 strike: zero ballistic intercepts — stocks exhausted",color:"#dc2626"},
        {icon:"⚡",label:"New threat",val:"Geran-4",sub:"Jet-powered, ~500km/h — degrades intercept windows",color:"#f97316"},
      ]}/>
    ...
    {tab==="uaindustry"&&<div>
      ...
      <Grid2 t={t} items={[
        ...
        {icon:"🇩🇰",label:"Denmark model",val:"$630M+",sub:"Frozen-asset-funded contracts for UA-built systems",color:"#5b8ec8"},
      ]}/>
...
function TheatersOverview({t,conflicts,onSelectConflict}){const STATUS_ORDER={"ESCALATING":0,"NEW CIVIL WAR":0,"US INTERVENTION":0,"MoU CRISIS":0,"CO-BELLIGERENT":1,"FLASHPOINT":1,"BLOCKADE":1,"Active":2,"MoU":3,"ELEVATED":4,"Fragile Ceasefire":5};const sorted=[...conflicts].sort((a,b)=>(STATUS_ORDER[a.status]??9)-(STATUS_ORDER[b.status]??9));const SECTION_MAP={"south-china-sea":"scs","taiwan":"scs","southsudan":"sudan","caribbean":"venezuela"};return <div><div style={{fontSize:10,fontWeight:700,color:t.sub,textTransform:"uppercase",letterSpacing:".1em",marginBottom:14}}>🌍 {conflicts.length} Active Theaters — Tap to Deep Dive</div><div style={{display:t.isLandscape?"grid":"block",gridTemplateColumns:t.isLandscape?"1fr 1fr":undefined,gap:t.isLandscape?12:0}}>{sorted.map((c,ci)=>{const sectionId=SECTION_MAP[c.id]??c.id;return <button key={c.id} className="theater-card" onPointerDown={e=>{const r=e.currentTarget.getBoundingClientRect();e.currentTarget.style.setProperty("--px",`${((e.clientX-r.left)/r.width*100)}%`);e.currentTarget.style.setProperty("--py",`${((e.clientY-r.top)/r.height*100)}%`);}} onClick={()=>onSelectConflict(sectionId)} style={{display:"block",width:"100%",background:t.card,borderTop:`1px solid ${t.border}`,borderRight:`1px solid ${t.border}`,borderBottom:`1px solid ${t.border}`,borderLeft:`4px solid ${c.statusColor}`,borderRadius:14,padding:"16px 18px",marginBottom:12,cursor:"pointer",fontFamily:FONT,textAlign:"left",animation:`riseIn .3s ease-out ${ci*0.05}s both`}}><div style={{display:"flex",alignItems:"flex-start",gap:12,marginBottom:10}}><span style={{fontSize:28,flexShrink:0,lineHeight:1}}>{c.icon}</span><div style={{flex:1,minWidth:0}}><div style={{fontSize:15,fontWeight:800,color:t.text,lineHeight:1.2,marginBottom:4}}>{c.name}</div><div style={{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}}><span style={{background:c.statusColor+"22",border:`1px solid ${c.statusColor}55`,borderRadius:20,padding:"2px 10px",fontSize:10,fontWeight:700,color:c.statusColor,textTransform:"uppercase"}}>{c.status}</span><span style={{fontSize:11,color:t.sub}}>{c.region}</span></div></div><span style={{fontSize:16,color:t.sub,flexShrink:0,marginTop:4}}>→</span></div><div style={{display:"flex",gap:20,marginBottom:10}}><div><div style={{fontSize:10,color:t.sub,marginBottom:1}}>Deaths</div><div style={{fontSize:13,fontWeight:700,color:c.statusColor}}>{c.deaths}</div></div><div><div style={{fontSize:10,color:t.sub,marginBottom:1}}>Displaced</div><div style={{fontSize:13,fontWeight:700,color:t.text}}>{c.displaced}</div></div>{c.warDay&&<div><div style={{fontSize:10,color:t.sub,marginBottom:1}}>War day</div><div style={{fontSize:13,fontWeight:700,color:t.text}}>{c.warDay}</div></div>}</div><div style={{fontSize:12,color:t.sub,lineHeight:1.6,background:t.isDark?"rgba(255,255,255,.03)":"rgba(0,0,0,.03)",borderRadius:8,padding:"9px 11px"}}>{c.summary}</div><div style={{marginTop:10,fontSize:11,color:"#5b8ec8",fontWeight:600}}>Open Deep Dive →</div></button>;})}</div>
  ...
  {[
    {id:"dronewar",name:"Drone War Dashboard",icon:"🛸",status:"WEEKLY TRACKER",statusColor:"#22c55e",region:"Ukraine / Russia",s1l:"RU launch rate",s1v:"~5k/mo",s2l:"UA output",s2v:"100k+/mo",summary:"Nightly launch/intercept data, saturation model, strike log, cost race, AD systems, and drone asset library. Current through Jul 4."},
...
function TrendsView({t}){
  ...
  return <div style={{padding:"16px 16px 0",animation:"fadeIn .25s ease-out"}}>
    ...
    <TrendChart t={t} data={dailyCas} color="#ef4444" label="Daily RU Personnel Losses" unit="killed/wounded per day (UA GenStaff)" desc="The dashboard's own daily-refresh record — the same series that feeds the Ukraine Losses tab, shown as a trend. Sustained 1,100-1,400/day band through late June and early July." />
    <Card t={t} style={{padding:"12px 8px 8px"}}>
      ...
      <div style={{fontSize:11,color:t.sub,lineHeight:1.5,padding:"6px 8px 2px"}}>Pulled straight from the Drone War daily log (current through Jul 4). Bars: total launched per night; line: intercepted/suppressed. The Jul 1 spike is the 570-projectile Kyiv mass strike. Weekly-cadence data — updates Sundays.</div>
    </Card>
    <Card t={t} style={{padding:"12px 8px 8px"}}>
  ...
  return <div>
    ...
    {tab==="timeline"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>From Operation Epic Fury (Feb 28) through the Islamabad MoU and the 39-day countdown to Aug 16.</div>
      </Hero>
    ...
    {tab==="gaps"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #ef4444"}}>
        <div style={{fontSize:11,color:"rgba(255,255,255,.4)",textTransform:"uppercase",letterSpacing:".08em",marginBottom:8}}>⚠️ Unresolved Gaps — 39 Days Remain</div>
...
function NuclearSection({t}){
  ...
  const VECTORS=[
    ...
    {flag:"🇮🇷",name:"Iran — Nuclear Clock",status:"39 DAYS",color:"#8b5cf6",text:"Islamabad MoU 60-day window closes ~Aug 16. IAEA inspector access disputed. Enrichment red lines unresolved — Pezeshkian: 'we will never back down from the right to enrich uranium.'"},
...
const DW_DAILY = [
  ...
  { date:"Jul 4",  ru_d:129,ru_m:0,  ru_int:115,ru_thru:14, ua_d:0,ua_int:0,ua_thru:0, alert_h:6.1, pw_gwh:0.20,
