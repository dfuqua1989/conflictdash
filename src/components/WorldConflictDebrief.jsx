...
const CONFLICTS=[
  ...
  {id:"gaza",name:"Gaza / West Bank",region:"Middle East",status:"Fragile Ceasefire",statusColor:"#f59e0b",icon:"🇵🇸",deaths:"73,039+ killed total",displaced:"1.9M displaced",summary:"Ceasefire since Oct 10, 2025. 1,027+ killed since ceasefire. Quiet annexation accelerating. 80% of buildings damaged.",warDay:null},
...
const NEWS=[
  ...
  {id:"b_iran_strikes",conflictId:"iran",severity:"major",icon:"🟠",headline:"US-Iran Stand-Down Holds; Technical Talks Proceed in Doha, Hormuz Reopens to Shipping",conflict:"Iran",conflictColor:"#8b5cf6",publishedAt:"Jun 30, 2026",bullets:["Following the Jun 26-27 CENTCOM strikes and Iranian retaliation on US bases in Bahrain and Kuwait, both sides agreed Jun 29 to freeze offensive operations — the Strait of Hormuz has reopened to commercial traffic","Witkoff and Kushner are in Doha for what Qatar's FM spokesperson calls technical-level tracks (nuclear, economic, regional security) — not the senior-level 'negotiations' Iran continues to publicly deny are scheduled","Iran's chief negotiator Gharibabadi says talks are unconfirmed at leadership level, but an expert delegation remains in Doha pursuing implementation of Clause 10 (oil sales licenses) and Clause 11 ($6B frozen asset release)","IAEA still has no access to the bombed Natanz/Isfahan/Fordow sites; Iran says inspections wait for a final deal. No new strikes reported in the Jun 28-30 window"],sources:["CNN","Al Jazeera","GlobalSecurity.org Iran War Day 122"],impact:"De-escalation is real but shallow — verbal stand-down, not a new agreement; underlying disputes over Hormuz control, tolls, and nuclear inspections are unresolved",impactColor:"#f97316"},
  ...
  {id:"b7",conflictId:"south-china-sea",severity:"watch",icon:"🟡",headline:"China Deploys Floating Platform Inside Scarborough Shoal — Philippines Protests",conflict:"S. China Sea",conflictColor:"#f97316",publishedAt:"Jun 2026",bullets:["Philippine aerial surveillance identified a 6x6m floating platform with antenna inside Scarborough Shoal","Philippines foreign ministry lodged formal diplomatic protest; China rejected objections","PLA Southern Theater shadowed US-Philippines Balikatan 2026 exercises with H-6 bombers","Japan-Philippines EEZ talks triggered CCG patrols east of Taiwan — beyond China's own 10-dash line"],sources:["Philippine DFA","CFR","ISS Maritime Awareness"],impact:"Strategic — Normalization of incursion pattern; EEZ boundary challenge widening",impactColor:"#f97316"},
...
const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,403,550",todayChange:"+1,350",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
  {id:2,category:"Tanks",total:"12,067",todayChange:"+1",color:"#f97316",icon:"🪖",description:"Main battle tanks"},
  {id:3,category:"Armoured Vehs",total:"24,851",todayChange:"+6",color:"#eab308",icon:"🚧",description:"APCs, IFVs, MRAPs"},
  {id:4,category:"Artillery",total:"45,040",todayChange:"+71",color:"#84cc16",icon:"💥",description:"Guns, howitzers, mortars"},
  {id:5,category:"MLRS",total:"1,901",todayChange:"—",color:"#22c55e",icon:"🚀",description:"Multiple launch rockets"},
  {id:6,category:"Air Defence",total:"1,455",todayChange:"+1",color:"#06b6d4",icon:"🛡️",description:"SAM & SHORAD systems"},
  {id:7,category:"UAVs",total:"381,176",todayChange:"+1,952",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
  ...
  {id:10,category:"Cruise Missiles",total:"4,797",todayChange:"—",color:"#14b8a6",icon:"🎯",description:"Destroyed in flight"},
  {id:11,category:"Ships/Boats",total:"33",todayChange:"—",color:"#64748b",icon:"⛵",description:"Naval vessels"},
  {id:12,category:"Vehicles",total:"114,104",todayChange:"+492",color:"#a78bfa",icon:"🚛",description:"Trucks & logistics"},
  {id:13,category:"Ground Robots",total:"1,777",todayChange:"+13",color:"#f43f5e",icon:"🤖",description:"UGV platforms"},
  {id:14,category:"Special Equip",total:"4,368",todayChange:"+2",color:"#fb923c",icon:"🔧",description:"Engineering & EW"},
],gaza:[
  {id:15,category:"Total Killed",total:"73,039+",todayChange:null,color:"#f59e0b",icon:"☠️",description:"Total killed since Oct 2023"},
  {id:16,category:"Children Killed",total:"20,179+",todayChange:null,color:"#ef4444",icon:"👶",description:"Children killed"},
  {id:17,category:"Post-ceasefire killed",total:"1,027+",todayChange:null,color:"#f97316",icon:"💀",description:"Killed since Oct 10, 2025 ceasefire"},
...
const STRIKES=[
  ...
  {id:13,date:"Jun 30",targetName:"Two road/rail bridges — Russian military logistics",region:"Russia (occupied areas)",distance:0,category:"Infrastructure",icon:"🌉",severity:"major",result:"Ukrainian forces struck two road/rail bridges used by Russia to transport forces and arms overnight Jun 29-30 per RBC-Ukraine. Exact locations not disclosed by General Staff."},
];
const CASUALTIES=[{date:"Jun 17",value:1260},{date:"Jun 18",value:1370},{date:"Jun 19",value:1240},{date:"Jun 20",value:1290},{date:"Jun 21",value:1290},{date:"Jun 22",value:1390},{date:"Jun 23",value:1260},{date:"Jun 24",value:1270},{date:"Jun 25",value:1310},{date:"Jun 26",value:1350},{date:"Jun 27",value:1250},{date:"Jun 28",value:1230},{date:"Jun 29",value:1350},{date:"Jun 30",value:1350}];
...
const BRIEFING={summary:"Ukraine's General Staff confirmed total Russian losses at 1,403,550 as of June 30, with daily attrition holding near 1,350. The US-Iran stand-down agreed June 29 is holding: the Strait of Hormuz has reopened to commercial shipping, and Witkoff and Kushner are in Doha for technical-level (not senior) talks on the MoU's frozen-asset release and nuclear inspections — Iran continues to deny any confirmed leadership-level negotiations. In Sudan, El-Obeid remains under the RSF's fiercest assault yet, with a widening humanitarian collapse and continued displacement toward White Nile state. NATO Ankara is now 7 days out with the diplomatic track still blocked.",signals:[{theater:"Ukraine",text:"1.4M+ Russian losses — Day 1,588"},{theater:"Iran",text:"Stand-down holding; Hormuz reopened; technical Doha talks only"},{theater:"Sudan",text:"El-Obeid siege — humanitarian collapse deepening"},{theater:"NATO",text:"Ankara 6 days out — track still blocked"}],watch:"Next 72hrs: whether the US-Iran stand-down survives the next shipping incident; whether the Nuclear Affairs working group secures a scheduled IAEA visit; El-Obeid ground offensive risk; NATO Ankara pre-summit positioning; Pokrovsk encirclement risk.",generatedAt:new Date().toISOString()};
...
const ENERGY_DISRUPTIONS=[
  ...
  {icon:"🚢",label:"Strait of Hormuz",text:"Reopened under the Islamabad MoU Jun 14, but directly tested by the Jun 26-27 drone-attack/CENTCOM-strike exchange — global oil-price risk remains live despite the formal ceasefire.",color:"#8b5cf6"},
...
const POLITICAL_CALENDAR=[
  ...
  {date:"TBD",label:"Venezuela political transition",note:"Delcy Rodríguez's interim presidency legitimacy is contested; opposition leader María Corina Machado, widely seen as the 2024 election's actual winner, has not been installed.",color:"#dc2626"},
];
const CYBER_HYBRID=[
...
const SIGNALS_TODAY=[{icon:"☠️",val:"1,403,550",label:"Total Russian losses",sub:"+1,350 today (est.) — Day 1,588",color:"#ef4444",trend:[1260,1270,1310,1350,1250,1230,1350]},{icon:"🛸",val:"+1,952",label:"UAVs down (24h)",sub:"cumulative 381,176 — Jun 30 briefing",color:"#5b8ec8",trend:[1650,1380,1900,1720,2100,1873,1873]},{icon:"⚓",val:"0 vessels",label:"BSF in Black Sea",sub:"Fleet fully expelled — historic",color:"#5b8ec8",trend:[12,10,8,6,4,2,0]},{icon:"🏝️",val:"47+",label:"SCS incidents in 2026",sub:"Near-daily water cannons",color:"#eab308",trend:[28,32,35,38,42,44,47]},{icon:"☢️",val:"48 days",label:"Iran nuclear clock",sub:"MoU clock — Aug 16 deadline",color:"#8b5cf6",trend:[69,68,66,64,52,49,48]},{icon:"🛢️",val:"~40%",label:"Russian refineries offline",sub:"French seized shadow fleet tanker",color:"#22c55e",trend:[15,22,28,30,35,38,40]},{icon:"🌉",val:"4 severed",label:"Crimea supply routes",sub:"Rail · fuel · power · road",color:"#f97316",trend:[1,1,2,2,3,3,4]}];
...
const Card=({t,children,style,onClick})=><div onClick={onClick} style={{background:t.card,borderRadius:12,marginBottom:10,border:`1px solid ${t.border}`,overflow:"hidden",boxShadow:t.isDark?"0 2px 8px rgba(0,0,0,.3)":"0 1px 4px rgba(59,130,246,.08)",...style}}>{children}</div>;
...
const Grid2=({t,items})=><div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:12}}>{items.map((item,i)=><div key={i} style={{background:"rgba(255,255,255,0.04)",borderRadius:10,padding:"10px 12px",border:`1px solid ${item.color}22`}}>{item.icon&&<div style={{fontSize:18,marginBottom:4}}>{item.icon}</div>}<div style={{fontSize:item.vs??22,fontWeight:800,color:item.color,lineHeight:1.1,fontVariantNumeric:"tabular-nums"}}>{item.val}</div><div style={{fontSize:11,fontWeight:700,color:"rgba(255,255,255,.7)",marginTop:2}}>{item.label}</div>{item.sub&&<div style={{fontSize:10,color:"rgba(255,255,255,.4)",marginTop:1,lineHeight:1.35}}>{item.sub}</div>}</div>)}</div>;
...
const REPORT_NOW=new Date("2026-07-01T12:00:00Z");
...
function BriefingPanel({t}){
  ...
  const regen=async()=>{
    ...
    const newsContext=NEWS.map(n=>`[${n.conflict} - ${n.severity.toUpperCase()}] ${n.headline}: ${n.bullets.join(" | ")} — Impact: ${n.impact}`).join("\n");
    const signalsContext=SIGNALS_TODAY.map(s=>`${s.label}: ${s.val} (${s.sub})`).join(", ");
    const prompt=`You are the night editor of World Conflict Debrief, a global conflict intelligence dashboard. Today is 1 July 2026.

Breaking news right now:
${newsContext}

Key signals: ${signalsContext}

Write a concise strategic briefing. Respond ONLY with a valid JSON object, no markdown, no backticks:
{
  "summary": "2-3 sentence strategic assessment of the most critical developments. Be direct, analytical, intelligence-brief style.",
  "signals": [
    {"theater":"Ukraine","text":"short signal"},
    {"theater":"Iran","text":"short signal"},
    {"theater":"Sudan","text":"short signal"},
    {"theater":"Global","text":"short signal"}
  ],
  "watch": "One sentence on the single most time-critical thing to watch in the next 72 hours."
}`;
    try{
      ...
      setBriefing({...parsed,generatedAt:new Date().toISOString()});
...
function UkraineSection({t,initialTab}){const[tab,setTab]=useState(initialTab??"overview");useEffect(()=>{if(initialTab)setTab(initialTab);},[initialTab]);return <div><div style={{display:"flex",gap:4,flexWrap:"wrap",marginBottom:12}}>{UKRAINE_TABS.map(tb=><button key={tb.id} onClick={()=>setTab(tb.id)} style={{padding:"5px 10px",fontSize:11,borderRadius:16,cursor:"pointer",fontFamily:FONT,fontWeight:600,background:tab===tb.id?"#5b8ec8":"none",color:tab===tb.id?"#fff":t.sub,border:`1px solid ${tab===tb.id?"#5b8ec8":t.border}`}}>{tb.label}</button>)}</div>{tab==="overview"&&<div><Hero t={t}><div style={{display:"flex",alignItems:"center",gap:6,marginBottom:10}}><span style={{width:8,height:8,borderRadius:"50%",background:"#ef4444",display:"inline-block",animation:"blink 1.4s ease-in-out infinite",flexShrink:0}}/><span style={{fontSize:11,color:"rgba(255,255,255,.45)",letterSpacing:".08em",textTransform:"uppercase"}}>War Day {UA_WAR_DAY} · Live</span><span style={{marginLeft:"auto",fontSize:11,color:"rgba(255,255,255,.35)"}}>1 July 2026</span></div><div style={{fontSize:11,color:"rgba(255,255,255,.4)",textTransform:"uppercase",letterSpacing:".05em"}}>🇷🇺 Total Russian Personnel Losses</div><div style={{fontSize:42,fontWeight:800,letterSpacing:-2,lineHeight:1,fontVariantNumeric:"tabular-nums"}}>1,403,550</div><div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",marginTop:14,paddingTop:12,borderTop:"1px solid rgba(255,255,255,.08)"}}><div><div style={{fontSize:11,color:"rgba(255,255,255,.4)"}}>Today</div><div style={{fontSize:22,fontWeight:800,color:"#ff9500",fontVariantNumeric:"tabular-nums"}}>+1,350</div></div><div><div style={{fontSize:11,color:"rgba(255,255,255,.4)"}}>7-Day Avg</div><div style={{fontSize:20,fontWeight:700,color:"#fbbf24",fontVariantNumeric:"tabular-nums"}}>~1,307</div></div><div><div style={{fontSize:11,color:"rgba(255,255,255,.4)"}}>Since Feb 22</div><div style={{fontSize:15,fontWeight:700,color:"rgba(255,255,255,.6)",marginTop:3}}>Day {UA_WAR_DAY}</div></div></div></Hero><Grid2 t={t} items={[{icon:"🛸",label:"UAVs Destroyed Today",val:"+1,952",sub:"cumulative 381,176",color:"#5b8ec8"},{icon:"⚔️",label:"Combat Clashes",val:"227",sub:"Jun 29 engagement count",color:"#8b5cf6"},{icon:"🪖",label:"Tanks Today",val:"+1",sub:"cumulative 12,067",color:"#f97316"},{icon:"💥",label:"Artillery Today",val:"+71",sub:"cumulative 45,040",color:"#ef4444"}]}/><ST t={t}>📋 This Week in the War</ST><Card t={t}>{WEEK_UPDATES.map((u,i)=><Row key={i} t={t} last={i===WEEK_UPDATES.length-1}><div style={{fontSize:12.5,color:t.text,lineHeight:1.55}}>{u}</div></Row>)}</Card></div>}{tab==="losses"&&<LossesTab t={t}/>}{tab==="frontline"&&<FrontlineTab t={t}/>}{tab==="diplomacy"&&<DiplomacyTab t={t}/>}{tab==="nato"&&<NATOTab t={t}/>}{tab==="crimea"&&<CrimeaTab t={t}/>}{tab==="blacksea"&&<BlackSeaTab t={t}/>}{tab==="strikes"&&<StrikesTab t={t}/>}{tab==="drones"&&<DroneWarTab t={t}/>}{tab==="economy"&&<EconomyTab t={t}/>}{tab==="manpower"&&<ManpowerTab t={t}/>}{tab==="intel"&&<IntelTab t={t}/>}{tab==="analysts"&&<AnalystsTab t={t}/>}</div>;}
...
function TheaterSection({t,conflict}){if(!conflict)return <Skeleton t={t} height={200}/>;const id=conflict.id;const events=EVENTS[id]??[];const losses=LOSSES[id]??[];const news=NEWS.filter(n=>n.conflictId===id);if(id==="gaza")return <div><ConflictOverviewCard conflict={conflict} t={t}/><LossMetrics t={t} losses={losses}/><ST t={t}>🗺️ Situation</ST><Card t={t}>{[{icon:"🤝",label:"Ceasefire Status (Oct 10, 2025)",text:"Fragile ceasefire holding — 1,027+ Palestinians killed since it began. Hamas not disarming. International monitoring mission deployed."},{icon:"📦",label:"Humanitarian Access",text:"UN flash appeal $4B+ only 13% funded. 1.9M displaced. Hospital system collapsed. 80% of buildings damaged/destroyed."},{icon:"🏛️",label:"Quiet Annexation",text:"Israel advancing settlement activity in West Bank. West Bank: 1,081+ killed since Oct 2023, highest displacement since 1967."}].map((item,i,a)=><div key={i} style={{display:"flex",gap:10,padding:"11px 14px",borderBottom:i<a.length-1?`.5px solid ${t.sep}`:0}}><span style={{fontSize:20,flexShrink:0}}>{item.icon}</span><div><div style={{fontSize:13,fontWeight:700,color:t.text,marginBottom:3}}>{item.label}</div><div style={{fontSize:12,color:t.sub,lineHeight:1.55}}>{item.text}</div></div></div>)}</Card><EventsTimeline t={t} events={events} label="Timeline"/></div>;if(id==="sudan")return <div><ConflictOverviewCard conflict={conflict} t={t}/><ST t={t}>⚠️ RSF El-Obeid Siege — Jun 2026</ST><Card t={t} style={{borderLeft:"4px solid #ef4444"}}><div style={{padding:"12px 14px"}}>{[{icon:"🛸",text:"RSF conducting daily drone strikes since Jun 10 — eight SAF fuel depots destroyed, main power station knocked out"},{icon:"⚖️",text:"UN High Commissioner Türk: RSF around El-Obeid carries risk of serious international crimes"},{icon:"📍",text:"El-Obeid controls highway crossroads linking Khartoum, Darfur, Kordofan, and southern Sudan — strategic prize"}].map((item,i)=><div key={i} style={{display:"flex",gap:8,marginBottom:8,fontSize:12.5,color:t.sub,lineHeight:1.5}}><span style={{fontSize:16,flexShrink:0}}>{item.icon}</span>{item.text}</div>)}</div></Card><LossMetrics t={t} losses={losses}/><Grid2 t={t} items={[{val:"SAF vs RSF",label:"Armed conflict",color:"#ef4444"},{val:"16%",label:"$9B appeal funded",color:"#ef4444"},{val:"Famine",label:"Confirmed in areas",color:"#f97316"},{val:"36+",label:"Countries w/ refugees",color:"#eab308"}]}/><EventsTimeline t={t} events={events} label="Key Events"/></div>;if(id==="taiwan")return <div><ConflictOverviewCard conflict={conflict} t={t}/><ST t={t}>🌊 Simplified Theater Map</ST><div style={{borderRadius:12,overflow:"hidden",border:`1px solid ${t.border}`,marginBottom:12}}><svg viewBox="0 0 400 240" width="100%" style={{display:"block",background:t.isDark?"#060d1c":"#dae6f5"}}><rect width="400" height="240" fill={t.isDark?"#060d1c":"#c5d8ed"}/><path d="M0,0 L260,0 L260,180 L220,200 L160,220 L80,240 L0,240 Z" fill={t.isDark?"#0e1e35":"#b5c9e0"}/><ellipse cx="300" cy="120" rx="18" ry="38" fill={t.isDark?"#1a3a5c":"#6b99c9"} stroke="#60a5fa" strokeWidth="1.5"/><ellipse cx="340" cy="190" rx="10" ry="22" fill={t.isDark?"#0e1e35":"#b5c9e0"}/><ellipse cx="360" cy="70" rx="12" ry="8" fill={t.isDark?"#0e1e35":"#b5c9e0"}/><text x="320" y="140" fontSize="9" fill="rgba(148,163,184,0.6)" textAnchor="middle">South China Sea</text><text x="265" y="115" fontSize="7" fill="#60a5fa" textAnchor="middle">Taiwan</text><text x="265" y="124" fontSize="7" fill="#60a5fa" textAnchor="middle">Strait</text><line x1="260" y1="82" x2="282" y2="82" stroke="#ef4444" strokeWidth="1.5" strokeDasharray="4,2" opacity="0.6"/><line x1="260" y1="158" x2="282" y2="158" stroke="#ef4444" strokeWidth="1.5" strokeDasharray="4,2" opacity="0.6"/><circle cx="308" cy="175" r="5" fill="#f97316" opacity="0.8"/><text x="308" y="188" fontSize="7" fill="#f97316" textAnchor="middle">Scarborough</text><text x="300" y="123" fontSize="8" fill="#93c5fd" textAnchor="middle" fontWeight="bold">🇹🇼</text><rect x="5" y="220" width="390" height="16" fill="rgba(0,0,0,0.5)"/><line x1="10" y1="228" x2="25" y2="228" stroke="#ef4444" strokeWidth="1.5" strokeDasharray="4,2"/><text x="29" y="232" fontSize="7" fill="#94a3b8">PLA patrol boundary</text><circle cx="115" cy="228" r="3" fill="#f97316"/><text x="120" y="232" fontSize="7" fill="#94a3b8">Scarborough Shoal (disputed)</text></svg></div><ST t={t}>📡 Intelligence Signals</ST><Card t={t}>{[{icon:"⚡",label:"Current threat level: ELEVATED but stable",text:"PLA continues normalizing military pressure via frequent joint combat readiness patrols across the median line."},{icon:"🚢",label:"Scarborough Shoal floating structure (Jun 2026)",text:"Philippine aerial surveillance identified 6x6m floating platform with antenna inside Scarborough Shoal lagoon."},{icon:"💻",label:"Semiconductor stakes: $1T+ shock risk",text:"Taiwan produces ~90% of world most advanced chips (TSMC ≤3nm). Any conflict or blockade triggers estimated $1T+ global GDP shock."}].map((item,i,a)=><div key={i} style={{display:"flex",gap:10,padding:"11px 14px",borderBottom:i<a.length-1?`.5px solid ${t.sep}`:0}}><span style={{fontSize:20,flexShrink:0}}>{item.icon}</span><div><div style={{fontSize:13,fontWeight:700,color:t.text,marginBottom:3}}>{item.label}</div><div style={{fontSize:12,color:t.sub,lineHeight:1.55}}>{item.text}</div></div></div>)}</Card><EventsTimeline t={t} events={events} label="Key Events"/></div>;if(id==="southsudan")return <div><ConflictOverviewCard conflict={conflict} t={t}/><div style={{background:"rgba(220,38,38,0.1)",border:"1px solid rgba(220,38,38,.25)",borderRadius:8,padding:"10px 12px",fontSize:12,color:"rgba(255,255,255,.75)",lineHeight:1.6,marginBottom:12}}>⚠️ <strong style={{color:"#fca5a5"}}>Gen. Olony (filmed Jan 26, 2026):</strong> Spare no lives. When we arrive there, dont spare an elderly, dont spare a chicken, dont spare a house. ICG: South Sudan has returned to war.</div><ST t={t}>⚔️ Warring Factions</ST><Card t={t} style={{borderLeft:"4px solid #5b8ec8"}}><div style={{padding:"12px 14px"}}><div style={{fontSize:13,fontWeight:700,color:t.text,marginBottom:3}}>🇸🇸 SSPDF (Government)</div><div style={{fontSize:12,color:t.sub}}>Ethnic Dinka. Led by President Salva Kiir. Launched Operation Enduring Peace Jan 2026. Uganda providing military support and defending Juba.</div></div></Card><Card t={t} style={{borderLeft:"4px solid #ef4444"}}><div style={{padding:"12px 14px"}}><div style={{fontSize:13,fontWeight:700,color:t.text,marginBottom:3}}>SPLM-IO (Machars movement)</div><div style={{fontSize:12,color:t.sub}}>Ethnic Nuer. Leader Riek Machar under house arrest + treason charges. White Army fighting despite decapitated leadership.</div></div></Card><LossMetrics t={t} losses={losses}/><EventsTimeline t={t} events={events} label="War Timeline — 2025–2026"/></div>;if(id==="iran")return <div><ConflictOverviewCard conflict={conflict} t={t}/><Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}><div style={{fontSize:11,color:"rgba(255,255,255,.4)",textTransform:"uppercase",letterSpacing:".08em",marginBottom:10}}>⏳ Islamabad MoU — 60-Day Clock</div><Grid2 t={t} items={[{val:"Jun 17",label:"MoU signed",sub:"Versailles G7 dinner",color:"#8b5cf6"},{val:"~Aug 16",label:"Deadline",sub:"60-day window closes",color:"#ef4444"},{val:"IAEA",label:"Inspectors returning",sub:"Natanz, Fordow, Isfahan",color:"#22c55e"},{val:"Israel",label:"NOT party to deal",sub:"Lebanon ops continue",color:"#f97316"}]}/></Hero><ST t={t}>📡 Key Intelligence</ST><Card t={t}>{[{icon:"📜",label:"Islamabad Memorandum",text:"Signed Jun 17. Pakistan brokered; Qatar, Saudi Arabia, Turkey, Egypt facilitated. 60-day negotiation covers nuclear program, Hormuz shipping, sanctions, missiles, Lebanon."},{icon:"🚢",label:"Hormuz blockade lifted",text:"Trump announced lifting of US naval blockade Jun 14. IMO: ~20,000 seafarers on ~2,000 vessels freed."},{icon:"☢️",label:"Nuclear: IAEA inspectors returning",text:"MoU allows IAEA inspectors back into Iran. 60-day talks to address enrichment levels and HEU stockpiles."},{icon:"⚠️",label:"Key risks to deal",text:"Israel Lebanon operations could destabilise agreement. If talks fail, Trump said he could relaunch attacks. Iran missile programme is a red line for Tehran."}].map((item,i,a)=><div key={i} style={{display:"flex",gap:10,padding:"11px 14px",borderBottom:i<a.length-1?`.5px solid ${t.sep}`:0}}><span style={{fontSize:20,flexShrink:0}}>{item.icon}</span><div><div style={{fontSize:13,fontWeight:700,color:t.text,marginBottom:3}}>{item.label}</div><div style={{fontSize:12,color:t.sub,lineHeight:1.55}}>{item.text}</div></div></div>)}</Card><EventsTimeline t={t} events={events} label="Timeline"/></div>;return <div><ConflictOverviewCard conflict={conflict} t={t}/><Note t={t} color="#5b8ec8">Detailed section for {conflict.name} coming soon.</Note></div>;}

// ── Theaters Overview ──────────────────────────────────────────────────────────────
function TheatersOverview({t,conflicts,onSelectConflict}){const STATUS_ORDER={"ESCALATING":0,"NEW CIVIL WAR":0,"US INTERVENTION":0,"CO-BELLIGERENT":1,"FLASHPOINT":1,"Active":2,"MoU":3,"ELEVATED":4,"Fragile Ceasefire":5};const sorted=[...conflicts].sort((a,b)=>(STATUS_ORDER[a.status]??9)-(STATUS_ORDER[b.status]??9));const SECTION_MAP={"south-china-sea":"scs","taiwan":"scs","southsudan":"sudan"};return <div><div style={{fontSize:10,fontWeight:700,color:t.sub,textTransform:"uppercase",letterSpacing:".1em",marginBottom:14}}>🌍 {conflicts.length} Active Theaters — Tap to Deep Dive</div><div style={{display:t.isLandscape?"grid":"block",gridTemplateColumns:t.isLandscape?"1fr 1fr":undefined,gap:t.isLandscape?12:0}}>{sorted.map(c=>{const sectionId=SECTION_MAP[c.id]??c.id;return <button key={c.id} onClick={()=>onSelectConflict(sectionId)} style={{display:"block",width:"100%",background:t.card,borderTop:`1px solid ${t.border}`,borderRight:`1px solid ${t.border}`,borderBottom:`1px solid ${t.border}`,borderLeft:`4px solid ${c.statusColor}`,borderRadius:14,padding:"16px 18px",marginBottom:12,cursor:"pointer",fontFamily:FONT,textAlign:"left",animation:"fadeIn .2s ease-out"}}><div style={{display:"flex",alignItems:"flex-start",gap:12,marginBottom:10}}><span style={{fontSize:28,flexShrink:0,lineHeight:1}}>{c.icon}</span><div style={{flex:1,minWidth:0}}><div style={{fontSize:15,fontWeight:800,color:t.text,lineHeight:1.2,marginBottom:4}}>{c.name}</div><div style={{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}}><span style={{background:c.statusColor+"22",border:`1px solid ${c.statusColor}55`,borderRadius:20,padding:"2px 10px",fontSize:10,fontWeight:700,color:c.statusColor,textTransform:"uppercase"}}>{c.status}</span><span style={{fontSize:11,color:t.sub}}>{c.region}</span></div></div><span style={{fontSize:16,color:t.sub,flexShrink:0,marginTop:4}}>→</span></div><div style={{display:"flex",gap:20,marginBottom:10}}><div><div style={{fontSize:10,color:t.sub,marginBottom:1}}>Deaths</div><div style={{fontSize:13,fontWeight:700,color:c.statusColor}}>{c.deaths}</div></div><div><div style={{fontSize:10,color:t.sub,marginBottom:1}}>Displaced</div><div style={{fontSize:13,fontWeight:700,color:t.text}}>{c.displaced}</div></div>{c.warDay&&<div><div style={{fontSize:10,color:t.sub,marginBottom:1}}>War day</div><div style={{fontSize:13,fontWeight:700,color:t.text}}>{c.warDay}</div></div>}</div><div style={{fontSize:12,color:t.sub,lineHeight:1.55,background:t.isDark?"rgba(255,255,255,.03)":"rgba(0,0,0,.03)",borderRadius:8,padding:"9px 11px"}}>{c.summary}</div><div style={{marginTop:10,fontSize:11,color:"#5b8ec8",fontWeight:600}}>Open Deep Dive →</div></button>;})}</div></div>;}
...
function LiveAttentionStrip({t}){
  ...
  useEffect(()=>{
    ...
    const q=encodeURIComponent('(Ukraine OR Gaza OR Sudan OR "South China Sea" OR Venezuela OR Iran) (war OR conflict OR military OR strike)');
    const url=`https://api.gdeltproject.org/api/v2/doc/doc?query=${q}&mode=timelinevol&timespan=3m&format=json`;
    (async()=>{
      try{
        const res=await fetch(url,{signal:ctrl.signal});
        if(!res.ok)throw new Error("status "+res.status);
        const json=await res.json();
        const series=json&&json.timeline&&json.timeline[0]&&json.timeline[0].data;
        if(!Array.isArray(series)||!series.length)throw new Error("no data");
        const fmt=raw=>{if(typeof raw!=="string")return String(raw??"");const m=raw.match(/^(\d{4})(\d{2})(\d{2})/);return m?`${m[2]}/${m[3]}`:raw.slice(0,5);};
        const pts=series.map(d=>({date:fmt(d.date),v:typeof d.value==="number"?d.value:parseFloat(d.value)})).filter(p=>!isNaN(p.v));
        if(!pts.length)throw new Error("unparseable");
        if(!alive)return;
        setData(pts);
        setUpdated(new Date().toLocaleString([],{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}));
        setState("ok");
      }catch(e){if(alive)setState("error");}
      finally{clearTimeout(timer);}
    })();
    return()=>{alive=false;ctrl.abort();clearTimeout(timer);};
  },[attempt]);
  return <Card t={t} style={{padding:"12px 8px 8px",borderLeft:"4px solid #06b6d4"}}>
    <div style={{padding:"0 8px 6px",display:"flex",alignItems:"center",gap:6}}>
      <span style={{width:7,height:7,borderRadius:"50%",background:state==="ok"?"#22c55e":state==="error"?"#ef4444":"#eab308",display:"inline-block",animation:state==="loading"?"blink 1s ease-in-out infinite":"none",flexShrink:0}}/>
      <div style={{fontSize:12,fontWeight:700,color:t.text,flex:1}}>Global Conflict Media Attention</div>
      <span style={{fontSize:9,fontWeight:700,color:"#06b6d4",background:"rgba(6,182,212,0.12)",border:"1px solid rgba(6,182,212,0.3)",borderRadius:10,padding:"1px 7px",textTransform:"uppercase",letterSpacing:".05em"}}>Live · GDELT</span>
    </div>
    {state==="loading"&&<div style={{height:120,display:"flex",alignItems:"center",justifyContent:"center",color:t.sub,fontSize:12}}>Fetching live data…</div>}
    {state==="error"&&<div style={{height:120,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:8,color:t.sub,fontSize:11.5,textAlign:"center",padding:"0 16px"}}><span style={{fontSize:20}}>📡</span><span>Live feed unavailable right now. The curated trends below are unaffected.</span><button onClick={()=>setAttempt(a=>a+1)} style={{background:"rgba(6,182,212,0.12)",border:"1px solid rgba(6,182,212,0.35)",borderRadius:8,padding:"4px 12px",cursor:"pointer",color:"#06b6d4",fontSize:11,fontWeight:700,fontFamily:FONT}}>↻ Retry</button></div>}
    {state==="ok"&&<><div style={{height:120}}>
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={data} margin={{top:4,right:8,left:-18,bottom:0}}>
          <defs><linearGradient id="gdeltGrad" x1="0" y1="0" x2="0" y2="1"><stop offset="5%" stopColor="#06b6d4" stopOpacity={0.35}/><stop offset="95%" stopColor="#06b6d4" stopOpacity={0}/></linearGradient></defs>
          <XAxis dataKey="date" tick={{fontSize:8,fill:t.sub}} tickLine={false} axisLine={false} interval={Math.max(0,Math.floor(data.length/6))}/>
          <YAxis tick={{fontSize:8,fill:t.sub}} tickLine={false} axisLine={false} width={32} tickFormatter={v=>`${v.toFixed(1)}%`}/>
          <Tooltip contentStyle={{background:t.isDark?"#101d30":"#fff",border:`1px solid ${t.border}`,borderRadius:8,fontSize:12}} labelStyle={{color:t.sub}} formatter={v=>[`${Number(v).toFixed(3)}%`,"of coverage"]}/>
          <Area type="monotone" dataKey="v" stroke="#06b6d4" fill="url(#gdeltGrad)" strokeWidth={2}/>
        </AreaChart>
      </ResponsiveContainer>
    </div>
    <div style={{fontSize:11,color:t.sub,lineHeight:1.5,padding:"6px 8px 2px"}}>Share of all worldwide online news coverage (65 languages) mentioning the tracked conflicts, daily over ~90 days. Live from GDELT, updated {updated}. This measures <strong>media attention, not ground truth</strong> — spikes track what the press is covering, which is noisy and can lead or lag actual events.</div></>}
  </Card>;
}
...
function GazaSection({t}){
  ...
  const HUM_METRICS=[
    {icon:"☠️",label:"Total killed",val:"73,039+",color:"#ef4444",desc:"Since Oct 7, 2023. UN OCHA/Gaza MoH. Actual toll likely higher — morgue capacity overwhelmed, thousands missing under rubble."},
    ...
    {icon:"💀",label:"Post-ceasefire killed",val:"1,027+",color:"#f97316",desc:"Palestinians killed since Oct 10, 2025 ceasefire. Hamas not disarming. Fragile ceasefire with no enforcement mechanism."},
...
function BelarusSection({t}){
  ...
  return <div>
    ...
    <EventsTimeline t={t} events={BEL_EVENTS} label="Belarus Timeline"/>
  </div>;
}
...
function USMilSection({t}){
  ...
  const TABS=[{id:"compare",label:"⚖️ Power Comparison"},{id:"china",label:"🇨🇳 China Deep Dive"},{id:"systems",label:"🚀 Systems"},{id:"posture",label:"🌍 Posture"},{id:"nato",label:"🤝 NATO & Allies"},{id:"rankings",label:"🌐 Global Rankings"}];
  ...
  const GLOBAL_MIL_RANKINGS=[
    {rank:1,flag:"🇺🇸",name:"United States",personnel:"2.1M",aircraft:13000,navy:480,tanks:4640,budget:"$895B",nuclear:"5,200+",goal:"Sustain simultaneous global forward presence across every theater — 750+ overseas bases, 11 nuclear carriers, and the baseline every other entry on this list is measured against."},
    {rank:2,flag:"🇷🇺",name:"Russia",personnel:"3.5M",aircraft:4292,navy:598,tanks:5750,budget:"$126B",nuclear:"5,900+",goal:"Mass + attrition doctrine, now battle-tested in Ukraine; nuclear deterrence (world's largest stockpile) as the core strategic asset offsetting a shrinking conventional-tech edge."},
    {rank:3,flag:"🇨🇳",name:"China",personnel:"3.1M",aircraft:3309,navy:730,tanks:6800,budget:"$266B",nuclear:"350+",goal:"World's largest navy by hull count; rapid nuclear expansion (350+ and growing); Taiwan-contingency readiness and Indo-Pacific area-denial are the organizing strategic priorities — see China Deep Dive tab."},
    {rank:4,flag:"🇮🇳",name:"India",personnel:"5.1M",aircraft:2229,navy:295,tanks:4201,budget:"$75B",nuclear:"160+",goal:"World's largest active manpower; two-front deterrence posture (Pakistan + China); 'Make in India' self-reliance push and a growing blue-water navy to secure the Indian Ocean."},
...
const DW_MONTHLY = [
  ...
  { month:"Jun '26", yr:2026, ru:5940, ua:6600, ruRate:91, uaRate:18, civ:85,  inj:340, alert_h:8.1, pw_gwh:3.5,  ru_cost:208, ua_cost:160, adDrone:45, adSam:25, adMfg:22, adEw:8, c:true,  src:"Jun 1–22 partial data. Confirmed: Jun 2 mass attack (22 killed), Jun 18 Moscow refinery hit x2." },
];
    ...
    <div style={{ background:DWC.bg, color:DWC.text, fontFamily:FONT, borderRadius:12, padding:"14px 12px", marginTop:4 }}>
      <div style={{ marginBottom:16 }}>
        <div style={{ display:"flex", alignItems:"center", gap:10, flexWrap:"wrap" }}>
          ...
          <span style={{ background:"#1e3a5f", color:DWC.uaLt, borderRadius:4, padding:"2px 8px", fontSize:11, fontWeight:700 }}>RUSSIA-UKRAINE · UPDATED JUN 23 '26</span>
        </div>
      ...
      {tab==="overview" && <>
        <div style={{ display:"flex", gap:6, marginBottom:14, flexWrap:"wrap" }}>
          ...
          <span style={{ marginLeft:"auto", color:DWC.muted, fontSize:11, alignSelf:"center" }}>{dailySlice.length} days · Jun 23, 2026</span>
        </div>
      ...
      {tab==="strikelog" && <>
        ...
        <DWCard style={{ marginBottom:14 }}>
          <DWSectionHead color={DWC.ua} icon="📋" title="Ukrainian Deep-Strike Drone Log" sub="confirmed long-range strikes · May 8 – Jun 23, 2026"/>
