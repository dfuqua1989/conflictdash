...
const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,440,580",todayChange:"+1,590",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
  {id:2,category:"Tanks",total:"12,225",todayChange:"+8",color:"#f97316",icon:"🪖",description:"Main battle tanks"},
  {id:3,category:"Armoured Vehs",total:"25,032",todayChange:"+13",color:"#eab308",icon:"🚧",description:"APCs, IFVs, MRAPs"},
  {id:4,category:"Artillery",total:"46,831",todayChange:"+37",color:"#84cc16",icon:"💥",description:"Guns, howitzers, mortars"},
  {id:5,category:"MLRS",total:"1,969",todayChange:"+1",color:"#22c55e",icon:"🚀",description:"Multiple launch rockets"},
  {id:6,category:"Air Defence",total:"1,519",todayChange:"+1",color:"#06b6d4",icon:"🛡️",description:"SAM & SHORAD systems"},
  {id:7,category:"UAVs",total:"429,555",todayChange:"+1,269",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
...
const REPORT_NOW=new Date("2026-07-27T21:15:00Z");
  ...
  return <div>
    ...
    {tab==="timeline"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>From Operation Epic Fury (Feb 28) through the Islamabad MoU and the 20-day countdown to Aug 16.</div>
      </Hero>
  ...
  return <div>
    ...
    {tab==="escalation"&&<div>
      ...
      <Card t={t}><div style={{padding:"14px 16px"}}>
        ...
        <button onClick={()=>setEscExpanded(e=>!e)} aria-expanded={escExpanded} style={{width:"100%",display:"flex",alignItems:"center",justifyContent:"center",gap:6,background:"none",border:`1px solid ${t.border}`,borderRadius:8,padding:"7px 10px",cursor:"pointer",color:"#dc2626",fontSize:11,fontWeight:700,fontFamily:FONT,letterSpacing:".03em"}}>
