...
const IRAN_BRIEFING={summaryShort:"US, Iran and Oman are closing in on an interim deal to reopen Hormuz, with Washington targeting a Wednesday (Aug 5) announcement, per Axios sourcing — naval mines would be cleared from the strait’s median lane within 30 days, then used for inbound/outbound traffic under a permanent Oman-Iran arrangement negotiated separately. CENTCOM says the southern route is already ‘free and open.’ Bessent explicitly rejected Iranian tolls (‘I think it would be freedom of movement’), though AP sourcing describes emerging ‘service fees.’ Brent fell 5.3% Tuesday on the optimism, then ticked up 0.43% to $79.70 Wednesday. Core gaps — enrichment, missiles, formal governance — remain unresolved with roughly 11 days left on the nominal MoU clock (closes ~Aug 16). A prior near-deal collapsed three weeks ago when Iran resumed attacks, underscoring the pattern risk.",summary:"Diplomatic signals accelerated sharply Tuesday into Wednesday, marking the most concrete movement yet on a Hormuz resolution. Axios reported Tuesday night that the US, Iran and Oman are closing in on an interim agreement, with Washington aiming for a Wednesday announcement — citing two regional sources and a US official. Under the emerging framework, naval mines would be cleared from the strait’s median lane within 30 days; once cleared, that lane would carry inbound and outbound traffic under a permanent arrangement to be negotiated separately between Oman and Iran. Qatari, Pakistani and Saudi officials were also involved in the mediation alongside Oman, and recent days saw several calls between Trump envoy Steve Witkoff, Iranian FM Abbas Araghchi and Omani FM Badr al-Busaidi. The context matters: the White House, Oman and regional mediators thought they had a deal three weeks ago, only to see Iran resume attacks on shipping — leading to two weeks of fighting that nearly became an all-out war. That history is why Tuesday’s optimism comes with caveats. Secretary of State Rubio said there’s ‘progress but not finality’ on the agreement, adding ‘we’re hoping that will happen very shortly.’ Treasury Secretary Bessent went further on CNBC, saying ‘there is a chance we may have a deal today or tomorrow,’ and explicitly rejected the idea of Iranian tolls when asked: ‘I think it would be freedom of movement.’ That directly conflicts with AP reporting citing two regional officials, who describe ships entering the Gulf via an Iranian-controlled route and exiting via an Oman-controlled route, with ‘service fees’ charged for security and environmental costs — the same discrepancy between the US and regional accounts that has run through this negotiation for weeks. Rubio has previously and explicitly ruled out any deal giving Iran control over the strait, calling it a ‘very dangerous precedent.’ CENTCOM moved from words to a formal position Wednesday, stating the ‘southern route of the Strait of Hormuz remains free and open’ via Omani territorial waters. Shipping data underscores how thin the current traffic still is: Kpler recorded just nine confirmed Hormuz transits on Sunday Aug 2 — seven via the Iranian route, only two of them tankers, and two of the nine sanctioned or shadow-fleet vessels — with an unknown number more transiting with transponders off. Markets moved sharply on the diplomatic signals: Brent crude fell 5.3% Tuesday, then recovered slightly Wednesday, up 0.43% to $79.70/barrel; WTI followed a similar pattern, up 0.21% to $75.95 after a 5.7% Tuesday drop. US equities rallied on the news — the Dow rose roughly 800 points (1.5%) Tuesday. None of the underlying negotiating gaps — uranium enrichment, the missile program, IAEA access to bombed sites — have moved; this remains a shipping-only arrangement explicitly separate from the denuclearization track, which Rubio called ‘the ultimate deal.’ The nominal 60-day Islamabad MoU window, signed Jun 17, closes around Aug 16 — roughly 11 days out.",assessment:[{cat:"Diplomacy — Interim Deal Nears",text:"Axios (Aug 5): US, Iran and Oman closing in on an interim agreement, targeting a Wednesday announcement. Naval mines cleared from the median lane within 30 days, then used for inbound/outbound traffic under a permanent Oman-Iran arrangement to be negotiated separately. Witkoff-Araghchi-Busaidi calls in recent days; Qatar, Pakistan and Saudi Arabia also mediating."},{cat:"Diplomacy — Tolls Discrepancy",text:"Bessent explicitly rejected Iranian tolls (‘freedom of movement’), but AP sourcing citing two regional officials describes ‘service fees’ for security and environmental costs on the Iran-controlled inbound route — the same US-regional discrepancy that has recurred for weeks. Rubio has separately and explicitly ruled out Iran controlling the strait as a ‘dangerous precedent.’"},{cat:"Operational Status",text:"CENTCOM states the strait’s southern route via Omani waters is ‘free and open.’ Kpler recorded only nine confirmed transits on Sunday Aug 2 (seven via the Iranian route, two tankers), with an unknown volume of dark-transponder traffic — real flow remains far below the pre-war ~130/day average even amid the diplomatic optimism."},{cat:"Markets",text:"Brent fell 5.3% Tuesday on the diplomatic optimism (not a rise, as Monday’s escalation-driven spike had suggested it might), then ticked up 0.43% to $79.70 Wednesday; WTI fell 5.7% then rose 0.21% to $75.95. US equities rallied Tuesday — Dow +~800pts (1.5%), S&P +1.2%, Nasdaq +1.7%."},{cat:"Pattern Risk",text:"The White House, Oman and mediators believed they had a deal three weeks ago, only for Iran to resume attacks on shipping — triggering two weeks of fighting that nearly escalated to all-out war. That precedent is the central reason Tuesday-Wednesday’s optimism is being read cautiously despite its more concrete tenor than prior rounds."},{cat:"MoU Clock",text:"Enrichment rights, the missile program and formal Hormuz governance remain entirely unresolved — this deal, if finalized, covers only shipping. Roughly 11 days remain on the nominal 60-day MoU clock (window closes ~Aug 16)."},{cat:"Iran Domestic",text:"No confirmed public appearance by successor Supreme Leader Mojtaba Khamenei since his father’s Jul 9-10 burial — now nearly four weeks with no image, video or voice recording."}],watch:"Whether the Wednesday interim-deal target Axios reported actually lands, or joins the list of near-deals that collapsed under renewed Iranian attacks; whether the Bessent/AP discrepancy over tolls gets resolved before or after any announcement; and whether CENTCOM’s ‘free and open’ characterization is matched by a real increase in transit volume beyond the current single-digit daily count.",generatedAt:new Date().toISOString()};
...
const REPORT_NOW=new Date("2026-08-05T23:59:00Z");
