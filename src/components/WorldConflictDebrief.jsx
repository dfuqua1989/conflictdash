...
const NEWS=[
  {id:"b_ukraine_pm_koretsky_jul16",conflictId:"ukraine",severity:"major",icon:"🟠",headline:"Zelensky Nominates Serhiy Koretsky as Prime Minister; Deputy Air Force Commander Resigns Same Day",conflict:"Ukraine",conflictColor:"#5b8ec8",publishedAt:"Jul 16, 2026",bullets:["President Zelensky submitted a proposal to the Verkhovna Rada to appoint Serhiy Koretsky as Prime Minister, a domestic political shuffle landing in the war's fifth year","Separately, Deputy Commander of the Ukrainian Air Force Pavlo Yelizarov submitted his resignation, citing failures he associates with his tenure — coming as air defense capacity remains the dashboard's most-cited structural gap (PAC-3/Patriot shortage)","Defense Minister Mykhailo Fedorov also expressed regret over not having transferred all procurement processes to competitive tender during his tenure — a rare public acknowledgment of unfinished defense-procurement reform"],sources:["Interfax-Ukraine","General Staff Facebook briefing"],impact:"Leadership churn in both the government and the Air Force command lands at a moment when air defense performance is already the central vulnerability this dashboard tracks — worth watching whether it signals accountability for recent ballistic-intercept failures or is unrelated routine rotation",impactColor:"#f97316"},
...
const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,424,620",todayChange:"+1,340",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
  {id:2,category:"Tanks",total:"12,144",todayChange:"+3",color:"#f97316",icon:"🪖",description:"Main battle tanks"},
  {id:3,category:"Armoured Vehs",total:"24,940",todayChange:"+2",color:"#eab308",icon:"🚧",description:"APCs, IFVs, MRAPs"},
  {id:4,category:"Artillery",total:"46,019",todayChange:"+66",color:"#84cc16",icon:"💥",description:"Guns, howitzers, mortars"},
  ...
  {id:7,category:"UAVs",total:"411,005",todayChange:"+1,801",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
  ...
  {id:12,category:"Vehicles",total:"120,727",todayChange:"+420",color:"#a78bfa",icon:"🚛",description:"Trucks & logistics"},
  {id:13,category:"Ground Robots",total:"1,919",todayChange:"+12",color:"#f43f5e",icon:"🤖",description:"UGV platforms"},
...
const BRIEFING={summary:"Ukraine pushed total Russian losses to 1,424,620 (Jul 16 MoD report, +1,340 on the day) — Russian UAV losses now past 411,000. The deep-strike and naval campaigns keep widening: a Jul 13 drone hit the Salavat oil refinery 1,400km inside Russia, and USF commander Brovdi reported 20 more Russian vessels hit in the Black Sea overnight, on top of 105 Azov vessels struck since Jul 6 — Moscow's fuel crisis (diesel exports banned, Putin requesting Crimea subsidies) keeps deepening as a result. Air defense had its best night in two weeks on Jul 13-14 — 5 of 8 ballistic missiles intercepted, likely with Patriots — though NATO's Ankara pledges ($80B for 2026, a Patriot manufacturing license) remain months from real production, and the same week saw Zelensky nominate Serhiy Koretsky as PM the day Ukraine's Deputy Air Force Commander resigned over his own tenure's shortcomings. The bigger story of the week is Iran: a single Jul 12 strike has become a five-night US campaign now backed by a full naval blockade of Iran's coastline — a blockade-running tanker was disabled by Hellfire fire near Kharg Island, IRGC has threatened to halt all regional oil exports, and Brent is holding near $80. The Aug 16 MoU deadline reads now as a formality already overtaken by events on the ground. Elsewhere: Gaza's governance transition remains stalled — the Board of Peace and NCAG were named in January but still haven't established real authority on the ground — while Mexico's cartel-FTO campaign and Haiti's Aug 30 elections round out an increasingly active Western Hemisphere file.",signals:[{theater:"Ukraine",text:"2nd Kyiv mass strike in 5 days kills 21; zero ballistic intercepts; 1.42M RU losses"},{theater:"NATO",text:"Ankara concluded — $80B/2026 pledged, Patriot license granted; timeline now the watch item"},{theater:"Iran",text:"Fifth straight day of US strikes; first confirmed blockade-enforcement action — a tanker disabled by Hellfire fire near Kharg Island for running the blockade; IRGC restated its threat to halt all regional energy exports; Brent holding near $80"}],watch:"Whether the Belma strike is a one-off deterrent or the start of routine blockade-running interdictions — the first vessel disabled, not sunk, is itself a signal about the threshold; whether Trump's 'bridges and power plants next week' threat materializes once that week arrives; whether Iran's parliament passes its Hormuz-control bill; whether the PAC-3 deliveries Zelensky says are due 'in the coming days' actually arrive; whether Russia retaliates against Ukrainian fuel infrastructure as its own crisis deepens.",generatedAt:new Date().toISOString()};
const UKRAINE_BRIEFING={summary:"Russia's attrition math has become unsustainable even as its ground offensive grinds on. CSIS's July 1 assessment puts the Russia:Ukraine battlefield loss ratio at nearly 8:1 in H1 2026 — up from 2:1-3:1 for most of the war — credited largely to Ukraine's AI-enabled drone interdiction campaign. The MoD's Jul 16 report puts cumulative Russian losses at 1,424,620 (+1,340 on the day), with daily losses still running above 1,000 most days. That said, the war is not simply going well for Ukraine: Russia's stalled offensive still holds Pokrovsk at genuine encirclement risk, and the Patriot/PAC-3 shortage — worsened by the 2026 Iran war draining US stocks — remains the one gap Ukraine cannot close on its own.",assessment:[{cat:"Attrition",text:"~8:1 RU:UA loss ratio in H1 2026 (CSIS). Cumulative Russian losses reached 1,424,620 as of the Jul 16 MoD report. Artillery jumped 66 on the day to 46,019 — one of the largest single-day artillery figures this month. Russian UAV losses passed 411,000 (411,005). Separately, USF commander Brovdi reported 20 more Russian vessels hit in the Black Sea overnight Wednesday, extending the Azov/Black Sea naval campaign beyond its original theater."},{cat:"Territory",text:"Russian advance remains grinding — Pokrovsk is now the single hottest sector on the front, 268 combat clashes recorded there Jul 8 alone, alongside Huliaipole. Monthly gain estimates diverge sharply by source: DeepState puts Russia's net gain at ~31 sq mi for Jun 9-Jul 7, ISW at just ~6 sq mi — among the slowest rates of any war in the past century either way. Russia had a net territorial LOSS in Apr-May 2026 (~400 km²), its first monthly net loss since Aug 2024."},{cat:"Deep Strikes",text:"The campaign has escalated into economic coercion. Jul 6: the deepest strike of the war — FP-1 drones flew ~3,000km to hit the Omsk refinery, Russia's largest, first-ever strike on the plant, offline within 24 hours. Jul 9: Tver and Stavropol oil depots hit, more tankers ablaze in the Sea of Azov — the cumulative effect is a nationwide Russian fuel crisis, with Moscow banning diesel exports and Putin publicly requesting Crimea fuel subsidies. Crimea airpower also a sustained target: Saky airbase struck twice in a week (7 aircraft hit Jul 3). The campaign keeps widening in both range and scale: a Jul 13 strike hit the Salavat refinery in Bashkortostan, 1,400km inside Russia — one of the deepest of the war — while the naval front has grown past its original Azov footprint: 105 vessels struck in the Azov since Jul 6, plus another 20 hit in the Black Sea overnight per USF commander Brovdi."},{cat:"Air Defense",text:"The decisive materiel question of the war may have just moved. CSIS: Ukraine intercepted 14 of 54 Russian ballistic missiles in June, and none of the 23 that hit Kyiv on Jul 6 — but downed 5 of 8 on Jul 13-14, the first successful ballistic intercepts in nearly two weeks, likely drawing on the same Patriot stocks. At Ankara on Jul 8 Trump licensed Ukraine to manufacture Patriots itself; Zelensky said Jul 9 the licence is agreed politically with supplies due within days, but officials put real domestic production months-to-years out. Poland will co-produce and maintain PAC-3s under a new multilateral agreement and is transferring 5 missiles now; Ukraine's domestic 'Freyja' interceptor may draw eight European partners. Drone-side economics still favor Ukraine ($7.5k interceptor vs $35k Shahed)."},{cat:"Diplomacy",text:"Ankara concluded: $80B allied pledge for 2026, Patriot manufacturing license, and a notably warm Trump-Zelensky bilateral — Trump said Zelensky has 'done an amazing job.' Russia had already rejected the Turkish ceasefire push, so the negotiating track itself remains blocked. Czech President Pavel: Ukraine has roughly two months to resume talks before the window narrows."}],watch:"Two variables now: whether Pokrovsk holds — still the most consequential sector against an otherwise favorable attrition/territorial picture — and whether the Jul 8 Patriot-license announcement acquires an actual production timeline, since officials themselves put real output months to years out.",generatedAt:new Date().toISOString()};
  ...
  return <div>
    ...
    {tab==="timeline"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>From Operation Epic Fury (Feb 28) through the Islamabad MoU and the 30-day countdown to Aug 16.</div>
      </Hero>
    ...
    {tab==="gaps"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #ef4444"}}>
        <div style={{fontSize:11,color:"rgba(255,255,255,.4)",textTransform:"uppercase",letterSpacing:".08em",marginBottom:8}}>⚠️ Unresolved Gaps — 30 Days Remain</div>
...
function NuclearSection({t,initialTab}){
  ...
  const VECTORS=[
    ...
    {flag:"🇮🇷",name:"Iran — Nuclear Clock",status:"30 DAYS",color:"#8b5cf6",text:"Islamabad MoU 60-day window closes ~Aug 16. IAEA inspector access disputed. Enrichment red lines unresolved — Pezeshkian: 'we will never back down from the right to enrich uranium.'"},
...
function USMilSection({t,initialTab}){
  ...
  return <div>
    ...
    {tab==="nato"&&<div>
      <div style={{fontSize:10,fontWeight:700,color:t.sub,textTransform:"uppercase",letterSpacing:".1em",marginBottom:10,marginTop:20}}>🔗 Arms-Flow Map</div>
