...
const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,454,210",todayChange:"+1,330",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
  ...
  {id:4,category:"Artillery",total:"47,455",todayChange:"+59",color:"#84cc16",icon:"💥",description:"Guns, howitzers, mortars"},
  ...
  {id:7,category:"UAVs",total:"446,266",todayChange:"+1,811",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
...
const BRIEFING={summaryShort:"Russian losses hold at 1,454,210 (+1,330 on Aug 5) — unchanged, no newer report yet. Iran: the Hormuz framework advanced but a real disagreement hardened — Iran wants ships transiting Iranian waters on both inbound and outbound legs, not the split routes reported earlier, and the US won’t accept it. Iran’s own President Pezeshkian says contact with Khamenei is ‘very difficult,’ and a new report claims his only meeting with Khamenei was minutes in a dark car. Ukraine: North Korea is sending 100+ missiles to Russia per ISW; ex-ambassador Stefanishyna’s bail was set at $130,000; Russian strikes continued (train workers killed in Lozova, 101 drones/missiles overnight).",summary:"Russian combat losses held at 1,454,210 as of the Aug 6 General Staff report (+1,330 on Aug 5) — no newer figure has posted. On Iran, the Hormuz diplomatic track advanced in form but hardened in substance: Iran and Oman say the route’s coordinates are agreed and a joint statement is in final drafting, awaiting Khamenei’s sign-off, but Iran now wants commercial ships transiting Iranian territorial waters on both the inbound and outbound legs — not the split Iran/Oman routes reported earlier this week — which US officials say they won’t accept. Iran’s Parliament is separately drafting a bill to bar US- and Israel-linked vessels outright. Iran’s own leadership opacity deepened: President Pezeshkian told state TV that contact with Khamenei is currently ‘very difficult,’ and an Iran International exclusive reported his only meeting with a man presented as Khamenei was a few minutes in a dark car, unable to see him — contradicting Pezeshkian’s own earlier account of a lengthy, cordial meeting. In Ukraine, ISW reports North Korea is sending over 100 missiles to Russia, a notable expansion of the supply relationship. A Ukrainian court set $130,000 bail for ex-ambassador Olha Stefanishyna following her Aug 3 dismissal amid a corruption probe. Russian strikes continued overnight into Aug 6 — 101 drones and missiles launched, dozens getting through, including a strike that killed railroad workers at a train station in Lozova. Ukraine’s own deep-strike campaign continued in parallel, hitting Russian oil refineries over 1,300km away.",watch:"Whether Khamenei actually signs off on the Hormuz draft given the ‘both legs’ detail the US has signaled it won’t accept; whether the Pezeshkian/Khamenei access story develops into a broader legitimacy question for Iran’s leadership; and what the North Korea missile shipment signals about Russia’s munitions posture heading into autumn.",generatedAt:new Date().toISOString()};
const UKRAINE_BRIEFING={summaryShort:"Russian losses hold at 1,454,210 as of the Aug 6 General Staff report (+1,330 on Aug 5) — no newer figure posted yet. ISW reports North Korea is sending over 100 missiles to Russia. A Ukrainian court set $130,000 bail for ex-ambassador Olha Stefanishyna following her Aug 3 dismissal. Russian strikes continued overnight into Aug 6 — 101 drones/missiles launched, railroad workers killed in Lozova — while Ukraine’s own deep-strike campaign hit Russian refineries over 1,300km away.",summary:"Russian losses remain at 1,454,210 as of the Aug 6 General Staff report (+1,330 on Aug 5) — the next report has not posted yet as of this update. ISW is warning of a growing threat from North Korea, which is reportedly sending over 100 missiles to Russia — a notable deepening of the DPRK-Russia military supply relationship beyond the troop deployments already tracked. In the Stefanishyna story, a Ukrainian court set bail at $130,000 for the ex-ambassador to the US, who was dismissed by decree Aug 3 amid an anti-corruption investigation — the first concrete legal step in that case since her removal, though no successor to the Washington post has been named. Russian strikes continued overnight into Aug 6: 101 drones and missiles were launched, with dozens getting through Ukrainian air defenses, including a strike on a train station in Lozova that killed railroad workers. Ukraine’s own deep-strike campaign continued in parallel, hitting Russian oil refineries more than 1,300km inside Russian territory — among the longer-range strikes of the campaign. The UK announced fresh sanctions on Russia’s shadow fleet, and Ukraine’s domestically-developed FP-7 ballistic missile is reportedly nearing certification, with first use expected this fall, per Reuters.",assessment:[{cat:"Attrition",text:"Cumulative losses hold at 1,454,210 as of Aug 6 (+1,330 on Aug 5) — no newer General Staff report has posted yet. Losses remain within the sustained 1,100–1,500/day range."},{cat:"Supply Chain — North Korea",text:"ISW reports North Korea is sending over 100 missiles to Russia, a notable expansion beyond the troop-deployment relationship already tracked — raises questions about Russian missile stockpile replenishment ahead of autumn."},{cat:"Political — Stefanishyna Bail Set",text:"A Ukrainian court set $130,000 bail for ex-ambassador Olha Stefanishyna following her Aug 3 dismissal amid an anti-corruption probe — the first concrete legal development in the case. The Washington ambassadorship remains vacant, no successor named."},{cat:"Strikes — Continued Exchange",text:"Russia launched 101 drones/missiles overnight into Aug 6, with dozens penetrating air defenses, including a strike that killed railroad workers in Lozova. Ukraine’s parallel deep-strike campaign hit Russian refineries over 1,300km away."},{cat:"Weapons Program",text:"Ukraine’s domestically-developed FP-7 ballistic missile is nearing certification, with first operational use expected this fall, per Reuters — a notable indigenous capability development."},{cat:"Sanctions",text:"The UK announced fresh sanctions targeting Russia’s shadow fleet, continuing the multilateral pressure campaign on Russia’s sanctions-evasion shipping network."},{cat:"Covert War",text:"The Aug 1 Moscow restaurant bombing killing 3 and injuring 20+ remains unofficially linked, but not confirmed by either government, to Gen. Alexander Chayko, commander of Russia’s Aerospace Forces and a Bucha war-crimes suspect."},{cat:"Command",text:"Fedorov’s dismissal from the July reshuffle remains unresolved with no new defense minister confirmed. Zelensky replaced Commander-in-Chief Syrskyi with Mykhailo Drapatyi and General Staff chief Hnatov with Ihor Skybiuk in July."}],watch:"What the North Korea missile shipment signals about Russian stockpile pressure heading into autumn; how the Stefanishyna bail case develops and whether it implicates others; whether the FP-7’s fall debut holds to schedule; and who Zelensky names to the vacant Washington ambassadorship.",generatedAt:new Date().toISOString()};
const IRAN_BRIEFING={summaryShort:"Iran and Oman say the Hormuz route’s coordinates are agreed and a joint statement is in final drafting, awaiting Khamenei’s sign-off — but a key detail shifted: Iran now wants ships transiting Iranian waters on BOTH inbound and outbound legs, not the split Iran/Oman routes reported earlier, and US officials say they won’t accept an Iran-controlled arrangement. Iran’s Parliament is separately drafting a bill barring US/Israel-linked vessels outright. CENTCOM: 49 vessels redirected since mid-July, only 29 crossed this week. Regionally, Houthis wounded 11 in Saudi Arabia — worst toll in 4+ years — and Trump is denying reports of a US munitions shortage after reportedly confronting Hegseth over it. Domestically, Pezeshkian admits contact with Khamenei is ‘very difficult’; Iran International reports his only meeting with a man presented as Khamenei was minutes in a dark car, unable to see him.",summary:"The Hormuz diplomatic track advanced further this week but a substantive disagreement hardened rather than resolved. Iran’s FM spokesman Esmail Baghaei said the route’s geographic coordinates are agreed with Oman and a joint statement is in final drafting; Iranian and Omani negotiators told AP the finalized draft awaits Supreme Leader Khamenei’s personal sign-off. But Deputy FM Kazem Gharibabadi disclosed a key detail that shifts the picture from earlier reporting: commercial ships would transit Iranian territorial waters on both the inbound AND outbound legs — not the split Iran-controlled-inbound/Oman-controlled-outbound arrangement described earlier this week. US officials have said they will not accept any arrangement that leaves Iran in control of the strait, calling it a dangerous precedent. Iran continues to deny holding direct talks with Washington, insisting negotiations run solely through Oman. Separately, and outside the Oman talks entirely, Iran’s Parliament is drafting a bill to bar vessels linked to the US, Israel, and other ‘hostile’ states from the strait outright — a unilateral legislative track that could complicate any negotiated framework. On the ground, CENTCOM says its blockade has redirected 49 vessels since mid-July, with only 29 crossing the strait this week (8 on Tuesday alone, per Kpler) against a pre-war average of roughly 130/day. The regional picture darkened elsewhere: a Houthi attack wounded 11 people in southern Saudi Arabia, the kingdom’s worst toll in over four years of conflict, and Saudi officials say they’re bracing for coordinated attacks by Iraqi militias working with the Houthis. In Washington, Trump publicly denied reports of a critical US munitions shortage limiting military options against Iran, after the Washington Post reported he confronted Defense Secretary Hegseth at Camp David over not being properly informed of the shortfall; Trump says the US has ‘massive amounts’ of munitions and is ‘extremely happy’ with Hegseth. Iran’s own leadership opacity deepened this week: President Pezeshkian told state TV that interaction with Khamenei is currently ‘very difficult’ — his most direct public admission yet — and an Iran International exclusive reported that Pezeshkian’s only encounter with a man presented as the Supreme Leader was a few minutes in a dark, tinted-window car, during which Pezeshkian could not see him and later questioned whether the voice was really Khamenei’s. That directly contradicts Pezeshkian’s own May account of a ‘cordial’ two-and-a-half-hour meeting. Five months into his tenure, Khamenei remains unseen, unheard in his own voice, and unrecorded on video. None of the underlying substantive gaps — enrichment, missiles, formal Hormuz governance — have moved. The nominal 60-day Islamabad MoU window, signed Jun 17, closes around Aug 16 — roughly 9 days out.",assessment:[{cat:"Diplomacy — Framework Nearly Final",text:"Iran and Oman say the route’s coordinates are agreed and a joint statement is in final drafting, awaiting Khamenei’s sign-off — the most concrete stage the process has reached since the Jun 17 MoU collapsed."},{cat:"Diplomacy — Both Legs, Not Split Routes",text:"Gharibabadi disclosed ships would transit Iranian waters on both inbound and outbound legs — a shift from the split Iran/Oman routes reported earlier this week. US officials say they won’t accept an arrangement leaving Iran in control, calling it a dangerous precedent."},{cat:"Iran’s Unilateral Track",text:"Separate from the Oman talks, Iran’s Parliament is drafting a bill to bar US- and Israel-linked vessels from the strait outright — a legislative move that could complicate or override any negotiated framework."},{cat:"Blockade Operational Reality",text:"CENTCOM: 49 vessels redirected since mid-July; only 29 crossed the strait this week (8 Tuesday, per Kpler) against a ~130/day pre-war average — real traffic remains a fraction of normal regardless of diplomatic tenor."},{cat:"Regional Widening",text:"A Houthi attack wounded 11 in southern Saudi Arabia, the kingdom’s worst toll in 4+ years; Saudi officials brace for coordinated attacks by Iraqi militias working with the Houthis — the conflict keeps widening beyond the Hormuz shipping dispute."},{cat:"US Munitions Controversy",text:"Trump publicly denies reports of a critical US munitions shortage limiting Iran options, after reportedly confronting Hegseth at Camp David over not being informed of the shortfall. Trump: ‘massive amounts’ of munitions, ‘extremely happy’ with Hegseth."},{cat:"Iran Domestic — Leadership Opacity Deepens",text:"Pezeshkian says contact with Khamenei is ‘very difficult.’ Iran International: his only meeting with a man presented as Khamenei was minutes in a dark car, unable to see him — contradicting Pezeshkian’s own May account of a 2.5-hour ‘cordial’ meeting. Five months in, Khamenei remains unseen, unheard, unrecorded."},{cat:"MoU Clock",text:"Enrichment, the missile program, and formal Hormuz governance remain entirely unresolved by any shipping-route framework alone. Roughly 9 days remain on the nominal 60-day MoU clock (window closes ~Aug 16)."}],watch:"Whether Khamenei actually signs off on the finalized draft, and whether the ‘both legs through Iranian waters’ detail becomes a dealbreaker for Washington; whether Iran’s Parliament bill advances in parallel with or in place of the Oman framework; and whether the Pezeshkian/Khamenei access story develops into a broader succession or legitimacy crisis story.",generatedAt:new Date().toISOString()};
...
const REPORT_NOW=new Date("2026-08-07T02:56:00Z");
