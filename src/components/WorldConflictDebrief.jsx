  ...
  return <div>
    ...
    {tab==="overview"&&<div>
      ...
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <Grid2 t={t} items={[{val:"3 killed",label:"US troops, Jordan attack",sub:"Confirmed Jul 19 — first US combat deaths since March",color:"#dc2626"},{val:"~9 vs ~130",label:"Hormuz daily crossings",sub:"Jul 20 vs pre-war average",color:"#dc2626"},{val:"~$91/bbl",label:"Brent crude",sub:"Up from ~$69 in June",color:"#f97316"},{val:"27 days",label:"MoU clock (nominal)",sub:"Now overtaken by events on the ground",color:"#8b5cf6"}]}/>
      </Hero>
