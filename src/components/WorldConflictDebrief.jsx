...
const NEWS=[
  ...
  {id:"b_iran_war_pause_jul29",confidence:"Confirmed",conflictId:"iran",severity:"critical",icon:"🔴",headline:"Iran War Goes Quiet: No US Strikes for Five Straight Nights as Both Sides Call It a Pause, Not a Ceasefire",conflict:"Iran",conflictColor:"#8b5cf6",publishedAt:"Jul 29, 2026",bullets:["No US strike on Iranian territory has been announced through Jul 29, extending the gap to five consecutive nights \u2014 the longest pause since the campaign resumed Jul 7","Trump said Jul 27 that Iran requested the pause \u2018because we\u2019ve been hitting them very hard,\u2019 and that strikes resume if talks fail; Iran\u2019s Foreign Ministry denies any direct negotiations with the US beyond ongoing talks with Oman","Separately, a drone reportedly struck a US gas storage tanker at an Egyptian port \u2014 an unconfirmed but potentially significant geographic expansion of the conflict if verified. Brent crude reversed a 16% three-session slide, rising toward $88/barrel on the uncertainty"],sources:["CNN","Globalsecurity.org"],impact:"The clearest sign yet that the Iran war may be entering a genuine off-ramp rather than merely another tactical pause \u2014 though officials on both sides are explicitly avoiding the word \u2018ceasefire,\u2019 and the reported Egypt tanker incident could reverse the trend immediately",impactColor:"#dc2626"},
...
const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,443,450",todayChange:"+1,310",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
  {id:2,category:"Tanks",total:"12,227",todayChange:"+1",color:"#f97316",icon:"🪖",description:"Main battle tanks"},
  {id:3,category:"Armoured Vehs",total:"25,044",todayChange:"+6",color:"#eab308",icon:"🚧",description:"APCs, IFVs, MRAPs"},
  {id:4,category:"Artillery",total:"46,962",todayChange:"+60",color:"#84cc16",icon:"💥",description:"Guns, howitzers, mortars"},
  {id:5,category:"MLRS",total:"1,969",todayChange:"+1",color:"#22c55e",icon:"🚀",description:"Multiple launch rockets"},
  {id:6,category:"Air Defence",total:"1,521",todayChange:"+2",color:"#06b6d4",icon:"🛡️",description:"SAM & SHORAD systems"},
  {id:7,category:"UAVs",total:"432,778",todayChange:"+1,468",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
...
const BRIEFING={summaryShort:"Russian losses have reached 1,443,450 (+1,310) per the Jul 29 MoD report, as Zelensky met Trump at the White House Jul 28 to discuss Patriot licensing and diplomacy \u2014 hours before Ukraine struck Russia's Ryazan refinery, one of its largest. The Iran war has gone quiet: no US strikes on Iranian territory for five straight nights as both sides describe a fragile pause, not a ceasefire. Zelensky remains unable to resolve the Fedorov political crisis. Gaza, Taiwan Strait tensions, and the Americas file all remain active.",summary:"Ukraine: Russian losses have climbed to 1,443,450 as of the Jul 29 MoD report. Zelensky met Trump at the White House on Jul 28 \u2014 a meeting he called \u2018good,\u2019 covering Patriot production licenses and diplomacy \u2014 and hours later Ukraine struck Russia's Ryazan oil refinery (roughly 5% of national refining capacity) alongside a Wildberries logistics complex, extending a deep-strike run that also hit a classified Rosrezerv strategic fuel reserve in Udmurtia and an export terminal in Rostov Oblast this week. Domestically, the fallout from Defense Minister Fedorov's dismissal remains unresolved: Commander-in-Chief Syrskyi was also replaced, by Mykhailo Drapatyi, and protests continue into a third week with no new defense minister named. The US Senate has begun advancing the Graham Sanctioning Russia and Iran Act as a tribute vote following Senator Graham's death. Iran: the war has gone quiet rather than ended \u2014 no US strikes on Iranian territory for five consecutive nights as of Jul 29, the longest pause since the campaign resumed Jul 7. Trump says the pause is to give renewed peace talks \u2018space,\u2019 claiming Iran requested it; Tehran denies any direct negotiations beyond ongoing talks with Oman. Separately, a drone reportedly struck a US gas storage tanker at an Egyptian port \u2014 a still-developing story that would mark a new geographic expansion of the conflict if confirmed. Brent crude has pulled back from its highs but remains elevated on the uncertainty. Elsewhere: Gaza's post-ceasefire violence continues, including a strike that destroyed a mosque in Gaza City; Netanyahu met US Defense Secretary Hegseth in Washington the same day; China's Taiwan Strait and South China Sea grey-zone activity remains elevated; and Venezuela, Cuba, Mexico and Haiti keep the Western Hemisphere file active.",watch:"Whether the Iran pause becomes a real de-escalation or a prelude to resumed strikes; whether the reported drone strike on a US tanker in Egypt is confirmed and represents a geographic expansion of the war; and whether Ukraine's political crisis produces a confirmed new defense minister.",generatedAt:new Date().toISOString()};

const UKRAINE_BRIEFING={summaryShort:"Russia's attrition math keeps worsening \u2014 an ~8:1 loss ratio in H1 2026 per CSIS, with cumulative losses now at 1,443,450 \u2014 even as its ground offensive grinds on at Pokrovsk. Zelensky's Jul 28 White House meeting with Trump covered Patriot licensing and diplomacy, hours before Ukraine's deepest strike run yet hit Russia's Ryazan refinery and a classified strategic reserve depot 1,300km inside Russia. Air defense shows a partial rebound \u2014 71% ballistic intercept rate on Jul 25-26, the best since the mid-July shortage began \u2014 while Zelensky remains unable to resolve the Fedorov/Syrskyi political crisis. Full breakdown below.",summary:"Russia's attrition math has become unsustainable even as its ground offensive grinds on. CSIS's H1 2026 assessment puts the Russia:Ukraine battlefield loss ratio at nearly 8:1 \u2014 up from 2:1\u20133:1 for most of the war \u2014 credited largely to Ukraine's AI-enabled drone interdiction campaign. The MoD's Jul 29 report puts cumulative Russian losses at 1,443,450 (+1,310 on the day). Zelensky's Jul 28 White House meeting with Trump \u2014 covering Patriot production licenses and diplomacy \u2014 was followed hours later by Ukraine's deepest strike of this cycle, hitting the Ryazan refinery and a classified Udmurtia strategic reserve depot 1,300km inside Russia. The war isn't simply going well for Ukraine, though: Russia's offensive still holds Pokrovsk at genuine encirclement risk, Kyiv and other cities continue absorbing periodic missile barrages, and the Patriot/PAC-3 shortage \u2014 worsened by the Iran war draining US stocks \u2014 remains only partially eased even after a rare 71% ballistic intercept night on Jul 25-26.",assessment:[{cat:"Attrition",text:"~8:1 RU:UA loss ratio in H1 2026 (CSIS). Cumulative Russian losses reached 1,443,450 as of the Jul 29 MoD report (+1,310 on the day) \u2014 tanks to 12,227, artillery to 46,962; Russian UAV losses passed 432,000. Ukraine's naval/deep-strike interdiction campaign remains a sustained second front, regularly reaching Moscow region and 1,000+km inside Russia."},{cat:"Territory",text:"Russian advance remains grinding \u2014 Pokrovsk is the single hottest sector on the front, alongside Huliaipole. Monthly gain estimates diverge sharply by source (DeepState vs. ISW), among the slowest rates of any war in the past century either way. Russia had a net territorial loss in Apr-May 2026, its first monthly net loss since Aug 2024."},{cat:"Deep Strikes",text:"Ukraine's deepest strike run yet: the Ryazan oil refinery (~5% of Russian refining capacity) and a Wildberries logistics complex hit Jul 29, hours after Zelensky's White House meeting with Trump; a classified Rosrezerv strategic fuel reserve in Udmurtia (1,300km deep) and a Rostov Oblast export terminal both struck the same week, alongside Russian-flagged vessels carrying Iranian military cargo across the Caspian Sea. The cumulative effect remains a nationwide Russian fuel crisis severe enough to have forced a diesel export ban."},{cat:"Air Defense",text:"A rare bright spot: Ukraine downed 5 of 7 ballistic missiles on Jul 25-26 (71%), the best single-night rate since the mid-July PAC-3 shortage began, though two subsequent nights (Jul 27-28) saw drone-only barrages with no ballistic missiles fired at all \u2014 too short a run to call a durable fix. Trump's Jul 28 meeting with Zelensky again touched on Patriot production licensing, though real domestic output remains months-to-years out; Poland continues co-producing and transferring PAC-3s."},{cat:"Diplomacy",text:"Zelensky's Jul 28 White House meeting with Trump \u2014 called \u2018good\u2019 by Zelensky \u2014 covered Patriot licenses and diplomacy, following the Rubio-Lavrov Manila meeting as the second notable US-facing diplomatic contact this month. Putin is still reported to have dropped territorial-concession offers entirely, and the Kremlin continues to treat the Anchorage understandings as void; the Turkish ceasefire push remains rejected by Moscow."},{cat:"Political",text:"The Fedorov dismissal remains a full command shake-up with no resolution: Zelensky replaced Commander-in-Chief Syrskyi with Mykhailo Drapatyi and General Staff chief Andrii Hnatov with Ihor Skybiuk. Fedorov continues demanding reinstatement rather than accepting Zelensky's alternative offer; protests have now run for close to three weeks with no new defense minister named."}],watch:"Whether Pokrovsk holds \u2014 still the most consequential sector against an otherwise favorable attrition/territorial picture \u2014 and whether the Jul 25-26 ballistic-intercept rebound holds or was a one-off, given the Patriot/PAC-3 stockpile remains strained by the parallel Iran war.",generatedAt:new Date().toISOString()};
...
const REPORT_NOW=new Date("2026-07-30T00:36:00Z");
  ...
  return <div>
    ...
    {tab==="timeline"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>From Operation Epic Fury (Feb 28) through the Islamabad MoU and the 18-day countdown to Aug 16.</div>
      </Hero>
