...
const BRIEFING={summaryShort:"Russian losses reached 1,454,210 (+1,330 on Aug 5) per the General Staff, as a massive overnight Russian missile/drone attack hit the Kyiv region, killing at least 14-17 and wounding dozens — warehouses and logistics hubs, including Epicentr, Rozetka and Nova Poshta facilities, took the brunt. Iran: the Hormuz story moved further — Iran and Oman have finalized the geographic coordinates of a shipping route and a draft joint statement, now awaiting Supreme Leader Khamenei’s approval. But Iran says the deal won’t automatically reopen the strait without further US concessions, and a real sticking point has emerged: Iran wants fees of 5-7% of cargo value, Oman wants less, Washington wants zero. A Gulf official puts the odds of a Friday signing at 50:50. Gaza and Sudan remain unresolved from recent days.",summary:"Russian combat losses reached 1,454,210 as of the Aug 6 General Staff report (+1,330 on Aug 5), within the sustained 1,100–1,500/day range. Russia answered Ukraine’s ongoing drone campaign with a massive overnight missile and drone attack on the Kyiv region Aug 5, killing at least 14 people and wounding 27 by the initial regional count (RBC-Ukraine cites a higher citywide toll of 17 killed, 44 injured as fuller reporting came in) — warehouses, logistics hubs and civilian businesses took the brunt, including facilities linked to Epicentr, Rozetka, Fozzy Group and Nova Poshta. On Hormuz, the diplomatic track advanced further still: Iran’s Deputy FM Kazem Gharibabadi said Wednesday that Iran and Oman are close to finalizing a proposed framework, having already agreed on the geographic coordinates of a safe shipping route, with a joint statement in final review — but he was explicit that the agreement “would not automatically reopen the waterway,” and that the US must meet additional conditions first. AP sources say the finalized draft now awaits Supreme Leader Khamenei’s sign-off. The real sticking point, per Reuters, is fees: Iran has proposed charges equivalent to 5-7% of cargo value, Oman is pushing for a lower figure, and Washington continues to insist on zero fees and free navigation. A Gulf official familiar with the talks put the odds of Iran and Oman reaching agreement by Friday at roughly 50:50. Baghaei also said Iran and Oman have no plans to travel to Qatar or Pakistan for further talks — a notable walk-back from earlier reporting that had cast Pakistan as an increasingly visible mediator. Gaza’s disarmament framework remains stalled against Netanyahu’s hardened withdrawal line, and Sudan’s El-Obeid siege continues with 500,000 still trapped and no ceasefire agreed.",watch:"Whether Khamenei actually signs off on the Iran-Oman draft, and whether the 5-7% fee dispute gets resolved or simply left ambiguous in the final text; whether the Friday target holds; and whether Russia’s Aug 5 Kyiv strike marks an escalation in response to Ukraine’s deep-strike campaign or a one-off.",generatedAt:new Date().toISOString()};
const UKRAINE_BRIEFING={summaryShort:"Russian losses reached 1,454,210 as of the Aug 6 General Staff report (+1,330 on Aug 5). Russia answered with a massive overnight missile/drone attack on the Kyiv region, killing at least 14-17 and wounding dozens, hitting warehouses and logistics hubs including Epicentr, Rozetka and Nova Poshta facilities. Ambassador Stefanishyna’s Washington post remains vacant since her Aug 3 dismissal, with no successor named. NATO reports a 250% YoY increase in July eastern-border aircraft scrambles.",summary:"Russian losses continued in the sustained 1,100–1,500/day range: cumulative losses reached 1,454,210 as of the Aug 6 General Staff report (+1,330 on Aug 5), alongside 1,811 drones and 59 artillery systems destroyed that day. Russia answered Ukraine’s ongoing deep-strike campaign with a massive missile and drone attack on the Kyiv region overnight Aug 5, the worst in recent days — initial regional reporting cited 14 killed and 27 wounded, with RBC-Ukraine’s fuller citywide count reaching at least 17 killed and 44 injured as reporting continued. Warehouses, logistics hubs and civilian businesses bore the brunt, including facilities linked to Epicentr, Rozetka, Fozzy Group and Nova Poshta — a strike pattern that mirrors, in reverse, Ukraine’s own recent campaign against Russian logistics infrastructure like the Wildberries network. Ukraine’s ambassadorial vacancy in Washington continues: no successor has been named to replace Olha Stefanishyna, dismissed by decree Aug 3 amid an anti-corruption probe, even as Zelensky maintains Kyiv is in ‘daily contact’ with Trump’s team. Separately, NATO recorded a 250% year-over-year increase in eastern-border aircraft scrambles in July 2026 compared to July 2025, attributed to Russian military aircraft skirting Alliance airspace without filed flight plans — a hybrid-pressure indicator distinct from, but related to, the main front.",assessment:[{cat:"Attrition",text:"Cumulative losses reached 1,454,210 as of Aug 6 (+1,330 on Aug 5), within the sustained 1,100–1,500/day range. Equipment losses that day included 1,811 drones, 59 artillery systems, 4 tanks and 416 vehicles/fuel tankers."},{cat:"Strike — Kyiv Region Hit",text:"A massive Russian missile/drone attack overnight Aug 5 killed at least 14-17 people and wounded dozens across the Kyiv region, striking warehouses and logistics hubs including Epicentr, Rozetka, Fozzy Group and Nova Poshta facilities — among the worst single nights in recent weeks."},{cat:"Deep Strikes",text:"Ukraine’s drone campaign continues targeting Russian logistics and oil infrastructure, having damaged 17%+ of Wildberries’ logistics network in recent weeks. The Aug 5 Kyiv strike hit comparable civilian-logistics targets on the Ukrainian side, suggesting a tit-for-tat dynamic around commercial/logistics infrastructure on both sides."},{cat:"Hybrid Pressure",text:"NATO recorded a 250% year-over-year increase in eastern-border aircraft scrambles in July 2026, driven by Russian military aircraft skirting Alliance airspace without flight plans — a rising-pressure indicator on NATO’s eastern flank distinct from the main front."},{cat:"Political — Ambassador Vacancy Continues",text:"No successor has been named to the Washington ambassadorship since Zelensky dismissed Olha Stefanishyna by decree Aug 3 amid an anti-corruption probe. The vacancy persists even as Zelensky says Kyiv is in ‘daily contact’ with Trump’s team."},{cat:"Covert War",text:"The Aug 1 Moscow restaurant bombing killing 3 and injuring 20+ remains unofficially linked, but not confirmed by either government, to Gen. Alexander Chayko, commander of Russia’s Aerospace Forces and a Bucha war-crimes suspect."},{cat:"Command",text:"Fedorov’s dismissal from the July reshuffle remains unresolved with no new defense minister confirmed. Zelensky replaced Commander-in-Chief Syrskyi with Mykhailo Drapatyi and General Staff chief Hnatov with Ihor Skybiuk in July."}],watch:"Whether the Aug 5 Kyiv strike represents an escalation pattern or a one-off; who Zelensky names to the vacant Washington ambassadorship; and whether the rise in NATO eastern-border scrambles continues into August.",generatedAt:new Date().toISOString()};
const IRAN_BRIEFING={summaryShort:"Iran and Oman have finalized the geographic coordinates of a Hormuz shipping route and a draft joint statement, now awaiting Supreme Leader Khamenei’s approval — the furthest the diplomatic track has advanced since the Jun 17 MoU collapsed. But Iran’s Deputy FM says the deal ‘would not automatically reopen the waterway’ without further US concessions. The real sticking point: Iran wants fees of 5-7% of cargo value, Oman wants less, Washington wants zero. A Gulf official puts Friday-signing odds at 50:50. Roughly 10 days left on the nominal MoU clock (closes ~Aug 16).",summary:"The Hormuz diplomatic track reached its most concrete point yet on Wednesday, though real disagreement remains just beneath the surface. Iran’s Foreign Ministry said the geographic coordinates of a proposed shipping route through the strait have been agreed with Oman, and a joint statement is in final review and drafting. AP sources describe the underlying draft as finalized and now awaiting a final sign-off from Supreme Leader Ayatollah Mojtaba Khamenei. Iranian Deputy FM Kazem Gharibabadi was explicit in a Wednesday interview, however, that even a finalized Iran-Oman framework ‘would not automatically reopen the waterway’ — Iran maintains the US must meet additional conditions before vessels can transit freely, and it remains unclear how any of this interacts with the nominally still-active June US-Iran MoU, whose Article 5 only committed Iran to ‘best efforts’ on safe passage rather than a firm guarantee. The dispute that had been described only vaguely as ‘service fees’ now has real numbers attached: Reuters reports Iran has proposed charges equivalent to 5-7% of cargo value, Oman is pushing for a lower rate, and Washington continues to insist on zero fees and free, unrestricted navigation — a gap wide enough that a senior Gulf official familiar with the talks put the odds of Iran and Oman actually reaching agreement by Friday at roughly 50:50. Baghaei added that Iran and Oman have no current plans to travel to Qatar or Pakistan for further talks, a detail that cuts against earlier reporting this week casting Pakistan as an increasingly visible mediator. Underlying questions remain unresolved regardless of what any joint statement says: whether Iran’s Revolutionary Guards accept reduced operational control over the strait, whether any reopening extends to US naval vessels, and how much cargo/destination information Iran will demand from transiting ships. Trump continued to signal optimism publicly — ‘it could happen, tomorrow or the next day... a lot of progress has been made’ — while VP Vance separately acknowledged the process can look repetitive from the outside. Markets have responded to the rhetoric more than to any signed text: oil prices have gyrated with each fresh round of optimism this week. Separately, a vessel sank after an attack in the Bab el-Mandeb Strait (Red Sea), a reminder that Houthi threats to a second Gulf-region waterway remain live even as attention concentrates on Hormuz.",assessment:[{cat:"Diplomacy — Draft Finalized, Awaiting Khamenei",text:"Iran and Oman have agreed on the geographic coordinates of a shipping route; AP sources say the underlying draft is finalized and awaits Supreme Leader Khamenei’s sign-off. This is the most concrete stage the process has reached since the Jun 17 MoU collapsed."},{cat:"Diplomacy — Not Automatic",text:"Iran’s Deputy FM Gharibabadi was explicit that an Iran-Oman agreement ‘would not automatically reopen the waterway’ — Iran says the US must meet further conditions first. How this interacts with the technically-still-active June MoU (Article 5’s vague ‘best efforts’ language) remains unclear."},{cat:"The Real Sticking Point — Fees",text:"Reuters: Iran has proposed fees equivalent to 5-7% of cargo value; Oman wants a lower rate; Washington wants zero and insists on free, unrestricted navigation. This is now a concrete, quantified gap rather than a vague ‘tolls’ dispute — a senior Gulf official puts the odds of a Friday signing at roughly 50:50."},{cat:"Mediators — Walk-Back",text:"Baghaei says Iran and Oman have no plans to travel to Qatar or Pakistan for further talks, cutting against earlier reporting this week that had cast Pakistan as an increasingly visible mediator alongside Oman."},{cat:"Unresolved Regardless of Text",text:"Whether the IRGC accepts reduced operational control over the strait; whether any reopening extends to US naval vessels; how much cargo/destination information Iran will demand — none of these are settled by an Iran-Oman route agreement alone."},{cat:"Pattern Risk",text:"Mediators believed they had a deal in mid-July, only for Iran to resume attacks on shipping, triggering two weeks of fighting that nearly escalated to all-out war. This week’s more concrete-sounding language (finalized coordinates, awaiting Khamenei) is still being read with real caution given that history."},{cat:"MoU Clock",text:"Enrichment rights, the missile program and formal Hormuz governance remain entirely separate from and unresolved by any shipping-route deal. Roughly 10 days remain on the nominal 60-day MoU clock (window closes ~Aug 16)."},{cat:"Iran Domestic",text:"No confirmed public appearance by successor Supreme Leader Mojtaba Khamenei since his father’s Jul 9-10 burial — now nearly four weeks with no image, video or voice recording, even as he is now reportedly the final approval authority on the Hormuz draft."}],watch:"Whether Khamenei actually signs off on the finalized draft, and on what timeline; whether the 5-7% vs. zero-fee gap gets bridged or left deliberately ambiguous in the final joint statement; whether the Gulf official’s Friday target holds; and what, if anything, the US formally requires beyond the Iran-Oman route agreement before it considers Hormuz reopened.",generatedAt:new Date().toISOString()};
...
const REPORT_NOW=new Date("2026-08-06T17:29:00Z");
