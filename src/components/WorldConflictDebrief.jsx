...
const CONFLICTS=[
  {id:"ukraine",name:"Ukraine War",region:"Eastern Europe",status:"Active",statusColor:"#ef4444",icon:"🇺🇦",deaths:"~500K–700K killed",displaced:"11.8M total",get summary(){return `War Day ${getWarDay()}. 1.437M+ Russian casualties. Putin publicly admitted fuel shortages at United Russia congress Jun 28 — first time. Rejected all diplomatic solutions. Russia launched 142 drones + 2 Zircon + 6 Iskander overnight. NATO Ankara concluded: $80B/yr pledged, Patriot co-production greenlit.`;},get warDay(){return getWarDay();}},
...
const NEWS=[
  ...
  {id:"b_taiwan_okinotori_jul24",conflictId:"south-china-sea",severity:"major",icon:"🟠",headline:"China Holds Taiwan Strait Live-Fire Drills, Then Fires Near Japan's Okinotori for the First Time",conflict:"South China Sea",conflictColor:"#eab308",publishedAt:"Jul 24, 2026",bullets:["China's military ran a two-day live-fire exercise in the Taiwan Strait (Jul 22-23) following increased incursions near Taiwan's waters and airspace, per Taiwan's defense ministry","Beijing then conducted live-fire drills near Japan's Okinotori for the first time, directly disputing Japan's claimed EEZ around the reef; the PRC argues Okinotori isn't a natural island and that Japan's EEZ claim there violates international law","The exercises follow joint PRC-Russian aerial drills that encroached into South Korea's air defense identification zone and the Jul 6-13 Joint Sea-2026 exercise off Qingdao — AEI assesses the drills may be building PLA-Russian interoperability relevant to a future Taiwan scenario. Wang Yi and Rubio met on the ASEAN sidelines Jul 22, with both sides stressing continued communication despite the tension"],sources:["TaiwanPlus","AEI"],impact:"A rare first-time live-fire challenge to Japan's EEZ claim, layered on top of already-elevated Taiwan Strait activity — expands the friction map beyond the usual median-line incursions right as regional diplomats are gathered in Manila",impactColor:"#f97316"},
];

const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,437,550",todayChange:"+1,450",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
  {id:2,category:"Tanks",total:"12,208",todayChange:"+7",color:"#f97316",icon:"🪖",description:"Main battle tanks"},
  {id:3,category:"Armoured Vehs",total:"25,011",todayChange:"+11",color:"#eab308",icon:"🚧",description:"APCs, IFVs, MRAPs"},
  {id:4,category:"Artillery",total:"46,724",todayChange:"+78",color:"#84cc16",icon:"💥",description:"Guns, howitzers, mortars"},
  {id:5,category:"MLRS",total:"1,968",todayChange:"—",color:"#22c55e",icon:"🚀",description:"Multiple launch rockets"},
  {id:6,category:"Air Defence",total:"1,518",todayChange:"+2",color:"#06b6d4",icon:"🛡️",description:"SAM & SHORAD systems"},
  {id:7,category:"UAVs",total:"426,836",todayChange:"+1,596",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
  ...
  {id:10,category:"Cruise Missiles",total:"4,943",todayChange:"+5",color:"#14b8a6",icon:"🎯",description:"Destroyed in flight"},
  {id:11,category:"Ships/Boats",total:"34",todayChange:"—",color:"#64748b",icon:"⛵",description:"Naval vessels"},
  {id:12,category:"Vehicles",total:"125,358",todayChange:"+571",color:"#a78bfa",icon:"🚛",description:"Trucks & logistics"},
  {id:13,category:"Ground Robots",total:"2,023",todayChange:"+17",color:"#f43f5e",icon:"🤖",description:"UGV platforms"},
  {id:14,category:"Special Equip",total:"4,462",todayChange:"+8",color:"#fb923c",icon:"🔧",description:"Engineering & EW"},
],gaza:[
...
const REPORT_NOW=new Date("2026-07-25T19:15:00Z");
  ...
  return <div>
    ...
    {tab==="timeline"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>From Operation Epic Fury (Feb 28) through the Islamabad MoU and the 22-day countdown to Aug 16.</div>
      </Hero>
...
function NuclearSection({t,initialTab}){
  ...
  const VECTORS=[
    ...
    {flag:"🇮🇷",name:"Iran — Nuclear Clock",status:"22 DAYS",color:"#8b5cf6",text:"Islamabad MoU 60-day window closes ~Aug 16. IAEA inspector access disputed. Enrichment red lines unresolved — Pezeshkian: 'we will never back down from the right to enrich uranium.'"},
...
const FAQ_ITEMS=[
  {q:"How often is this updated?",a:"Once daily, at 8:00 PM EST."},
  ...
  return <div onClick={onClose} style={{position:"fixed",inset:0,zIndex:950,background:"rgba(0,0,0,0.55)",display:"flex",alignItems:"flex-end",justifyContent:"center",animation:"fadeIn .18s ease-out"}}>
    <div onClick={e=>e.stopPropagation()} style={{background:t.card,width:"100%",maxWidth:480,borderRadius:"16px 16px 0 0",border:`1px solid ${t.border}`,borderBottom:"none",padding:"18px 18px 26px",fontFamily:FONT,color:t.text,maxHeight:"78vh",overflowY:"auto"}}>
      ...
      <div style={{marginTop:16,paddingTop:12,borderTop:`1px solid ${t.sep}`,fontSize:10,color:t.sub,letterSpacing:".03em",textAlign:"center"}}>
        Unclassified · OSINT · Updated daily 8:00 PM EST · @fuquad08
      </div>
    </div>
  </div>;
}
