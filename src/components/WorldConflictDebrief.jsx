...
const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,450,510",todayChange:"+1,390",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
...
const BRIEFING={summaryShort:"A bomb killed 3 at a Moscow restaurant Aug 1 in what multiple sources say was an assassination attempt on Gen. Alexander Chayko, commander of Russia's Aerospace Forces and a Bucha war-crimes suspect — the most senior Russian military figure targeted since the invasion began. Russian losses reached 1,450,510+ (+1,390 on Aug 3) per the General Staff. Iran: Trump called off a threatened major strike Aug 1 after Gulf-state appeals and voiced optimism Aug 2 that a Hormuz deal was close, then reversed Monday, branding Tehran 'unbelievably duplicitous' after Iran denied direct US talks were happening — Iran says it's negotiating only with Oman over a shipping route, not reopening the strait. CBS reports no new US-Iran talks are actually planned despite Trump's claims. Gaza's Jul 31 disarmament announcement remains unimplemented; Ukraine's Fedorov crisis remains unresolved.",summary:"A bomb ripped through Moscow's Balzi Rossi restaurant on the evening of Aug 1, delivered by a female courier who died in the blast along with a security guard who'd refused her entry and a third victim — Russia's National Anti-Terrorism Committee puts the toll at 3 dead, 20+ injured. Multiple Russian and Ukrainian outlets, and a source who spoke to the Kyiv Independent, say the target was Gen. Alexander Chayko, appointed commander of Russia's Aerospace Forces in May 2026 and wanted in Ukraine for war crimes tied to the 2022 occupation of Bucha — he was reportedly celebrating his 55th birthday at the restaurant. If confirmed as targeted, it's the most senior Russian military figure targeted for assassination since the full-scale invasion began, and follows a similar late-July attempt on a Ukrainian brigade commander in Kharkiv by a recruit of Russian intelligence. Russian losses reached roughly 1,450,510 (+1,390) per the Aug 3 General Staff report, continuing a steady climb. Iran has whipsawed over the past 48 hours: Trump called off a threatened major strike on Iranian energy infrastructure Aug 1 after appeals from Gulf allies, then told reporters Sunday a Hormuz deal was close and a nuclear deal would follow. That optimism reversed Monday morning when Iran's Foreign Ministry publicly denied Trump's claim that direct US-Iran talks were set to resume, saying its only active discussions are with Oman over a temporary safe shipping route — not a reopening of the strait itself. Trump responded by calling Iran's leadership 'unbelievably duplicitous' on Truth Social, insisted negotiations were happening 'whether Iran wants to admit it or not,' called it Iran's 'last chance' before 'decapitation,' and claimed Hormuz would reopen to traffic Tuesday — though CBS reports US officials say no new negotiations are actually scheduled. A cargo vessel was separately struck by an unidentified projectile near Oman early Tuesday. Gaza's Jul 31 Board of Peace disarmament framework remains unimplemented. Elsewhere: Ukraine's Fedorov/Syrskyi political crisis remains unresolved.",watch:"Whether Russian authorities confirm or deny Chayko was the target, and how Moscow responds to a security failure this senior; whether Trump's Tuesday Hormuz-reopening claim materializes or proves to be another false start in a months-long pattern of announced-then-reversed Iran de-escalation; and whether the Oman-mediated shipping talks produce an actual route agreement.",generatedAt:new Date().toISOString()};
const UKRAINE_BRIEFING={summaryShort:"A bomb killed 3 at a Moscow restaurant Aug 1 in what multiple sources describe as an assassination attempt on Gen. Alexander Chayko, Russia's Aerospace Forces commander and a Bucha war-crimes suspect — the most senior Russian officer targeted since the invasion began. Russian losses reached roughly 1,450,510 (+1,390) as of the Aug 3 General Staff report, continuing the steady post-record-July climb. The Engels-2/Saratov deep-strike campaign and the Patriot-licensing walkback both remain live threads. Fedorov/Syrskyi crisis remains unresolved.",summary:"The Moscow bombing is the week's most striking development. A bomb delivered by a female courier detonated at the Balzi Rossi restaurant on the evening of Aug 1, killing her, a security guard who'd refused her entry, and a third victim, with 20+ injured, per Russia's National Anti-Terrorism Committee. Multiple Russian and Ukrainian outlets, and a source who spoke to the Kyiv Independent, say the actual target was Gen. Alexander Chayko — appointed commander of Russia's Aerospace Forces in May 2026, wanted in Ukraine for war crimes tied to his command of forces that occupied Bucha in 2022, and reportedly marking his 55th birthday at the restaurant when the bomb went off. Neither Russian authorities nor Ukraine has confirmed it as a targeted operation, but if it was, it's the most senior Russian military figure targeted for assassination since the war began, and follows a similar late-July attempt on a Ukrainian brigade commander in Kharkiv by a man recruited by Russian intelligence posing as the SBU — pointing to an intensifying shadow war running alongside the front line on both sides. Meanwhile, Russia's own attrition continues climbing steadily: cumulative losses reached roughly 1,450,510 as of Aug 3 (+1,390 on the day), keeping pace after July's record 42,860-personnel month. The Engels-2 strategic bomber base and Saratov refinery strikes from Aug 1-2 remain the deep-strike campaign's most significant recent escalation, and a separate Aug 3 strike reportedly hit a Wildberries logistics center in Vladimir Oblast, continuing the pattern of economic-target strikes deep inside Russia. The Jul 31 Patriot-licensing walkback continues to draw commentary as the real story behind the Aug 1 Kyiv ballistic-intercept shortage.",assessment:[{cat:"Covert War",text:"The Aug 1 Moscow restaurant bombing that killed 3 and injured 20+ is widely reported, though not officially confirmed, to have targeted Gen. Alexander Chayko, commander of Russia's Aerospace Forces and a Bucha war-crimes suspect — the most senior Russian military figure targeted since the invasion began if confirmed. Follows a late-July attempt on a Ukrainian brigade commander in Kharkiv via a Russian-recruited asset posing as the SBU. Neither side has claimed responsibility for either incident."},{cat:"Attrition",text:"Cumulative Russian losses reached roughly 1,450,510 as of the Aug 3 General Staff report (+1,390 on the day) — a steady continuation of the post-record-July pace (42,860 in July, the worst month of 2026). Artillery (47,276, +80) and UAV losses (440,948+) both climbed sharply again."},{cat:"Territory",text:"Russian advance remains grinding — Pokrovsk is the single hottest sector on the front, alongside Huliaipole. Monthly gain estimates diverge sharply by source (DeepState vs. ISW), among the slowest rates of any war in the past century either way."},{cat:"Deep Strikes",text:"The Aug 1-2 strikes on the Engels-2 strategic bomber base and Saratov refinery — both over 600km from the front line and personally confirmed by Zelensky — remain the campaign's most significant recent escalation. A separate Aug 3 strike reportedly hit a Wildberries logistics center in Vladimir Oblast, continuing the pattern of economic-target strikes deep inside Russia."},{cat:"Air Defense",text:"The Aug 1 Kyiv attack (1 of 27 ballistic missiles intercepted) continues to drive commentary about the Jul 31 Patriot-licensing walkback. Ukrainian analysts argue the refusal 'changes almost nothing' in practice, since domestic PAC-3 production was always a multi-year proposition."},{cat:"Political",text:"Fedorov's dismissal remains a full command shake-up with no resolution: Zelensky replaced Commander-in-Chief Syrskyi with Mykhailo Drapatyi and General Staff chief Andrii Hnatov with Ihor Skybiuk. Separately, Rustem Umerov — a close Zelensky ally and former defense minister — was appointed to head Ukraine's Foreign Intelligence Service while retaining his role coordinating peace talks and the drone-deal initiative."}],watch:"Whether Russian authorities confirm or deny Chayko was the target of the Moscow bombing, and how the Kremlin responds to a security failure at this level; whether Russia retaliates specifically against the Engels-2 strike; and whether Pokrovsk holds against an otherwise favorable attrition picture.",generatedAt:new Date().toISOString()};
const IRAN_BRIEFING={summaryShort:"Trump called off a threatened major strike on Iranian energy infrastructure Aug 1 after Gulf-state appeals and voiced optimism Aug 2 that a Hormuz deal was close. That reversed Monday when Iran's Foreign Ministry publicly denied direct US-Iran talks were resuming, saying it's negotiating only with Oman over a temporary shipping route — not reopening the strait. Trump branded Tehran 'unbelievably duplicitous' and claimed Hormuz would reopen Tuesday, but CBS reports US officials say no new talks are actually scheduled. A vessel was struck by an unidentified projectile near Oman early Tuesday. Core gaps — enrichment, missiles, Hormuz governance — remain unbridged with roughly 12 days left on the nominal MoU clock.",summary:"Iran policy has whipsawed hard over the past 48 hours. Trump paused the threatened strikes on Iranian energy infrastructure Aug 1 after appeals from Gulf allies, then told reporters aboard Air Force One Sunday evening that 'there's a deal on Hormuz and then there will be a deal on the nuclear,' suggesting talks were about to resume. That confidence reversed by Monday morning: Iranian Foreign Ministry spokesman Esmaeil Baqaei publicly denied any direct US-Iran negotiations, saying Tehran's only active discussions are with Oman over a new shipping route through the strait that would 'respect the sovereign rights of both sides' — explicitly not a reopening of Hormuz to unrestricted traffic. Trump responded with a lengthy Truth Social post calling Iran's leadership 'unbelievably duplicitous,' saying they 'ask for a meeting, some would say beg' and then publicly deny talks are happening; he added the strait is 'already completely controlled by the United States Navy' and that nothing changes 'unless a Deal, or Total Surrender, is accomplished.' Separately Monday, Trump called this Iran's 'last chance' before 'decapitation' and claimed Hormuz would be open to marine traffic by Tuesday — but CBS News reports US officials say no new negotiations are actually planned despite the president's public claims. Underscoring the gap between rhetoric and reality on the ground, a cargo vessel was struck by an unidentified projectile near Oman early Tuesday, and oil prices fell roughly 4% on renewed diplomacy hopes even as the substance of any deal remains unclear. Iran's Foreign Minister Araghchi held calls with his Saudi and Pakistani counterparts over the weekend on the broader diplomatic track. None of the core negotiating gaps — uranium enrichment, the missile program, Hormuz shipping governance, IAEA access to bombed sites — have visibly moved. The nominal 60-day Islamabad MoU window, signed Jun 17, closes around Aug 16 — roughly 12 days out.",assessment:[{cat:"Military",text:"Trump called off a threatened major strike on Iranian energy infrastructure Aug 1 after Gulf-state appeals, and the plan remains paused rather than shelved. No strikes have followed as of this report."},{cat:"Diplomacy Whiplash",text:"Trump's mood swung from Sunday optimism ('there's a deal on Hormuz') to Monday's 'unbelievably duplicitous' after Iran's Foreign Ministry denied direct US talks were resuming, saying its only active channel is with Oman over a shipping route — not a strait reopening. CBS reports US officials confirm no new negotiations are actually scheduled despite Trump's public claims, a pattern that has now repeated across multiple announced-then-reversed de-escalation attempts since June."},{cat:"Escalation Risk",text:"A cargo vessel was struck by an unidentified projectile near Oman early Tuesday, and the master of another tanker reported an explosion nearby over the weekend — low-level risk to shipping continues even amid diplomatic signaling. Trump's 'last chance' / 'decapitation' framing keeps the threat of renewed strikes explicitly on the table."},{cat:"Geographic Expansion",text:"The Damietta, Egypt drone strike on gas vessels earlier raised fears of Suez Canal shipping disruption — a potential chokepoint beyond Hormuz. Iran's Foreign Minister Araghchi held calls with Saudi and Pakistani counterparts over the weekend, suggesting Tehran is working regional channels beyond the US-Oman track."},{cat:"Diplomacy/MoU",text:"No substantive movement on the core gaps. Iran and Oman are reportedly close to an understanding on a shipping-route arrangement, but Iran maintains this is distinct from reopening the strait or resuming direct US talks. Enrichment rights, the missile program, and Hormuz shipping governance remain unbridged with roughly 12 days left on the nominal MoU clock (window closes ~Aug 16)."},{cat:"Iran Domestic",text:"No confirmed public appearance by successor Supreme Leader Mojtaba Khamenei since his father's Jul 9-10 burial — now over three weeks with no image, video or voice recording."}],watch:"Whether Trump's claim that Hormuz reopens Tuesday actually materializes, or proves to be another reversed de-escalation announcement; whether the Iran-Oman shipping-route talks produce a concrete agreement; and whether the string of unidentified projectile/explosion incidents near Oman escalates into a confirmed attack.",generatedAt:new Date().toISOString()};
...
const REPORT_NOW=new Date("2026-08-04T04:35:00Z");
