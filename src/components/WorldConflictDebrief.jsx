...
const NEWS=[
  {id:"b_syrskyi_denial_jul20",conflictId:"ukraine",severity:"critical",icon:"🔴",headline:"General Staff Denies Reports Commander-in-Chief Syrskyi Was Dismissed Amid Second Day of Protests",conflict:"Ukraine",conflictColor:"#5b8ec8",publishedAt:"Jul 21, 2026",bullets:["Reports spread rapidly on Jul 20 that Commander-in-Chief Gen. Oleksandr Syrskyi had been removed — journalist Vitaliy Glagola, citing sources in Zelensky's office and the Ministry of Defense, said the dismissal would be announced later that day, and MP Yaroslav Zheleznyak said his sources confirmed it ahead of a scheduled 16:30 Staff meeting","The General Staff officially denied the reports: 'Reports circulating in the media... regarding the alleged dismissal of General Oleksandr Syrskyi... are untrue.' Both Syrskyi and General Staff chief Lt. Gen. Andrii Hnatov 'continue to perform their duties' — the statement noted dismissals from such posts require a presidential decree, which has not been issued","The rumors landed on the second consecutive day of protests in Kyiv and other cities, where demonstrators called for both Fedorov's reinstatement and Syrskyi's resignation; former Defense Minister Fedorov has framed his own dismissal as effectively an ultimatum. Syrskyi has publicly said he is 'ready to work with any defense minister' since he is 'at war with Russia, not the ministry'","Separately, Zelensky held his first phone call with new UK Prime Minister Burnham, and met with Deputy Chief of the General Staff Volodymyr Horbatiuk and Joint Forces commander Mykhailo Drapatyi to discuss defense strategy","Syrskyi later moved to publicly defuse the situation, telling reporters he was 'surprised to learn we had a conflict' with Fedorov and effectively apologizing; he separately said mobilization reform is the Defense Ministry's remit, not his — 'I want to see it as much as the whole country does.' Zelensky's chief of staff promised 'results' after the president met with field commanders"],sources:["Ukrinform","LIGA.net","Mezha.net"],impact:"Whether or not the dismissal itself was ever real, the fact that it was widely believed for hours shows how fragile the wartime cabinet's standing has become just five days after Fedorov's removal — the political story is now as live a front as the battlefield one",impactColor:"#dc2626"},
  {id:"b_iran_10thnight_jul21",conflictId:"iran",severity:"critical",icon:"🔴",headline:"US Names Third Fatality as Tenth Night of Strikes Hits Iran; Houthis Target Saudi Arabia Directly",conflict:"Iran",conflictColor:"#8b5cf6",publishedAt:"Jul 21, 2026",bullets:["The Pentagon named the third confirmed US death: Sgt. Michael Emmanuel Swinton, 30, of Fayetteville, NC, killed during a controlled detonation of a downed Iranian drone at Erbil Air Base, Iraq on Jul 19 — separate from the two soldiers, from Texas and Hawaii, killed in the Jordan strikes. Trump warned Tehran would 'pay' for the deaths","The US carried out a tenth consecutive night of strikes, with explosions reported in Sirik, Bandar Abbas, Qeshm Island, Shiraz and Isfahan; a US official said fighter jet numbers in the Middle East are increasing and dozens of aerial refueling tankers have arrived in Israel","Iranian retaliation hit Kuwait especially hard — a desalination facility and power plants caught fire and suffered serious damage — plus renewed strikes on Bahrain and Jordan; Iran's Revolutionary Guard claimed 'massive fires' on two tankers it said took 'an unsafe route' through the Strait of Hormuz, where daily crossings remain collapsed to roughly 9 vessels versus a ~130/day pre-war average","The Houthis escalated further, declaring their maritime embargo specifically against Saudi Arabia and threatening the Bab-el-Mandeb Strait — risking a second chokepoint closure on top of Hormuz that could remove a further ~7% of global oil supply. Meeting in Manila alongside a broader ASEAN summit also attended by China's Wang Yi and Russia's Lavrov, Southeast Asian foreign ministers issued a joint statement of 'serious concern,' noting the region depends on the strait for roughly 60% of its energy supply. US gasoline prices have climbed back to a $4/gallon national average, and the Pentagon disclosed nearly 100 US troops injured (mostly minor) since Jul 7 ahead of Defense Secretary Hegseth facing Senate questioning"],sources:["CNN","Al Jazeera","AP/Britannica"],impact:"A named casualty humanizes the war's cost domestically just as it spreads to a second maritime chokepoint and draws a formal statement of concern from a regional bloc that had largely stayed on the sidelines — the conflict's economic and diplomatic footprint is now expanding faster than its battlefield one",impactColor:"#dc2626"},
...
const REPORT_NOW=new Date("2026-07-21T14:20:00Z");
  ...
  return <div>
    ...
    {tab==="overview"&&<div>
      ...
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <Grid2 t={t} items={[{val:"3 killed",label:"US troops (all named)",sub:"2 in Jordan strikes, 1 in Erbil drone-detonation incident",color:"#dc2626"},{val:"~9 vs ~130",label:"Hormuz daily crossings",sub:"vs pre-war average",color:"#dc2626"},{val:"~$91/bbl",label:"Brent crude",sub:"Up from ~$69 in June; US gas back to $4/gal avg",color:"#f97316"},{val:"26 days",label:"MoU clock (nominal)",sub:"Now overtaken by events on the ground",color:"#8b5cf6"}]}/>
      </Hero>
