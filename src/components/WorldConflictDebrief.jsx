...
const CONFLICTS=[
  ...
  {id:"gaza",name:"Israel & the Levant",region:"Middle East",status:"Multi-Front",statusColor:"#f59e0b",icon:"🇵🇸",deaths:"73,317+ killed total",displaced:"1.9M displaced",summary:"Ceasefire since Oct 10, 2025. 1,191+ killed since ceasefire. Quiet annexation accelerating. 80% of buildings damaged.",warDay:null},
...
const LOSSES={ukraine:[
  ...
  {id:17,category:"Post-ceasefire killed",total:"1,191+",todayChange:null,color:"#f97316",icon:"💀",description:"Killed since Oct 10, 2025 ceasefire"},
...
const REPORT_NOW=new Date("2026-07-25T23:50:00Z");
...
const HISTORICAL={
  ...
  gazaCasualtiesSinceCeasefire:[{m:"Jan",v:451},{m:"Apr",v:800},{m:"Jun",v:981},{m:"Jul",v:1191}],
...
function GazaSection({t,initialTab}){
  ...
  const HUM_METRICS=[
    ...
    {icon:"💀",label:"Post-ceasefire killed",val:"1,191+",color:"#f97316",desc:"Palestinians killed since Oct 10, 2025 ceasefire, Gaza MoH as of Jul 19 (3,703 wounded). Hamas not disarming; Israel controls ~65% of the Strip. Fragile ceasefire with no enforcement mechanism."},
  ...
  return <div>
    ...
    {tab==="governance"&&<div>
      ...
      <Grid2 t={t} items={[{val:"$70B",label:"Estimated cost",sub:"Brookings — \"no modern comparison\"",color:"#8b5cf6"},{val:"0",label:"Reconstruction begun",sub:"Six months post-ceasefire",color:"#ef4444"},{val:"80%",label:"Buildings damaged",sub:"Or destroyed",color:"#f97316"},{val:"1,191+",label:"Killed since ceasefire",sub:"As of Jul 25 (Gaza MoH)",color:"#ef4444"}]}/>
...
function IranSection({t,initialTab}){
  ...
  const TIMELINE=[
    ...
    {date:"Jul 24, 2026",label:"13th night; Iran disputes ceasefire-rejection report; US fires on another vessel",color:"#dc2626",text:"CENTCOM continued the campaign through a 13th consecutive night, hitting Bandar Abbas, Qeshm and Hormozgan targets; separately, US forces fired on another merchant vessel attempting to breach the Iranian ports blockade. Iran publicly disputed a New York Times report describing an Iraqi-brokered US ceasefire proposal as rejected by Tehran — Iranian officials call the story 'misleading' and blame the Trump administration instead for 'breach of its promises' under the Islamabad MoU; neither government has confirmed a return to diplomacy. Trump said he believes 'Tehran is getting more serious' while meeting his Cabinet Jul 24 to weigh further escalation. Iran's health ministry reports 59 killed and 666 injured since the ceasefire collapsed Jun 27."},
