...
const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,446,150",todayChange:"+1,340",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
  {id:2,category:"Tanks",total:"12,231",todayChange:"+1",color:"#f97316",icon:"🪖",description:"Main battle tanks"},
  {id:3,category:"Armoured Vehs",total:"25,056",todayChange:"+7",color:"#eab308",icon:"🚧",description:"APCs, IFVs, MRAPs"},
  {id:4,category:"Artillery",total:"47,045",todayChange:"+42",color:"#84cc16",icon:"💥",description:"Guns, howitzers, mortars"},
  {id:5,category:"MLRS",total:"1,969",todayChange:"+1",color:"#22c55e",icon:"🚀",description:"Multiple launch rockets"},
  {id:6,category:"Air Defence",total:"1,525",todayChange:"+3",color:"#06b6d4",icon:"🛡️",description:"SAM & SHORAD systems"},
  {id:7,category:"UAVs",total:"435,665",todayChange:"+1,525",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
...
const BRIEFING={summaryShort:"Russian losses reached 1,446,150 (+1,340) per the Jul 31 MoD report; Poland has confirmed the Kh-101 that crashed on its territory was manufactured this year in the Moscow region and summoned Russia\u2019s ambassador. The Iran war keeps widening: Trump now says the US will be \u2018hitting Iran hard\u2019 over the next four weeks \u2014 a notably harder line than his \u2018losing faith\u2019 comment from earlier the same day \u2014 after Iranian retaliation for a deadly US strike on Qeshm island hit US-linked targets across Kuwait, Jordan and Bahrain. Trump\u2019s Board of Peace announced a Hamas disarmament agreement for Gaza, though Israel hasn\u2019t publicly endorsed it. Ukraine\u2019s Fedorov political crisis remains unresolved.",summary:"Ukraine: Russian losses climbed to 1,446,150 as of the Jul 31 MoD report (+1,340 on the day). Poland\u2019s foreign ministry confirmed the Kh-101 cruise missile that crashed in the Lublin Voivodeship during the Jul 29-30 mass attack was manufactured in Q2 2026 in the Moscow region, and formally summoned Russia\u2019s ambassador over the incident \u2014 the clearest official confirmation yet of a Russian-origin munition landing on NATO territory. Domestically, the Fedorov/Syrskyi political crisis remains unresolved with no new defense minister named. Iran: the war has continued widening rather than calming. Iran held a funeral for Revolutionary Guard members reportedly killed in the Qeshm island strike \u2014 a detail suggesting the target had a military as well as civilian dimension beyond the family of three initially reported killed. Trump\u2019s tone has hardened considerably within a single day: asked what Iran can expect over the next four weeks, he told reporters the US will be \u2018hitting Iran hard,\u2019 a markedly more aggressive posture than his earlier \u2018losing faith\u2019 remark. Iran\u2019s retaliation for the Qeshm strike remains broader than first reported, hitting US-linked targets across Kuwait, Jordan and Bahrain; Iraq\u2019s Iran-backed militias separately claim 20 killed and 32 wounded from US counter-strikes. Gaza: Trump\u2019s Board of Peace announced Thursday that Hamas has agreed to a phased disarmament roadmap tied to a gradual Israeli withdrawal \u2014 the international community has responded with cautious optimism, per Al Jazeera, though Israel has not publicly endorsed the agreement and Hamas says it won\u2019t implement its side unless Israel withdraws first. Elsewhere: Taiwan Strait tensions and the Americas file remain active without major new developments today.",watch:"Whether Trump\u2019s \u2018hitting Iran hard\u2019 comment translates into actual renewed strikes given the four-week window he named; whether the Gaza disarmament agreement survives the sequencing dispute between Israel and Hamas; and whether Ukraine\u2019s political crisis produces a confirmed new defense minister.",generatedAt:new Date().toISOString()};

const UKRAINE_BRIEFING={summaryShort:"Russia's attrition math keeps worsening \u2014 an ~8:1 loss ratio in H1 2026 per CSIS, with cumulative losses now at 1,446,150 \u2014 even as its ground offensive grinds on at Pokrovsk. This follows the Jul 29-30 mass attack (largest in weeks, 8-10 killed, a missile crossing into Poland) and Zelensky's Jul 28 White House meeting with Trump on Patriot licensing. Zelensky remains unable to resolve the Fedorov/Syrskyi political crisis. Full breakdown below.",summary:"Russia's attrition math has become unsustainable even as its ground offensive grinds on. CSIS's H1 2026 assessment puts the Russia:Ukraine battlefield loss ratio at nearly 8:1 \u2014 up from 2:1\u20133:1 for most of the war \u2014 credited largely to Ukraine's AI-enabled drone interdiction campaign. The MoD's Jul 31 report puts cumulative Russian losses at 1,446,150 (+1,340 on the day). This follows the Jul 29-30 mass attack \u2014 the largest combined strike since the mid-July interceptor shortage began, killing 8-10 people including 3 children from one family near Kryvyi Rih, with a missile crossing into Poland's Lublin region and prompting NATO jets to scramble. The war isn't simply going well for Ukraine, though: Russia's offensive still holds Pokrovsk at genuine encirclement risk, and the Patriot/PAC-3 shortage \u2014 worsened by the Iran war draining US stocks \u2014 was starkly exposed when only 1 of 9 ballistic missiles was intercepted in that attack.",assessment:[{cat:"Attrition",text:"~8:1 RU:UA loss ratio in H1 2026 (CSIS). Cumulative Russian losses reached 1,446,150 as of the Jul 31 MoD report (+1,340 on the day) \u2014 tanks to 12,231, artillery to 47,045; Russian UAV losses passed 435,000. Ukraine's naval/deep-strike interdiction campaign remains a sustained second front, regularly reaching Moscow region and 1,000+km inside Russia."},{cat:"Territory",text:"Russian advance remains grinding \u2014 Pokrovsk is the single hottest sector on the front, alongside Huliaipole. Monthly gain estimates diverge sharply by source (DeepState vs. ISW), among the slowest rates of any war in the past century either way. Russia had a net territorial loss in Apr-May 2026, its first monthly net loss since Aug 2024."},{cat:"Deep Strikes",text:"Ukraine's deep-strike campaign continues reaching deep inside Russia \u2014 the Ryazan oil refinery (~5% of Russian refining capacity) and a classified Rosrezerv strategic fuel reserve in Udmurtia (1,300km deep) both hit this week, alongside a Rostov Oblast export terminal and Iranian-cargo vessels in the Caspian Sea. The cumulative effect remains a nationwide Russian fuel crisis severe enough to have forced a diesel export ban."},{cat:"Air Defense",text:"The Jul 29-30 mass attack exposed the real state of the shortage: just 1 of 9 ballistic missiles intercepted, despite a brief 71% rebound on Jul 25-26. Trump's Jul 28 meeting with Zelensky again touched on Patriot production licensing, though real domestic output remains months-to-years out; Poland continues co-producing and transferring PAC-3s."},{cat:"Diplomacy",text:"Zelensky's Jul 28 White House meeting with Trump \u2014 called 'good' by Zelensky \u2014 covered Patriot licenses and diplomacy. Putin is still reported to have dropped territorial-concession offers entirely, and the Kremlin continues to treat the Anchorage understandings as void; the Turkish ceasefire push remains rejected."},{cat:"Political",text:"Fedorov's dismissal remains a full command shake-up with no resolution: Zelensky replaced Commander-in-Chief Syrskyi with Mykhailo Drapatyi and General Staff chief Andrii Hnatov with Ihor Skybiuk. Fedorov continues rejecting Zelensky's alternative offer, insisting the Defense Ministry job is one of only three that actually shape the war's course; protests have now run for close to three weeks with no new defense minister named."}],watch:"Whether Pokrovsk holds \u2014 still the most consequential sector against an otherwise favorable attrition/territorial picture \u2014 and whether the Jul 29-30 attack's near-total ballistic-intercept failure was a one-off exposed by a maximum-effort strike or the new normal given the Patriot/PAC-3 shortage.",generatedAt:new Date().toISOString()};

const IRAN_BRIEFING={summaryShort:"The war keeps widening. Iran held a funeral for Revolutionary Guard members reportedly killed in the Qeshm island strike \u2014 suggesting a military as well as civilian dimension to that target \u2014 and Trump\u2019s tone has hardened sharply: he now says the US will be \u2018hitting Iran hard\u2019 over the next four weeks, a notably more aggressive line than his \u2018losing faith\u2019 comment earlier the same day. Iran\u2019s retaliation remains broader than first reported, hitting US-linked targets across Kuwait, Jordan and Bahrain. The core gaps \u2014 enrichment, missiles, Hormuz governance \u2014 remain unbridged with 16 days left on the nominal MoU clock.",summary:"The picture continued to darken through Jul 31. Iran held a funeral for Islamic Revolutionary Guard Corps members reportedly killed in the US strike that hit Qeshm island \u2014 a detail that complicates the earlier framing of that strike as having killed a civilian family, suggesting the target had a military dimension Tehran is now publicly acknowledging via the funeral itself. Trump\u2019s public tone shifted within hours: after saying earlier in the day that he was \u2018losing faith\u2019 with Iran but hadn\u2019t ruled out a deal, he told reporters asking what Iran can expect over the next four weeks that the US will be \u2018hitting Iran hard\u2019 \u2014 a materially harder public posture than the pause-and-reassess framing from just hours earlier. Iran\u2019s retaliation for the Qeshm strike remains broader than first reported: the IRGC claims strikes on US-linked targets across Kuwait, Jordan and Bahrain, not just Jordan, and Iraq\u2019s Iran-backed Popular Mobilization Forces separately claim 20 killed and 32 wounded from US counter-strikes. CENTCOM says it continues reviewing the Qeshm strike itself. On the Egypt front, Iran\u2019s Foreign Ministry\u2019s official denial of any role in the Damietta port tanker incident still stands \u2014 that specific expansion claim remains unresolved rather than confirmed. None of the core negotiating gaps \u2014 uranium enrichment, the missile program, Hormuz shipping governance, IAEA access to bombed sites \u2014 have moved. The nominal 60-day Islamabad MoU window closes in 16 days.",assessment:[{cat:"Military",text:"Trump\u2019s \u2018hitting Iran hard\u2019 comment, made hours after his softer \u2018losing faith\u2019 remark, is the most concrete public signal yet that renewed strikes are likely within the four-week window he named. Iran\u2019s funeral for IRGC members killed in the Qeshm strike suggests that target had a genuine military dimension. CENTCOM\u2019s review of the strike remains ongoing with no findings announced."},{cat:"Geographic Expansion",text:"Iran\u2019s retaliation for Qeshm hit US-linked targets across Kuwait, Jordan and Bahrain \u2014 broader than first reported. Saudi Arabia\u2019s joint strikes with the US in Iraq remain the clearest first-time expansion marker. The Egypt Damietta port incident remains officially denied by Iran and unresolved as to origin."},{cat:"Diplomacy/MoU",text:"Trump\u2019s tone hardened materially within a single day \u2014 from \u2018losing faith\u2019 to \u2018hitting Iran hard\u2019 \u2014 with no confirmed direct US-Iran negotiations beyond ongoing Oman-mediated talks. Enrichment rights, the missile program, and Hormuz shipping governance remain unbridged core gaps with 16 days left on the nominal MoU clock."},{cat:"Hormuz/Economy",text:"Iran\u2019s IRGC maintains the strait stays closed to normal traffic as long as US \u2018interference\u2019 continues. Brent crude has remained elevated through the week\u2019s expanded retaliation and Trump\u2019s hardened rhetoric."},{cat:"Iran Domestic",text:"No confirmed public appearance by successor Supreme Leader Mojtaba Khamenei since his father\u2019s Jul 9-10 burial \u2014 now several weeks with no image, video or voice recording. The IRGC funeral for members killed at Qeshm is a rare instance of Tehran publicly acknowledging a military casualty from a specific named strike in this war."}],watch:"Whether Trump\u2019s \u2018hitting Iran hard\u2019 comment translates into actual renewed strikes within the four-week window he named; whether CENTCOM\u2019s review of the Qeshm strike produces any findings; and whether the Oman-mediated channel produces anything resembling real negotiations before the Aug 16 MoU deadline.",generatedAt:new Date().toISOString()};
...
const REPORT_NOW=new Date("2026-07-31T22:50:00Z");
