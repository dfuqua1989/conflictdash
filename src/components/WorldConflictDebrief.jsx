...
const CONFLICTS=[
  ...
  {id:"venezuela",name:"Venezuela",region:"Latin America",status:"QUIET",statusColor:"#8496a8",icon:"🇻🇪",deaths:"221+ killed in Caribbean boat strikes",displaced:"Maduro captured Jan 3, 2026",summary:"Quiet on the intervention front, dominated by disaster response. US captured Maduro Jan 3, 2026 (Operation Absolute Resolve); Southern Spear boat strikes killed 221+ since Sept 2025 but have been paused entirely since Jun 21. The Jun 24 twin earthquakes are now the defining story — confirmed dead passed 6,125 as of Aug 3 (National Assembly President Jorge Rodríguez), tens of thousands still missing, World Bank estimates ~$20B in physical damage. The Caribbean's other live front is Cuba's grid collapse — see the Cuba Blockade card.",warDay:null},
...
const NEWS=[
  ...
  {id:"b_mecca_defense_pact_aug7",confidence:"Confirmed",conflictId:"iran",severity:"major",icon:"🤝",headline:"Saudi Arabia, Turkey and Pakistan Sign Mutual-Defense Pact in Mecca",conflict:"Iran",conflictColor:"#8b5cf6",publishedAt:"Aug 7, 2026",bullets:["Saudi Arabia’s crown prince, Turkey’s president and Pakistan’s prime minister signed a mutual-defense agreement in Mecca stating that any armed attack against one of the three states will be regarded as an attack against them all","The pact lands amid a widening regional picture — Saudi Arabia has separately said it’s bracing for coordinated attacks by Iraqi militias working with the Houthis, and multiple outlets report a large-scale Houthi strike on Saudi forces this week with casualty figures still unconfirmed","Trump said Thursday the war ‘can’t go much longer,’ as Hormuz traffic remains subdued — 8 confirmed crossings Aug 7, down 33% day-on-day, while Bab el-Mandeb crossings rose 18% in the same window"],sources:["Al Jazeera"],impact:"A significant new regional security architecture that reshapes the calculus around any future Iran confrontation, formed by three major regional powers as the broader conflict continues to widen beyond the original Hormuz shipping dispute",impactColor:"#f97316"},
  {id:"b_nk_missiles_russia_aug6",confidence:"Confirmed",conflictId:"ukraine",severity:"major",icon:"🇰🇵",headline:"ISW: North Korea Sending Over 100 Missiles to Russia, Deepening Military Supply Relationship",conflict:"Ukraine",conflictColor:"#5b8ec8",publishedAt:"Aug 6, 2026",bullets:["The Institute for the Study of War reported Aug 6 that North Korea is sending more than 100 missiles to Russia, warning of a growing threat to Ukraine as the shipment adds a new dimension to the DPRK-Russia military relationship beyond the troop deployments already documented","The shipment lands the same week a Ukrainian court set $130,000 bail for ex-ambassador to the US Olha Stefanishyna, dismissed Aug 3 amid a corruption probe, and Russia launched 101 drones and missiles overnight into Aug 6, with dozens penetrating air defenses including a strike that killed railroad workers in Lozova","Ukraine’s own deep-strike campaign continued in parallel, hitting Russian oil refineries more than 1,300km inside Russian territory, while the UK announced fresh sanctions on Russia’s shadow fleet"],sources:["ISW","RBC-Ukraine"],impact:"A notable expansion of North Korea’s support role beyond personnel, raising questions about Russian missile stockpile replenishment as the war heads into autumn",impactColor:"#f97316"},
  {id:"b_iran_khamenei_dark_car_meeting",confidence:"Confirmed",conflictId:"iran",severity:"major",icon:"🕶️",headline:"Iran’s President Says Contact With Khamenei ‘Very Difficult’ After Report His Only Meeting Was in a Dark Car",conflict:"Iran",conflictColor:"#8b5cf6",publishedAt:"Aug 5, 2026",bullets:["President Pezeshkian told Iranian state TV that interaction with Supreme Leader Mojtaba Khamenei is currently ‘very difficult’ — his most direct public admission yet of an access problem that has run since Khamenei took the role in March","An Iran International exclusive reported that Pezeshkian’s only known meeting with a man presented as Khamenei was a few minutes in a dark, tinted-window car at a secret location — Pezeshkian could not see the man beside him and later asked whether the voice he’d heard really belonged to the Supreme Leader","That account directly contradicts Pezeshkian’s own public description in May of a ‘cordial’ two-and-a-half-hour meeting; five months into his tenure, Khamenei remains unseen, unheard in his own voice, and unrecorded on video since surviving the strike that killed his father"],sources:["Iran International","NBC News","Jerusalem Post"],impact:"Raises real questions about who is actually directing Iranian state decisions during the most consequential negotiation of the war — including the Hormuz talks Iran’s own officials say await Khamenei’s personal sign-off",impactColor:"#dc2626"},
  {id:"b_kyiv_region_overnight_strike_aug5",confidence:"Confirmed",conflictId:"ukraine",severity:"critical",icon:"💥",headline:"Massive Russian Missile and Drone Attack Hits Kyiv Region Overnight, Killing at Least 14-17",conflict:"Ukraine",conflictColor:"#5b8ec8",publishedAt:"Aug 5, 2026",bullets:["A large-scale Russian missile and drone attack struck the Kyiv region overnight Aug 5, with initial regional reporting citing 14 killed and 27 wounded; RBC-Ukraine’s fuller citywide count put the toll at 17 killed and 44 injured as reporting continued through the day","Warehouses, logistics hubs and civilian businesses bore the brunt of the strike, including facilities linked to major Ukrainian retailers and logistics operators Epicentr, Rozetka, Fozzy Group and Nova Poshta, alongside residential fires that required extended firefighting response","The attack lands the same week Ukraine’s own drone campaign has been targeting Russian logistics infrastructure including Wildberries warehouses, with a Wildberries facility in Russia’s Tula region also catching fire overnight Aug 5 — underscoring a tit-for-tat dynamic around commercial/logistics targets on both sides of the front"],sources:["RBC-Ukraine","Ukrinform"],impact:"Among the worst single nights for Kyiv-region civilians in recent weeks, hitting the same category of commercial/logistics infrastructure that Ukraine has been targeting inside Russia",impactColor:"#dc2626"},
  {id:"b_hormuz_iran_oman_agreement_aug5",confidence:"Confirmed",conflictId:"iran",severity:"critical",icon:"🚢",headline:"Iran and Oman Say They’ve Reached Agreement on Hormuz Shipping Route, Joint Statement in Final Drafting",conflict:"Iran",conflictColor:"#8b5cf6",publishedAt:"Aug 5, 2026",bullets:["Iran’s foreign ministry said Wednesday it has reached agreement with Oman on a proposed route for shipping through the Strait of Hormuz — the most concrete diplomatic language either side has used since the Jun 17 MoU collapsed — with a joint statement under review and in final drafting","FM spokesman Esmail Baghaei called the talks ‘forward-moving’ but said a deal would be struck ‘if certain third parties do not obstruct this process,’ a pointed reference to continued US involvement; Trump said Tuesday evening a deal ‘could happen’ Wednesday or Thursday","Brent crude fell more than 5% Tuesday to around $79.50 on the news before steadying; Bessent maintains any deal means ‘freedom of movement’ rather than Iranian tolls, while AP’s regional sourcing continues to describe ‘service fees’ on the Iran-controlled route — the same US-regional discrepancy that has run through this negotiation for weeks"],sources:["Bloomberg","CNBC","NBC News"],impact:"The furthest the Hormuz diplomatic track has advanced since talks collapsed in mid-July, though the pattern of prior near-deals falling apart under renewed Iranian attacks argues for reading the more confident language with caution until a text is actually signed",impactColor:"#f97316"},
  {id:"b_ukraine_ambassador_dismissed_aug3",confidence:"Confirmed",conflictId:"ukraine",severity:"major",icon:"🇺🇸",headline:"Zelensky Dismisses Ambassador to US Stefanishyna Amid Corruption Probe, Leaves Washington Post Vacant",conflict:"Ukraine",conflictColor:"#5b8ec8",publishedAt:"Aug 3, 2026",bullets:["President Zelensky dismissed Olha Stefanishyna as Ukraine’s ambassador to the United States by decree on Aug 3, ending a tenure that began in August 2025; Stefanishyna says the decision to leave was her own, citing personal circumstances","The dismissal lands amid an active Specialized Anti-Corruption Prosecutor’s Office investigation into asset-management irregularities connected to her circle, and amid a broader ambassadorial reshuffle following July’s government shake-up that replaced the prime minister and defense minister","No successor has been named, leaving Ukraine’s most consequential diplomatic post vacant at the same moment Zelensky says Kyiv is in ‘daily contact’ with Trump’s team and expects Witkoff and Kushner to step up involvement through August"],sources:["Kyiv Independent","Reuters","Ukrainska Pravda"],impact:"A politically awkward vacancy at Ukraine’s most important embassy just as the Trump relationship enters what Zelensky calls its most active phase in months",impactColor:"#eab308"},
  {id:"b_colombia_delaespriella_inauguration",confidence:"Confirmed",conflictId:"venezuela",severity:"major",icon:"🗳️",headline:"Colombia’s Right-Wing President-Elect Set to Dismantle ‘Total Peace’ at Aug 7 Inauguration",conflict:"Colombia",conflictColor:"#fcd116",publishedAt:"Aug 5, 2026",bullets:["Abelardo de la Espriella, a Trump-endorsed criminal-defense lawyer, won Colombia’s Jun 21 runoff 49.66% to 48.7% over leftist Iván Cepeda — marking the country’s first transfer of power from a leftist to a right-wing president in modern history — and will be inaugurated Aug 7 at a military garrison in Cauca, breaking 140 years of tradition","The incoming government has already announced eliminating the Peace Commissioner post entirely and will reinstate arrest warrants against ELN and FARC-dissident leaders starting Aug 7, reversing the negotiating-track suspensions granted under Petro’s ‘Total Peace’ policy","That policy leaves behind a record of expansion, not contraction: illegal armed-group membership grew roughly 90% since 2022 to nearly 29,000 fighters by Jul 2026, with only one small faction (99 fighters) successfully demobilized; intelligence agencies have warned of possible strikes in major cities timed to the inauguration"],sources:["Americas Quarterly","The City Paper Bogotá","ColombiaOne"],impact:"A hard-line security government replaces a negotiation-first one just as armed groups have grown stronger than when Total Peace began — raising the near-term risk of escalation as warrants are reinstated and ceasefire-era suspensions lifted",impactColor:"#f97316"},
  {id:"b_hormuz_interim_deal_nears_aug5",confidence:"Confirmed",conflictId:"iran",severity:"critical",icon:"🚢",headline:"US, Iran and Oman Close In on Interim Hormuz Deal as CENTCOM Declares Southern Route ‘Free and Open’",conflict:"Iran",conflictColor:"#8b5cf6",publishedAt:"Aug 5, 2026",bullets:["Axios reports the US, Iran and Oman are closing in on an interim agreement to reopen the Strait of Hormuz, with Washington aiming for a Wednesday announcement — naval mines would be cleared from the median lane within 30 days, then used for traffic under a permanent Oman-Iran arrangement negotiated separately","Bessent explicitly rejected the idea of Iranian tolls (‘I think it would be freedom of movement’), directly conflicting with AP reporting citing regional officials who describe ‘service fees’ on the Iran-controlled inbound route — the same US-regional discrepancy that has recurred for weeks","Brent crude fell 5.3% Tuesday on the diplomatic optimism, then ticked up 0.43% to $79.70 Wednesday as CENTCOM stated the strait’s southern route via Omani waters is ‘free and open’; a prior near-deal collapsed three weeks ago when Iran resumed attacks on shipping"],sources:["Axios","AP","CNBC"],impact:"The most concrete-sounding diplomatic movement yet on Hormuz, though the pattern of prior collapsed near-deals and the persistent US-Iran discrepancy over tolls argue for caution until an announcement actually lands",impactColor:"#f97316"},
  {id:"b_sudan_el_obeid_siege_update",confidence:"Confirmed",conflictId:"sudan",severity:"major",icon:"🚨",headline:"UN Warns El-Obeid Risks Repeat of El Fasher ‘Hallmarks of Genocide’ as RSF Siege Tightens",conflict:"Sudan",conflictColor:"#dc2626",publishedAt:"Aug 5, 2026",bullets:["The RSF has spent months massing forces around El-Obeid, North Kordofan’s capital and a key SAF logistics hub — the UN Human Rights Council passed a motion Jul 6 warning that an assault could replicate the atrocities documented at El Fasher’s October 2025 fall","Roughly 500,000 people, including 105,000 already displaced by earlier fighting, remain trapped in the city; UN High Commissioner Volker Türk cited 50 civilians killed in drone strikes over just 10 days in late June, with the city’s power station and water supply both damaged","The US State Department has separately warned of ‘alarming indications that mass atrocities could be imminent’; as of early August the city has not fallen, but no ceasefire or humanitarian corridor has been agreed and the encirclement continues tightening"],sources:["Al Jazeera","UN OHCHR"],impact:"A major, currently unfolding humanitarian crisis that has received limited international attention relative to Ukraine and the Middle East despite UN warnings of genocide-level risk to half a million trapped civilians",impactColor:"#dc2626"},
  {id:"b_gaza_netanyahu_hardens_aug4",confidence:"Confirmed",conflictId:"gaza",severity:"critical",icon:"🚫",headline:"Netanyahu Hardens Line on Gaza Withdrawal as Al-Quds Brigades Separately Joins Disarmament Deal",conflict:"Gaza",conflictColor:"#f59e0b",publishedAt:"Aug 4, 2026",bullets:["Netanyahu said Aug 4 that Israel will not withdraw ‘from our current lines’ in Gaza ‘until Hamas is completely disarmed’ — a firmer, more public version of the sequencing dispute that has stalled the Jul 31 Board of Peace agreement since it was announced","Islamic Jihad’s armed wing, the Al-Quds Brigades, separately consented to the disarmament plan on Aug 2 — a real widening of factional buy-in beyond Hamas alone, though smaller factions and clan militias have not yet followed","National Security Minister Ben-Gvir called the plan ‘unacceptable’; former PM Naftali Bennett countered that Netanyahu ‘gave the Qataris the keys to Gaza’ and bears responsibility for stalling implementation — Israeli strikes have intensified rather than eased since the deal, killing at least 18 on Aug 1 alone, the biggest single-day toll in weeks"],sources:["Times of Israel","Al Jazeera"],impact:"The disarmament announcement increasingly reads as a paper agreement overtaken by events on the ground — wider factional buy-in on one side, harder public red lines and rising violence on the other",impactColor:"#f97316"},
  {id:"b_venezuela_quake_toll_6125_aug3",confidence:"Confirmed",conflictId:"venezuela",severity:"major",icon:"🌍",headline:"Venezuela Earthquake Death Toll Passes 6,125 as Government Faces Mounting Criticism Over Response",conflict:"Venezuela",conflictColor:"#8496a8",publishedAt:"Aug 3, 2026",bullets:["National Assembly President Jorge Rodríguez confirmed 6,125 deaths from the Jun 24 twin earthquakes as of Aug 3 — up nearly 600 from the Jul 25 figure of 5,546, with 61,000 people treated in hospitals to date","World Bank places physical damage at roughly $20B; funding sources for reconstruction remain unclear despite international pledges of support in the weeks following the disaster","Interim President Delcy Rodríguez’s government continues to face criticism over the pace of the response even as her constitutionally-mandated 180-day interim window (which lapsed Jul 3) remains unresolved with no election scheduled"],sources:["Al Jazeera","Reuters"],impact:"The earthquake has become the dominant story in Venezuela, eclipsing the frozen political transition and further straining a government whose legitimacy was already contested before the disaster",impactColor:"#f97316"},
...
const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,455,420",todayChange:"+1,210",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
  ...
  {id:7,category:"UAVs",total:"447,855",todayChange:"+1,589",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
...
const EVENTS={ukraine:[{id:1,date:"Jan 6, 2026",label:"Coalition of Willing — Paris",note:"35 nations at Elysée Palace. UK + France pledge troops post-ceasefire.",color:"#22c55e",isUpcoming:false},{id:2,date:"Feb 17, 2026",label:"Geneva trilateral talks",note:"Military track: constructive. Political track: stuck.",color:"#f97316",isUpcoming:false},{id:3,date:"May 9, 2026",label:"Trump 3-day ceasefire",note:"Expired. Full-scale combat resumed immediately.",color:"#f97316",isUpcoming:false},{id:4,date:"Jun 7, 2026",label:"Putin refuses direct talks",note:"Declines Zelensky face-to-face proposal.",color:"#ef4444",isUpcoming:false},{id:5,date:"Jun 23, 2026",label:"Rail bridge to Crimea destroyed",note:"Last intact rail link from north severed.",color:"#ef4444",isUpcoming:false},{id:6,date:"Jun 25, 2026",label:"Belarus halts Shahed relay",note:"Partial compliance with Ukraine ultimatum.",color:"#22c55e",isUpcoming:false},{id:7,date:"Jun 27, 2026",label:"Putin-Lukashenko Valdai summit",note:"2-day secret talks at Putin's private residence. WSJ: Russia pressuring Belarus to open second front. No communiqué issued.",color:"#ef4444",isUpcoming:false},{id:8,date:"Jun 27, 2026",label:"Serbia's Vucic announces resignation",note:"Snap elections coming. Pro-Russia Balkan president destabilised. Serbia has warm ties with Moscow — election outcome uncertain.",color:"#f59e0b",isUpcoming:false},{id:10,date:"Jun 16-17, 2026",label:"Russia rejects Turkish ceasefire proposal",note:"Fidan proposed ceasefire in Moscow — Russia rejected, remained firm on Donbas demands. Turkey had hoped to bring both sides to NATO Ankara. Diplomatic track blocked.",color:"#ef4444",isUpcoming:false},{id:11,date:"Jun 28, 2026",label:"Putin United Russia congress — rejects diplomacy",note:"First public admission of fuel shortages. ISW: 'rejected diplomatic solutions.' United Russia formally claimed as Putin's party. Duma elections Sept 2026.",color:"#ef4444",isUpcoming:false},{id:9,date:"Jul 7, 2026",label:"NATO Ankara Summit",note:"Potential ceasefire deadline. Security guarantees on agenda. Slovakia refuses aid pledge. Turkey jet engine deal confirmed.",color:"#5b8ec8",isUpcoming:true}],iran:[
    ...
    {id:28,date:"Aug 4, 2026",label:"Iran International exclusive: Pezeshkian\u2019s only Khamenei meeting was in a dark car",note:"President Pezeshkian was taken to a secret Tehran location for what sources describe as a few-minutes-long meeting with a man presented as Supreme Leader Mojtaba Khamenei, seated beside him in a dark, tinted-window car \u2014 Pezeshkian could not see the man and later asked whether the voice belonged to the real Khamenei. Directly contradicts Pezeshkian\u2019s own May account of a \u2018cordial\u2019 two-and-a-half-hour meeting. Five months into his tenure, Khamenei remains unseen, unheard on his own voice, and unrecorded.",color:"#ef4444",isUpcoming:false},
{id:29,date:"Aug 5-6, 2026",label:"Hormuz framework nears completion; Iranian Parliament drafts hostile-shipping bill",note:"Iran and Oman say the route\u2019s geographic coordinates are agreed and a joint statement is in final drafting, awaiting Khamenei\u2019s sign-off \u2014 but Deputy FM Gharibabadi says commercial ships would transit Iranian territorial waters on both inbound AND outbound legs (a shift from earlier inbound-Iran/outbound-Oman reporting), which US officials say they won\u2019t accept if it leaves Iran in control. Separately, Iran\u2019s Parliament is drafting a bill to bar US- and Israel-linked vessels from the strait entirely \u2014 a unilateral track separate from the Oman talks. CENTCOM: 49 vessels redirected by the US blockade since mid-July; only 29 crossed the strait this week, 8 on Tuesday alone.",color:"#8b5cf6",isUpcoming:false},
{id:30,date:"Aug 5-6, 2026",label:"Pezeshkian: contact with Khamenei \u2018very difficult\u2019; Houthis hit Saudi Arabia",note:"Pezeshkian told state TV that interaction with Khamenei is currently \u2018very difficult,\u2019 his most direct public admission yet of the access problem. Separately, a Houthi attack wounded 11 people in southern Saudi Arabia \u2014 the kingdom\u2019s highest toll in over four years of conflict \u2014 and Saudi officials say they are bracing for \u2018multiple coordinated attacks\u2019 by Iraqi militias working with the Houthis, a sign the regional conflict continues widening beyond the Hormuz shipping dispute.",color:"#f97316",isUpcoming:false},
...
const BRIEFING={summaryShort:"Russian losses reached 1,455,420 (+1,210 on Aug 6). Iran: AP reports two regional officials briefed on Hormuz talks believe Supreme Leader Khamenei was wounded in the war’s opening strikes — the likely real reason behind five months of zero public appearances. FM Araghchi reportedly agreed to Hormuz terms ‘in principle’ over the weekend, still awaiting Khamenei and the Supreme National Security Council. Trump says the war ‘can’t go much longer.’ Saudi Arabia, Turkey and Pakistan signed a Mecca mutual-defense pact. Reports also describe a large-scale Houthi strike on Saudi forces, toll still forming. Hormuz traffic remains subdued — 8 crossings Aug 7, down 33% day-on-day.",summary:"Russian combat losses reached 1,455,420 as of the Aug 7 General Staff report (+1,210 on Aug 6), within the sustained range. The biggest single development this cycle is a new AP report: two regional officials briefed on the Hormuz negotiations say Iran’s Supreme Leader Mojtaba Khamenei is believed to have been wounded in the war’s opening strikes — a possible explanation, offered for the first time by sourced reporting rather than speculation, for why he has made no in-person public appearance in five months. Separately, two Axios sources say Iranian FM Abbas Araghchi agreed to the Hormuz deal’s terms ‘in principle’ over the weekend, but the agreement still requires sign-off from both Khamenei and Iran’s Supreme National Security Council before any announcement. Trump said the war ‘can’t go much longer.’ In a significant regional development, Saudi Arabia’s crown prince, Turkey’s president and Pakistan’s prime minister signed a mutual-defense pact in Mecca stating any armed attack on one signatory would be treated as an attack on all three. Separately, multiple reports describe a large-scale Houthi (Ansar Allah) strike on Saudi forces; the toll is still forming and estimates vary significantly between sources, so treat specific casualty figures with caution pending clearer confirmation. Hormuz traffic remains subdued regardless of the diplomatic tenor — just 8 confirmed crossings on Aug 7, down 33% day-on-day, with most vessels using Iran’s unilateral routing scheme; Bab el-Mandeb crossings rose 18% in the same period, suggesting some traffic diversion to the alternate chokepoint. In Ukraine, deep strikes continued on both sides — Ukrainian drones hit oil refineries in Russia’s Yaroslavl and Bashkortostan regions, and Ukrainian forces struck Russian military boats and shadow-fleet vessels in the Black Sea — while Ukrainian prosecutors opened a war crimes investigation into the reported execution of a captured Ukrainian soldier near Myrne, Donetsk.",watch:"Whether the Khamenei-wounded reporting gets further corroborated or officially addressed by Iran; whether Araghchi’s ‘agreed in principle’ actually converts to a signed announcement; how the Mecca defense pact affects the region’s calculus on Iran; and whether the Houthi-Saudi attack toll clarifies into a confirmed, consistent figure.",generatedAt:new Date().toISOString()};
const UKRAINE_BRIEFING={summaryShort:"Russian losses reached 1,455,420 as of the Aug 7 report (+1,210 on Aug 6). Ukrainian drones hit oil refineries in Yaroslavl and Bashkortostan; Ukrainian forces struck Russian military boats and shadow-fleet vessels in the Black Sea. Ukrainian prosecutors opened a war crimes investigation into the reported execution of a captured Ukrainian soldier near Myrne, Donetsk. Ukraine and the UK discussed strengthening air defense, air capabilities and drone production Aug 6.",summary:"Russian losses reached 1,455,420 as of the Aug 7 General Staff report (+1,210 on Aug 6, alongside 1,589 UAVs and 67 artillery systems destroyed that day), within the sustained range. Ukraine’s deep-strike campaign continued overnight into Aug 7, with drones hitting oil refineries in Russia’s Yaroslavl and Bashkortostan regions and sparking a fire at one facility. Ukraine’s Defense Forces separately struck Russian military boats and shadow-fleet vessels in the Black Sea, extending the maritime interdiction campaign alongside Operation MoLoChKa. In a grim development, Ukrainian prosecutors launched a war crimes investigation into the reported execution of a captured Ukrainian soldier near Myrne in Donetsk region by Russian forces — one of a continuing pattern of similar allegations. On the diplomatic and materiel side, Ukraine and the UK held talks Aug 6 on strengthening air defense, air capabilities and drone production, part of the broader Western effort to backfill Ukraine’s interceptor shortfall. Ukraine’s Air Force separately said its air defenses intercepted over 5,300 aerial targets during large-scale attacks in July — a data point on overall drone/missile defense volume, distinct from the ballistic-specific intercept rate tracked on this page, which has told a much bleaker story in early August.",assessment:[{cat:"Attrition",text:"Cumulative losses reached 1,455,420 as of Aug 7 (+1,210 on Aug 6), within the sustained 1,100–1,500/day range. Equipment losses that day included 1,589 UAVs and 67 artillery systems."},{cat:"Deep Strikes",text:"Ukrainian drones hit oil refineries in Russia’s Yaroslavl and Bashkortostan regions overnight into Aug 7, sparking a fire at one facility — continuing the sustained economic-targeting campaign against Russian energy infrastructure."},{cat:"Maritime",text:"Ukrainian forces struck Russian military boats and shadow-fleet vessels in the Black Sea, extending the naval interdiction campaign that runs alongside the dedicated Operation MoLoChKa effort near Crimea."},{cat:"War Crimes",text:"Ukrainian prosecutors opened a war crimes investigation into the reported execution of a captured Ukrainian soldier near Myrne, Donetsk region — part of a continuing pattern of similar allegations documented throughout the war."},{cat:"Air Defense Cooperation",text:"Ukraine and the UK discussed strengthening air defense, air capabilities and drone production Aug 6, part of the broader Western effort to address the interceptor shortfall behind the recent ballistic intercept-rate collapse."},{cat:"Political — Ambassador Vacancy",text:"No successor has been named to the Washington ambassadorship since Zelensky dismissed Olha Stefanishyna by decree Aug 3; a Ukrainian court has since set her bail at $130,000 amid the underlying anti-corruption probe."},{cat:"Supply Chain — North Korea",text:"ISW’s Aug 6 report that North Korea is sending over 100 missiles to Russia remains the most recent data point on Russian munitions resupply, alongside the previously reported troop deployments."},{cat:"Covert War",text:"The Aug 1 Moscow restaurant bombing killing 3 and injuring 20+ remains unofficially linked, but not confirmed by either government, to Gen. Alexander Chayko, commander of Russia’s Aerospace Forces and a Bucha war-crimes suspect."}],watch:"Whether the war crimes investigation into the Myrne execution produces further documentation or identifies additional cases; how the UK air-defense talks translate into concrete interceptor deliveries; and whether the ballistic intercept collapse tracked on this page shows any sign of recovery as Western resupply discussions continue.",generatedAt:new Date().toISOString()};
const IRAN_BRIEFING={summaryShort:"AP: two regional officials briefed on the Hormuz talks believe Khamenei was wounded in the war’s opening strikes — the first sourced explanation for five months of zero public appearances. FM Araghchi reportedly agreed to Hormuz terms ‘in principle’ over the weekend, still awaiting sign-off from Khamenei and the Supreme National Security Council. Trump: the war ‘can’t go much longer.’ Saudi Arabia, Turkey and Pakistan signed a Mecca mutual-defense pact. A large-scale Houthi strike reportedly hit Saudi forces, toll still forming and contested between sources. Hormuz traffic remains subdued — 8 crossings Aug 7, down 33% day-on-day; Bab el-Mandeb crossings rose 18% in the same period. Roughly 9 days to Aug 16.",summary:"The most significant single development this cycle reframes months of speculation: AP reports that two regional officials briefed on the Hormuz negotiations believe Supreme Leader Mojtaba Khamenei was wounded in the war’s opening strikes — the first sourced, attributed explanation for why he has made no in-person public appearance in the five months since succeeding his father. It directly follows President Pezeshkian’s own admission Wednesday that reaching Khamenei directly has become ‘very difficult’ and this week’s Iran International report that Pezeshkian’s only known encounter with a man presented as Khamenei was minutes in a dark car. On the negotiating track itself, two Axios sources say FM Abbas Araghchi agreed to the Hormuz deal’s terms ‘in principle’ over the weekend, but the agreement still requires sign-off from both Khamenei and Iran’s Supreme National Security Council before any announcement — meaning the same access bottleneck now sits squarely between Iran and a deal it has reportedly already agreed to in substance. Trump said Thursday the war ‘can’t go much longer.’ A formal draft outline of Hormuz operating terms has been sent to Iran’s legislature, provoking sharp domestic reaction; the draft reportedly bars vessels linked to the US and Israel, with ambiguity over how broadly ‘linked’ could be interpreted given complex vessel ownership structures. In a major regional development separate from the Hormuz talks, Saudi Arabia’s crown prince, Turkey’s president and Pakistan’s prime minister signed a mutual-defense pact in Mecca — any armed attack on one signatory to be treated as an attack on all three — a significant new security architecture that reshapes the regional calculus around any future Iran confrontation. Separately, multiple outlets report a large-scale Houthi (Ansar Allah) strike on Saudi forces; casualty figures vary sharply between sources (from roughly a dozen wounded to over 50 killed depending on outlet), so the actual toll should be treated as unconfirmed pending clearer corroboration. On the ground, the Strait of Hormuz remained subdued Aug 7 with just 8 confirmed crossings, down 33% day-on-day, with most vessels using Iran’s unilateral routing scheme; Bab el-Mandeb crossings rose 18% in the same period, suggesting some traffic diversion to the alternate chokepoint. Chinese and Indian refiners are reportedly seeking vessels to enter the strait and load discounted crude at Iraq’s Basrah Oil Terminal. Separately, Trump has privately complained that reports of a dwindling Pentagon munitions stockpile make the US look weak in these negotiations, per senior US officials — deepening the story first reported around his Camp David exchange with Hegseth. None of the underlying substantive gaps — enrichment, missiles, formal Hormuz governance — have moved. The nominal 60-day Islamabad MoU window, signed Jun 17, closes around Aug 16 — roughly 9 days out.",assessment:[{cat:"Iran Domestic — Khamenei Wounded (New)",text:"AP: two regional officials briefed on Hormuz talks believe Khamenei was wounded in the war’s opening strikes — the first sourced, attributed explanation for five months without a single in-person public appearance."},{cat:"Diplomacy — Araghchi Agreed in Principle",text:"Two Axios sources say FM Araghchi agreed to Hormuz terms ‘in principle’ over the weekend, but sign-off from Khamenei and Iran’s Supreme National Security Council remains outstanding — the same access bottleneck as the wounded-Khamenei story."},{cat:"Iran’s Legislative Track",text:"A formal draft of Hormuz operating terms, reportedly barring US- and Israel-linked vessels, has been sent to Iran’s legislature and is provoking sharp domestic reaction — ambiguity remains over how broadly ‘linked’ vessels would be interpreted."},{cat:"Regional Security Architecture — Mecca Pact",text:"Saudi Arabia, Turkey and Pakistan signed a mutual-defense pact in Mecca: an attack on any one signatory is to be treated as an attack on all three — a significant new regional alignment separate from, but relevant to, the Iran standoff."},{cat:"Saudi-Houthi Escalation — Toll Unconfirmed",text:"Multiple outlets report a large-scale Houthi strike on Saudi forces with sharply conflicting casualty figures (roughly a dozen wounded to 50+ killed depending on source) — treat the actual toll as unconfirmed pending clearer corroboration."},{cat:"Operational Status",text:"Hormuz traffic remained subdued Aug 7: 8 confirmed crossings, down 33% day-on-day, mostly via Iran’s unilateral routing scheme. Bab el-Mandeb crossings rose 18% in the same window — some diversion to the alternate chokepoint."},{cat:"US Munitions Controversy",text:"Trump has privately complained that dwindling Pentagon munitions stockpile reports make the US look weak in negotiations, per senior officials — the story first surfaced around a reported Camp David exchange with Hegseth."},{cat:"MoU Clock",text:"Enrichment, the missile program, and formal Hormuz governance remain entirely unresolved regardless of any shipping-route framework. Roughly 9 days remain on the nominal 60-day MoU clock (window closes ~Aug 16)."}],watch:"Whether the Khamenei-wounded reporting gets further corroborated, denied, or officially addressed by Tehran; whether Araghchi’s ‘in principle’ agreement converts into an actual signed announcement now that the same access bottleneck blocks both tracks; how the Mecca pact factors into any future US-Iran military calculus; and whether the Houthi-Saudi attack toll clarifies into a single confirmed figure.",generatedAt:new Date().toISOString()};
...
const POLITICAL_CALENDAR=[
  {date:"Aug 18, 2026",label:"DRC–M23 peace deal signing target",note:"Committed Jul 19 in a Doha declaration of principles under Qatari mediation; negotiations on remaining terms were set to restart no later than Aug 8. Echoes prior slipped deadlines (Jun 2025 Washington deal, subsequent Doha framework).",color:"#eab308"},
...
function useCountUp(target,start,duration=1400){
  ...
  useEffect(()=>{
    if(startedRef.current||isNaN(target)||isNaN(start))return;
...
function CountUpTotal({total,delta,duration=1400,style}){
  const target=parseInt(String(total).replace(/[^0-9]/g,""),10);
  if(isNaN(target))return <span style={style}>{total}</span>;
  const d=delta&&delta!=="—"?Math.abs(parseInt(String(delta).replace(/[^0-9]/g,""),10)||0):0;
  const start=Math.max(0,target-d);
  const display=useCountUp(target,start,duration);
  const prefix=String(total).trim().startsWith("+")?"+":"";
  const suffix=(String(total).match(/[^0-9,]+$/)||[""])[0];
  return <span style={style}>{prefix}{display.toLocaleString()}{suffix}</span>;
}
function TrendTooltip({active,payload,label,t,color,unit}){
  if(!active||!payload?.length)return null;
  const v=payload[0]?.value;
  return <div style={{background:t.isDark?"#101d30":"#fff",border:`1px solid ${color}66`,borderRadius:8,padding:"7px 11px",fontSize:11,boxShadow:"0 4px 16px rgba(0,0,0,.28)"}}>
    <div style={{color:t.sub,fontSize:10,marginBottom:2}}>{label}</div>
    <div style={{color,fontWeight:800,fontSize:14,fontVariantNumeric:"tabular-nums"}}>{typeof v==="number"?v.toLocaleString():v}</div>
    <div style={{color:t.sub,fontSize:9.5}}>{unit}</div>
  </div>;
}
...
const REPORT_NOW=new Date("2026-08-07T18:27:00Z");
...
const FIGURES={
  ruPersonnelTotal:"1,455,420",   // General Staff cumulative, as of REPORT_NOW
  ruPersonnelDaily:"+1,210",      // most recent daily delta
...
const SEV_COLORS={critical:"#dc2626",major:"#f97316",watch:"#eab308"};
function sevColor(s){return SEV_COLORS[s]??SEV_COLORS.watch;}
function uaLoss(category){return LOSSES.ukraine.find(l=>l.category===category)??{total:"\u2014",todayChange:"\u2014",color:"#8496a8"};}
function ageInfo(s){const d=parseNewsDate(s);if(!d)return null;const days=Math.floor((REPORT_NOW-d)/86400000);return{days,stale:days>=NEWS_MAX_AGE_DAYS-4,expired:days>=NEWS_MAX_AGE_DAYS};}
function isFreshNews(item){const info=ageInfo(item.publishedAt);return!info||!info.expired;}
...
function LossesTab({t}){const[sortBy,setSortBy]=useState("default");const chartData=CASUALTIES.map(c=>({d:c.date,kia:c.value}));const avg7d=Math.round(CASUALTIES.slice(-7).reduce((a,b)=>a+b.value,0)/7);const vals=chartData.map(d=>d.kia);const yMin=Math.floor(Math.min(...vals)/50)*50-50;const yMax=Math.ceil(Math.max(...vals)/50)*50+50;const sortedByTotal=useMemo(()=>[...LOSSES.ukraine].sort((a,b)=>(parseInt(b.total.replace(/[^0-9]/g,""))||0)-(parseInt(a.total.replace(/[^0-9]/g,""))||0)),[]);const displayLosses=sortBy==="total"?sortedByTotal:LOSSES.ukraine;
  ...
  return <div><ST t={t}>📊 Daily Russian Casualties — Last 14 Days</ST><Card t={t} style={{padding:"14px 8px 8px"}}><div style={{height:180}}><ResponsiveContainer width="100%" height="100%"><AreaChart data={chartData} margin={{top:0,right:4,left:-20,bottom:0}}><defs><linearGradient id="areaGrad" x1="0" y1="0" x2="0" y2="1"><stop offset="5%" stopColor="#ef4444" stopOpacity={0.3}/><stop offset="95%" stopColor="#ef4444" stopOpacity={0}/></linearGradient></defs><XAxis dataKey="d" tick={{fontSize:9,fill:t.sub}} tickLine={false} axisLine={false}/><YAxis domain={[yMin,yMax]} tick={{fontSize:9,fill:t.sub}} tickLine={false} axisLine={false}/><Tooltip cursor={{stroke:"#ef4444",strokeWidth:1,strokeDasharray:"4 3",opacity:0.65}} content={<TrendTooltip t={t} color="#ef4444" unit="killed/wounded that day"/>}/><ReferenceLine y={avg7d} stroke="#fbbf24" strokeDasharray="4 2" strokeWidth={1.5}/><Area type="monotone" dataKey="kia" stroke="#ef4444" fill="url(#areaGrad)" strokeWidth={2} activeDot={{r:5,fill:"#ef4444",stroke:t.isDark?"#0b1420":"#fff",strokeWidth:2}}/></AreaChart></ResponsiveContainer></div><div style={{display:"flex",alignItems:"center",gap:6,padding:"4px 8px",fontSize:11,color:t.sub}}><span style={{width:18,height:2,background:"#fbbf24",display:"inline-block"}}/>7-day avg: ~{avg7d.toLocaleString()}/day</div></Card><div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginTop:14,marginBottom:6}}><ST t={t}>🇷🇺 Equipment Destroyed</ST><div style={{display:"flex",gap:4}}>{["default","total"].map(s=><button key={s} onClick={()=>setSortBy(s)} style={{padding:"3px 8px",fontSize:10,borderRadius:6,cursor:"pointer",fontFamily:FONT,fontWeight:600,background:sortBy===s?"#5b8ec8":"none",color:sortBy===s?"#fff":t.sub,border:`1px solid ${sortBy===s?"#5b8ec8":t.border}`}}>{s==="default"?"Default":"Sort by Total"}</button>)}</div></div><Card t={t}>{displayLosses.map((item,i)=><Row key={item.id} t={t} last={i===displayLosses.length-1}><span style={{fontSize:18,width:28,textAlign:"center",flexShrink:0}}>{item.icon}</span><div style={{flex:1}}><div style={{fontSize:13,fontWeight:600,color:t.text}}>{item.category}</div><div style={{fontSize:11,color:t.sub}}>{item.description}</div></div><div style={{textAlign:"right",flexShrink:0}}><div style={{fontSize:15,fontWeight:700,color:item.color??t.text,fontVariantNumeric:"tabular-nums"}}><CountUpTotal total={item.total} delta={item.todayChange} duration={1200}/></div><div style={{fontSize:11,fontWeight:500,color:item.todayChange==="—"?t.sub:"#22c55e"}}>{item.todayChange}</div></div></Row>)}</Card>
    <ST t={t}>📈 2026 Trends</ST>
    <TrendChart t={t} data={HISTORICAL.ruCasualtiesCumulative} color="#ef4444" label="Cumulative RU Casualties" unit="total killed/wounded" area desc="Crossed 1.4M in June, reached 1,447,620 by end of July. Not a flat rate — attrition has climbed steadily since February’s low, with July’s 42,860 a 2026 record and no sign of the rate easing." />
    <TrendChart t={t} data={ruMonthlyWithMTD()} color="#f97316" label="Monthly RU Casualty Rate" unit="killed/wounded per month" desc="July closed at 42,860 — Russia’s worst month of the war so far per Ukraine’s General Staff, up roughly a third from June’s 39,290. Every month from March onward has cost more than the last; February (26,090) remains the year’s low point. The final point is the current month accumulating in real time from the daily MoD reports, so it sits below the completed months until the month closes." />
    <div style={{height:150}}><ResponsiveContainer width="100%" height="100%">
        <ComposedChart data={weeklyCas} margin={{top:4,right:8,left:-12,bottom:0}}>
          ...
          <Tooltip cursor={{fill:"#ef444422"}} content={<TrendTooltip t={t} color="#ef4444" unit="avg/day, 7-day window"/>}/>
    ...
    <TrendChart t={t} data={HISTORICAL.ruTerritoryKm2} color="#eab308" label="RU Territorial Gains" unit="km² captured per month" desc="Russian advance peaked in March (31km²), fell through June, then ticked back up in July to a new year-high ~38km², per ISW — but that uptick came the same month Russia suffered a record 42,860 casualties, the starkest attrition-vs-gain mismatch of the war so far." />
    <TrendChart t={t} data={costPerKm} color="#dc2626" label="Casualties per km² Gained" unit="RU killed/wounded per km² captured" area desc="Derived series: monthly casualties divided by territorial gain. The ratio bottomed at ~1,030 in March, then climbed sharply through Q2 as gains shrank while casualties rose, peaking at ~3,570 per km² in June. July reversed that spike — back down to ~1,130 per km² — not because the war got cheaper, but because territorial gains jumped back to a year-high (~38km²) alongside record casualties (42,860). Read alongside the raw casualty and territory charts above rather than in isolation." />
    <TrendChart t={t} data={HISTORICAL.refineryOffline} color="#22c55e" label="RU Refining Capacity Offline" unit="% of national capacity" area desc="From ~8% in January to 43% by July, per Ukraine's General Staff — the cumulative effect of the deep-strike campaign on Russia's fuel economy. Some independent trackers reported even steeper mid-to-late-July estimates; 43% is the more conservative, officially-sourced figure." />
  </div>;}
...
const STRIKE_IMPACT_WEEK={weekLabel:"Jul 30 \u2013 Aug 5",cities:[
  {name:"Kyiv",x:186.6,y:71.4,hit:true,severity:"critical",note:"Hit twice this week. Aug 1: 27 ballistic missiles + 185 Shaheds, 9 killed, 30+ wounded, only 1 ballistic missile intercepted. Aug 5: 24 ballistic + 4 Zircon/Oniks + 115 drones, 14-17 killed, dozens wounded, zero ballistic missiles intercepted \u2014 warehouses and logistics hubs (Epicentr, Rozetka, Fozzy, Nova Poshta) took the brunt both nights."},
  {name:"Kharkiv",x:309.2,y:86.2,hit:true,severity:"major",note:"Aug 2-3: transport, industrial, cultural and educational infrastructure struck, per ISW/Critical Threats \u2014 Russian sources also claimed a Nova Poshta terminal and gas station hit. No confirmed casualty count found for this week specifically."},
  {name:"Dnipro",x:283.6,y:135.4,hit:true,severity:"minor",note:"Aug 3: hit alongside Kharkiv and Kryvyi Rih in a wider round of frontline-zone strikes, per Russian MoD claims relayed through Pravda's daily chronicle \u2014 lower confidence source, no independent casualty confirmation found."},
  {name:"Odesa",x:190.8,y:199.2,hit:true,severity:"major",note:"Repeatedly targeted this week \u2014 Aug 2: fuel tanks struck at Odesa City Port per Russian MoD claims; Aug 3: infrastructure hit again per Pravda chronicle; Russia separately claimed hitting three bulk carriers off the coast it called Ukrainian military transports, unconfirmed by Kyiv."},
  {name:"Donetsk",x:342.9,y:149.6,hit:false},
  {name:"Luhansk",x:375.3,y:131.9,hit:false},
]};
function StrikeImpactMap({t,data}){
  const[sel,setSel]=useState(null);
  const selCity=sel?data.cities.find(c=>c.name===sel):null;
  const sevColor=s=>s==="critical"?"#ef4444":s==="major"?"#f97316":"#eab308";
  return <div>
  ...
  {!selCity&&<div style={{fontSize:10.5,color:t.sub,textAlign:"center",marginBottom:8,opacity:0.6}}>Tap a highlighted city for strike detail</div>}
  </div>;
}
function AirDefTab({t}){return <div>
      <Hero t={t} color="#06b6d4"><div style={{fontSize:11,fontWeight:800,letterSpacing:".12em",color:"#67e8f9",marginBottom:6}}>🛡️ AIR DEFENSE — THE INTERCEPT WAR</div><div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>Ukraine wins the drone fight on economics and loses the ballistic fight on inventory. A brief late-July recovery (up to 71% on Jul 25-26) reversed hard in August: 1 of 27 intercepted Aug 1 in Kyiv, 0 of 24 nationwide on Aug 5. The gap was never skill — it is PAC-3 stock, and Zelensky says allies have delivered only a third of 2026's planned air-defense missiles versus 2025. On Jul 8 at Ankara, Trump licensed Ukraine to manufacture Patriots itself; no timeline yet exists.</div></Hero>
      <Grid2 t={t} items={[
        ...
        {icon:"🚀",label:"Ballistic intercepts",val:"0 of 24",sub:"Aug 5 nationwide. 1 of 27 on Aug 1 (Kyiv). June baseline: 14 of 54 (CSIS).",color:"#dc2626"},
      ...
      <ST t={t} color="#06b6d4">🗺️ This Week's Impact Map</ST>
      <StrikeImpactMap t={t} data={STRIKE_IMPACT_WEEK}/>
      <div style={{fontSize:10.5,color:t.sub,lineHeight:1.5,marginBottom:12,paddingLeft:2}}>Shows confirmed large-scale strikes on major Ukrainian cities this week only — not every reported incident. Ballistic intercept rate trend (June\u2013present) moved to Ukraine Overview.</div>
...
<Card t={t} style={{padding:"12px 8px 8px"}}>
  ...
  <div style={{height:120}}><ResponsiveContainer width="100%" height="100%"><AreaChart data={HISTORICAL.refineryOffline} margin={{top:4,right:8,left:-14,bottom:0}}><defs><linearGradient id="g_ovRef" x1="0" y1="0" x2="0" y2="1"><stop offset="5%" stopColor="#f97316" stopOpacity={0.4}/><stop offset="95%" stopColor="#f97316" stopOpacity={0}/></linearGradient></defs><XAxis dataKey="m" tick={{fontSize:9,fill:t.sub}} tickLine={false} axisLine={false}/><YAxis tick={{fontSize:8,fill:t.sub}} tickLine={false} axisLine={false} width={30} tickFormatter={v=>v+"%"}/><Tooltip cursor={{stroke:"#f97316",strokeWidth:1,strokeDasharray:"4 3",opacity:0.65}} content={<TrendTooltip t={t} color="#f97316" unit="% of national capacity offline"/>}/><Area type="monotone" dataKey="v" stroke="#f97316" strokeWidth={2} fill="url(#g_ovRef)" name="Refining offline %" activeDot={{r:5,fill:"#f97316",stroke:t.isDark?"#0b1420":"#fff",strokeWidth:2}}/></AreaChart></ResponsiveContainer></div>
  <div style={{fontSize:10,color:t.sub,padding:"6px 10px 2px",textAlign:"right"}}>Deeper energy & attrition trends: RU Economy tab · Losses tab (2026 Trends)</div>
</Card>
...
<ST t={t}>📋 This Week in the War</ST><Card t={t}>{WEEK_UPDATES.map((u,i)=><Row key={i} t={t} last={i===WEEK_UPDATES.length-1}><div style={{fontSize:12.5,color:t.text,lineHeight:1.55}}>{u}</div></Row>)}</Card><ST t={t} color="#06b6d4">🛡️ Ballistic Intercept Rate</ST><Card t={t} style={{padding:"12px 14px 10px"}}>
...
function Sparkline({data,color,width=56,height=20}){
  ...
  useEffect(()=>{
    if(lineRef.current){
      try{setPathLen(lineRef.current.getTotalLength());}catch(e){setPathLen(null);}
    }
  },[data]);
  useEffect(()=>{
  ...
  const L=pathLen??300;
  return <svg ref={svgRef} width={width} height={height} style={{display:"block",flexShrink:0}} aria-hidden="true">
    <polyline ref={lineRef} points={pts} fill="none" stroke={color} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" style={{strokeDasharray:L,strokeDashoffset:visible?0:L,transition:pathLen?"stroke-dashoffset .8s ease-out":"none"}}/>
    <circle cx={width} cy={lastY} r="2" fill={color} style={{opacity:visible?1:0,transition:"opacity .3s ease-out .55s"}}/>
  </svg>;
}
...
// ── Today View ─────────────────────────────────────────────────────────────────────
const HISTORICAL={
  ruCasualtiesCumulative:[{m:"Jan",v:1240580},{m:"Feb",v:1266670},{m:"Mar",v:1298670},{m:"Apr",v:1331670},{m:"May",v:1365470},{m:"Jun",v:1404760},{m:"Jul",v:1447620}],
  ruCasualtiesMonthly:[{m:"Jan",v:31700},{m:"Feb",v:26090},{m:"Mar",v:32000},{m:"Apr",v:33000},{m:"May",v:33800},{m:"Jun",v:39290},{m:"Jul",v:42860}],
  refineryOffline:[{m:"Jan",v:8},{m:"Feb",v:14},{m:"Mar",v:19},{m:"Apr",v:25},{m:"May",v:38},{m:"Jun",v:40},{m:"Jul",v:43}],
  ruTerritoryKm2:[{m:"Jan",v:18},{m:"Feb",v:24},{m:"Mar",v:31},{m:"Apr",v:22},{m:"May",v:16},{m:"Jun",v:11},{m:"Jul",v:38}],
  ...
  boatStrikeDeaths:[{m:"Jan",v:24},{m:"Feb",v:58},{m:"Mar",v:97},{m:"Apr",v:142},{m:"May",v:188},{m:"Jun",v:221},{m:"Jul",v:221}],
    oilPriceBrent:[{m:"Jan",v:61},{m:"Feb",v:72},{m:"Mar",v:118},{m:"Apr",v:92},{m:"May",v:107},{m:"Jun",v:85}],
    ...
    <div style={{height:140}}>
      <ResponsiveContainer width="100%" height="100%">
        <Chart data={data} margin={{top:4,right:8,left:-12,bottom:0}}>
          ...
          <Tooltip cursor={{stroke:color,strokeWidth:1,strokeDasharray:"4 3",opacity:0.65}} content={<TrendTooltip t={t} color={color} unit={unit}/>}/>
          {area?<Area type="monotone" dataKey="v" stroke={color} fill={`url(#g_${label.replace(/[^a-z]/gi,"")})`} strokeWidth={2} activeDot={{r:5,fill:color,stroke:t.isDark?"#0b1420":"#fff",strokeWidth:2}}/>:<Line type="monotone" dataKey="v" stroke={color} strokeWidth={2} dot={(p)=>p.index===partialIdx?<circle key={p.index} cx={p.cx} cy={p.cy} r={4} fill={t.card} stroke={color} strokeWidth={2} strokeDasharray="2 1.5"/>:<circle key={p.index} cx={p.cx} cy={p.cy} r={2.5} fill={color}/>} activeDot={{r:5,fill:color,stroke:t.isDark?"#0b1420":"#fff",strokeWidth:2}}/>}
        </Chart>
      </ResponsiveContainer>
    </div>
...
const BALLISTIC_INTERCEPTS_RECENT=[
  ...
  {label:"Aug 1 (Kyiv)",n:27,downed:1,src:"Zelensky/UA AF via Reuters, NPR"},
  {label:"Aug 5 (nationwide)",n:24,downed:0,src:"UA AF via Reuters"},
];
  ...
  return <div>
    ...
    {tab==="governance"&&<div>
      ...
      <Card t={t}>{[
        ...
        {icon:"🎖",label:"Aug 2 — Al-Quds Brigades consents",text:"Islamic Jihad’s armed wing, the second-largest militant faction in Gaza after Hamas, agreed to the disarmament plan on Aug 2 — a real, if partial, widening of buy-in beyond Hamas alone. Whether smaller factions and clan militias follow remains unresolved."},
        {icon:"🚫",label:"Aug 4 — Netanyahu hardens public line",text:"Netanyahu said Israel will not withdraw ‘from our current lines’ in Gaza ‘until Hamas is completely disarmed’ — a firmer, more public rejection of the sequencing Hamas has demanded. National Security Minister Ben-Gvir called the plan ‘unacceptable’; former PM Naftali Bennett countered that Netanyahu ‘gave the Qataris the keys to Gaza’ and bears responsibility for stalling implementation."},
        {icon:"⚠️",label:"Strikes intensified after the deal, not before",text:"Israeli strikes killed at least 18 Palestinians on Aug 1 — the single biggest daily toll in weeks — followed by more deaths Aug 2-3, including two warehouses near a hospital struck as alleged Hamas weapons caches. Gaza’s Civil Defence completed a two-week search of one flattened Sabra-neighborhood home on Aug 1, recovering 112 bodies, 40 of them children. The disarmament announcement has not yet translated into reduced violence on the ground."},
...
function RHRadarMap({t}){
  ...
  return <Card t={t} style={{padding:"12px 8px 8px",background:PANEL,border:`1px solid ${LINE}`}}>
    ...
    <div style={{padding:"8px 6px 0",display:"flex",gap:8,flexWrap:"wrap",fontSize:8.5,color:PAPERDIM}}>
      <span>\u25cf<span style={{color:ALARM}}>\u25cf</span> Struck</span>
...
function HormuzMap({t}){
  ...
  return <Card t={t} style={{padding:"12px 8px 8px",background:PANEL,border:`1px solid ${LINE}`}}>
    ...
    <svg viewBox={`0 0 ${HZ.W} ${HZ.H}`} style={{width:"100%",height:"auto",display:"block"}} role="img" aria-label="Radar-style map of the Strait of Hormuz showing Iran, Oman's Musandam Peninsula, the shipping lane and the 21-nautical-mile chokepoint.">
      ...
      <path d={HZ_IRAN_PATH} fill="#141f18" stroke="#2c4034" strokeWidth="1"/>
      <path d={HZ_OMAN_PATH} fill="#141f18" stroke="#2c4034" strokeWidth="1"/>

      <path d={hzPath(HZ_LANE)} fill="none" stroke={ICE} strokeWidth="7" strokeOpacity="0.14" strokeLinecap="round" strokeLinejoin="round"/>
      <path d={hzPath(HZ_LANE)} fill="none" stroke={ICE} strokeWidth="1.6" strokeDasharray="7 5" strokeLinecap="round" strokeLinejoin="round"/>
    ...
    <div style={{display:"flex",gap:12,flexWrap:"wrap",padding:"8px 6px 2px",fontSize:9,color:PAPERDIM}}>
      ...
      <span><span style={{display:"inline-block",width:14,height:2,background:ICE,marginRight:4,verticalAlign:"middle"}}/>Shipping lane</span>
      <span><span style={{display:"inline-block",width:10,height:8,background:"#ff4a3540",marginRight:4,verticalAlign:"middle"}}/>US blockade zone</span>
    </div>
...
function IranSection({t,initialTab}){
  const[tab,setTab]=useState(initialTab??"hormuz");useEffect(()=>{if(initialTab)setTab(initialTab);},[initialTab]);
  ...
  const GAPS=[
  {icon:"🚢",label:"Hormuz governance & routes",status:"NEARING DEAL, DISPUTED TERMS",color:"#f97316",text:"The gap that ignited Jul 6-8 has moved from missiles to a negotiating table: Iran and Oman say a route's geographic coordinates are agreed and a joint statement is in final drafting, awaiting Khamenei's sign-off. But Deputy FM Gharibabadi says ships would transit Iranian territorial waters on both inbound and outbound legs — not the split Iran/Oman routes earlier reported — and US officials say they won't accept an arrangement that leaves Iran in control. Iran's Parliament is separately drafting a bill barring US- and Israel-linked vessels outright. The MoU text obliged Iran to keep the strait open and toll-free through the 60-day window — both sides still claim the other broke it, even as they negotiate past it."},
  ...
  return <div>
    ...
    {tab==="overview"&&<div>
      <div style={{background:t.isDark?"linear-gradient(135deg,#1a0f24,#241238)":"linear-gradient(135deg,#f3ecfb,#ece3f8)",border:"1px solid rgba(139,92,246,0.25)",borderLeft:"4px solid #8b5cf6",borderRadius:14,padding:"14px 16px",marginBottom:16}}>
        ...
        {briefExpanded&&<div style={{marginTop:10,paddingTop:10,borderTop:`1px solid ${t.isDark?"rgba(255,255,255,.08)":"rgba(0,0,0,.08)"}`}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:7}}>
            {IRAN_BRIEFING.assessment.map((a,i)=><div key={i} style={{fontSize:11.5}}>
              <div style={{color:"#8b5cf6",fontWeight:700,marginBottom:2}}>{a.cat}</div>
              <div style={{color:t.sub,lineHeight:1.5}}>{a.text}</div>
            </div>)}
          </div>
        </div>}
      ...
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <Grid2 t={t} items={[{val:"Final drafting",label:"Iran-Oman framework",sub:"Route coordinates agreed; joint statement pending",color:"#8b5cf6"},{val:"Awaiting Khamenei",label:"Final approval",sub:"Draft reportedly complete, sign-off still pending",color:"#f97316"},{val:"Both legs",label:"Iran’s ask",sub:"Inbound + outbound via Iranian waters — US resists",color:"#dc2626"},{val:"9 days",label:"MoU clock (nominal)",sub:"Hormuz talks now the live front of the MoU",color:"#8b5cf6"}]}/>
      </Hero>
    ...
    {tab==="timeline"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>From Operation Epic Fury (Feb 28) through the Islamabad MoU and the 9-day countdown to Aug 16.</div>
      </Hero>
      <EventsTimeline t={t} events={events} label="US-Iran War Timeline"/>
    </div>}
    {tab==="gaps"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #ef4444"}}>
        <div style={{fontSize:11,color:"rgba(255,255,255,.4)",textTransform:"uppercase",letterSpacing:".08em",marginBottom:8}}>⚠️ Unresolved Gaps — 9 Days Remain</div>
    ...
    {tab==="hormuz"&&<div>
      ...
      <Grid2 t={t} items={[
        ...
        {icon:"⏳",label:"MoU deadline",val:"Aug 16 (9 days)",sub:"60-day Islamabad window — Hormuz talks now its live front",color:"#8b5cf6"},
      ]}/>
      ...
      <Card t={t}><div style={{padding:"11px 14px"}}><div style={{fontSize:12,color:t.sub,lineHeight:1.7}}>
        ...
        <div style={{marginTop:6}}><span style={{color:t.text,fontWeight:700}}>Jul 30 – Aug 3 — diplomacy quietly overtakes the guns</span> — After the Jul 29-30 retaliation spike (Kuwait/Jordan/Bahrain), the story shifts from strikes to talks: Iran and Oman resume negotiating a shipping-route framework, with both sides describing coordinates as agreed by Aug 4-5. CENTCOM maintains the blockade throughout — 49 vessels redirected in total since mid-July.</div>
...
function USMilSection({t,initialTab}){
  ...
  const VECTORS=[
    ...
    {flag:"🇮🇷",name:"Iran — Nuclear Clock",status:"9 DAYS",color:"#8b5cf6",text:"Islamabad MoU 60-day window closes ~Aug 16. IAEA inspector access disputed. Enrichment red lines unresolved — Pezeshkian: 'we will never back down from the right to enrich uranium.'"},
...
;
  ...
  return <div>
    <div style={{display:"flex",gap:4,flexWrap:"wrap",marginBottom:12}}>
      {TABS.map(tb=>{const isCyber=tb.id==="cyber";return <button key={tb.id} onClick={()=>setTab(tb.id)} style={{padding:isCyber?"5px 12px":"5px 10px",fontSize:11,borderRadius:16,cursor:"pointer",fontFamily:FONT,fontWeight:isCyber?800:600,background:tab===tb.id?(isCyber?"#dc2626":"#5b8ec8"):(isCyber?"rgba(220,38,38,.14)":"none"),color:tab===tb.id?"#fff":(isCyber?"#f87171":t.sub),border:`${isCyber?"1.5px":"1px"} solid ${tab===tb.id?(isCyber?"#dc2626":"#5b8ec8"):(isCyber?"#dc2626":t.border)}`}}>{tb.label}</button>;})}
    </div>
    ...
    {tab==="escalation"&&<div>
      ...
      <Card t={t}><div style={{padding:"14px 16px"}}>
        ...
        {escExpanded&&<div style={{marginTop:10,paddingTop:10,borderTop:`1px solid ${t.isDark?"rgba(255,255,255,.08)":"rgba(0,0,0,.08)"}`}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:7}}>
            {ESCALATION_BRIEFING.assessment.map((a,i)=><div key={i} style={{fontSize:11.5}}>
              <div style={{color:"#dc2626",fontWeight:700,marginBottom:2}}>{a.cat}</div>
              <div style={{color:t.sub,lineHeight:1.5}}>{a.text}</div>
            </div>)}
          </div>
        </div>}
...
function VenezuelaSection({t,initialTab}){
  ...
  return <div>
    ...
    {tab==="conflict"&&<div>
      ...
      <Note t={t} color="#0ea5e9">Death toll resumed climbing after a brief plateau: 235 (Jun 26) → 3,535 (Jul 7) → 4,930 (Jul 16) → 5,546 (Jul 25) → 6,125 confirmed (Aug 3, per National Assembly President Jorge Rodríguez) — a jump of nearly 600 in the space of a week, with 61,000 people treated in hospitals to date. World Bank places physical damage at ~$20B; funding sources for reconstruction remain unclear despite international pledges. The missing count is the most contested figure: Venezuela's government hasn't updated its own tally since Jun 25 (157 then), leaving the field to a citizen-run tracker reporting ~29,500 unresolved reports as of Jul 25 — plausible given UN estimates of 40,000–50,000 still unaccounted for in mid-July. Caracas and La Guaira remain hardest-hit.</Note>
    ...
    {tab==="colombia"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #fcd116"}}>
        ...
        <Grid2 t={t} items={[
          ...
          {icon:"🗳️",label:"De la Espriella inaugurated",val:"Aug 7, 2026",sub:"Right-wing outsider won Jun 21 runoff, 49.66%–48.7%",color:"#5b8ec8"},
        ]}/>
      </Hero>
      ...
      <ST t={t} color="#fcd116">🗳️ The election that ends Total Peace</ST><Card t={t} style={{borderLeft:"4px solid #5b8ec8"}}><div style={{padding:"11px 14px"}}><div style={{fontSize:12,color:t.sub,lineHeight:1.7}}><div style={{marginBottom:6}}><span style={{color:t.text,fontWeight:700}}>The result</span> — Right-wing outsider Abelardo de la Espriella, a criminal-defense lawyer endorsed by Trump, won the Jun 21 runoff with 49.66% to leftist Iván Cepeda’s 48.7% — a margin of roughly 250,000 votes out of 12.9M cast, the highest turnout since Colombia’s runoff system began in 1994. Petro-aligned Cepeda alleged irregularities without evidence; international observers called the process orderly and transparent. It marks Colombia’s first transfer of power from a leftist to a right-wing president in modern history — Petro is constitutionally barred from a second term.</div><div style={{marginBottom:6}}><span style={{color:t.text,fontWeight:700}}>Inauguration, Aug 7</span> — De la Espriella takes office alongside VP José Manuel Restrepo (a former finance minister, seen as a market-friendly signal) at a military garrison in Cauca province rather than Bogotá’s Plaza de Bolívar — the first break with that 140-year tradition. Congress temporarily relocated to Cauca to hold the ceremony; de la Espriella framed the choice as a tribute to the armed forces and a rebuke of the outgoing government.</div><div style={{marginBottom:6}}><span style={{color:t.text,fontWeight:700}}>Total Peace dismantled before he even takes office</span> — The incoming government has already announced the elimination of the Peace Commissioner post entirely, replacing it with a "High Commissioner for Security" — an explicit rejection of what de la Espriella calls "false peace" processes. His interior-security pick has pledged that, starting Aug 7, the administration will reinstate arrest warrants against ELN and FARC-dissident leaders, reversing the suspensions Petro granted during negotiations. A broader restructuring cuts 229 government posts.</div><div><span style={{color:t.text,fontWeight:700}}>The record Total Peace leaves behind</span> — Illegal armed-group membership grew roughly 90% under the policy, from about 15,120 fighters in 2022 to nearly 29,000 by Jul 2026 (Clan del Golfo more than doubled; ELN grew 22%), per la FIP. Only one faction — 99 Comandos de la Frontera dissidents in Putumayo — successfully demobilized. Intelligence agencies have warned of possible strikes in major cities timed to the inauguration; analysts expect the ELN and FARC dissidents to resist de la Espriella’s hard-line shift rather than stand down.</div></div></div></Card><ST t={t} color="#fcd116">🧩 A fractured battlefield</ST>
      <div style={{display:"flex",justifyContent:"flex-end",marginBottom:6}}>
...
function AfricaSection({t,initialTab,onFlash}){
  ...
  return <div>
    ...
    {tab==="sudan"&&<div>
      ...
      <ST t={t} color="#dc2626">🚨 El-Obeid — the next El Fasher?</ST><Card t={t}><div style={{padding:"11px 14px"}}><div style={{fontSize:12,color:t.sub,lineHeight:1.7}}>The RSF has spent months massing forces around El-Obeid, North Kordofan’s capital and a key SAF logistics hub linking southern and western Sudan to the Nile Valley — the city hosts the SAF’s 5th Infantry Division and its joint operations room with Egypt, set up after El Fasher fell. The UN Human Rights Council passed a motion Jul 6 condemning escalating violence and warning that an RSF assault could replicate the “hallmarks of genocide” documented at El Fasher. Roughly 500,000 people, including 105,000 already displaced by earlier fighting, remain trapped in the city with nowhere safe to flee; some residents are buying bus tickets out at a rate of roughly 500 people a day. The RSF has kept up “relentless” drone strikes on the city — UN High Commissioner Volker Türk cited 50 civilians killed in drone strikes over just 10 days in late June — damaging the power station, disrupting water supplies, and striking markets and schools. The US State Department has separately warned of “alarming indications that mass atrocities could be imminent.” As of early August the city has not yet fallen, but the encirclement is tightening and no ceasefire or humanitarian corridor has been agreed.</div></div></Card><ST t={t} color="#dc2626">🛸 The drone war escalation</ST>
    ...
    {tab==="drc"&&<div>
      ...
      <ST t={t} color="#eab308">📅 A new signing target: Aug 18</ST><Card t={t}><div style={{padding:"11px 14px"}}><div style={{fontSize:12,color:t.sub,lineHeight:1.7}}>The DRC and M23 committed Jul 19 to signing a full peace agreement by Aug 18, per a declaration of principles signed in Doha under Qatari mediation — negotiations on the remaining terms were set to restart no later than Aug 8. Trump’s senior Africa adviser Massad Boulos called both sides “confident and hopeful,” but the timeline echoes the Jun 2025 Washington deal and the subsequent Doha framework, both of which set ambitious dates that slipped as fighting continued on the ground. Whether Aug 18 holds is this theater’s most concrete near-term test.</div></div></Card><ST t={t} color="#eab308">⛏️ Minerals & the US Deal</ST>
      <Card t={t}><div style={{padding:"11px 14px"}}>
    ...
    {tab==="sahel"&&<div>
      ...
      <ST t={t} color="#dc2626">🔒 Shrinking oversight</ST><Card t={t}><div style={{padding:"11px 14px"}}><div style={{fontSize:12,color:t.sub,lineHeight:1.7}}>The UN Human Rights Office announced Jun 30 it will permanently close its Burkina Faso office after authorities indefinitely suspended its activities in February, following OHCHR criticism of restrictions on civic space. Burkinabé authorities suspended at least 929 civil society groups between April and May alone. The UN recorded 2,640 conflict-related civilian deaths across the central Sahel in the first quarter of 2026 — a toll compounding as independent monitoring capacity itself shrinks.</div></div></Card><ST t={t} color="#8b5cf6">🇷🇺 The Russia Pivot</ST>
      <Card t={t}><div style={{padding:"11px 14px"}}>
...
function SouthAsiaSection({t,initialTab,onFlash}){
  ...
  return <div>
    ...
    <ST t={t} color="#f97316">🗳️ Pakistan-administered Kashmir election crisis</ST><Card t={t}><div style={{padding:"11px 14px"}}><div style={{fontSize:12,color:t.sub,lineHeight:1.7}}>An election in Pakistan-administered Kashmir (AJK) deteriorated into one of Pakistan’s biggest political challenges in the region since the Kashmir conflict began, per Al Jazeera (Jul 29) — weeks of protests by a now-banned group demanding electoral reforms escalated into confrontations between demonstrators and security forces that left dozens dead. The unrest is domestic to Pakistan’s side of the Line of Control rather than a cross-border incident, but it underscores that AJK’s own governance remains a live pressure point independent of the India-Pakistan military standoff.</div></div></Card><ST t={t} color="#f97316">💧 Water, tariffs and a cautious thaw</ST>
...
const SECTION_TAB_LISTS={
  ...
  iran:[{id:"hormuz",label:"🚢 Hormuz"},{id:"overview",label:"🇮🇷 Overview"},{id:"timeline",label:"📅 Timeline"},{id:"gaps",label:"⚠️ Gaps"}],
