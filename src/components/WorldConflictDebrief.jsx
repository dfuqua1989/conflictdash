...
const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,405,900",todayChange:"+1,140",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
...
const BRIEFING={summary:"Ukraine held total Russian losses at 1,405,900 (Jul 1 figure; Jul 3 report pending) while pressing its Crimea campaign — the SBU struck Saky airbase for the second time in a week, hitting seven aircraft, as new MoD data showed a record 2,074 Russian artillery systems destroyed in June, the highest monthly total of the war. The NATO Ankara summit opens Jul 7: a draft declaration pledges €70B in 2026 Ukraine aid and reaffirms Article 5, though it remains unratified and US-Europe burden-sharing friction persists. The US-Iran stand-down holds into its fifth day; the Doha round produced a violation-notification channel, with nuclear talks deferred until after Khamenei's Jul 9 burial. El-Obeid remains under RSF siege.",signals:[{theater:"Ukraine",text:"1.4M+ RU losses — 2nd Saky strike, record June artillery losses"},{theater:"NATO",text:"Ankara opens Jul 7 — draft: €70B aid, Article 5 reaffirmed"},{theater:"Iran",text:"Stand-down holds; nuclear talks after Jul 9 funeral"},{theater:"Sudan",text:"El-Obeid siege — humanitarian collapse deepening"}],watch:"Next 72hrs: NATO Ankara final declaration (will the €70B survive ratification?); whether Russia's telegraphed mass strike on Ukraine materializes; Khamenei funeral processions Jul 4-9 as an Iran stability test; Pokrovsk encirclement risk.",generatedAt:new Date().toISOString()};
const UKRAINE_BRIEFING={summary:"Russia's attrition math has become unsustainable even as its ground offensive grinds on. CSIS's July 1 assessment puts the Russia:Ukraine battlefield loss ratio at nearly 8:1 in H1 2026 — up from 2:1-3:1 for most of the war — credited largely to Ukraine's AI-enabled drone interdiction campaign. Russian monthly casualties (30,000+) now exceed monthly recruitment (~27,000), a deficit compounding every month it continues. That said, the war is not simply going well for Ukraine: Russia's stalled offensive still holds Pokrovsk at genuine encirclement risk, and the Patriot/PAC-3 shortage — worsened by the 2026 Iran war draining US stocks — remains the one gap Ukraine cannot close on its own.",assessment:[{cat:"Attrition",text:"~8:1 RU:UA loss ratio in H1 2026 (CSIS). June set records: 2,074 Russian artillery systems destroyed (highest of the war) and the highest air-defense losses in two years, per Ukraine's MoD."},{cat:"Territory",text:"Russian advance has slowed to 50-90m/day around Pokrovsk, Kostiantynivka and Sloviansk — among the slowest rates of any war in the past century. Russia had a net territorial LOSS in Apr-May 2026 (~400 km²), its first monthly net loss since Aug 2024."},{cat:"Deep Strikes",text:"Crimea airpower now a sustained target — Saky airbase struck twice in a week (7 aircraft hit Jul 3), alongside the Jul 1-2 Ufa/Penza refinery-and-missile-component wave."},{cat:"Air Defense",text:"91.7% drone intercept rate (May '26). Interceptor-drone economics ($7.5k vs. a $35k Shahed) have flipped the cost equation Ukraine's way — though ballistic missile defense is the exception, with Patriot/PAC-3 stock critically short."},{cat:"Diplomacy",text:"NATO Ankara Summit 6 days out; Russia has already rejected the Turkish ceasefire push heading into it. Track remains blocked."}],watch:"Whether Pokrovsk holds — that single sector is the most consequential near-term variable, sitting against an otherwise favorable attrition and territorial picture.",generatedAt:new Date().toISOString()};
...
const SIGNALS_TODAY=[{icon:"☠️",val:"1,405,900",label:"Total Russian losses",sub:"+1,140 (Jul 1) — Day 1,591",color:"#ef4444",trend:[1310,1350,1250,1230,1350,1210,1140]},{icon:"🛸",val:"2,123",label:"RU drones downed",sub:"claimed Jul 1 (Gen Staff daily)",color:"#5b8ec8",trend:[1650,1720,1873,1900,2100,1891,2123]},{icon:"⚓",val:"0 vessels",label:"BSF in Black Sea",sub:"Fleet fully expelled — historic",color:"#5b8ec8",trend:[12,10,8,6,4,2,0]},{icon:"🏝️",val:"47+",label:"SCS incidents in 2026",sub:"Near-daily water cannons",color:"#eab308",trend:[28,32,35,38,42,44,47]},{icon:"☢️",val:"45 days",label:"Iran nuclear clock",sub:"MoU clock — Aug 16 deadline",color:"#8b5cf6",trend:[66,64,52,49,48,46,45]},{icon:"🛢️",val:"~40%",label:"Russian refineries offline",sub:"French seized shadow fleet tanker",color:"#22c55e",trend:[15,22,28,30,35,38,40]},{icon:"🌉",val:"4 severed",label:"Crimea supply routes",sub:"Rail · fuel · power · road",color:"#f97316",trend:[1,1,2,2,3,3,4]}];
...
const REPORT_NOW=new Date("2026-07-03T12:00:00Z");
...
function BriefingPanel({t}){
  ...
  const regen=async()=>{
    ...
    const prompt=`You are the night editor of World Conflict Debrief, a global conflict intelligence dashboard. Today is 3 July 2026.
...
const DW_MONTHLY = [
  ...
  { month:"Jun '26", yr:2026, ru:7334, ua:9335, ruRate:91, uaRate:18, civ:98,  inj:449, alert_h:8.3, pw_gwh:3.7,  ru_cost:257, ua_cost:226, adDrone:45, adSam:25, adMfg:22, adEw:8, c:true,  src:"Jun 1–29 partial data (29 days). Confirmed: Jun 2 mass attack (22 killed), Jun 18 Moscow refinery hit x2, Jun 24 Orenburg helium plant strike, Jun 26 one of UA's largest drone assaults (660+, RU MoD claim), Jun 29 RU strikes killed 13/injured 109, Dubna comms center struck twice. Est. based on updated ~253 RU/day, ~322 UA/day." },
];
    ...
    <div style={{ background:DWC.bg, color:DWC.text, fontFamily:FONT, borderRadius:12, padding:"14px 12px", marginTop:4 }}>
      <div style={{ marginBottom:16 }}>
        <div style={{ display:"flex", alignItems:"center", gap:10, flexWrap:"wrap" }}>
          ...
          <span style={{ background:"#1e3a5f", color:DWC.uaLt, borderRadius:4, padding:"2px 8px", fontSize:11, fontWeight:700 }}>RUSSIA-UKRAINE · UPDATED JUN 30 '26</span>
        </div>
      ...
      {tab==="overview" && <>
        <div style={{ display:"flex", gap:6, marginBottom:14, flexWrap:"wrap" }}>
          ...
          <span style={{ marginLeft:"auto", color:DWC.muted, fontSize:11, alignSelf:"center" }}>{dailySlice.length} days · Jun 30, 2026</span>
        </div>
      ...
      {tab==="strikelog" && <>
        ...
        <DWCard style={{ marginBottom:14 }}>
          <DWSectionHead color={DWC.ua} icon="📋" title="Ukrainian Deep-Strike Drone Log" sub="confirmed long-range strikes · May 8 – Jun 30, 2026"/>
...
function SplashScreen({onDone}){
  ...
  return <div style={{position:"fixed",inset:0,zIndex:9999,display:"flex",alignItems:"center",justifyContent:"center",background:"radial-gradient(ellipse at center,#0a1526 0%,#050a14 70%)",animation:phase==="out"?"splashFadeOut .6s ease forwards":"none",overflow:"hidden"}}>
    ...
    <div style={{position:"relative",display:"flex",flexDirection:"column",alignItems:"center",gap:22}}>
      <div style={{position:"relative",width:"66vw",maxWidth:280,aspectRatio:"3/2",borderRadius:14,overflow:"hidden",boxShadow:"0 0 90px rgba(0,87,183,0.6),0 0 30px rgba(255,215,0,0.15)",animation:"flagWave 3s ease-in-out infinite"}}>
        ...
        <div style={{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center"}}>
          ...
          <span style={{fontSize:56,animation:"tridentIn .8s cubic-bezier(.34,1.56,.64,1) .55s both, splashPulse 2.2s ease-in-out 1.4s infinite",filter:"drop-shadow(0 0 14px rgba(0,0,0,0.45)) drop-shadow(0 0 22px rgba(255,255,255,0.25))"}}>{"\u{1F531}"}</span>
        </div>
      </div>
      <div style={{fontSize:12,fontWeight:800,color:"#cddcf2",textTransform:"uppercase",fontFamily:FONT,animation:"textReveal .9s ease-out 1.1s both",textShadow:"0 0 18px rgba(91,142,196,0.6)"}}>{"\u0421\u043B\u0430\u0432\u0430 \u0423\u043A\u0440\u0430\u0457\u043D\u0456"}</div>
      <div style={{fontSize:9,fontWeight:700,color:"#5b8ec8",letterSpacing:".3em",textTransform:"uppercase",fontFamily:FONT,animation:"textReveal .9s ease-out 1.5s both",opacity:.8}}>World Conflict Debrief</div>
    </div>
  </div>;
}
    ...
    <div style={{background:t.isDark?"linear-gradient(180deg,#070e1c,#0b1628)":t.card,borderBottom:"2px solid rgba(91,142,196,0.35)",position:"sticky",top:0,zIndex:100}}>
      ...
      <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:10,padding:"10px 16px 0"}}>
        <div style={{flex:1}}>
          ...
          <div style={{fontSize:11,color:t.sub,marginTop:1}}>3 July 2026 · War Day {UA_WAR_DAY}</div>
        </div>
