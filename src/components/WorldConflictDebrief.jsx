...
const LOSSES={ukraine:[
  ...
  {id:2,category:"Tanks",total:"12,066",todayChange:"+3",color:"#f97316",icon:"🪖",description:"Main battle tanks"},
  {id:3,category:"Armoured Vehs",total:"24,845",todayChange:"+1",color:"#eab308",icon:"🚧",description:"APCs, IFVs, MRAPs"},
  {id:4,category:"Artillery",total:"44,969",todayChange:"+49",color:"#84cc16",icon:"💥",description:"Guns, howitzers, mortars"},
  {id:5,category:"MLRS",total:"1,901",todayChange:"—",color:"#22c55e",icon:"🚀",description:"Multiple launch rockets"},
  {id:6,category:"Air Defence",total:"1,454",todayChange:"—",color:"#06b6d4",icon:"🛡️",description:"SAM & SHORAD systems"},
  {id:7,category:"UAVs",total:"379,224",todayChange:"+1,724",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
  ...
  {id:10,category:"Cruise Missiles",total:"4,797",todayChange:"+7",color:"#14b8a6",icon:"🎯",description:"Destroyed in flight"},
  {id:11,category:"Ships/Boats",total:"33",todayChange:"—",color:"#64748b",icon:"⛵",description:"Naval vessels"},
  {id:12,category:"Vehicles",total:"113,612",todayChange:"+477",color:"#a78bfa",icon:"🚛",description:"Trucks & logistics"},
  {id:13,category:"Ground Robots",total:"1,764",todayChange:"+10",color:"#f43f5e",icon:"🤖",description:"UGV platforms"},
  {id:14,category:"Special Equip",total:"4,366",todayChange:"+6",color:"#fb923c",icon:"🔧",description:"Engineering & EW"},
],gaza:[
...
const CASUALTIES=[{date:"Jun 16",value:1230},{date:"Jun 17",value:1260},{date:"Jun 18",value:1370},{date:"Jun 19",value:1240},{date:"Jun 20",value:1290},{date:"Jun 21",value:1290},{date:"Jun 22",value:1390},{date:"Jun 23",value:1260},{date:"Jun 24",value:1270},{date:"Jun 25",value:1310},{date:"Jun 26",value:1350},{date:"Jun 27",value:1250},{date:"Jun 28",value:1230},{date:"Jun 29",value:1350}];
...
const REPORT_NOW=new Date("2026-06-30T12:00:00Z");
...
function BriefingPanel({t}){
  ...
  const regen=async()=>{
    ...
    const prompt=`You are the night editor of World Conflict Debrief, a global conflict intelligence dashboard. Today is 30 June 2026.
