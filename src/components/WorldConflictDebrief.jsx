...
const NEWS=[
  ...
  {id:"b_iran_funeral_hormuz_patrol",conflictId:"iran",severity:"major",icon:"\uD83D\uDFE0",headline:"Khamenei’s Multi-Day Funeral Begins as Iran Rebuffs UK-French Offer to Patrol Hormuz",conflict:"Iran",conflictColor:"#8b5cf6",publishedAt:"Jul 4, 2026",bullets:["Public funeral ceremonies for slain Supreme Leader Ali Khamenei began Jul 4 in Tehran, running through Jul 9 across Tehran, Qom and Mashhad in Iran and Najaf and Karbala in Iraq; Iranian officials expect 15-20 million mourners in Tehran alone","France and the UK offered to deploy naval forces to help patrol the Strait of Hormuz for freedom of navigation; Iran’s chief negotiator publicly rejected the offer, warning the ‘crisis-makers will be held accountable’ and asserting only coastal states control Hormuz security","Reports indicate US-Iran nuclear negotiations are provisionally set to resume Jul 11, after this funeral-week pause; satellite imagery separately continues to flag tunnel-related construction activity near Natanz, echoing the Pickaxe Mountain concerns already flagged as a possible MoU friction point","Trump said the US deliberately paused pressure during the funeral — ‘we gave them a week off’ — while reiterating Iran is ‘begging to make a deal’; Tehran’s airspace closes entirely for the procession"],sources:["CNN","PBS News","Times of Israel"],impact:"A UK/French naval offer over Hormuz — flatly rejected — is a new friction point layered on top of the funeral-week diplomatic freeze, with the Jul 11 resumption date the next concrete marker to watch",impactColor:"#8b5cf6"},
  ...
  return <div>
    ...
    {tab==="timeline"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>From Operation Epic Fury (Feb 28) through the Islamabad MoU and the 43-day countdown to Aug 16.</div>
      </Hero>
