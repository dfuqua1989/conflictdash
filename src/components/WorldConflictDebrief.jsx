...
const NEWS=[
  ...
  {id:"b_iran_war_jul23",conflictId:"iran",severity:"critical",icon:"🔴",headline:"12th Night of Strikes as Brent Tops $100; First B-1 Bomber Mission; Trump Threatens to Hit Tehran Itself",conflict:"Iran",conflictColor:"#8b5cf6",publishedAt:"Jul 23, 2026",bullets:["THE CAMPAIGN — CENTCOM struck Iranian military operations centers, maritime capabilities, aircraft hangars, drone storage and logistics infrastructure through a 12th consecutive night, hitting Bandar Abbas, Qeshm and Hormozgan province targets. The US used a B-1 long-range bomber for the first time this phase of the war — a single B-1 can carry two dozen 2,000lb bombs or dozens of cruise missiles — signaling a real expansion of the campaign's scale. Iranian authorities say 95+ locations across 12+ cities have been hit since the campaign resumed; Hegseth puts the cost to the US at $37.5B, and the House has now adopted a $95B budget package to fund the war","US CASUALTIES — Cumulative US deaths in the war stand at 18, including 3 in the Jul 17 Jordan strike (all now named: two from Texas and Hawaii, plus Sgt. Angel S. Rampersad, initially listed missing) and a separate death, Sgt. Michael Emmanuel Swinton, in a drone-detonation incident at Erbil Air Base. Trump has escalated his rhetoric further, threatening to destroy an Iranian bridge or power plant — including inside Tehran itself — every time Iran hits a ship in Hormuz; Iran's FM Araghchi called the doctrine 'eye for an eye' and warned any country actively supporting US strikes","OIL AND SHIPPING — Brent crude topped $100/bbl for the first time since May, up roughly $13 in a single week; US gas averages $3.94+/gallon and rising. The Houthis moved from declaring an embargo to actually attacking Saudi-bound tankers in the Red Sea, risking a second chokepoint alongside Hormuz. Iran's IRGC said a tanker caught fire attempting a 'mined route' south of the strait, forcing two others to turn back; US forces say they've redirected 12 vessels since resuming the blockade. Iran also struck Kuwait and Jordan again overnight, with sirens in Bahrain","DIPLOMACY & NUCLEAR THREAT — Trump said he's considering a 'massive attack' on Iran but hasn't made a final call; he has separately threatened the fortified Pickaxe Mountain nuclear site, where satellite imagery has shown reconstruction since June. Regional mediators' 10-day ceasefire proposal remains unaccepted by either side. On the Ukraine track, meanwhile, Rubio and Lavrov met for 35 minutes in Manila — see the Ukraine political thread for details"],sources:["ABC News","Fox News","Al Jazeera","Just Security","Britannica"],impact:"Every axis of this war just moved at once: oil at a fresh high, a heavier bomber in the rotation, and a president publicly weighing whether to hit the Iranian capital directly — the ceasefire proposal on the table looks further from being picked up than it did two days ago",impactColor:"#dc2626"},
  {id:"b_ukraine_political_crisis",conflictId:"ukraine",severity:"critical",icon:"🔴",headline:"Fedorov Confirms He Will Only Return as Defense Minister as Trust Polling Turns Decisively Against Syrskyi",conflict:"Ukraine",conflictColor:"#5b8ec8",publishedAt:"Jul 23, 2026",bullets:["HOW IT STARTED — Zelensky announced Jul 12 that Ukraine was 'changing its political strategy,' launching the war's fourth government reshuffle: PM Yulia Svyrydenko resigned Jul 15, replaced by ex-Naftogaz CEO Serhii Koretsky (Rada confirmed the new Cabinet Jul 16). The bigger shock was the dismissal of Defense Minister Mykhailo Fedorov after just six months — credited with cutting ministry corruption and persuading Elon Musk to deny Russia Starlink access — with SBU officer Yevhenii Khmara installed as acting defense minister. Analysts point to a feud between Fedorov and then-Commander-in-Chief Oleksandr Syrskyi as the real driver; Fedorov declined an advisor role, saying 'I don't need to be Minister of Defense just to be Minister of Defense'","THE COMMANDER FALLS — After the General Staff flatly denied Jul 20 reports that Syrskyi had been removed, Zelensky did exactly that on Jul 21, appointing Maj. Gen. Mykhailo Drapatyi (previously Joint Forces commander) as commander-in-chief to 'reset' the war effort. Syrskyi broke his usual silence with an op-ed apologizing if he'd offended Fedorov while defending his record: he says he established Ukraine's drone forces as a separate branch and couldn't 'switch a million-people army to drones in two months.' Russia responded by urgently adding Drapatyi to its wanted list","STILL UNRESOLVED — Fedorov confirmed Jul 23 he will accept nothing but reinstatement as defense minister, rejecting Zelensky's tech-modernization role offer outright; a senior air force commander resigned in protest, as did Deputy Air Force Commander Pavlo Yelizarov earlier. Zelensky says Syrskyi will stay on as an adviser to the new command, and separately replaced General Staff chief Andrii Hnatov with Ihor Skybiuk on Jul 22. A Rating Group poll (Jul 20-21) found Fedorov's trust surged from 35% to 65% in a week while Syrskyi's fell from 39% to 23% — though a separate Rating Group poll found 55% of Ukrainians actually agreed with Syrskyi's dismissal (15% opposed, 19% indifferent)","THE DEADLINE ARRIVES — Protests that began with 1,000+ in Kyiv's central square — some dubbing it the 'Cardboard Maidan' — have run over a week and spread to Lviv, Odesa, Dnipro and beyond. Organizer and veteran Dmytro Koziatynskyi says protesters return to the square today, Jul 24, warning of an open-ended nightly protest if Zelensky hasn't fully met their demands; Zelensky is reportedly choosing a new defense minister from a list of 11 candidates","CONTEXT — Martial law and mobilization were both extended to Oct 31, 2026 (the 20th such vote). The churn lands squarely on the dashboard's central open thread: Patriot-production licensing and air-defense reform now ride on an untested defense minister and a brand-new commander-in-chief. The UN human rights mission (Danielle Bell) reported 1,396 civilians killed and 7,978 wounded nationwide in H1 2026"],sources:["Kyiv Independent","RFE/RL","Ukrinform","Financial Times","RBC-Ukraine","Al Jazeera","Newsweek","EA WorldView"],impact:"Ukraine's most serious wartime political crisis to date: two of the three people running the war effort replaced inside ten days, a firm Jul 24 deadline arriving today, and public trust numbers that show the country sided decisively with the minister who was fired",impactColor:"#dc2626"},
  {id:"b_ukraine_strike_exchange",conflictId:"ukraine",severity:"critical",icon:"🔴",headline:"Four Straight Nights of Russian Strikes on Kyiv and Kharkiv, Answered Each Time by Ukrainian Deep Strikes",conflict:"Ukraine",conflictColor:"#5b8ec8",publishedAt:"Jul 22, 2026",bullets:["Jul 18-19 — Russia launched 41 missiles (25 of them ballistic) and 125 attack drones, with Kyiv the primary target, in one of the war's largest ballistic-heavy barrages; Ukraine's Air Force intercepted or suppressed 18 missiles and 108 drones, but fires broke out across five Kyiv districts, killing 1 and wounding 16","Jul 19-20 — Strikes hit Kyiv and the Kharkiv outskirts, killing at least 4 and injuring 20+; the Kyiv strike destroyed the UKRTAC plant and its warehouses, and 16 were injured in Kharkiv region, three seriously","Jul 22 — More than 10 impacts were reported across Ukraine after another combined overnight missile-and-drone attack. Ukraine answered in kind through the week: three Russian oil depots hit deep inside Russia, a Buk air defense system, a logistics bridge, two tankers plus a floating crane in the Black and Azov seas, the sanctioned shadow-fleet tanker Avero, and a Russian MiG-29 destroyed on its airbase in Kursk region","Zelensky personally confirmed strikes on a Russian oil depot and other key targets, while ISW reported Russia's renewed push into northern Sumy region failed to gain ground — Moscow is still trying to establish buffer zones along the border. The exchange keeps landing on the dashboard's central materiel question: Ukraine's PAC-3/Patriot stocks are drawn from the same US inventory the parallel Iran war is consuming"],sources:["NPR","AP","RBC-Ukraine","Ukrainska Pravda","ISW"],impact:"A sustained, bidirectional escalation rather than isolated attacks — neither side is de-escalating, and Ukraine's interceptor supply is the variable that decides whether the Russian half of the exchange keeps getting through",impactColor:"#dc2626"},
  {id:"b_scs_ayungin_jul21",conflictId:"south-china-sea",severity:"major",icon:"🟠",headline:"Filipino Sailor Injured Near Second Thomas Shoal as US and Australia Condemn China",conflict:"South China Sea",conflictColor:"#eab308",publishedAt:"Jul 21, 2026",bullets:["A Filipino Navy sailor was injured near Ayungin Shoal (Second Thomas Shoal) on Jul 20 in an encounter with Chinese vessels; the US State Department said it 'condemns China's dangerous and aggressive actions against Philippine navy personnel' and called on Beijing to 'immediately cease its destabilizing conduct.' Australia joined the condemnation","The incident landed just as Secretary of State Rubio arrived in Manila for the ASEAN Foreign Ministers' Meeting, where Rubio said he was open to a possible sideline meeting with China's Wang Yi; in an op-ed published the same day he touted Washington's 'commitment to freedom of navigation in Southeast Asia'","The clash threatens to overshadow an ASEAN agenda already dominated by Myanmar's civil war and the regional fallout from the Iran war's effect on Hormuz shipping"],sources:["Philstar","France24","State Department"],impact:"A fresh flashpoint at the exact moment US and Chinese diplomats are in the same city — a real test of whether ASEAN can address South China Sea tensions while everyone's attention is split with the Middle East",impactColor:"#f97316"},
  ...
  {id:"b_graham_death_jul12",conflictId:"ukraine",severity:"major",icon:"🟠",headline:"Senator Lindsey Graham, a Leading Congressional Voice for Ukraine and Russia Sanctions, Dies at 71",conflict:"Ukraine",conflictColor:"#5b8ec8",publishedAt:"Jul 12, 2026",bullets:["Sen. Lindsey Graham (R-SC) died Saturday night at 71, hours after returning from a trip to Ukraine; preliminary finding was aortic dissection. He was the lead Senate sponsor of the Russia sanctions bill this dashboard tracks and a vocal supporter of the Iran campaign","Trump led tributes calling him 'one of the greatest people and Senators I have ever known.' South Carolina's governor will appoint a replacement, with a special election in November"],sources:["NPR","Axios","NBC News"],impact:"A real loss of institutional capital for Ukraine's Congressional support base — adds uncertainty to future sanctions or Patriot-funding votes",impactColor:"#f97316"},
  {id:"b_venezuela_quake_jul12",conflictId:"venezuela",severity:"major",icon:"🟠",headline:"Venezuela Earthquake Death Toll Climbs Past 4,490 as US Navy Ship Takes Over Wrecked La Guaira Port",conflict:"Venezuela",conflictColor:"#f59e0b",publishedAt:"Jul 12, 2026",bullets:["Twin earthquakes struck Venezuela's Caribbean coast Jun 24 near Caracas and La Guaira; the toll has climbed steadily to 4,490 as of Jul 12, with ~18,000 unhoused and 16,700+ injured","USS San Antonio has taken over reconstruction of the badly damaged La Guaira port — the same waters as the active Southern Spear boat-interdiction campaign, though the quake itself is unrelated to that conflict story"],sources:["Al Jazeera","AFP","Reuters"],impact:"A humanitarian catastrophe running in parallel with the Venezuela conflict story — the death toll now dwarfs every other Venezuela metric by an order of magnitude",impactColor:"#f97316"},
  {id:"b_cuba_blackout_jul10",conflictId:"venezuela",severity:"major",icon:"🟠",headline:"Cuba Hit by Two Island-Wide Blackouts in a Week as Fuel Blockade Collapses the Grid — ~10M in the Dark",conflict:"Caribbean",conflictColor:"#f59e0b",publishedAt:"Jul 10, 2026",bullets:["Cuba's grid went fully dark island-wide on Jul 10 — the second total blackout in a week, fourth since January — affecting ~10M people each time; electricity pumps ~80% of the island's water, so outages cascade into a drinking-water emergency","Díaz-Canel called the US fuel blockade 'genocidal'; only one Russian tanker has reached Cuba in months. Cuba took the blockade to the UN General Assembly Jul 8, citing $8B in damage"],sources:["Al Jazeera","Reuters","AP"],impact:"The grid is now failing outright rather than degrading — chronic shortage has become acute collapse",impactColor:"#dc2626"},
];

const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,436,100",todayChange:"+1,410",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
  {id:2,category:"Tanks",total:"12,201",todayChange:"+10",color:"#f97316",icon:"🪖",description:"Main battle tanks"},
  {id:3,category:"Armoured Vehs",total:"25,000",todayChange:"+6",color:"#eab308",icon:"🚧",description:"APCs, IFVs, MRAPs"},
  {id:4,category:"Artillery",total:"46,646",todayChange:"+76",color:"#84cc16",icon:"💥",description:"Guns, howitzers, mortars"},
  {id:5,category:"MLRS",total:"1,968",todayChange:"+7",color:"#22c55e",icon:"🚀",description:"Multiple launch rockets"},
  {id:6,category:"Air Defence",total:"1,516",todayChange:"+1",color:"#06b6d4",icon:"🛡️",description:"SAM & SHORAD systems"},
  {id:7,category:"UAVs",total:"425,240",todayChange:"+1,652",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
  {id:8,category:"Aircraft",total:"439",todayChange:"+1",color:"#8b5cf6",icon:"✈️",description:"Fixed-wing aircraft"},
  {id:9,category:"Helicopters",total:"354",todayChange:"—",color:"#ec4899",icon:"🚁",description:"Rotary-wing aircraft"},
  {id:10,category:"Cruise Missiles",total:"4,938",todayChange:"+2",color:"#14b8a6",icon:"🎯",description:"Destroyed in flight"},
  {id:11,category:"Ships/Boats",total:"34",todayChange:"—",color:"#64748b",icon:"⛵",description:"Naval vessels"},
  {id:12,category:"Vehicles",total:"124,787",todayChange:"+544",color:"#a78bfa",icon:"🚛",description:"Trucks & logistics"},
  {id:13,category:"Ground Robots",total:"2,006",todayChange:"+12",color:"#f43f5e",icon:"🤖",description:"UGV platforms"},
  {id:14,category:"Special Equip",total:"4,454",todayChange:"+1",color:"#fb923c",icon:"🔧",description:"Engineering & EW"},
],gaza:[
...
const BRIEFING={summaryShort:"Ukraine pushed Russian losses to 1,436,100 (+1,410) as the Black Sea corridor edges toward a functioning blockade — two grain ships hit in four days, Maersk suspending port calls — while political turmoil deepens after both the defense minister and commander-in-chief were replaced this month. Rubio and Lavrov held their first substantive Ukraine talks in months in Manila, but Iran remains the bigger story: a 12th night of US strikes, Brent crude past $100, and Trump threatening to hit Tehran directly. Gaza's post-ceasefire toll keeps climbing, a Filipino sailor was hurt near Second Thomas Shoal, and Venezuela, Cuba and Haiti keep the Western Hemisphere file active.",summary:"Ukraine pushed total Russian losses to 1,436,100 (Jul 24 MoD report, +1,410 on the day) — Russian UAV losses now past 425,000 (425,240). The Black Sea has become the sharpest front: a Russian missile strike sank the grain ship Golden Leo off Odesa late Jul 19, killing 10, and a second bulk carrier, the Golden Rose, was struck Jul 22 (crew rescued). Maersk has now suspended operations at a Ukrainian port and Kyiv has called an emergency UN meeting over what it calls a Russian blockade of the grain corridor; Odesa's governor says Russian strikes have killed 28 in the region this month alone. Four straight nights of strikes on Kyiv and Kharkiv followed — including a Jul 18-19 barrage of 41 missiles (25 ballistic) and 125 drones, one of the war's largest — with more than 10 impacts reported again overnight Jul 22. Ukraine answered each time: three oil depots hit deep inside Russia, a Buk air defense system, a logistics bridge, Black and Azov Sea vessels, the sanctioned shadow-fleet tanker Avero, a MiG-29 destroyed at its Kursk airbase, and a 400+-drone barrage on Moscow region — sustaining pressure on a Russian fuel crisis severe enough to have forced a diesel export ban — though RBC-Ukraine reports the shortage has begun to ease as Ukraine shifts its targeting, and Russian troops are still complaining of fuel shortages at the front. ISW reports Moscow's renewed push into northern Sumy failed to gain ground, and separately assesses the Kremlin is preparing for possible mobilization and domestic unrest. Ukraine's political crisis is now the second front: after dismissing Defense Minister Fedorov on Jul 16, Zelensky dismissed Commander-in-Chief Syrskyi on Jul 21 — a day after the General Staff denied exactly that — installing Mykhailo Drapatyi, whom Russia promptly added to its wanted list. Fedorov has refused Zelensky's offer of a senior tech-sector role, protests have run over a week across four cities with a Jul 24 deadline for his reinstatement, and both martial law and mobilization now run to Oct 31. On the diplomatic track, Rubio and Lavrov met for 35 minutes on the sidelines of the ASEAN ministerial in Manila — the first substantive US-Russia contact on Ukraine in months. Rubio called it 'good' and 'frank' but said new ideas are needed and dismissed hopes of a quick deal; Lavrov reaffirmed readiness for a settlement while Bloomberg reports Putin has dropped territorial concessions entirely. EU ambassadors approved a 21st sanctions package the same week. The bigger story remains Iran, now in a 12th consecutive night of US strikes: the US flew a B-1 bomber for the first time this phase of the war, Brent crude topped $100/bbl (up ~$13 in a week), and Trump threatened to destroy an Iranian bridge or power plant — including in Tehran itself — every time Iran hits a ship in Hormuz. Cumulative US deaths in the war stand at 18, including 3 named service members from the Jul 17 Jordan strike and a separate Erbil drone-detonation death. Iran says roughly 3,000 people in Iran have been killed across the war, and its FM Araghchi calls the reprisal doctrine 'eye for an eye,' warning any state actively aiding US strikes. The Houthis have moved from declaring Bab el-Mandeb closed to Saudi Arabia to actually attacking Saudi-bound tankers there; US forces say they've redirected 12 vessels since resuming the Hormuz blockade, and Trump has separately threatened to strike the fortified Pickaxe Mountain nuclear site — which Tehran calls a red line. Mediators have floated a 10-day ceasefire and Iran's interior minister travelled to Pakistan for talks, but Trump says he's weighing a 'massive attack' without a final decision yet; the Aug 16 MoU deadline (23 days out) reads as a formality already overtaken by events. Elsewhere: Gaza's post-ceasefire death toll is past 1,144 after the heaviest stretch of Israeli fire since October, with the Board of Peace/NCAG transition still lacking real authority; a Filipino sailor was injured near Second Thomas Shoal, drawing US and Australian condemnation of China as Rubio landed in Manila for the ASEAN ministerial; and Venezuela's earthquake recovery, Cuba's grid collapse, Mexico's cartel-FTO campaign and Haiti's Aug 30 elections keep the Western Hemisphere file active.",signals:[{theater:"Ukraine",text:"Zelensky dismisses Commander-in-Chief Syrskyi and names Drapatyi (whom Russia immediately puts on its wanted list); Fedorov refuses an alternative role, and protests hit a Jul 24 reinstatement deadline"},{theater:"Ukraine",text:"Rubio and Lavrov meet 35 minutes in Manila — no breakthrough, but the first real US-Russia contact on Ukraine in months; Bloomberg says Putin has dropped territorial concessions entirely"},{theater:"Ukraine",text:"Second grain ship struck in four days; Maersk suspends Ukrainian port calls and Kyiv calls an emergency UN meeting over the Black Sea corridor"},{theater:"Iran",text:"12th consecutive night of strikes; first B-1 bomber mission of this phase; Trump threatens to hit Tehran directly every time Iran strikes a ship in Hormuz"},{theater:"Iran",text:"Brent crude tops $100/bbl for the first time since May; Houthis move from threatening to actually attacking Saudi-bound tankers in the Red Sea"},{theater:"Gaza",text:"Post-ceasefire death toll past 1,144 after the heaviest stretch of Israeli fire since the Oct 2025 truce; governance transition still without real authority on the ground"},{theater:"SCS",text:"Filipino sailor injured near Second Thomas Shoal; US and Australia condemn China as Rubio arrives in Manila for the ASEAN Foreign Ministers' Meeting"},{theater:"Americas",text:"Venezuela's earthquake toll past 4,490 with USS San Antonio rebuilding La Guaira port; Cuba's grid has failed island-wide twice in a week under the fuel blockade (~10M affected each time)"}],watch:"Whether the 10-day ceasefire proposal survives contact with an 11th-night strike campaign, and whether Trump follows through on Pickaxe Mountain — the one target Tehran has explicitly called a major escalation; whether the Houthi closure of Bab el-Mandeb actually holds, since a second closed chokepoint changes the oil picture far more than Hormuz alone; whether Ukraine's Jul 24 protest deadline forces Fedorov's reinstatement or a harder confrontation; and whether Drapatyi's 'reset' produces any visible change in a front where Russia's Sumy push is already failing.",generatedAt:new Date().toISOString()};
const UKRAINE_BRIEFING={summaryShort:"Russia's attrition math keeps worsening — an ~8:1 loss ratio in H1 2026 per CSIS, with cumulative losses now at 1,436,100 — even as its ground offensive grinds on at Pokrovsk and its Sumy push fails to gain ground. Ukraine's deep-strike and Black Sea interdiction campaigns keep escalating, reaching Moscow region itself and 1,400km into Russia, while a political shake-up and a strained Patriot/PAC-3 supply add real uncertainty. Full attrition, territory, strikes, air defense, diplomacy and political breakdown below.",summary:"Russia's attrition math has become unsustainable even as its ground offensive grinds on. CSIS's July 1 assessment puts the Russia:Ukraine battlefield loss ratio at nearly 8:1 in H1 2026 — up from 2:1-3:1 for most of the war — credited largely to Ukraine's AI-enabled drone interdiction campaign. The MoD's Jul 24 report puts cumulative Russian losses at 1,436,100 (+1,410 on the day), with daily losses still running above 1,000 most days. That said, the war is not simply going well for Ukraine: Russia's stalled offensive still holds Pokrovsk at genuine encirclement risk (though ISW says its renewed push into northern Sumy has failed to gain ground), Kyiv and Kharkiv have absorbed four straight nights of strikes with 10+ impacts again on Jul 22, Commander-in-Chief Syrskyi was dismissed Jul 21 and replaced with Mykhailo Drapatyi, and the Patriot/PAC-3 shortage — worsened by the 2026 Iran war draining US stocks — remains the one gap Ukraine cannot close on its own.",assessment:[{cat:"Attrition",text:"~8:1 RU:UA loss ratio in H1 2026 (CSIS). Cumulative Russian losses reached 1,436,100 as of the Jul 24 MoD report (+1,410 on the day) — tanks to 12,201 (+10), artillery to 46,646 (+76); Russian UAV losses passed 425,000 (425,240). The naval/deep-strike campaign keeps compounding and widening: strikes landed inside Moscow region itself Jul 18 (Noginsk oil depot, an Unmanned Systems Forces warehouse in Elektrostal, a Wildberries logistics fire), and overnight Jul 19-20 Ukraine hit 3 more Russian oil depots plus a Buk air defense system, a logistics bridge, Black/Azov Sea vessels, and the shadow-fleet tanker Avero — the Azov/Black Sea interdiction remains a sustained second front."},{cat:"Territory",text:"Russian advance remains grinding — Pokrovsk is now the single hottest sector on the front, 268 combat clashes recorded there Jul 8 alone, alongside Huliaipole. Monthly gain estimates diverge sharply by source: DeepState puts Russia's net gain at ~31 sq mi for Jun 9-Jul 7, ISW at just ~6 sq mi — among the slowest rates of any war in the past century either way. Russia had a net territorial LOSS in Apr-May 2026 (~400 km²), its first monthly net loss since Aug 2024."},{cat:"Deep Strikes",text:"The campaign has escalated into economic coercion and now reaches Moscow region itself. Jul 6: the deepest strike of the war — FP-1 drones flew ~3,000km to hit the Omsk refinery, Russia's largest, first-ever strike on the plant, offline within 24 hours. Jul 13: a strike hit the Salavat refinery in Bashkortostan, 1,400km inside Russia. Jul 16: a re-strike on the Slavneft-YANOS refinery in Yaroslavl and confirmation the Jul 14-15 Engels-2 airbase strike tore the tail off a Tu-95 bomber. Jul 18: strikes for the first time landed inside Moscow region proper — an oil depot in Noginsk, a Center of Unmanned Systems Forces warehouse destroyed in Elektrostal, and a fire at a major Wildberries logistics hub — as Moscow's mayor reported 1,892 Ukrainian drones detected heading toward the region in the preceding week alone. Jul 21-22: a Russian MiG-29 destroyed on its airbase in Kursk region, a rare Russian radar and military depots hit, and Zelensky personally confirming further oil-depot strikes. Jul 19-20: three more Russian oil depots hit overnight, plus a Buk air defense system, a logistics bridge, and Black/Azov Sea vessels. The cumulative effect is a nationwide Russian fuel crisis, with Moscow banning diesel exports and Putin publicly requesting Crimea fuel subsidies."},{cat:"Air Defense",text:"The decisive materiel question of the war may have just moved again. Russia fired 41 missiles (25 ballistic) and 125 drones at Kyiv overnight Jul 18-19 — one of the largest ballistic barrages of the war — with 18 missiles and 108 drones intercepted/suppressed, 1 killed and 16 wounded. That follows a mixed week: 5 of 8 ballistic missiles downed Jul 13-14 (likely Patriot), but only 1 of 8 missiles downed the night of Jul 16-17. At Ankara on Jul 8 Trump licensed Ukraine to manufacture Patriots itself; Zelensky said Jul 9 the licence is agreed politically with supplies due within days, but officials put real domestic production months-to-years out. Poland will co-produce and maintain PAC-3s under a new multilateral agreement and is transferring 5 missiles now; Ukraine's domestic 'Freyja' interceptor may draw eight European partners. Drone-side economics still favor Ukraine ($7.5k interceptor vs $35k Shahed)."},{cat:"Diplomacy",text:"First real movement in months: Rubio and Lavrov met for 35 minutes on the ASEAN sidelines in Manila on Jul 23 — their fourth meeting since 2025. Rubio called it 'good' and 'frank,' said fresh proposals are needed after previous ideas failed, and dismissed hopes of rapid progress; Lavrov reaffirmed Russia's readiness for a settlement and its commitment to the Anchorage proposals, even as Bloomberg reports Putin has abandoned territorial concessions and the Kremlin treats the Anchorage understandings as void. Zelensky spoke with US envoys Witkoff and Kushner on Jul 22. Earlier: Ankara concluded with an $80B allied pledge for 2026, a Patriot manufacturing license, and a notably warm Trump-Zelensky bilateral — Trump said Zelensky has 'done an amazing job.' Russia had already rejected the Turkish ceasefire push, so the negotiating track itself remains blocked. Czech President Pavel: Ukraine has roughly two months to resume talks before the window narrows."},{cat:"Political",text:"The Fedorov dismissal produced a real casualty after all: Zelensky dismissed Commander-in-Chief Syrskyi on Jul 21 — days after the General Staff had denied Jul 20 reports of exactly that — naming Mykhailo Drapatyi (previously Joint Forces commander) to replace him, in what Zelensky called a 'reset' of the war effort. It hasn't settled things: Fedorov confirmed Jul 23 he will accept nothing but reinstatement as defense minister, rejecting Zelensky's tech-modernization role offer outright. Public opinion has moved decisively too — a Rating Group poll (Jul 20-21) found his trust rating surged from 35% to 65% in a week while Syrskyi's fell from 39% to 23%, with Zaluzhnyi still the most trusted figure at 70%. Zelensky says Syrskyi will remain on as an adviser to the new command, and separately replaced General Staff chief Andrii Hnatov with Ihor Skybiuk on Jul 22; protests have run over a week and spread to Lviv, Odesa and Dnipro with a Jul 24 deadline. A senior air force commander resigned in protest, and Russia moved immediately to add Drapatyi to its wanted list. Syrskyi used a parting op-ed to defend his record — he says he made drone forces a separate branch and could not 'switch a million-people army to drones in two months.' The rift's substance — Fedorov's drone/robotics-forward reform push versus Syrskyi's conventional artillery-and-manpower approach — is still unresolved even with the personnel change."}],watch:"Two variables now: whether Pokrovsk holds — still the most consequential sector against an otherwise favorable attrition/territorial picture — and whether the string of strikes on Kyiv and Kharkiv since Jul 18 signals a renewed heavy-missile campaign that a strained Patriot/PAC-3 stockpile (drained further by the Iran war) can't keep pace with.",generatedAt:new Date().toISOString()};
...
const DEADLINES=[{date:"Resolved",target:new Date("2026-06-22T00:00:00Z"),label:"Belarus Ultimatum — Elapsed",icon:"🇧🇾",color:"#22c55e",desc:"Window closed Jun 22 with partial compliance (relay shutdown). No further Ukrainian strikes on Belarusian territory followed — treated as a closed case pending any reversal."},{date:"Jul 7–8",target:new Date("2026-07-07T09:00:00Z"),label:"NATO Ankara Summit",icon:"🤝",color:"#5b8ec8",desc:"CONCLUDED. Allies pledged $80B (~€70B) for Ukraine in 2026 and reaffirmed Article 5; Trump gave an apparent green light for Europe/Ukraine to produce Patriot missiles under license — no firm dates yet. Zelensky met Trump and Syria's al-Sharaa on the sidelines. Russia's Turkish ceasefire push was rejected before the summit began."},{date:"Jul 24",target:new Date("2026-07-24T00:00:00Z"),label:"Ukraine Protest Deadline",icon:"🇺🇦",color:"#dc2626",desc:"Protesters demand Fedorov's reinstatement as defense minister. Syrskyi's dismissal did not end the standoff; Fedorov has refused Zelensky's alternative role offer."},{date:"~Aug 16",target:new Date("2026-08-16T00:00:00Z"),label:"Iran Nuclear Deadline",icon:"☢️",color:"#8b5cf6",desc:"60-day MoU window closes. Trump: could relaunch attacks if talks fail."}];
...
const POLITICAL_CALENDAR=[
  ...
  {date:"Jul 24, 2026",label:"Ukraine protest deadline on Fedorov",note:"Demonstrators across Kyiv, Lviv, Odesa and Dnipro have set Jul 24 as the deadline for Mykhailo Fedorov's reinstatement as defense minister. Fedorov has refused an alternative role; Zelensky has already replaced Commander-in-Chief Syrskyi without ending the standoff.",color:"#dc2626"},
...
const REPORT_NOW=new Date("2026-07-24T20:05:00Z");
...
function BriefingPanel({t}){
  const SC={Ukraine:"#5b8ec8",Gaza:"#f59e0b",Taiwan:"#eab308",SCS:"#eab308",Iran:"#8b5cf6",Americas:"#f97316",Global:"#22c55e"};
  ...
  return <div style={{background:t.isDark?"linear-gradient(135deg,#091321,#0d1f38)":"linear-gradient(135deg,#eef3fc,#e6edf9)",border:"1px solid rgba(59,130,246,0.25)",borderLeft:"4px solid #5b8ec8",borderRadius:14,padding:"14px 16px",marginBottom:16}}>
    ...
    <button onClick={()=>setExpanded(e=>!e)} aria-expanded={expanded} style={{width:"100%",display:"flex",alignItems:"center",justifyContent:"center",gap:6,background:"none",border:`1px solid ${t.border}`,borderRadius:8,padding:"7px 10px",cursor:"pointer",color:"#5b8ec8",fontSize:11,fontWeight:700,fontFamily:FONT,letterSpacing:".03em"}}>
...
<ST t={t}>📋 This Week in the War</ST><Card t={t}>{WEEK_UPDATES.map((u,i)=><Row key={i} t={t} last={i===WEEK_UPDATES.length-1}><div style={{fontSize:12.5,color:t.text,lineHeight:1.55}}>{u}</div></Row>)}</Card><div style={{background:t.isDark?"linear-gradient(135deg,#091321,#0d1f38)":"linear-gradient(135deg,#eef3fc,#e6edf9)",border:"1px solid rgba(59,130,246,0.25)",borderLeft:"4px solid #5b8ec8",borderRadius:14,padding:"14px 16px",marginBottom:16}}>
  ...
  <button onClick={()=>setBriefExpanded(e=>!e)} aria-expanded={briefExpanded} style={{width:"100%",display:"flex",alignItems:"center",justifyContent:"center",gap:6,background:"none",border:`1px solid ${t.border}`,borderRadius:8,padding:"7px 10px",cursor:"pointer",color:"#5b8ec8",fontSize:11,fontWeight:700,fontFamily:FONT,letterSpacing:".03em"}}>
...
function TodayView({t}){const critical=NEWS.filter(n=>n.severity==="critical");const watch=NEWS.filter(n=>n.severity==="watch"||n.severity==="major");const criticalShown=critical.slice(0,5);const watchShown=watch.slice(0,7-criticalShown.length);const shown=[...criticalShown,...watchShown];const shownCritical=shown.filter(n=>n.severity==="critical").length;const shownMajor=shown.filter(n=>n.severity==="major").length;const shownWatch=shown.filter(n=>n.severity==="watch").length;return <div style={{padding:"16px 16px 0",animation:"fadeIn .25s ease-out",position:"relative"}}><SJMark size={30} style={{top:2,right:6,transform:"rotate(-6deg)"}}/>
    <div style={{position:"relative",overflow:"hidden",background:t.isDark?"linear-gradient(135deg,#140b0b,#1c0f0f)":"linear-gradient(135deg,#fdf4f4,#fbeaea)",border:"1px solid rgba(220,38,38,.35)",borderRadius:14,padding:"16px 16px 12px",marginBottom:16,boxShadow:t.isDark?"0 4px 18px rgba(0,0,0,.42)":"0 2px 10px rgba(220,38,38,.10)"}}>
      ...
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:3}}>
        ...
        <span style={{fontSize:9,fontWeight:700,color:t.sub,opacity:.85,fontVariantNumeric:"tabular-nums",background:t.isDark?"rgba(255,255,255,.06)":"rgba(0,0,0,.05)",borderRadius:5,padding:"2px 7px",letterSpacing:".03em"}}>WCD-{getWarDay()}</span>
      </div>
...
function IranSection({t,initialTab}){
  ...
  const TIMELINE=[
    ...
    {date:"Jul 21, 2026",label:"Tenth night; third US death named; Kuwait facilities on fire; Houthis target Saudi Arabia specifically",color:"#dc2626",text:"The Pentagon named the third confirmed US fatality: Sgt. Michael Emmanuel Swinton, 30, of Fayetteville, NC, killed during a controlled detonation of a downed Iranian drone at Erbil Air Base, Iraq on Jul 19 — separate from the two soldiers (from Texas and Hawaii) killed in the Jordan strikes. Trump warned Tehran would 'pay' for the deaths as the US carried out a tenth consecutive night of strikes (Sirik, Bandar Abbas, Qeshm, Shiraz, Isfahan). Iranian retaliation hit Kuwait especially hard — a desalination facility and power plants caught fire and suffered serious damage — plus strikes on Bahrain and Jordan; IRGC claimed 'massive fires' on two tankers taking 'an unsafe route' through Hormuz. The Houthis escalated further, declaring a maritime embargo specifically against Saudi Arabia and threatening the Bab-el-Mandeb Strait — risking a second chokepoint closure that could cut a further 7% of global oil supply on top of Hormuz's ~20%. ASEAN foreign ministers, meeting in Manila with US, Chinese and Russian top diplomats also present, issued a joint statement of 'serious concern' over the war's threat to regional energy security; US gas prices climbed back to a $4/gallon national average, and the Pentagon disclosed nearly 100 US troops injured (mostly minor) since Jul 7 as Defense Secretary Hegseth prepared to face Senate questioning."},
    {date:"Jul 22, 2026",label:"Eleventh night; third Jordan fatality named; Houthis close Bab el-Mandeb to Saudi Arabia",color:"#dc2626",text:"CENTCOM struck Iranian military operations centers, maritime capabilities, aircraft hangars, drone storage and logistics infrastructure in an 11th consecutive night, with Iranian state media reporting explosions across seven provinces — including an electrical installation near the Bushehr nuclear plant. The Pentagon identified Sgt. Angel S. Rampersad, 28, of Ozone Park, N.Y., initially listed missing, as the third US service member killed in the Jul 17 Jordan strike; cumulative US deaths in the war reached 18. Iran struck the Jordan base again plus Bahrain's Sheikh Isa air base, and hit another tanker in Hormuz, pushing Brent past $92/bbl. The Houthis declared Bab el-Mandeb off limits to Saudi Arabia and warned international shipping away — roughly 2.5M barrels/day at risk, with six ships turning course. Trump said the US plans to hit a fortified underground site near a main enrichment facility (Pickaxe Mountain); Iran called any strike on nuclear or sensitive facilities a major escalation. Iranian Interior Minister Eskander Momeni travelled to Pakistan for talks aimed at reviving the collapsed ceasefire, while Trump said Iran is 'getting decimated' and that Washington has 'no interest' until Tehran meets 'in a meaningful way.' Iran says roughly 3,000 people, many civilians, have been killed across the war; remains of 32 victims of the Feb 28 girls'-school strike, identified by DNA, were buried this week."},
    {date:"Jul 23, 2026",label:"Twelfth night; first B-1 bomber strike; Brent tops $100; Trump threatens Tehran directly",color:"#dc2626",text:"CENTCOM continued the campaign through a 12th consecutive night, hitting Bandar Abbas, Qeshm and Hormozgan targets. The US flew a B-1 long-range bomber for the first time this phase of the war — a real escalation in the tonnage available per sortie. Brent crude topped $100/bbl for the first time since May (+$13 in a week); US gas is back above $3.94/gallon and rising. Trump threatened to destroy an Iranian bridge or power plant, including in Tehran itself, every time Iran hits a ship in Hormuz; Iran's FM Araghchi called this an 'eye for an eye' doctrine and warned any state actively supporting US strikes. The Houthis moved from declaring an embargo to actually attacking Saudi-bound tankers in the Red Sea; Iran's IRGC said a tanker caught fire on a 'mined route' south of the strait, forcing two others to turn back, and US forces say they've redirected 12 vessels since resuming the blockade. The House adopted a $95B budget package to fund the war; Trump said he's considering a 'massive attack' on Iran but has not made a final call."},
  ...
  return <div>
    ...
    {tab==="timeline"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>From Operation Epic Fury (Feb 28) through the Islamabad MoU and the 23-day countdown to Aug 16.</div>
      </Hero>
    ...
    {tab==="gaps"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #ef4444"}}>
        <div style={{fontSize:11,color:"rgba(255,255,255,.4)",textTransform:"uppercase",letterSpacing:".08em",marginBottom:8}}>⚠️ Unresolved Gaps — 23 Days Remain</div>
...
function NuclearSection({t,initialTab}){
  ...
  const VECTORS=[
    ...
    {flag:"🇮🇷",name:"Iran — Nuclear Clock",status:"23 DAYS",color:"#8b5cf6",text:"Islamabad MoU 60-day window closes ~Aug 16. IAEA inspector access disputed. Enrichment red lines unresolved — Pezeshkian: 'we will never back down from the right to enrich uranium.'"},
...
export default function Dashboard(){
  ...
  return <div style={{background:t.bg,minHeight:"100vh",maxWidth:t.isLandscape?900:480,margin:"0 auto",fontFamily:FONT,lineHeight:1.5,WebkitFontSmoothing:"antialiased",paddingBottom:34,position:"relative"}} className={t.isDark?"t-dark":""}>
    ...
    <div onTouchStart={e=>{touchStartX.current=e.touches[0].clientX;}} onTouchEnd={e=>{if(touchStartX.current!==null){handleSwipe(touchStartX.current-e.changedTouches[0].clientX);touchStartX.current=null;}}}>
      ...
      {view==="theaters"&&<div style={{padding:"16px 16px 0",animation:"fadeIn .25s ease-out",position:"relative"}}><SJMark size={26} style={{bottom:10,right:8,transform:"rotate(-4deg)"}}/><WorldMap t={t} conflicts={CONFLICTS} onSelect={id=>{setSelectedConflict(id==="south-china-sea"||id==="taiwan"?"scs":id);setView("deepdive");}} selectedId={selectedConflict==="scs"?"south-china-sea":selectedConflict}/><TheatersOverview t={t} conflicts={CONFLICTS} onSelectConflict={id=>{setSelectedConflict(id);setView("deepdive");}}/></div>}
