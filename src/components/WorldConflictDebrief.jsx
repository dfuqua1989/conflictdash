...
const NEWS=[
  {id:"b_iran_jordan_jul18",conflictId:"iran",severity:"critical",icon:"🔴",headline:"Iranian Strikes on US Forces in Jordan Kill 2 American Troops, 1 Missing — First US Combat Fatalities Since March",conflict:"Iran",conflictColor:"#8b5cf6",publishedAt:"Jul 18, 2026",bullets:["CENTCOM said two US service members were killed and a third is missing in action after Iranian missile and drone strikes on US forces in Jordan on Jul 17 — the first confirmed American combat fatalities since the conflict resumed, and the war's cumulative US death toll now stands at 16 per tracking sources","The US answered with an eighth consecutive night of strikes on Iran, hitting Sirik and Hajiabad in Hormozgan province; CENTCOM says the goal is to further degrade Iran's ability to choke the Strait of Hormuz. Iran's army said it targeted US military assets at two bases in Kuwait in response","Iran struck Kuwait's main desalination plant for a second time (Jul 17 and Jul 18), leaving roughly 10,000 people without water in one of the world's most arid countries; Kuwait's military said it intercepted hostile ballistic missiles and drones in its airspace. Iranian missile activity also triggered sirens in Jordan's Aqaba and an Iron Dome intercept over Eilat, Israel on Jul 19","Iran's Health Ministry says at least 50 people have been killed and 500+ injured domestically by US strikes since Jul 6; an Iranian negotiator says the Islamabad MoU is 'effectively suspended' over US violations. Trump has been presented options to expand the campaign, including threats against civilian infrastructure and energy targets, and told CNN 'we were in Vietnam for 19 years, we're here for four months.' The State Department issued a worldwide caution citing potential retaliation against US interests globally"],sources:["CNN","Al Jazeera","Bloomberg","Fox News"],impact:"The first confirmed US combat deaths of this round mark a real inflection — a war that had been fought almost entirely in the air now has American service-member fatalities, raising the political pressure for the escalation to civilian/energy targets that Trump has so far held back",impactColor:"#dc2626"},
...
const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,428,930",todayChange:"+1,520",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
  {id:2,category:"Tanks",total:"12,156",todayChange:"+5",color:"#f97316",icon:"🪖",description:"Main battle tanks"},
  {id:3,category:"Armoured Vehs",total:"24,963",todayChange:"+7",color:"#eab308",icon:"🚧",description:"APCs, IFVs, MRAPs"},
  {id:4,category:"Artillery",total:"46,261",todayChange:"+92",color:"#84cc16",icon:"💥",description:"Guns, howitzers, mortars"},
  {id:5,category:"MLRS",total:"1,950",todayChange:"+4",color:"#22c55e",icon:"🚀",description:"Multiple launch rockets"},
  {id:6,category:"Air Defence",total:"1,505",todayChange:"+3",color:"#06b6d4",icon:"🛡️",description:"SAM & SHORAD systems"},
  {id:7,category:"UAVs",total:"416,656",todayChange:"+1,858",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
  ...
  {id:10,category:"Cruise Missiles",total:"4,915",todayChange:"+1",color:"#14b8a6",icon:"🎯",description:"Destroyed in flight"},
  {id:11,category:"Ships/Boats",total:"34",todayChange:"—",color:"#64748b",icon:"⛵",description:"Naval vessels"},
  {id:12,category:"Vehicles",total:"122,289",todayChange:"+547",color:"#a78bfa",icon:"🚛",description:"Trucks & logistics"},
  {id:13,category:"Ground Robots",total:"1,956",todayChange:"+13",color:"#f43f5e",icon:"🤖",description:"UGV platforms"},
  {id:14,category:"Special Equip",total:"4,430",todayChange:"+2",color:"#fb923c",icon:"🔧",description:"Engineering & EW"},
],gaza:[
...
const BRIEFING={summary:"Ukraine pushed total Russian losses to 1,428,930 (Jul 19 MoD report, +1,520 on the day) — Russian UAV losses now past 416,000 (416,656). The deep-strike and naval campaigns keep widening: Ukraine struck inside Moscow region itself Jul 18 (a Noginsk oil depot, an Unmanned Systems Forces warehouse in Elektrostal, a Wildberries logistics fire) after the Jul 13 Salavat refinery strike 1,400km inside Russia — Moscow's fuel crisis (diesel exports banned, Putin requesting Crimea subsidies) keeps deepening as a result. Air defense had its toughest night of the week early Jul 19 — Russia fired 41 missiles (25 ballistic) and 125 drones at Kyiv, one of the largest ballistic barrages of the war, killing 1 and wounding 16 — though NATO's Ankara pledges ($80B for 2026, a Patriot manufacturing license) remain months from real production, and the same week saw Zelensky dismiss popular Defense Minister Fedorov after just six months, sparking real protests in Kyiv, while Serhii Koretsky was already approved by parliament as the new PM. The bigger story of the week is Iran, which has sharply escalated: Iranian strikes on US forces in Jordan killed 2 American service members and left 1 missing — the first US combat fatalities of the conflict since March — prompting an eighth consecutive night of US strikes; Kuwait's main desalination plant was hit for a second time, leaving 10,000 people without water, and Iran's health ministry says at least 50 people have been killed and 500+ injured domestically since Jul 6. Iran's negotiators now call the MoU 'effectively suspended' over US violations, and Trump is reportedly weighing strikes on civilian infrastructure and energy targets. The Aug 16 MoU deadline (27 days out) reads now as a formality already overtaken by events on the ground. Elsewhere: Gaza saw its heaviest stretch of Israeli fire since the October 2025 ceasefire — a funeral-procession strike killed 7-8 on Jul 17, and further strikes on two Gaza City neighborhoods killed at least 8 more on Jul 18 — with post-ceasefire deaths now past 1,123 and rising, the Board of Peace/NCAG governance transition still without real authority on the ground, and government ministers joining thousands of settler activists who breached four IDF checkpoints toward Gaza on Jul 19 calling for renewed settlements; Mexico's cartel-FTO campaign and Haiti's Aug 30 elections round out an increasingly active Western Hemisphere file.",signals:[{theater:"Ukraine",text:"41 missiles (25 ballistic) + 125 drones hit Kyiv overnight Jul 18-19, one of the war's largest ballistic barrages — 1 killed, 16 wounded, fires in 5 districts"},{theater:"Ukraine",text:"Zelensky fires popular Defense Minister Fedorov, sparking Kyiv protests, in 4th wartime government reshuffle; Koretsky already approved as new PM"},{theater:"Iran",text:"Iranian strikes on US forces in Jordan kill 2 American troops, 1 missing — first US combat fatalities since March; US answers with an 8th straight night of strikes; Iran says the MoU is 'effectively suspended'"},{theater:"Iran",text:"Kuwait's main desalination plant hit for a second time, 10,000 without water; Iran reports 50+ killed, 500+ injured domestically since Jul 6"},{theater:"Gaza",text:"Heaviest stretch of Israeli fire since the Oct 2025 ceasefire — a funeral-procession strike killed 7-8 Jul 17, two more neighborhoods hit Jul 18 killing 8+; post-ceasefire toll now past 1,123 and rising"},{theater:"Americas",text:"Venezuela's earthquake toll has climbed past 4,490 dead as USS San Antonio takes over reconstruction of La Guaira port; Cuba's grid has failed island-wide twice in a week under the fuel blockade (~10M affected each time), while Mexico's cartel-FTO campaign and Haiti's Aug 30 elections keep the wider region active"}],watch:"Whether the Jordan attack and US fatalities push Washington toward the civilian-infrastructure/energy strikes Trump is reportedly weighing, and how Iran's 'full-scale invasion and annihilation' rhetoric from hardliners translates into actual capability; whether Iran's MoU suspension becomes a formal withdrawal before Aug 16; whether the Jul 18-19 Kyiv barrage is a one-off or the start of a renewed ballistic-heavy campaign now that Ukraine's PAC-3 stocks are already strained; whether Russia retaliates against Ukrainian fuel infrastructure as its own crisis deepens.",generatedAt:new Date().toISOString()};
const UKRAINE_BRIEFING={summary:"Russia's attrition math has become unsustainable even as its ground offensive grinds on. CSIS's July 1 assessment puts the Russia:Ukraine battlefield loss ratio at nearly 8:1 in H1 2026 — up from 2:1-3:1 for most of the war — credited largely to Ukraine's AI-enabled drone interdiction campaign. The MoD's Jul 19 report puts cumulative Russian losses at 1,428,930 (+1,520 on the day), with daily losses still running above 1,000 most days. That said, the war is not simply going well for Ukraine: Russia's stalled offensive still holds Pokrovsk at genuine encirclement risk, air defense just faced one of the largest ballistic barrages of the war on Kyiv overnight Jul 18-19, and the Patriot/PAC-3 shortage — worsened by the 2026 Iran war draining US stocks — remains the one gap Ukraine cannot close on its own.",assessment:[{cat:"Attrition",text:"~8:1 RU:UA loss ratio in H1 2026 (CSIS). Cumulative Russian losses reached 1,428,930 as of the Jul 19 MoD report (+1,520 on the day); artillery again ran high (+92 to 46,261) and Russian UAV losses passed 416,000 (416,656). The naval/deep-strike campaign keeps compounding and widening: strikes landed inside Moscow region itself Jul 18 (Noginsk oil depot, an Unmanned Systems Forces warehouse in Elektrostal, a Wildberries logistics fire), on top of the Azov/Black Sea interdiction that remains a sustained second front."},{cat:"Territory",text:"Russian advance remains grinding — Pokrovsk is now the single hottest sector on the front, 268 combat clashes recorded there Jul 8 alone, alongside Huliaipole. Monthly gain estimates diverge sharply by source: DeepState puts Russia's net gain at ~31 sq mi for Jun 9-Jul 7, ISW at just ~6 sq mi — among the slowest rates of any war in the past century either way. Russia had a net territorial LOSS in Apr-May 2026 (~400 km²), its first monthly net loss since Aug 2024."},{cat:"Deep Strikes",text:"The campaign has escalated into economic coercion and now reaches Moscow region itself. Jul 6: the deepest strike of the war — FP-1 drones flew ~3,000km to hit the Omsk refinery, Russia's largest, first-ever strike on the plant, offline within 24 hours. Jul 13: a strike hit the Salavat refinery in Bashkortostan, 1,400km inside Russia. Jul 16: a re-strike on the Slavneft-YANOS refinery in Yaroslavl and confirmation the Jul 14-15 Engels-2 airbase strike tore the tail off a Tu-95 bomber. Jul 18: strikes for the first time landed inside Moscow region proper — an oil depot in Noginsk, a Center of Unmanned Systems Forces warehouse destroyed in Elektrostal, and a fire at a major Wildberries logistics hub — as Moscow's mayor reported 1,892 Ukrainian drones detected heading toward the region in the preceding week alone. The cumulative effect is a nationwide Russian fuel crisis, with Moscow banning diesel exports and Putin publicly requesting Crimea fuel subsidies."},{cat:"Air Defense",text:"The decisive materiel question of the war may have just moved again. Russia fired 41 missiles (25 ballistic) and 125 drones at Kyiv overnight Jul 18-19 — one of the largest ballistic barrages of the war — with 18 missiles and 108 drones intercepted/suppressed, 1 killed and 16 wounded. That follows a mixed week: 5 of 8 ballistic missiles downed Jul 13-14 (likely Patriot), but only 1 of 8 missiles downed the night of Jul 16-17. At Ankara on Jul 8 Trump licensed Ukraine to manufacture Patriots itself; Zelensky said Jul 9 the licence is agreed politically with supplies due within days, but officials put real domestic production months-to-years out. Poland will co-produce and maintain PAC-3s under a new multilateral agreement and is transferring 5 missiles now; Ukraine's domestic 'Freyja' interceptor may draw eight European partners. Drone-side economics still favor Ukraine ($7.5k interceptor vs $35k Shahed)."},{cat:"Diplomacy",text:"Ankara concluded: $80B allied pledge for 2026, Patriot manufacturing license, and a notably warm Trump-Zelensky bilateral — Trump said Zelensky has 'done an amazing job.' Russia had already rejected the Turkish ceasefire push, so the negotiating track itself remains blocked. Czech President Pavel: Ukraine has roughly two months to resume talks before the window narrows."}],watch:"Two variables now: whether Pokrovsk holds — still the most consequential sector against an otherwise favorable attrition/territorial picture — and whether the Jul 18-19 ballistic barrage on Kyiv signals a renewed heavy-missile campaign that a strained Patriot/PAC-3 stockpile (drained further by the Iran war) can't keep pace with.",generatedAt:new Date().toISOString()};
...
const REPORT_NOW=new Date("2026-07-20T09:00:00Z");
  ...
  return <div>
    ...
    {tab==="timeline"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>From Operation Epic Fury (Feb 28) through the Islamabad MoU and the 27-day countdown to Aug 16.</div>
      </Hero>
    ...
    {tab==="gaps"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #ef4444"}}>
        <div style={{fontSize:11,color:"rgba(255,255,255,.4)",textTransform:"uppercase",letterSpacing:".08em",marginBottom:8}}>⚠️ Unresolved Gaps — 27 Days Remain</div>
...
function NuclearSection({t,initialTab}){
  ...
  const VECTORS=[
    ...
    {flag:"🇮🇷",name:"Iran — Nuclear Clock",status:"27 DAYS",color:"#8b5cf6",text:"Islamabad MoU 60-day window closes ~Aug 16. IAEA inspector access disputed. Enrichment red lines unresolved — Pezeshkian: 'we will never back down from the right to enrich uranium.'"},
