...
const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,449,120",todayChange:"+1,500",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
  {id:2,category:"Tanks",total:"12,231",todayChange:"—",color:"#f97316",icon:"🪖",description:"Main battle tanks"},
  {id:3,category:"Armoured Vehs",total:"25,070",todayChange:"+10",color:"#eab308",icon:"🚧",description:"APCs, IFVs, MRAPs"},
  {id:4,category:"Artillery",total:"47,196",todayChange:"+69",color:"#84cc16",icon:"💥",description:"Guns, howitzers, mortars"},
  {id:5,category:"MLRS",total:"1,988",todayChange:"+8",color:"#22c55e",icon:"🚀",description:"Multiple launch rockets"},
  {id:6,category:"Air Defence",total:"1,529",todayChange:"+2",color:"#06b6d4",icon:"🛡️",description:"SAM & SHORAD systems"},
  {id:7,category:"UAVs",total:"439,291",todayChange:"+1,788",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
  ...
  {id:12,category:"Vehicles",total:"128,953",todayChange:"+456",color:"#a78bfa",icon:"🚛",description:"Trucks & logistics"},
  {id:13,category:"Ground Robots",total:"2,108",todayChange:"+11",color:"#f43f5e",icon:"🤖",description:"UGV platforms"},
  {id:14,category:"Special Equip",total:"4,484",todayChange:"—",color:"#fb923c",icon:"🔧",description:"Engineering & EW"},
],gaza:[
...
const BRIEFING={summaryShort:"Ukraine struck deep into Russia overnight into Aug 2 — Zelensky personally confirmed simultaneous hits on the Saratov oil refinery and the Engels-2 strategic bomber base (Tu-95MS/Tu-160), over 600km from the front line, plus a Kaluga fuel depot and a Bryansk drone-prep site. It follows an Aug 1 multi-target night in Crimea (rail bridges, a naval-drone depot, a Black Sea Fleet SIGINT unit) and a record July for Russian losses (42,860 in the month, 238,650 for H1). Russian losses reached 1,449,120 (+1,500) per the Aug 2 report. Iran: still pending — Trump has not given final authorization for threatened strikes on Iranian energy infrastructure, and Iran has explicitly threatened to hit Israeli and US regional energy facilities in response if they proceed. Gaza's Jul 31 disarmament announcement remains unimplemented; Ukraine's Fedorov crisis remains unresolved.",summary:"Ukraine's deep-strike campaign is now the dominant story of the week. Overnight into Aug 2, Ukrainian forces hit Russia's Saratov oil refinery (~7M tonnes/year, Rosneft) and the Engels-2 strategic bomber base 17km away — home to Tu-95MS and Tu-160 aircraft used to launch missiles at Ukraine — in a strike Zelensky confirmed personally, alongside a fuel depot in Kaluga and a drone-preparation site in Bryansk. It follows an Aug 1 night that hit two Crimean rail bridges (Sivash/Chonhar and Vladyslavivka), a naval-drone storage depot, a Black Sea Fleet electronic-reconnaissance unit in Sevastopol, and — via HUR — a Pantsir-S1 air defense system and a Sargan patrol boat. Russia's own losses hit a 2026 record in July: 42,860 personnel killed and wounded, the worst single month of the year, bringing the seven-month 2026 total to 238,650. Cumulative losses reached 1,449,120 (+1,500) as of the Aug 2 General Staff report. Iran: the threatened weekend strikes on Iranian energy infrastructure still have not been authorized by Trump as of the latest reporting — officials say a final 'go' order was still pending. Iran has responded to the CBS report of the plan by calling it 'reckless' and explicitly threatening to retaliate against critical infrastructure in Israel and US regional energy facilities if it proceeds; a joint US-Israeli strike would also mark Israel's first return to combat operations since the truce collapsed. Gaza: the Jul 31 Board of Peace disarmament framework remains unimplemented — neither Hamas nor Israel has taken a concrete first step. Elsewhere: Ukraine's Fedorov/Syrskyi political crisis remains unresolved with no new defense minister named.",watch:"Whether the Iran energy-infrastructure strikes are authorized and whether Israel's return to combat operations widens the war further; whether Russia retaliates specifically against the Engels-2/Saratov strike given its strategic-bomber significance; and whether Hamas or Israel take any concrete first step on the Gaza disarmament framework.",generatedAt:new Date().toISOString()};

const UKRAINE_BRIEFING={summaryShort:"A major deep-strike week: Ukraine hit Russia's Engels-2 strategic bomber base and Saratov refinery overnight into Aug 2, plus a multi-target Crimea night on Aug 1 (rail bridges, naval-drone depot, Black Sea Fleet SIGINT). Russia's own July losses hit a 2026 record (42,860), even as cumulative losses climb steadily to 1,449,120. The Patriot-licensing walkback from Trump's Jul 31 Cabinet remarks continues to draw commentary as the real air-defense story. Fedorov/Syrskyi crisis remains unresolved.",summary:"Ukraine's long-range strike campaign had its most significant week in months. Overnight into Aug 2, Zelensky personally confirmed simultaneous strikes on Russia's Saratov oil refinery and the Engels-2 strategic bomber base 17km away — home to the Tu-95MS and Tu-160 bombers that launch Russia's cruise-missile strikes on Ukraine — over 600km from the front line, alongside a fuel depot in Kaluga and a drone-preparation site in Bryansk. That followed an Aug 1 night that hit two Crimean rail bridges linking the peninsula to Russian-held southern Ukraine, a naval-drone storage depot, a Black Sea Fleet electronic-reconnaissance unit in Sevastopol, and — via HUR — a Pantsir-S1 air defense system and Sargan patrol boat. Meanwhile Russia's own attrition set a 2026 record: July's 42,860 personnel losses were the worst single month of the year, pushing the seven-month total to 238,650. Cumulative losses reached 1,449,120 (+1,500) as of Aug 2, up from 1,447,620 the day before — a steady climb even as the monthly rate fluctuates. Commentary continues to focus on the Patriot-licensing walkback from Trump's Jul 31 Cabinet remarks as the real story behind the Aug 1 Kyiv attack's exposed interceptor shortage, with Ukrainian outlets noting the refusal 'changes almost nothing' practically since domestic production was always going to take years regardless.",assessment:[{cat:"Attrition",text:"July was Russia's worst month of 2026 for personnel losses: 42,860 killed and wounded, bringing the seven-month total to 238,650. Cumulative losses reached 1,449,120 as of the Aug 2 MoD report (+1,500 on the day) — artillery losses continue climbing (47,196, +69), ground robot losses accelerating (2,108, +11). Ukraine's deep-strike campaign remains a sustained second front, this week reaching a strategic bomber base 600km from the front line for the first time in weeks."},{cat:"Territory",text:"Russian advance remains grinding — Pokrovsk is the single hottest sector on the front, alongside Huliaipole. Monthly gain estimates diverge sharply by source (DeepState vs. ISW), among the slowest rates of any war in the past century either way. Russia had a net territorial loss in Apr-May 2026, its first monthly net loss since Aug 2024."},{cat:"Deep Strikes",text:"The week's dominant story. Aug 1-2 hit Engels-2 (Tu-95MS/Tu-160 strategic bomber base) and the Saratov refinery, both over 600km from the front line and personally confirmed by Zelensky — a significant escalation in target selection beyond the refinery-focused campaign of recent months. The preceding night hit two Crimean rail bridges, a naval-drone depot, and Black Sea Fleet SIGINT infrastructure in Sevastopol. The cumulative effect remains a nationwide Russian fuel crisis severe enough to have forced a diesel export ban and, per Financial Times analysis, disrupted over 30% of operational refining capacity."},{cat:"Air Defense",text:"The Aug 1 Kyiv attack (1 of 27 ballistic missiles intercepted) continues to drive commentary about the Jul 31 Patriot-licensing walkback. Ukrainian analysts argue the refusal 'changes almost nothing' in practice, since domestic PAC-3 production was always a multi-year proposition — the immediate shortage is about existing stockpiles and allied transfers, not the licensing dispute itself. Poland continues co-producing and transferring PAC-3s as a partial workaround."},{cat:"Diplomacy",text:"Notable and unexplained: Ukrainian reporting describes Trump-Zelensky relations as having 'unexpectedly warmed' amid the US war with Iran, without full detail on the cause — worth watching for whether this translates into any concrete shift on the Patriot question. The Kremlin continues to treat the Anchorage understandings as void; the Turkish ceasefire push remains rejected."},{cat:"Political",text:"Fedorov's dismissal remains a full command shake-up with no resolution: Zelensky replaced Commander-in-Chief Syrskyi with Mykhailo Drapatyi and General Staff chief Andrii Hnatov with Ihor Skybiuk. Fedorov continues rejecting Zelensky's alternative offer; protests have now run for over three weeks with no new defense minister named."}],watch:"Whether Russia retaliates specifically against the Engels-2 strike given its strategic-bomber significance; whether the 'unexpectedly warmed' Trump-Zelensky dynamic produces any concrete shift on Patriot licensing; and whether Pokrovsk holds against an otherwise favorable attrition picture.",generatedAt:new Date().toISOString()};

const IRAN_BRIEFING={summaryShort:"Still pending as of Aug 2: Trump has not given final authorization for the threatened strikes on Iranian energy infrastructure, though officials say the plan remains live and could still proceed. Iran has responded by explicitly threatening retaliation against Israeli and US regional energy infrastructure if it does — and a joint operation would mark Israel's first return to combat operations since the truce collapsed. The core gaps — enrichment, missiles, Hormuz governance — remain unbridged with 14 days left on the nominal MoU clock.",summary:"The threatened weekend strikes on Iranian energy infrastructure have not materialized as of Aug 2 — Trump has still not given the final 'go' order, per the latest US reporting, though the plan remains live rather than shelved. What's new since Friday is the sharpness of Iran's response: Tehran called the CBS report of the plan 'reckless' and explicitly threatened to retaliate by striking critical infrastructure in both Israel and US regional energy facilities if the strikes go ahead — a direct, named threat rather than a general warning. A joint US-Israeli operation would also mark a real escalation in scope: Israel has not struck Iran since the memorandum of understanding collapsed, and a joint strike would mark its return to active combat operations in this war. Separately, the Damietta drone strike on gas vessels at Egypt's Mediterranean port has raised fears the conflict could threaten Suez Canal shipping — a chokepoint distinct from Hormuz that has not previously been at risk in this war. None of the core negotiating gaps — uranium enrichment, the missile program, Hormuz shipping governance, IAEA access to bombed sites — have moved. The nominal 60-day Islamabad MoU window closes in 14 days.",assessment:[{cat:"Military",text:"Trump has still not authorized the reported weekend strikes on Iranian energy infrastructure as of Aug 2 — the plan remains live, not shelved, per CBS sourcing. Some White House political aides are reported to oppose it internally. There was reportedly discussion of concluding any campaign before Monday's market open, given concern about global economic impact, though no firm end point was set."},{cat:"Escalation Risk",text:"Iran's threat to strike Israeli and US regional energy infrastructure is more specific and more direct than prior general warnings — naming both targets explicitly rather than issuing a vague retaliation threat. A joint US-Israeli strike would mark Israel's first return to combat operations since the truce collapsed, which is itself a scope expansion regardless of what Iran does in response."},{cat:"Geographic Expansion",text:"The Damietta, Egypt drone strike on gas vessels has raised fears of Suez Canal shipping disruption — a new potential chokepoint beyond Hormuz that hasn't previously featured in this war. Iran's retaliation for the earlier Qeshm strike already reached Kuwait, Jordan and Bahrain; Saudi Arabia's joint strikes with the US in Iraq remain the clearest first-time expansion marker."},{cat:"Diplomacy/MoU",text:"No movement. Iran's public posture has hardened into direct threats rather than any renewed engagement with the Oman-mediated channel. Enrichment rights, the missile program, and Hormuz shipping governance remain unbridged core gaps with 14 days left on the nominal MoU clock."},{cat:"Hormuz/Economy",text:"Iran's IRGC maintains the strait stays closed to normal traffic as long as US 'interference' continues. A confirmed strike campaign against energy infrastructure would be a direct escalation against the same economic chokepoint the blockade already targets — and Iran's named threat against US/Israeli energy facilities suggests it sees energy infrastructure as the appropriate retaliatory target class too."},{cat:"Iran Domestic",text:"No confirmed public appearance by successor Supreme Leader Mojtaba Khamenei since his father's Jul 9-10 burial — now over three weeks with no image, video or voice recording. The explicit retaliation threat naming Israel and US regional facilities is the most senior public Iranian messaging since the Qeshm funeral."}],watch:"Whether Trump gives final authorization for the energy-infrastructure strikes and whether Iran follows through on its explicit retaliation threat against Israeli/US energy facilities; whether the Damietta incident escalates into an actual Suez shipping disruption; and whether Israel's potential return to combat operations changes the war's basic two-party structure.",generatedAt:new Date().toISOString()};
...
const REPORT_NOW=new Date("2026-08-02T22:45:00Z");
...
const HZ_IRAN=[[26.55,54.50],[26.55,54.88],[26.70,55.20],[26.80,55.50],[26.95,55.90],[27.05,56.15],[27.18,56.28],[27.15,56.60],[27.00,56.90],[26.80,57.20],[26.50,57.50],[26.20,57.70],[25.95,57.80],[25.72,57.86],[25.55,58.10],[27.50,58.10],[27.50,54.50]];
const HZ_OMAN=[[24.90,55.10],[25.50,55.60],[25.79,55.94],[26.00,56.10],[26.18,56.24],[26.30,56.35],[26.39,56.51],[26.25,56.60],[26.05,56.50],[25.85,56.40],[25.62,56.27],[25.35,56.35],[25.12,56.34],[25.00,56.55],[24.90,56.55]];
const HZ_QESHM=[[26.75,55.30],[26.90,55.50],[27.00,55.80],[26.98,56.10],[26.85,56.28],[26.70,56.20],[26.62,55.90],[26.65,55.55]];
...
function HormuzMap({t}){
  ...
  return <Card t={t} style={{padding:"12px 8px 8px"}}>
    ...
    <svg viewBox={`0 0 ${HZ.W} ${HZ.H}`} style={{width:"100%",height:"auto",display:"block",background:sea}} role="img" aria-label="Map of the Strait of Hormuz showing Iran, Oman's Musandam Peninsula, the shipping lane and the 21-nautical-mile chokepoint.">
      ...
      <path d={hzPath(HZ_IRAN)+" Z"} fill="url(#hzBlock)"/>

      {/* landmasses */}
      <path d={hzPath(HZ_IRAN)+" Z"} fill={land} stroke={edge} strokeWidth="1"/>
      <path d={hzPath(HZ_OMAN)+" Z"} fill={land} stroke={edge} strokeWidth="1"/>
      <path d={hzPath(HZ_QESHM)+" Z"} fill={land} stroke={edge} strokeWidth="1"/>
