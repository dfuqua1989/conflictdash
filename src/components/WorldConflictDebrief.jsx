...
const BRIEFING={summaryShort:"Russian losses reached 1,454,210 (+1,330 on Aug 5) per the General Staff — unchanged since yesterday, no newer report yet. The big movement: Oman formally agreed Thursday to a framework deal with Iran to temporarily reopen Hormuz — inbound traffic via an Iran-controlled route, outbound via Oman, with no tolls per an Iranian official. Iran’s FM spokesman was explicit this is ‘an entirely new model,’ not an implementation of the June MoU’s Article 5. Framed as a temporary arrangement meant to lay groundwork for a new ceasefire and resumed nuclear talks. Ukraine: still no successor named for the vacant Washington ambassadorship since Stefanishyna’s Aug 3 dismissal.",summary:"Russian combat losses held at 1,454,210 as of the Aug 6 General Staff report (+1,330 on Aug 5) — no newer figure has posted yet today. The main development is on Hormuz: two Middle East diplomats told MS NOW that Oman agreed Thursday to the framework of a deal with Iran to temporarily reopen the strait, following through on Wednesday’s announcement that a joint statement was in final drafting. Under the framework, commercial vessels would enter the Gulf via an Iranian-controlled route and exit via a route controlled by Oman — and according to an Iranian government official linked to the deal, it does not include tolls on shipping, resolving in Iran’s telling the fee dispute that had run through the negotiation for weeks. Iran’s FM spokesman Esmail Baghaei was explicit in later remarks that this is not an implementation of the June US-Iran MoU’s Article 5 — which had only committed Iran to ‘best efforts’ on safe passage — but ‘an entirely new model reflecting today’s security environment.’ The arrangement is being described as temporary, intended to lay the foundation for a new ceasefire and a resumption of the broader nuclear talks. Real questions remain unresolved regardless of the framework: whether the IRGC accepts reduced operational control, whether reopening extends to US naval vessels, and how much cargo/destination information Iran will demand. In Ukraine, the Washington ambassadorship remains vacant with no successor named since Zelensky dismissed Olha Stefanishyna on Aug 3, even as he maintains Kyiv is in daily contact with Trump’s team.",watch:"Whether Oman’s framework agreement converts into a signed, public joint statement in the coming days, and whether Iran’s Supreme Leader Khamenei gives the final sign-off it’s still said to be awaiting; whether ‘no tolls’ holds up once details are published, given weeks of conflicting US-Iran signals on exactly that point; and who Zelensky names to the vacant Washington post.",generatedAt:new Date().toISOString()};
const UKRAINE_BRIEFING={summaryShort:"Russian losses hold at 1,454,210 as of the Aug 6 General Staff report (+1,330 on Aug 5) — no newer figure posted yet today. The Aug 5 overnight Kyiv-region strike (14-17 killed, dozens wounded, warehouses and logistics hubs hit) remains the week’s worst single night for civilians. The Washington ambassadorship stays vacant since Stefanishyna’s Aug 3 dismissal, with no successor named even as Zelensky maintains Kyiv is in ‘daily contact’ with Trump’s team.",summary:"Russian losses remain at 1,454,210 as of the Aug 6 General Staff report (+1,330 on Aug 5, alongside 1,811 drones, 59 artillery systems and 4 tanks that day) — the next report hasn’t posted yet as of this update. The Aug 5 overnight missile and drone attack on the Kyiv region remains the dominant story from the past 48 hours: at least 14-17 killed and dozens wounded, with warehouses and logistics hubs bearing the brunt, including facilities linked to Epicentr, Rozetka, Fozzy Group and Nova Poshta. Ukraine’s own deep-strike campaign continues in parallel — a Wildberries warehouse in Russia’s Tula region caught fire the same night, underscoring the tit-for-tat dynamic around commercial and logistics targets on both sides. Ukraine’s ambassadorial vacancy in Washington persists: no successor has been named since Zelensky dismissed Olha Stefanishyna by decree on Aug 3 amid an anti-corruption probe, even as Zelensky says Kyiv remains in ‘daily contact’ with Trump’s team and expects Witkoff and Kushner to step up involvement through August. NATO’s reported 250% year-over-year rise in July eastern-border aircraft scrambles remains the clearest hybrid-pressure indicator distinct from the main front.",assessment:[{cat:"Attrition",text:"Cumulative losses hold at 1,454,210 as of Aug 6 (+1,330 on Aug 5) — no newer General Staff report has posted yet today. Losses remain within the sustained 1,100–1,500/day range."},{cat:"Strike — Kyiv Region",text:"The Aug 5 overnight missile/drone attack on the Kyiv region (14-17 killed, dozens wounded, warehouses and logistics hubs hit) remains the worst single night for civilians this week, with no comparable follow-up strike reported since."},{cat:"Deep Strikes",text:"Ukraine’s drone campaign continues targeting Russian logistics and oil infrastructure — a Wildberries warehouse fire in Tula region the same night as the Kyiv strike underscores the parallel, tit-for-tat targeting of commercial/logistics infrastructure on both sides."},{cat:"Hybrid Pressure",text:"NATO’s reported 250% year-over-year increase in July eastern-border aircraft scrambles, driven by Russian military aircraft skirting Alliance airspace without flight plans, remains the most recent hybrid-pressure data point."},{cat:"Political — Ambassador Vacancy",text:"No successor has been named to the Washington ambassadorship since Zelensky dismissed Olha Stefanishyna by decree Aug 3 amid an anti-corruption probe — the vacancy now enters its fourth day, alongside Zelensky’s continued claim of ‘daily contact’ with Trump’s team."},{cat:"Covert War",text:"The Aug 1 Moscow restaurant bombing killing 3 and injuring 20+ remains unofficially linked, but not confirmed by either government, to Gen. Alexander Chayko, commander of Russia’s Aerospace Forces and a Bucha war-crimes suspect."},{cat:"Command",text:"Fedorov’s dismissal from the July reshuffle remains unresolved with no new defense minister confirmed. Zelensky replaced Commander-in-Chief Syrskyi with Mykhailo Drapatyi and General Staff chief Hnatov with Ihor Skybiuk in July."}],watch:"Whether the next General Staff casualty report shows continuation of the 1,100–1,500/day range or a break from it; who Zelensky names to the vacant Washington ambassadorship; and whether Russia follows the Aug 5 Kyiv strike with further large-scale attacks in the coming days.",generatedAt:new Date().toISOString()};
const IRAN_BRIEFING={summaryShort:"Oman formally agreed Thursday to the framework of a temporary deal with Iran to reopen Hormuz — inbound traffic via an Iran-controlled route, outbound via Oman, with no tolls per an Iranian official, resolving (in Iran’s telling) the fee dispute that dogged talks for weeks. Iran’s FM spokesman was explicit this is ‘an entirely new model,’ not implementation of the June MoU’s Article 5. Framed as temporary, meant to lay groundwork for a new ceasefire and resumed nuclear talks. Key questions — IRGC control, US naval access, cargo disclosure — remain unresolved. Roughly 10 days left on the nominal MoU clock (closes ~Aug 16).",summary:"The Hormuz diplomatic track crossed a real threshold Thursday: two Middle East diplomats told MS NOW that Oman has agreed to the framework of a temporary deal with Iran to reopen the strait, following Wednesday’s announcement that a joint statement was in final drafting. Under the arrangement, commercial vessels would enter the Gulf via an Iranian-controlled route and exit via a route controlled by Oman. An Iranian government official linked to the deal told MS NOW it does not include tolls on shipping — a direct resolution, at least in Iran’s account, of the fee dispute (previously reported as Iran seeking 5-7% of cargo value) that has run through the negotiation for weeks and repeatedly conflicted with US officials’ own ‘freedom of movement’ framing. Iran’s FM spokesman Esmail Baghaei was explicit in later remarks, however, that this does not represent implementation of the June US-Iran MoU’s Article 5, which had only committed Iran to ‘best efforts’ on safe passage for 60 days without a firm operational plan. Instead, he described the Iran-Oman understanding as ‘an entirely new model reflecting today’s security environment rather than a continuation of the previous 60-year arrangement’ governing the strait. CNN’s reporting frames this carefully: an Iran-Oman agreement, even if signed, would not by itself reopen the waterway as Trump has hoped — real questions remain about whether Iran’s Revolutionary Guards accept reduced operational control, whether any reopening extends to foreign (including American) naval vessels, and how much cargo and destination information Iran will demand from transiting ships. The arrangement is being described by involved officials as a temporary one, intended to lay groundwork for a new ceasefire and a resumption of the broader nuclear negotiations rather than a final settlement. None of the core substantive gaps — uranium enrichment, the missile program, IAEA access to bombed sites — have moved. The nominal 60-day Islamabad MoU window, signed Jun 17, closes around Aug 16 — roughly 10 days out.",assessment:[{cat:"Diplomacy — Oman Agrees to Framework",text:"Two Middle East diplomats tell MS NOW that Oman agreed Thursday to the framework of a temporary Iran-Oman deal to reopen Hormuz — a step forward from Wednesday’s ‘final drafting’ stage. Inbound Gulf traffic via an Iran-controlled route, outbound via Oman."},{cat:"Diplomacy — Tolls Resolved (Iran’s Account)",text:"An Iranian official says the deal includes no tolls on shipping — resolving, at least as Iran describes it, the 5-7%-of-cargo-value fee dispute that had persisted for weeks and conflicted with US officials’ ‘freedom of movement’ framing. Not yet independently confirmed by a US source."},{cat:"Diplomacy — Not Article 5",text:"Baghaei explicitly denied this implements the June MoU’s Article 5 (‘best efforts,’ no firm plan), calling the Iran-Oman understanding ‘an entirely new model’ replacing rather than continuing the strait’s prior 60-year governance arrangement."},{cat:"Not a Full Reopening",text:"CNN’s analysis is explicit: an Iran-Oman route agreement, even signed, would not by itself reopen the waterway as Trump hopes. Unresolved: whether the IRGC accepts reduced control, whether US naval vessels are covered, and how much cargo/destination data Iran will demand."},{cat:"Temporary, Not Final",text:"Officials describe the framework as a temporary arrangement meant to lay groundwork for a new ceasefire and resumption of the broader nuclear talks — not a final settlement of the underlying US-Iran dispute."},{cat:"Pattern Risk",text:"Mediators believed they had a deal in mid-July, only for Iran to resume attacks on shipping, triggering two weeks of fighting that nearly escalated to all-out war. Thursday’s framework agreement is still short of a signed, published joint statement."},{cat:"MoU Clock",text:"Enrichment rights, the missile program and formal Hormuz governance remain unresolved by any shipping-route framework alone. Roughly 10 days remain on the nominal 60-day MoU clock (window closes ~Aug 16)."},{cat:"Iran Domestic",text:"No confirmed public appearance by successor Supreme Leader Mojtaba Khamenei since his father’s Jul 9-10 burial — nearly four weeks with no image, video or voice recording, even as he was reported Wednesday to be the final approval authority on the underlying draft."}],watch:"Whether Thursday’s Oman framework agreement converts into a signed, public joint statement in the coming days; whether the ‘no tolls’ claim holds up once full details are published; and whether this temporary arrangement actually produces the ceasefire and resumed nuclear talks it’s being described as a foundation for.",generatedAt:new Date().toISOString()};
...
const REPORT_NOW=new Date("2026-08-06T22:24:00Z");
...
function USMilSection({t,initialTab}){
  ...
  const VECTORS=[
    ...
    {flag:"🇮🇷",name:"Iran — Nuclear Clock",status:"10 DAYS",color:"#8b5cf6",text:"Islamabad MoU 60-day window closes ~Aug 16. IAEA inspector access disputed. Enrichment red lines unresolved — Pezeshkian: 'we will never back down from the right to enrich uranium.'"},
