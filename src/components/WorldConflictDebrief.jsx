...
const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,430,530",todayChange:"+1,600",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
  {id:2,category:"Tanks",total:"12,158",todayChange:"+2",color:"#f97316",icon:"🪖",description:"Main battle tanks"},
  {id:3,category:"Armoured Vehs",total:"24,971",todayChange:"+8",color:"#eab308",icon:"🚧",description:"APCs, IFVs, MRAPs"},
  {id:4,category:"Artillery",total:"46,343",todayChange:"+82",color:"#84cc16",icon:"💥",description:"Guns, howitzers, mortars"},
  {id:5,category:"MLRS",total:"1,953",todayChange:"+3",color:"#22c55e",icon:"🚀",description:"Multiple launch rockets"},
  {id:6,category:"Air Defence",total:"1,511",todayChange:"+6",color:"#06b6d4",icon:"🛡️",description:"SAM & SHORAD systems"},
  {id:7,category:"UAVs",total:"418,425",todayChange:"+1,769",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
  ...
  {id:10,category:"Cruise Missiles",total:"4,933",todayChange:"+18",color:"#14b8a6",icon:"🎯",description:"Destroyed in flight"},
  {id:11,category:"Ships/Boats",total:"34",todayChange:"—",color:"#64748b",icon:"⛵",description:"Naval vessels"},
  {id:12,category:"Vehicles",total:"122,894",todayChange:"+605",color:"#a78bfa",icon:"🚛",description:"Trucks & logistics"},
  {id:13,category:"Ground Robots",total:"1,965",todayChange:"+9",color:"#f43f5e",icon:"🤖",description:"UGV platforms"},
  {id:14,category:"Special Equip",total:"4,433",todayChange:"+3",color:"#fb923c",icon:"🔧",description:"Engineering & EW"},
],gaza:[
...
const REPORT_NOW=new Date("2026-07-20T19:17:00Z");
