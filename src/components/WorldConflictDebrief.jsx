...
const NEWS=[
  {id:"b_us_iran_strikes_jul7",conflictId:"iran",severity:"critical",icon:"🔴",headline:"US Strikes 80+ Iranian Targets After Tanker Attacks in Hormuz — MoU in Deepest Crisis Since Signing",conflict:"Iran",conflictColor:"#8b5cf6",publishedAt:"Jul 7, 2026",bullets:["Iran attacked three commercial tankers transiting the Strait of Hormuz Monday night-Tuesday — including Qatar's Al Rekayyat and Saudi Arabia's Wedyan — reportedly for using non-Iranian-designated routes; both Gulf states condemned the strikes as violations of international law","CENTCOM responded with a 'series of powerful strikes' on 80+ targets: air defense systems, command-and-control networks, coastal radar, anti-ship missile sites, and 60+ IRGC small boats in and near the strait; explosions reported on Kharg Island (Iran's key oil-export hub), Qeshm, Bandar Abbas and Sirik","The Treasury simultaneously revoked GL X — the Jun 21 license authorizing Iranian oil sales, the MoU's core economic benefit: 'the MOU is entirely performance-based... Iran will only reap benefits if they exhibit good behavior'; Brent jumped 5.5% to ~$76","Iran's chief negotiator Ghalibaf accused Washington of 'major violations of the MOU' — 'the era of bullying and extortion is over. We don't fold' — and Tehran vowed a 'crushing response'; Kuwait and Bahrain air defenses activated against missile and drone threats early Wednesday. All during Khamenei's funeral week, with Trump at the NATO summit in Ankara"],sources:["CENTCOM","CNN","CBS News"],impact:"The largest US-Iran exchange since the MoU was signed — the agreement has survived skirmishes before, but simultaneous kinetic strikes AND revocation of its core economic benefit is a different order of stress test, with Gulf states now under Iranian retaliatory fire",impactColor:"#dc2626"},
...
const BRIEFING={summary:"Ukraine pushed total Russian losses to 1,413,510 (Jul 8 MoD report, +1,260 on the day) while sustaining its deep-strike campaign — Russian refining is at 42.47% of design capacity after the St. Petersburg Oil Terminal and Kronstadt raids. Russia answered with two Kyiv mass strikes in five days: roughly 570 missiles and drones on Jul 1-2 (30 killed), then 68 missiles and 351 drones on Jul 5-6 (21 killed) with zero ballistic intercepts — Patriot stocks exhausted. NATO Ankara opens today, with air defense the forced centerpiece after two Kyiv mass strikes in five days: the draft commits €70B/year through 2027 (€140B total), brands Russia a 'long-term threat,' and reaffirms Article 5 — ratification is the day's question. The Iran MoU hit its deepest crisis since signing: Iran struck three tankers in Hormuz (including Qatari and Saudi vessels), the US answered with strikes on 80+ targets — air defenses, coastal radar, 60+ IRGC boats — and revoked the GL X oil-sales license, the deal's core economic benefit. Tehran vows a 'crushing response'; Kuwait and Bahrain air defenses are active; Brent jumped 5.5%. All during Khamenei's funeral week, with his successor Mojtaba still unseen before the Jul 9 burial. The UN Human Rights Council held an urgent debate Jul 3 on El-Obeid, drafting a resolution condemning starvation as a method of warfare, as Venezuela's earthquake recovery collides with acting President Rodríguez's expired interim mandate and Machado's bid to return.",signals:[{theater:"Ukraine",text:"2nd Kyiv mass strike in 5 days kills 21; zero ballistic intercepts; 1.41M RU losses"},{theater:"NATO",text:"Ankara Day 2 (final) — Trump-Zelensky bilateral 14:30; €140B/2yr ratification watch"},{theater:"Iran",text:"US strikes 80+ targets after tanker attacks; GL X oil license revoked; Brent +5.5%"},{theater:"Sudan",text:"UN urgent debate on El-Obeid — draft resolution on starvation as warfare"}],watch:"Next 48hrs: Iran's vowed 'crushing response' — whether Gulf-state air defense activations (Kuwait, Bahrain) mark the MoU's collapse or another survivable skirmish; Ankara Day 2 — Trump-Zelensky bilateral Wed 14:30, €140B ratification, any Patriot deliverable; whether Jul 11 talks still happen; Mojtaba's first appearance before the Jul 9 burial.",generatedAt:new Date().toISOString()};
  ...
  return <div>
    ...
    {tab==="hormuz"&&<div>
      ...
      <Grid2 t={t} items={[
        ...
        {icon:"↩️",label:"Ships U-turned testing the strait",val:"8",sub:"Jul 4 alone, per tracking data",color:"#f97316"},
        {icon:"🚢",label:"Convoy transits via Omani route",val:"5+",sub:"Jul 5 — tankers hugging the Omani coast",color:"#22c55e"},
        {icon:"⏳",label:"Days to MoU deadline",val:"42",sub:"Aug 16 — 60-day Islamabad window closes",color:"#8b5cf6"},
      ]}/>
      <ST t={t} color="#0e7490">📋 Status Board</ST>
      <Card t={t}><div style={{padding:"11px 14px"}}><div style={{fontSize:12,color:t.sub,lineHeight:1.7}}>
        <div style={{marginBottom:6}}><span style={{color:t.text,fontWeight:700}}>Jul 7 crisis</span> — Iran struck three tankers (Qatari Al Rekayyat, Saudi Wedyan among them) reportedly for using non-designated routes; the US hit 80+ targets including 60+ IRGC boats and revoked the GL X oil license. Insurance and transit calculus reset overnight — the partial reopening of early July (5-vessel convoys, 8 U-turns Jul 4) is now moot pending Iran's response.</div>
