...
const NEWS=[
  {id:"b_syrskyi_dismissed_jul21",conflictId:"ukraine",severity:"critical",icon:"🔴",headline:"Zelensky Actually Dismisses Syrskyi as Commander-in-Chief, Names Drapatyi to Replace Him",conflict:"Ukraine",conflictColor:"#5b8ec8",publishedAt:"Jul 21, 2026",bullets:["Days after the General Staff denied Jul 20 reports that Syrskyi had been removed, Zelensky reversed course Jul 21 and dismissed him for real — appointing Maj. Gen. Mykhailo Drapatyi, previously the Joint Forces commander, as the new commander-in-chief. Zelensky said the move was made to 'reset' the war effort after consultations with Drapatyi, SBU special-operations commander Yevhen Khmara, and presidential-office deputy head Pavlo Palisa","Zelensky thanked Syrskyi in a farewell statement: 'I am grateful to Oleksandr Syrskyi and to every one of our warriors for Ukraine's strong front-line positions.' Drapatyi has previously praised Fedorov's tenure and called for a systemic overhaul of the army, aligning him more with the reform camp than Syrskyi was","The dismissal came after six-plus days of nationwide protests, which have now spread beyond Kyiv into Lviv, Odesa and Dnipro. Protesters have set a Jul 24 deadline for Fedorov's reinstatement — meaning Syrskyi's removal alone hasn't ended the standoff","Zelensky met with Fedorov and offered him 'a respected position in the government' unifying the country's tech sector — Fedorov has since refused the offer, per the Financial Times, keeping the standoff alive; the Kyiv Independent reports both camps remain in a stalemate, with neither side willing to compromise. A senior air force commander also resigned in protest over the shakeup. Separately, the UN's human rights mission in Ukraine (Danielle Bell) reported 1,396 civilians killed and 7,978 wounded nationwide in H1 2026","Syrskyi broke his usual public silence with an opinion piece for local military media, apologizing if he'd offended Fedorov but defending his record — he said he'd established Ukraine's drone unit as a separate branch and pushed back on claims he resisted drone warfare: 'I can't switch a million-people army to drones in two months.' Fedorov congratulated Drapatyi on the appointment"],sources:["Al Jazeera","Washington Post","Euronews","Euromaidan Press","Kyiv Independent","NPR","CNN"],impact:"The commander-in-chief change is the concession protesters won, but it doesn't resolve the underlying fight — Fedorov has now formally refused the alternative role offered him, a hard Jul 24 deadline is on the table, and the reform-vs-conventional-command rift that caused this in the first place remains open",impactColor:"#dc2626"},
  {id:"b_iran_10thnight_jul21",conflictId:"iran",severity:"critical",icon:"🔴",headline:"Mediators Float 10-Day Ceasefire as Trump Threatens to Hit Reported New Nuclear Site 'Very Heavily'",conflict:"Iran",conflictColor:"#8b5cf6",publishedAt:"Jul 21, 2026",bullets:["The war's human cost is now fully named: CENTCOM initially reported 2 US troops killed and 1 missing after the Jul 17 Jordan strikes, then confirmed 3 killed by Jul 19 once remains were recovered; the Pentagon later identified all three — two soldiers from Texas and Hawaii killed in Jordan, and Sgt. Michael Emmanuel Swinton, 30, of Fayetteville NC, killed in a controlled drone-detonation incident at Erbil Air Base, Iraq. Trump posted that Iran will 'pay for that killing many times over' every time it kills an American soldier","The US carried out a tenth consecutive night of strikes — explosions reported in Sirik, Bandar Abbas, Qeshm Island, Shiraz and Isfahan — with Iranian authorities saying 95 locations across 12 cities have now been hit over 10 days; Hegseth estimates the war has cost the US $37.5B so far. Trump separately said Iran is 'desperate' to talk even as he threatened to attack 'Pickaxe Mountain,' a reported new Iranian nuclear facility site, 'very heavily'","Iranian retaliation hit Kuwait especially hard — a desalination facility and power plants caught fire and suffered serious damage — plus renewed strikes on Bahrain and Jordan; Iran attacked another tanker in the Strait of Hormuz early Jul 21, and its Revolutionary Guard claimed 'massive fires' on two vessels it said took an 'unsafe route.' Israel's defense minister and IDF chief have both warned Israel will respond immediately to any Iranian attack on it directly. Iran's Health Ministry says 50+ have been killed and 500+ injured domestically since Jul 6","The Houthis escalated to a maritime embargo specifically targeting Saudi Arabia, putting an estimated 2.5M barrels/day at risk and threatening the Bab-el-Mandeb Strait as a second chokepoint alongside Hormuz, where daily crossings remain collapsed to roughly 9 vessels versus a ~130/day pre-war average. ASEAN foreign ministers, meeting in Manila alongside China's Wang Yi and Russia's Lavrov, issued a joint 'serious concern' statement. Brent has topped $91/bbl and US gasoline is back to a $4/gallon national average; regional mediators have reportedly floated a 10-day ceasefire proposal to Washington and Tehran, though analysts note the two sides remain far apart"],sources:["CNN","Al Jazeera","CNBC","AP/Britannica"],impact:"A named human cost, a quantified financial one ($37.5B), and now a specific new nuclear-site threat, all arriving the same day a ceasefire proposal is reportedly on the table — the war is simultaneously escalating and being offered an off-ramp",impactColor:"#dc2626"},
...
const REPORT_NOW=new Date("2026-07-22T00:20:00Z");
  ...
  return <div>
    ...
    {tab==="timeline"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>From Operation Epic Fury (Feb 28) through the Islamabad MoU and the 25-day countdown to Aug 16.</div>
      </Hero>
    ...
    {tab==="gaps"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #ef4444"}}>
        <div style={{fontSize:11,color:"rgba(255,255,255,.4)",textTransform:"uppercase",letterSpacing:".08em",marginBottom:8}}>⚠️ Unresolved Gaps — 25 Days Remain</div>
...
function NuclearSection({t,initialTab}){
  ...
  const VECTORS=[
    ...
    {flag:"🇮🇷",name:"Iran — Nuclear Clock",status:"25 DAYS",color:"#8b5cf6",text:"Islamabad MoU 60-day window closes ~Aug 16. IAEA inspector access disputed. Enrichment red lines unresolved — Pezeshkian: 'we will never back down from the right to enrich uranium.'"},
