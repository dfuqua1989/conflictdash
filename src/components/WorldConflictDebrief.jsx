...
const CONFLICTS=[
  ...
  {id:"gaza",name:"Israel & the Levant",region:"Middle East",status:"Multi-Front",statusColor:"#f59e0b",icon:"🇵🇸",deaths:"73,066+ killed total",displaced:"1.9M displaced",summary:"Ceasefire since Oct 10, 2025. 1,123+ killed since ceasefire. Quiet annexation accelerating. 80% of buildings damaged.",warDay:null},
...
const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,427,410",todayChange:"+1,420",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
  {id:2,category:"Tanks",total:"12,151",todayChange:"+3",color:"#f97316",icon:"🪖",description:"Main battle tanks"},
  {id:3,category:"Armoured Vehs",total:"24,956",todayChange:"+10",color:"#eab308",icon:"🚧",description:"APCs, IFVs, MRAPs"},
  {id:4,category:"Artillery",total:"46,169",todayChange:"+85",color:"#84cc16",icon:"💥",description:"Guns, howitzers, mortars"},
  {id:5,category:"MLRS",total:"1,946",todayChange:"+3",color:"#22c55e",icon:"🚀",description:"Multiple launch rockets"},
  {id:6,category:"Air Defence",total:"1,502",todayChange:"+6",color:"#06b6d4",icon:"🛡️",description:"SAM & SHORAD systems"},
  {id:7,category:"UAVs",total:"414,798",todayChange:"+1,914",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
  {id:8,category:"Aircraft",total:"438",todayChange:"+1",color:"#8b5cf6",icon:"✈️",description:"Fixed-wing aircraft"},
  {id:9,category:"Helicopters",total:"354",todayChange:"—",color:"#ec4899",icon:"🚁",description:"Rotary-wing aircraft"},
  {id:10,category:"Cruise Missiles",total:"4,914",todayChange:"+5",color:"#14b8a6",icon:"🎯",description:"Destroyed in flight"},
  {id:11,category:"Ships/Boats",total:"34",todayChange:"—",color:"#64748b",icon:"⛵",description:"Naval vessels"},
  {id:12,category:"Vehicles",total:"121,742",todayChange:"+526",color:"#a78bfa",icon:"🚛",description:"Trucks & logistics"},
  {id:13,category:"Ground Robots",total:"1,943",todayChange:"+11",color:"#f43f5e",icon:"🤖",description:"UGV platforms"},
  {id:14,category:"Special Equip",total:"4,428",todayChange:"+4",color:"#fb923c",icon:"🔧",description:"Engineering & EW"},
],gaza:[
  ...
  {id:17,category:"Post-ceasefire killed",total:"1,123+",todayChange:null,color:"#f97316",icon:"💀",description:"Killed since Oct 10, 2025 ceasefire"},
...
const REPORT_NOW=new Date("2026-07-18T12:00:00Z");
...
const HISTORICAL={
  ...
  gazaCasualtiesSinceCeasefire:[{m:"Jan",v:451},{m:"Apr",v:800},{m:"Jun",v:981},{m:"Jul",v:1123}],
...
function GazaSection({t,initialTab}){
  ...
  const HUM_METRICS=[
    ...
    {icon:"💀",label:"Post-ceasefire killed",val:"1,123+",color:"#f97316",desc:"Palestinians killed since Oct 10, 2025 ceasefire, local health officials as of Jul 17. Hamas not disarming; Israel controls ~65% of the Strip. Fragile ceasefire with no enforcement mechanism."},
  ...
  return <div>
    ...
    {tab==="governance"&&<div>
      ...
      <Grid2 t={t} items={[{val:"$70B",label:"Estimated cost",sub:"Brookings — \"no modern comparison\"",color:"#8b5cf6"},{val:"0",label:"Reconstruction begun",sub:"Six months post-ceasefire",color:"#ef4444"},{val:"80%",label:"Buildings damaged",sub:"Or destroyed",color:"#f97316"},{val:"1,123+",label:"Killed since ceasefire",sub:"As of Jul 17 (local health officials)",color:"#ef4444"}]}/>
  ...
  return <div>
    ...
    {tab==="timeline"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>From Operation Epic Fury (Feb 28) through the Islamabad MoU and the 29-day countdown to Aug 16.</div>
      </Hero>
    ...
    {tab==="gaps"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #ef4444"}}>
        <div style={{fontSize:11,color:"rgba(255,255,255,.4)",textTransform:"uppercase",letterSpacing:".08em",marginBottom:8}}>⚠️ Unresolved Gaps — 29 Days Remain</div>
    ...
    {tab==="hormuz"&&<div>
      ...
      <Grid2 t={t} items={[
        ...
        {icon:"🎯",label:"Confirmed enforcement strikes",val:"1",sub:"M/T Belma, Jul 15 — disabled, not sunk",color:"#f97316"},
      ...
      <Card t={t}><div style={{padding:"11px 14px"}}><div style={{fontSize:12,color:t.sub,lineHeight:1.7}}>
        ...
        <div style={{marginBottom:6}}><span style={{color:t.text,fontWeight:700}}>Jul 15 — first enforcement, tanker disabled</span> — The M/T Belma ignored warnings toward Kharg Island and was hit with Hellfire fire — the blockade's first confirmed enforcement action. Same day: a fifth straight night of US strikes; IRGC restated its threat to halt all regional oil exports "for everyone or for no one."</div>
        <div style={{marginBottom:6}}><span style={{color:t.text,fontWeight:700}}>Jul 16 — campaign widens into northern Iran</span> — Strikes expanded geographically for the first time; CENTCOM destroyed an IRGC port surveillance tower near the strait used to track commercial vessels (Iran calls it civilian). Iran's FM said the MoU has "entered a crisis stage"; Oman-mediated talks focused solely on Hormuz reached no agreement.</div>
        <div><span style={{color:t.text,fontWeight:700}}>Still unresolved</span> — UK and French patrol offers were rejected by Iran's chief negotiator, who asserted only coastal states control Hormuz security. The Ankara NATO summit's draft language calling on Iran to "fully respect freedom of navigation" was the alliance's first collective statement on the strait — largely symbolic so far.</div>
      </div></div></Card>
...
function NuclearSection({t,initialTab}){
  ...
  const VECTORS=[
    ...
    {flag:"🇮🇷",name:"Iran — Nuclear Clock",status:"29 DAYS",color:"#8b5cf6",text:"Islamabad MoU 60-day window closes ~Aug 16. IAEA inspector access disputed. Enrichment red lines unresolved — Pezeshkian: 'we will never back down from the right to enrich uranium.'"},
      ...
      <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:10,padding:"10px 16px 0"}}>
        <div style={{flex:1}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:6}}>
            ...
            <h1 style={{fontSize:15,fontWeight:800,color:t.isDark?"#e4ecf6":t.text,letterSpacing:"-.01em",margin:0,display:"inline"}}>WORLD CONFLICT DEBRIEF<span className="tt-cursor"/></h1>
          </div>
