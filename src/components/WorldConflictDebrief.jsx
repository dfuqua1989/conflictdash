...
const BRIEFING={summaryShort:"Russian losses have reached 1,442,140 (+1,560) per the Jul 28 MoD report, with the Black Sea corridor still strained after repeated grain-ship strikes and Maersk's port suspension. Zelensky remains unable to resolve the political crisis from Fedorov's dismissal as protests run into a third week. Iran remains the dominant global story, now well past two weeks of continuous US strikes with Brent above $100. Gaza, Taiwan Strait tensions, and the Americas file all remain active.",summary:"Ukraine: Russian losses have climbed to 1,442,140 as of the Jul 28 MoD report. The Black Sea corridor is the sharpest active front \u2014 after Russian strikes hit two grain ships this month, Maersk suspended Ukrainian port calls and Kyiv pressed an emergency UN session over what it calls a blockade. Domestically, the fallout from Defense Minister Fedorov's dismissal has widened: Commander-in-Chief Syrskyi was also replaced, by Mykhailo Drapatyi, and protests continue into a third week with no new defense minister named. On diplomacy, Rubio and Lavrov's Manila meeting was the first substantive US-Russia Ukraine contact in months, though Putin is now reported to have dropped territorial-concession offers entirely; the EU adopted its 21st sanctions package the same week. Iran: the war is now well into its third week, with the diplomatic track clouded by a dispute over a reported \u2014 and denied \u2014 Iraqi-brokered ceasefire proposal. Brent crude has topped $100/bbl, the Houthis have escalated from threatening to actually attacking Saudi-bound tankers, and the Aug 16 MoU deadline is now 19 days out. Elsewhere: Gaza's post-ceasefire death toll continues climbing past 1,200; China has run live-fire drills near Taiwan and, for the first time, near Japan's Okinotori; Venezuela, Cuba, Mexico and Haiti keep the Western Hemisphere file active.",watch:"Whether the Iran ceasefire dispute reflects genuine miscommunication or a quietly abandoned diplomatic track; whether Trump follows through on Pickaxe Mountain, the target Tehran calls a red line; and whether Ukraine's political crisis produces a confirmed new defense minister or drags on unresolved.",generatedAt:new Date().toISOString()};

const UKRAINE_BRIEFING={summaryShort:"Russia's attrition math keeps worsening \u2014 an ~8:1 loss ratio in H1 2026 per CSIS, with cumulative losses now at 1,442,140 \u2014 even as its ground offensive grinds on at Pokrovsk. Ukraine's deep-strike and Black Sea interdiction campaigns continue escalating, while Zelensky remains unable to resolve the Fedorov/Syrskyi political crisis and a strained Patriot/PAC-3 supply adds real uncertainty. Full attrition, territory, strikes, air defense, diplomacy and political breakdown below.",summary:"Russia's attrition math has become unsustainable even as its ground offensive grinds on. CSIS's H1 2026 assessment puts the Russia:Ukraine battlefield loss ratio at nearly 8:1 \u2014 up from 2:1\u20133:1 for most of the war \u2014 credited largely to Ukraine's AI-enabled drone interdiction campaign. The MoD's Jul 28 report puts cumulative Russian losses at 1,442,140 (+1,560 on the day), with daily losses still running above 1,000 most days. The war isn't simply going well for Ukraine, though: Russia's offensive still holds Pokrovsk at genuine encirclement risk, Kyiv and Kharkiv continue absorbing periodic missile barrages, Commander-in-Chief Syrskyi was replaced by Mykhailo Drapatyi amid the political fallout, and the Patriot/PAC-3 shortage \u2014 worsened by the Iran war draining US stocks \u2014 remains the one gap Ukraine cannot close on its own.",assessment:[{cat:"Attrition",text:"~8:1 RU:UA loss ratio in H1 2026 (CSIS). Cumulative Russian losses reached 1,442,140 as of the Jul 28 MoD report (+1,560 on the day) \u2014 tanks to 12,226, artillery to 46,902; Russian UAV losses passed 431,000. Ukraine's naval/deep-strike interdiction campaign remains a sustained second front, regularly reaching Moscow region and 1,000+km inside Russia."},{cat:"Territory",text:"Russian advance remains grinding \u2014 Pokrovsk is the single hottest sector on the front, alongside Huliaipole. Monthly gain estimates diverge sharply by source (DeepState vs. ISW), among the slowest rates of any war in the past century either way. Russia had a net territorial loss in Apr-May 2026, its first monthly net loss since Aug 2024."},{cat:"Deep Strikes",text:"The campaign has escalated into sustained economic coercion, regularly reaching deep inside Russia \u2014 including a first-ever strike on the Omsk refinery (Russia's largest) roughly 3,000km from Ukrainian territory, repeated hits on the Yaroslavl and Salavat refineries, strikes on the Engels-2 strategic bomber base, and strikes now landing inside Moscow region itself. The cumulative effect is a nationwide Russian fuel crisis severe enough to have forced a diesel export ban, even as Russian troops continue reporting fuel shortages at the front."},{cat:"Air Defense",text:"The Patriot/PAC-3 supply question remains the decisive materiel issue of the war. Russia continues firing large mixed missile-and-drone barrages at Kyiv and other cities, with interception rates fluctuating night to night. Trump has licensed Ukraine to manufacture Patriots domestically, though real production remains months-to-years out; Poland is co-producing and transferring PAC-3s under a new multilateral agreement, and Ukraine's domestic 'Freyja' interceptor program is drawing European partners. Drone-side economics still favor Ukraine (~$7.5k interceptor vs. ~$35k Shahed)."},{cat:"Diplomacy",text:"Rubio and Lavrov's Manila meeting was the first substantive US-Russia Ukraine contact in months \u2014 Rubio called it 'good' and 'frank' but said new proposals are needed; Lavrov reaffirmed Russia's readiness for a settlement even as Bloomberg reports Putin has dropped territorial-concession offers entirely and the Kremlin now treats the Anchorage understandings as void. The Turkish ceasefire push remains rejected by Moscow, leaving the negotiating track largely blocked."},{cat:"Political",text:"The Fedorov dismissal widened into a full command shake-up: Zelensky also replaced Commander-in-Chief Syrskyi with Mykhailo Drapatyi (43, seen as a reformer) and General Staff chief Andrii Hnatov with Ihor Skybiuk. Fedorov has rejected Zelensky's alternative offer and continues demanding reinstatement; protests have now run for weeks across multiple cities with no new defense minister named. The underlying rift \u2014 Fedorov's drone/robotics-forward reform push versus a more conventional artillery-and-manpower approach \u2014 remains unresolved even after the personnel changes."}],watch:"Whether Pokrovsk holds \u2014 still the most consequential sector against an otherwise favorable attrition/territorial picture \u2014 and whether the Patriot/PAC-3 stockpile, strained further by the Iran war, can keep pace with continued Russian missile pressure on Kyiv and Kharkiv.",generatedAt:new Date().toISOString()};
