...
const CONFLICTS=[
  ...
  {id:"gaza",name:"Israel & the Levant",region:"Middle East",status:"Multi-Front",statusColor:"#f59e0b",icon:"🇵🇸",deaths:"73,066+ killed total",displaced:"1.9M displaced",summary:"Ceasefire since Oct 10, 2025. 1,092+ killed since ceasefire. Quiet annexation accelerating. 80% of buildings damaged.",warDay:null},
...
const NEWS=[
  ...
  {id:"b_khamenei_burial_jul10",conflictId:"iran",severity:"major",icon:"🟠",headline:"Khamenei Buried in Mashhad as US Strikes Continue Through the Funeral — Successor Mojtaba Invisible for Entire Six-Day Procession",conflict:"Iran",conflictColor:"#8b5cf6",publishedAt:"Jul 10, 2026",bullets:["Khamenei and four family members killed with him Feb 28 were buried at the Imam Reza shrine in Mashhad, completed early Friday per IRNA — the culmination of six days of processions through Tehran, Qom, Najaf and Karbala that drew millions; crowds in Mashhad chanted 'By the blood of the supreme leader, Trump, we will kill you'","US strikes continued for a second and third consecutive day through the burial, breaking Trump's promised funeral pause; the Tehran-Mashhad rail line was damaged, stranding passengers, and the coffin's return from Iraq was delayed hours by crowd size","Successor Mojtaba Khamenei never appeared once — the NYT reports he was barred from the funeral over fears of assassination or being tracked; senior Tehran sources say he is 'recovering' but not well enough for public appearances. Four months after his proclamation, Iranians have seen no image, video or voice recording of their supreme leader","No senior officials appeared in the front row of the burial per state video; Ghalibaf, Ejei and Mokhber attended in the crowd. Nuclear talks were slated to resume ~Jul 11, after the funeral — whether they convene is now the clearest signal of whether the MoU survives"],sources:["IRNA/Reuters","The National","Times of Israel"],impact:"The funeral projected mass mobilization but also exposed the regime's core vulnerability: a supreme leader who cannot be seen, a burial the US bombed through, and a deal whose survival now rides on whether anyone shows up to talks tomorrow",impactColor:"#f97316"},
  ...
  {id:"b_ua_tempo_jul8",conflictId:"ukraine",severity:"major",icon:"🟠",headline:"Ukraine's Oil Campaign Triggers a Russian Fuel Crisis — Moscow Bans Diesel Exports as Ufa, Tver and Stavropol Burn",conflict:"Ukraine",conflictColor:"#5b8ec8",publishedAt:"Jul 9, 2026",bullets:["Ukrainian drones struck an oil-pumping station in Ufa (~1,500km from the border), a reserve fuel storage site ~800km from the front, an oil terminal in Tver and oil reservoirs in Stavropol that forced local evacuations — Zelensky confirmed the targets personally","In the Sea of Azov, Ukraine's Defense Forces struck 12 Russian tankers, a tugboat and a dry cargo ship plus an oil-loading terminal in Rostov Oblast; Rostov Gov. Slusar confirmed two tankers ablaze with crews evacuated — the campaign is now aimed at fuel supply to occupied Crimea","The cumulative effect has become a nationwide Russian fuel crisis: gasoline shortages, rationing across multiple regions and hours-long queues. Moscow responded by banning diesel exports until at least month's end, and Putin publicly called for fuel subsidies for Crimea","Russia's MoD claimed 73 Ukrainian drones downed overnight. The Omsk refinery — Russia's largest, hit Jul 6 — remains offline"],sources:["AP/Washington Times","Kyiv Independent","Ukrinform"],impact:"The deep-strike campaign has crossed from attrition into economic coercion — an export ban and subsidy call are Moscow conceding domestic cost. Watch whether Russia answers by escalating against Ukrainian fuel infrastructure, which it has already begun doing around Nikopol",impactColor:"#f97316"},
  {id:"b_us_iran_strikes_jul7",conflictId:"iran",severity:"critical",icon:"🔴",headline:"US-Iran Exchange Spirals: 80+ Targets Struck, IRGC Hits Back at Bahrain and Kuwait, Trump Declares MoU 'Over'",conflict:"Iran",conflictColor:"#8b5cf6",publishedAt:"Jul 8, 2026",bullets:["Iran attacked three commercial tankers transiting the Strait of Hormuz Jul 6-7 — the Marshall Islands-flagged Al Rekayyat, Saudi-flagged Wedyan and Liberian-flagged Cyprus Prosperity — for using non-Iranian-designated routes; Saudi Arabia and Qatar condemned the strikes as violations of international law","CENTCOM responded with a 'series of powerful strikes' on 80+ targets: air defense systems, command-and-control networks, coastal radar, anti-ship missile sites, and 60+ IRGC small boats in and near the strait; explosions reported on Kharg Island (Iran's key oil-export hub), Qeshm, Bandar Abbas and Sirik","The Treasury simultaneously revoked GL X — the Jun 21 license authorizing Iranian oil sales, the MoU's core economic benefit: 'the MOU is entirely performance-based... Iran will only reap benefits if they exhibit good behavior'; Brent jumped 5.5% to ~$76","The spiral arrived Jul 8: IRGC claims strikes on 85 US military installations in Bahrain (5th Fleet HQ, Sheikh Isa airbase) and Kuwait (Ali Salem airbase) — sirens sounded three times in Bahrain, and Kuwait protested the attacks on its soil. Trump declared the MoU 'over' and talks a 'waste of time' from the NATO summit stage, then ordered a second US strike wave (Sirik, Bushehr, Konarak, Chabahar, Kish Island). Brent rose 6% to $78; Pezeshkian cut short his attendance at Khamenei's funeral procession"],sources:["CENTCOM","CNN","CBS News"],impact:"A full retaliatory cycle in 48 hours — tankers, 80+ targets, Gulf-state counterstrikes, a second US wave — with the president declaring the deal dead while his administration insists it technically survives. Whether Jul 11 talks happen is now the clearest signal to watch",impactColor:"#dc2626"},
  {id:"b_kyiv_strike_jul6",conflictId:"ukraine",severity:"critical",icon:"🔴",headline:"Second Kyiv Mass Strike in Five Days Kills 21 on NATO Summit Eve — Zero Ballistic Missiles Intercepted",conflict:"Ukraine",conflictColor:"#5b8ec8",publishedAt:"Jul 6, 2026",bullets:["Russia launched 68 missiles and 351 attack drones overnight Jul 5-6, hitting 10+ locations across Kyiv including residential buildings in the Darnytskyi district — the same area devastated in the Jul 1-2 attack; at least 15 killed in the capital, 6 more in the wider region, 56+ injured","Zelensky said Ukraine intercepted zero ballistic missiles due to an 'insufficient supply of interceptor missiles,' and demanded allies leave Ankara with 'strong decisions' on air defense: 'As long as Patriot missiles remain in our allies' stockpiles, Russia is only encouraged'","Timing was explicit — Zelensky had warned hours earlier a new mass strike was coming: 'This is typical of Putin: right after America's Independence Day and before the NATO Summit'; Geran-4 jet drones were used in both mass strikes","Von der Leyen: Ukraine 'urgently needs more air defense' and the EU is preparing a new sanctions package; the first €6B tranche of the €90B Ukraine Support Loan was released last week for drone procurement. UN monitors report 2026 civilian casualties running significantly above 2025's pace"],sources:["CNN","TIME","UN HRMMU"],impact:"Two mass strikes in five days with zero ballistic intercepts converts the Patriot shortage from a materiel issue into the central agenda item of a summit that starts in under 24 hours",impactColor:"#dc2626"},
  {id:"b_kostiantynivka_claim",conflictId:"ukraine",severity:"major",icon:"🟠",headline:"Russia Claims Capture of Kostiantynivka — Zelensky: 'Putin Decided to Lie'",conflict:"Ukraine",conflictColor:"#5b8ec8",publishedAt:"Jul 5, 2026",bullets:["Russia's military claimed Jul 4 to have fully seized Kostiantynivka, the key Donbas defensive hub — which would be Moscow's first significant claimed battlefield success this year","Zelensky flatly refuted the claim after a call with Trump, saying 'Putin decided to lie' to the world; Ukraine's General Staff released footage from inside the city showing it under Defense Forces control","ISW and independent analysts note Russia has repeatedly claimed control of cities prematurely; fighting inside Kostiantynivka is confirmed, full control is not","Context cuts against Moscow's framing: ISW assesses Russia's spring-summer 2026 offensive has failed to make operationally significant gains, with June's rate of advance a fraction of June 2025's — and Ukraine's General Staff reports Russian refining down to 42.47% of design capacity"],sources:["ISW","Ukrainska Pravda","ABC News"],impact:"A contested capture claim timed to the eve of NATO Ankara — whether Kostiantynivka actually falls matters less than whether the claim shifts summit-week narratives",impactColor:"#f97316"},
  {id:"b_kyiv_massive_strike",conflictId:"ukraine",severity:"critical",icon:"\uD83D\uDD34",headline:"Russia’s Most Massive Strike on Kyiv Yet Kills 30, Injures 91 — Ballistic Missiles and Jet-Powered Drones Overwhelm Air Defense",conflict:"Ukraine",conflictColor:"#5b8ec8",publishedAt:"Jul 3, 2026",bullets:["Russia launched roughly 570 missiles and drones overnight Jul 1-2 — including 24-28 Iskander ballistic missiles and Zircon hypersonic cruise missiles — in what Kyiv’s mayor called the war’s most massive attack on the capital; 25-33 projectiles penetrated to hit ~20-25 sites","Kyiv City Military Administration confirmed 30 dead and 91 injured as of Jul 3, after search-and-rescue recovered further bodies from a collapsed 9-story apartment building in the Darnytskyi district; Jul 3 was declared a day of mourning","Russia’s MoD called the strike retaliation for Ukraine’s deep-strike campaign against its oil refineries and defense-industrial sites; Zelensky called the civilian-building targeting deliberate and renewed calls for more Patriot/PAC-3 interceptors","ISW flagged jet-powered Geran-4 drones (up to 500km/h) as a new capability degrading Ukrainian intercept rates on faster-moving threats, even as Ukraine’s air force reported ~90% of missiles and drones intercepted overall"],sources:["CNN","Kyiv Independent","Euronews"],impact:"The mass strike Zelensky had explicitly warned of materialized — among the war’s deadliest single attacks on Kyiv — and underscores the Patriot/PAC-3 shortage as the one air-defense gap Ukraine cannot close alone",impactColor:"#dc2626"},
  {id:"b_iran_funeral_hormuz_patrol",conflictId:"iran",severity:"major",icon:"\uD83D\uDFE0",headline:"Iran's Named Successor Mojtaba Khamenei Still Hasn't Appeared as Funeral Crowds Chant for Trump's Death",conflict:"Iran",conflictColor:"#8b5cf6",publishedAt:"Jul 5, 2026",bullets:["Multi-day public funeral ceremonies for slain Supreme Leader Ali Khamenei continue in Tehran through burial at the Imam Reza shrine in Mashhad on Jul 9; hundreds of thousands have turned out at the Grand Mosalla over the weekend","Mojtaba Khamenei, named the new Supreme Leader a week after his father's Feb 28 killing, has still not made a single public appearance — reportedly wounded in the same strike and in hiding over assassination fears; three of his brothers attended funeral prayers in his place","A performer at the Jul 5 prayers led crowds in chants calling for Trump's death, alongside 'Death to America' and 'Death to Israel' chants — a marked escalation in rhetoric even as Iran leans on the funeral's turnout to strengthen its negotiating hand on Hormuz","France and the UK offered to help patrol the Strait of Hormuz for freedom of navigation; Iran rejected the offer. Tracking data shows a handful of tankers now testing the Omani-hugging route through the strait — some completing transit, at least 8 U-turning Jul 4 — a tentative, uneven sign of recovery. Nuclear/Hormuz talks remain frozen until the funeral ends"],sources:["CNN","AP","Times of Israel"],impact:"A named but unseen successor, funeral crowds calling for a US president's death, and only a partial Hormuz reopening leave Iran's post-Khamenei trajectory as unsettled as the negotiations it has paused",impactColor:"#8b5cf6"},
  ...
  {id:"b_nato_ankara_draft",conflictId:"ukraine",severity:"major",icon:"🟠",headline:"NATO Ankara Draft Firms Up: €70B/Year for Ukraine Through 2027, Russia Named a 'Long-Term Threat' — Summit Opens Jul 7",conflict:"NATO",conflictColor:"#5b8ec8",publishedAt:"Jul 5, 2026",bullets:["The text, now seen by multiple outlets, commits European allies and Canada to €70B ($80B) annually for Ukraine in both 2026 and 2027 — €140B total over two years — up from the earlier framing of 2027 support only 'at an equivalent level'; Italy and Poland had pushed back on locking in the 2027 figure specifically","The declaration brands Russia a 'long-term threat' to Euro-Atlantic security and has NATO leaders including Trump affirm an 'ironclad commitment' to Article 5, while for the first time folding in language that Iran 'must never have a nuclear weapon' and calling on Tehran to respect Hormuz freedom of navigation","Trump is set to meet separately with Zelensky and Syria's President al-Sharaa on the summit sidelines; Zelensky said after a Jul 4 call with Trump that 'there is a real prospect of ending this war'","Turkey imposed a blanket ban on all protests in Ankara ahead of the summit; Amnesty International raised concerns Jun 26"],sources:["Reuters","Ukrainska Pravda","Times of Israel"],impact:"The €140B/two-year framing and the new Russia 'long-term threat' and Iran/Hormuz language are firmer than the earlier draft — but final ratification at the Jul 7-8 summit is still the thing to watch",impactColor:"#5b8ec8"},
  ...
  {id:"b_iran_talks_jul11",conflictId:"iran",severity:"critical",icon:"🟠",headline:"US-Iran Talks Resume in Pakistan After Khamenei Burial — First Test of Whether the MoU Survives",conflict:"Iran",conflictColor:"#8b5cf6",publishedAt:"Jul 11, 2026",bullets:["The first negotiating round since Khamenei's days-long funeral convenes in Pakistan, per Al Arabiya — agenda spans US sanctions, Iran's frozen assets, and the nuclear program","The backdrop is contradictory: Trump has publicly declared the MoU 'over,' yet mediated technical talks in Doha (Jul 1) were described by both sides as constructive, with a disputed partial-frozen-funds understanding","Neither Washington nor Tehran had officially confirmed the meeting as of the funeral's close; Iran had not named its delegation lead, a decision deferred until after the burial","Core gaps are unchanged from Lucerne and Islamabad: zero-enrichment vs Iran's 'inalienable right,' IAEA access, missile limits, and the sequencing of $300B reconstruction and sanctions relief"],sources:["Al Arabiya","Times of Israel","CNN"],impact:"With the funeral over, the stated reason for pausing diplomacy is gone — whether anyone actually sits down is now the single clearest signal of whether the 60-day MoU window (closing ~Aug 16) leads to a deal or back to strikes",impactColor:"#f97316"},
...
const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,419,090",todayChange:"+1,320",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
  {id:2,category:"Tanks",total:"12,120",todayChange:"+4",color:"#f97316",icon:"🪖",description:"Main battle tanks"},
  {id:3,category:"Armoured Vehs",total:"24,928",todayChange:"+6",color:"#eab308",icon:"🚧",description:"APCs, IFVs, MRAPs"},
  {id:4,category:"Artillery",total:"45,807",todayChange:"+53",color:"#84cc16",icon:"💥",description:"Guns, howitzers, mortars"},
  {id:5,category:"MLRS",total:"1,928",todayChange:"+4",color:"#22c55e",icon:"🚀",description:"Multiple launch rockets"},
  {id:6,category:"Air Defence",total:"1,485",todayChange:"+4",color:"#06b6d4",icon:"🛡️",description:"SAM & SHORAD systems"},
  {id:7,category:"UAVs",total:"403,959",todayChange:"+2,034",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
  {id:8,category:"Aircraft",total:"437",todayChange:"—",color:"#8b5cf6",icon:"✈️",description:"Fixed-wing aircraft"},
  {id:9,category:"Helicopters",total:"353",todayChange:"—",color:"#ec4899",icon:"🚁",description:"Rotary-wing aircraft"},
  {id:10,category:"Cruise Missiles",total:"4,889",todayChange:"+2",color:"#14b8a6",icon:"🎯",description:"Destroyed in flight"},
  {id:11,category:"Ships/Boats",total:"33",todayChange:"—",color:"#64748b",icon:"⛵",description:"Naval vessels"},
  {id:12,category:"Vehicles",total:"119,038",todayChange:"+428",color:"#a78bfa",icon:"🚛",description:"Trucks & logistics"},
  {id:13,category:"Ground Robots",total:"1,883",todayChange:"+15",color:"#f43f5e",icon:"🤖",description:"UGV platforms"},
  {id:14,category:"Special Equip",total:"4,407",todayChange:"+5",color:"#fb923c",icon:"🔧",description:"Engineering & EW"},
],gaza:[
  ...
  {id:17,category:"Post-ceasefire killed",total:"1,092+",todayChange:null,color:"#f97316",icon:"💀",description:"Killed since Oct 10, 2025 ceasefire"},
...
const BRIEFING={summary:"Ukraine pushed total Russian losses to 1,419,090 (Jul 12 MoD report, +1,320 on the day) — Russian UAV losses now past 400,000 (401,925) — while its deep-strike campaign tipped Russia into a domestic fuel crisis: Tver and Stavropol oil depots hit Jul 9, two more tankers set ablaze in the Sea of Azov, Omsk still offline — Moscow has banned diesel exports until month's end and Putin is calling for Crimea fuel subsidies. At Ankara, Trump licensed Ukraine to manufacture Patriots; Zelensky says the deal is agreed politically, though officials warn production is months to years away. Russia answered with two Kyiv mass strikes in five days: roughly 570 missiles and drones on Jul 1-2 (30 killed), then 68 missiles and 351 drones on Jul 5-6 (21 killed) with zero ballistic intercepts — Patriot stocks exhausted. NATO Ankara opens today, with air defense the forced centerpiece after two Kyiv mass strikes in five days: the draft commits €70B/year through 2027 (€140B total), brands Russia a 'long-term threat,' and reaffirms Article 5 — ratification is the day's question. The US-Iran exchange has spiraled into a full retaliatory cycle: Iran struck three tankers, the US hit 80+ targets and revoked the GL X oil license, the IRGC claims 85 US military sites struck in Bahrain and Kuwait, and a second US wave followed — with Trump declaring the MoU 'over' from the NATO summit stage while his administration insists it technically survives. Brent is at $78 (+6%). Khamenei was buried in Mashhad (completed early Jul 10) with US strikes continuing through the funeral despite Trump's promised pause; successor Mojtaba never appeared once in six days — reportedly barred over assassination fears and 'recovering' — leaving Iran's supreme leader invisible four months into his tenure. The UN Human Rights Council held an urgent debate Jul 3 on El-Obeid, drafting a resolution condemning starvation as a method of warfare, as Venezuela's earthquake recovery collides with acting President Rodríguez's expired interim mandate and Machado's bid to return.",signals:[{theater:"Ukraine",text:"2nd Kyiv mass strike in 5 days kills 21; zero ballistic intercepts; 1.42M RU losses"},{theater:"NATO",text:"Ankara concluded — $80B/2026 pledged, Patriot license granted; timeline now the watch item"},{theater:"Iran",text:"Full retaliatory cycle: IRGC hits Bahrain/Kuwait bases; 2nd US wave; Trump: MoU 'over'"}],watch:"Next 48hrs: whether Jul 11 US-Iran talks actually convene — the funeral is over, the stated reason for pause is gone, and Trump has called the MoU 'over'; whether Mojtaba finally appears now that burial is complete (four months invisible); whether the PAC-3 deliveries Zelensky says are due 'in the coming days' actually arrive; whether Russia retaliates against Ukrainian fuel infrastructure as its own crisis deepens.",generatedAt:new Date().toISOString()};
const UKRAINE_BRIEFING={summary:"Russia's attrition math has become unsustainable even as its ground offensive grinds on. CSIS's July 1 assessment puts the Russia:Ukraine battlefield loss ratio at nearly 8:1 in H1 2026 — up from 2:1-3:1 for most of the war — credited largely to Ukraine's AI-enabled drone interdiction campaign. The MoD's Jul 12 report puts cumulative Russian losses at 1,419,090 (+1,320 on the day), with daily losses still running above 1,000 most days. That said, the war is not simply going well for Ukraine: Russia's stalled offensive still holds Pokrovsk at genuine encirclement risk, and the Patriot/PAC-3 shortage — worsened by the 2026 Iran war draining US stocks — remains the one gap Ukraine cannot close on its own.",assessment:[{cat:"Attrition",text:"~8:1 RU:UA loss ratio in H1 2026 (CSIS). Cumulative Russian losses reached 1,419,090 as of the Jul 12 MoD report; Russian UAV losses passed 403,000 (403,959, +2,034 on the day). Artillery is at 45,807 — still climbing after June's record monthly pace."},{cat:"Territory",text:"Russian advance remains grinding — Pokrovsk is now the single hottest sector on the front, 268 combat clashes recorded there Jul 8 alone, alongside Huliaipole. Monthly gain estimates diverge sharply by source: DeepState puts Russia's net gain at ~31 sq mi for Jun 9-Jul 7, ISW at just ~6 sq mi — among the slowest rates of any war in the past century either way. Russia had a net territorial LOSS in Apr-May 2026 (~400 km²), its first monthly net loss since Aug 2024."},{cat:"Deep Strikes",text:"The campaign has escalated into economic coercion. Jul 6: the deepest strike of the war — FP-1 drones flew ~3,000km to hit the Omsk refinery, Russia's largest, first-ever strike on the plant, offline within 24 hours. Jul 9: Tver and Stavropol oil depots hit, more tankers ablaze in the Sea of Azov — the cumulative effect is a nationwide Russian fuel crisis, with Moscow banning diesel exports and Putin publicly requesting Crimea fuel subsidies. Crimea airpower also a sustained target: Saky airbase struck twice in a week (7 aircraft hit Jul 3)."},{cat:"Air Defense",text:"The decisive materiel question of the war may have just moved. CSIS: Ukraine intercepted 14 of 54 Russian ballistic missiles in June, and none of the 23 that hit Kyiv on Jul 6. At Ankara on Jul 8 Trump licensed Ukraine to manufacture Patriots itself; Zelensky said Jul 9 the licence is agreed politically with supplies due within days, but officials put real domestic production months-to-years out. Poland will co-produce and maintain PAC-3s under a new multilateral agreement and is transferring 5 missiles now; Ukraine's domestic 'Freyja' interceptor may draw eight European partners. Drone-side economics still favor Ukraine ($7.5k interceptor vs $35k Shahed)."},{cat:"Diplomacy",text:"Ankara concluded: $80B allied pledge for 2026, Patriot manufacturing license, and a notably warm Trump-Zelensky bilateral — Trump said Zelensky has 'done an amazing job.' Russia had already rejected the Turkish ceasefire push, so the negotiating track itself remains blocked. Czech President Pavel: Ukraine has roughly two months to resume talks before the window narrows."}],watch:"Two variables now: whether Pokrovsk holds — still the most consequential sector against an otherwise favorable attrition/territorial picture — and whether the Jul 8 Patriot-license announcement acquires an actual production timeline, since officials themselves put real output months to years out.",generatedAt:new Date().toISOString()};
...
const ST=({t,children,color})=><div style={{fontSize:11,fontWeight:700,color:color??t.sub,textTransform:"uppercase",letterSpacing:".1em",marginBottom:8,marginTop:18,paddingLeft:9,borderLeft:`3px solid ${color??(t.isDark?"#5b8ec8":"#3a4a5c")}`,lineHeight:1.3}}>{children}</div>;
...
const REPORT_NOW=new Date("2026-07-12T12:00:00Z");
...
function BriefingPanel({t}){
  const SC={Ukraine:"#5b8ec8",Gaza:"#f59e0b",Taiwan:"#eab308",Iran:"#8b5cf6",Global:"#22c55e"};
...
<Hero t={t}><div style={{display:"flex",alignItems:"center",gap:6,marginBottom:10}}><span style={{width:8,height:8,borderRadius:"50%",background:"#ef4444",display:"inline-block",animation:"blink 1.4s ease-in-out infinite",flexShrink:0}}/><span style={{fontSize:11,color:"rgba(255,255,255,.45)",letterSpacing:".08em",textTransform:"uppercase"}}>War Day {UA_WAR_DAY} · Live</span><span style={{marginLeft:"auto",fontSize:11,color:"rgba(255,255,255,.35)"}}>{REPORT_NOW.toLocaleDateString("en-GB",{day:"numeric",month:"long",year:"numeric"})}</span></div><div style={{fontSize:11,color:"rgba(255,255,255,.4)",textTransform:"uppercase",letterSpacing:".05em"}}>🇷🇺 Total Russian Personnel Losses</div><div style={{fontSize:42,fontWeight:800,letterSpacing:-2,lineHeight:1,fontVariantNumeric:"tabular-nums"}}>{LOSSES.ukraine[0].total}</div><div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",marginTop:14,paddingTop:12,borderTop:"1px solid rgba(255,255,255,.08)"}}><div><div style={{fontSize:11,color:"rgba(255,255,255,.4)"}}>Today</div><div style={{fontSize:22,fontWeight:800,color:"#ff9500",fontVariantNumeric:"tabular-nums"}}>+1,190</div></div><div><div style={{fontSize:11,color:"rgba(255,255,255,.4)"}}>7-Day Avg</div><div style={{fontSize:20,fontWeight:700,color:"#fbbf24",fontVariantNumeric:"tabular-nums"}}>~1,231</div></div><div><div style={{fontSize:11,color:"rgba(255,255,255,.4)"}}>Since Feb 22</div><div style={{fontSize:15,fontWeight:700,color:"rgba(255,255,255,.6)",marginTop:3}}>Day {UA_WAR_DAY}</div></div></div></Hero><Grid2 t={t} items={[{icon:"🛸",label:"UAVs Destroyed Today",val:LOSSES.ukraine[6].todayChange,sub:"cumulative "+LOSSES.ukraine[6].total,color:"#5b8ec8"},{icon:"☠️",label:"Personnel Today",val:LOSSES.ukraine[0].todayChange,sub:"cumulative "+LOSSES.ukraine[0].total,color:"#8b5cf6"},{icon:"🪖",label:"Tanks Today",val:LOSSES.ukraine[1].todayChange,sub:"cumulative "+LOSSES.ukraine[1].total,color:"#f97316"},{icon:"💥",label:"Artillery Today",val:LOSSES.ukraine[3].todayChange,sub:"cumulative "+LOSSES.ukraine[3].total,color:"#ef4444"}]}/><ST t={t}>📋 This Week in the War</ST><Card t={t}>{WEEK_UPDATES.map((u,i)=><Row key={i} t={t} last={i===WEEK_UPDATES.length-1}><div style={{fontSize:12.5,color:t.text,lineHeight:1.55}}>{u}</div></Row>)}</Card><div style={{background:t.isDark?"linear-gradient(135deg,#091321,#0d1f38)":"linear-gradient(135deg,#eef3fc,#e6edf9)",border:"1px solid rgba(59,130,246,0.25)",borderLeft:"4px solid #5b8ec8",borderRadius:14,padding:"14px 16px",marginBottom:16}}>
  ...
  <div style={{fontSize:11,color:t.sub,fontStyle:"italic",paddingTop:10,borderTop:`1px solid ${t.isDark?"rgba(255,255,255,.08)":"rgba(0,0,0,.08)"}`}}>
...
</div>}{tab==="losses"&&<LossesTab t={t}/>}{tab==="frontline"&&<FrontlineTab t={t}/>}{tab==="diplomacy"&&<DiplomacyTab t={t}/>}{tab==="nato"&&<NATOTab t={t}/>}{tab==="crimea"&&<CrimeaTab t={t}/>}{tab==="blacksea"&&<BlackSeaTab t={t}/>}{tab==="strikes"&&<StrikesTab t={t}/>}{tab==="economy"&&<EconomyTab t={t}/>}{tab==="manpower"&&<ManpowerTab t={t}/>}{tab==="intel"&&<IntelTab t={t}/>}{tab==="airdef"&&<div>
    ...
    {tab==="diplomacy"&&<div>
      <Hero t={t} color="#22c55e"><div style={{fontSize:11,fontWeight:800,letterSpacing:".12em",color:"#86efac",marginBottom:6}}>🕊️ NEGOTIATION TRACKER</div><div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>Every active diplomatic track in one place — who proposed what, who blocked it, and what's actually moving. The pattern of 2026 so far: pressure produces meetings, meetings produce prisoner swaps, and prisoner swaps remain the only channel that consistently delivers.</div></Hero>
      <ST t={t} color="#22c55e">📋 Track Status Board</ST>
      <Card t={t}><div style={{padding:"11px 14px"}}><div style={{fontSize:12,color:t.sub,lineHeight:1.7}}>
        <div style={{marginBottom:6}}><span style={{color:t.text,fontWeight:700}}>🇹🇷 Turkish ceasefire push — BLOCKED</span> — Ankara's pre-summit ceasefire initiative was rejected by Moscow outright (late Jun), freezing the only active comprehensive-ceasefire track before the NATO summit even opened.</div>
        <div style={{marginBottom:6}}><span style={{color:t.text,fontWeight:700}}>🇺🇸 Trump-Zelensky channel — ACTIVE</span> — Jul 4 call produced Zelensky's most optimistic language of the year ('a real prospect of ending this war') and a confirmed sideline meeting at Ankara Jul 7-8. Substance unconfirmed; tone shift is the signal.</div>
        <div style={{marginBottom:6}}><span style={{color:t.text,fontWeight:700}}>🔄 Prisoner swaps — DELIVERING</span> — The Istanbul-framework exchanges continue working through backlogs (most recently late-Jun rounds); the only track with an unbroken 2026 record.</div>
        <div style={{marginBottom:6}}><span style={{color:t.text,fontWeight:700}}>💰 Sanctions-relief sequencing — UNTESTED</span> — Western position ties any relief to verified withdrawal/ceasefire steps; Russia demands relief first. No mechanism agreed; frozen-asset profits meanwhile fund Ukrainian production (Denmark model).</div>
        <div><span style={{color:t.text,fontWeight:700}}>🇷🇺 Moscow's posture — MAXIMALIST</span> — Territorial recognition plus NATO renunciation remain preconditions; the contested Kostiantynivka claim (Jul 4) suggests narrative-building for negotiating leverage rather than imminent flexibility.</div>
      </div></div></Card>
      <Note t={t} color="#22c55e">Status labels are editorial reads of open reporting (Reuters, Ukrainska Pravda, ISW), not official designations. Fuller diplomatic narrative: Diplomacy tab. Aid politics: NATO tab. This tab tracks mechanics — proposals, blockers, and what actually closes.</Note>
    </div>}
...
function TheatersOverview({t,conflicts,onSelectConflict}){const STATUS_ORDER={"ESCALATING":0,"NEW CIVIL WAR":0,"US INTERVENTION":0,"MoU CRISIS":0,"CO-BELLIGERENT":1,"FLASHPOINT":1,"BLOCKADE":1,"Active":2,"MoU":3,"ELEVATED":4,"Fragile Ceasefire":5};const sorted=[...conflicts].sort((a,b)=>(STATUS_ORDER[a.status]??9)-(STATUS_ORDER[b.status]??9));const SECTION_MAP={"south-china-sea":"scs","taiwan":"scs","caribbean":"venezuela"};return <div><div style={{fontSize:10,fontWeight:700,color:t.sub,textTransform:"uppercase",letterSpacing:".1em",marginBottom:14}}>🌍 {conflicts.length} Active Theaters — Tap to Deep Dive</div><div style={{display:t.isLandscape?"grid":"block",gridTemplateColumns:t.isLandscape?"1fr 1fr":undefined,gap:t.isLandscape?12:0}}>{sorted.map((c,ci)=>{const sectionId=SECTION_MAP[c.id]??c.id;return <button key={c.id} className="theater-card" onPointerDown={e=>{const r=e.currentTarget.getBoundingClientRect();e.currentTarget.style.setProperty("--px",`${((e.clientX-r.left)/r.width*100)}%`);e.currentTarget.style.setProperty("--py",`${((e.clientY-r.top)/r.height*100)}%`);}} onClick={()=>onSelectConflict(sectionId)} style={{display:"block",width:"100%",background:t.card,borderTop:`1px solid ${t.border}`,borderRight:`1px solid ${t.border}`,borderBottom:`1px solid ${t.border}`,borderLeft:`4px solid ${c.statusColor}`,borderRadius:14,padding:"16px 18px",marginBottom:12,cursor:"pointer",fontFamily:FONT,textAlign:"left",animation:`riseIn .3s ease-out ${ci*0.05}s both`}}><div style={{display:"flex",alignItems:"flex-start",gap:12,marginBottom:10}}><span style={{fontSize:28,flexShrink:0,lineHeight:1}}>{c.icon}</span><div style={{flex:1,minWidth:0}}><div style={{fontSize:15,fontWeight:800,color:t.text,lineHeight:1.2,marginBottom:4}}>{c.name}</div><div style={{display:"flex",alignItems:"center",gap:8,flexWrap:"wrap"}}><span style={{background:c.statusColor+"22",border:`1px solid ${c.statusColor}55`,borderRadius:20,padding:"2px 10px",fontSize:10,fontWeight:700,color:c.statusColor,textTransform:"uppercase"}}>{c.status}</span><span style={{fontSize:11,color:t.sub}}>{c.region}</span></div></div><span style={{fontSize:16,color:t.sub,flexShrink:0,marginTop:4}}>→</span></div><div style={{display:"flex",gap:20,marginBottom:10}}><div><div style={{fontSize:10,color:t.sub,marginBottom:1}}>Deaths</div><div style={{fontSize:13,fontWeight:700,color:c.statusColor}}>{c.deaths}</div></div><div><div style={{fontSize:10,color:t.sub,marginBottom:1}}>Displaced</div><div style={{fontSize:13,fontWeight:700,color:t.text}}>{c.displaced}</div></div>{c.warDay&&<div><div style={{fontSize:10,color:t.sub,marginBottom:1}}>War day</div><div style={{fontSize:13,fontWeight:700,color:t.text}}>{c.warDay}</div></div>}</div><div style={{fontSize:12,color:t.sub,lineHeight:1.6,background:t.isDark?"rgba(255,255,255,.03)":"rgba(0,0,0,.03)",borderRadius:8,padding:"9px 11px"}}>{c.summary}</div><div style={{marginTop:10,fontSize:11,color:"#5b8ec8",fontWeight:600}}>Open Deep Dive →</div></button>;})}</div>
  ...
  {[
    ...
    {id:"cyber",name:"Cyber & Hybrid Warfare",icon:"🛰️",status:"GREY-ZONE",statusColor:"#8b5cf6",region:"Global",s1l:"Cables",s1v:"Baltic",s2l:"EW / GPS",s2v:"Daily",summary:"Undersea cable incidents, electronic warfare and GPS jamming, state cyber intrusions, and the shadow-fleet grey-zone playbook."},
    {id:"usmil",name:"Great Power Rivalry",icon:"⚔️",status:"REFERENCE",statusColor:"#5b8ec8",region:"US / China / Russia",s1l:"Tabs",s1v:"15",s2l:"Focus",s2v:"Mil balance",summary:"Power comparison, rankings, naval pipeline, 5th-gen fighters, space & counterspace, critical minerals, arms flow, Arctic, and the defense-industrial production race."},
    {id:"nuclear",name:"Nuclear Proliferation",icon:"☢️",status:"POST-TREATY",statusColor:"#ef4444",region:"Global",s1l:"New START",s1v:"Expired",s2l:"Iran MoU",s2v:"Aug 16",summary:"Active vectors, global arsenals, delivery-system triad modernization, and the treaty architecture after New START's Feb 2026 lapse."},
...
function TrendsView({t}){
  ...
  return <div style={{padding:"16px 16px 0",animation:"fadeIn .25s ease-out"}}>
    ...
    <Card t={t} style={{padding:"12px 8px 8px"}}>
      <div style={{padding:"0 8px 6px",display:"flex",alignItems:"baseline",justifyContent:"space-between"}}><div style={{fontSize:12,fontWeight:700,color:t.text}}>The Two-Way War — UA vs RU Nightly Launches</div><div style={{fontSize:10,color:t.sub}}>drones+missiles/night, 14 nights</div></div>
      <div style={{height:150}}><ResponsiveContainer width="100%" height="100%">
        <LineChart data={DW_DAILY.slice(-14).map(d=>({m:d.date,ru:d.ru_d+d.ru_m,ua:d.ua_d}))} margin={{top:4,right:8,left:-12,bottom:0}}>
          <XAxis dataKey="m" tick={{fontSize:8,fill:t.sub}} tickLine={false} axisLine={false} interval={1}/>
          <YAxis tick={{fontSize:9,fill:t.sub}} tickLine={false} axisLine={false} width={34}/>
          <Tooltip contentStyle={{background:t.isDark?"#101d30":"#fff",border:`1px solid ${t.border}`,borderRadius:8,fontSize:12}} labelStyle={{color:t.sub}}/>
          <Legend wrapperStyle={{fontSize:10}}/>
          <Line type="monotone" dataKey="ru" name="🇷🇺 Russia" stroke="#ef4444" strokeWidth={2} dot={{r:2,fill:"#ef4444"}}/>
          <Line type="monotone" dataKey="ua" name="🇺🇦 Ukraine" stroke="#5b8ec8" strokeWidth={2} dot={{r:2,fill:"#5b8ec8"}}/>
        </LineChart>
      </ResponsiveContainer></div>
      <div style={{fontSize:11,color:t.sub,lineHeight:1.5,padding:"6px 8px 2px"}}>Trends elsewhere show one side; this shows both. Ukraine's Jul 3 spike (~500) is the St. Petersburg/Kronstadt raid — its deepest Baltic strike — answering Russia's Jul 1 mass strike two nights earlier. UA nightly figures are estimates where Russia's MoD is the only source.</div>
    </Card>
    <Card t={t} style={{padding:"12px 8px 8px"}}>
...
function GazaSection({t,initialTab}){
  ...
  const HUM_METRICS=[
    {icon:"☠️",label:"Total killed",val:"73,118+",color:"#ef4444",desc:"Since Oct 7, 2023 (incl. 21,500 children), Gaza MoH via OCHA as of Jul 9, 2026. Actual toll likely higher — morgue capacity overwhelmed, thousands missing under rubble."},
    ...
    {icon:"💀",label:"Post-ceasefire killed",val:"1,092+",color:"#f97316",desc:"Palestinians killed since Oct 10, 2025 ceasefire (3,507 injured), Gaza MoH as of Jul 9. Hamas not disarming; Israel controls ~64% of the Strip. Fragile ceasefire with no enforcement mechanism."},
  ...
  return <div>
    <div style={{display:"flex",gap:4,flexWrap:"wrap",marginBottom:12}}>
      {[{id:"conflict",label:"⚔️ Gaza"},{id:"humanitarian",label:"🆘 Humanitarian"},{id:"governance",label:"🌐 Governance"},{id:"lebanon",label:"🇱🇧 Lebanon Front"}].map(tb=><button key={tb.id} onClick={()=>setTab(tb.id)} style={{...TB,background:tab===tb.id?"#f59e0b":"none",color:tab===tb.id?"#fff":t.sub,border:`1px solid ${tab===tb.id?"#f59e0b":t.border}`}}>{tb.label}</button>)}
    </div>
    {tab==="conflict"&&<div>
    ...
    {tab==="governance"&&<div>
      ...
      <Grid2 t={t} items={[{val:"$70B",label:"Estimated cost",sub:"Brookings — \"no modern comparison\"",color:"#8b5cf6"},{val:"0",label:"Reconstruction begun",sub:"Six months post-ceasefire",color:"#ef4444"},{val:"80%",label:"Buildings damaged",sub:"Or destroyed",color:"#f97316"},{val:"1,092+",label:"Killed since ceasefire",sub:"As of Jul 9 (Gaza MoH/OCHA)",color:"#ef4444"}]}/>
  ...
  return <div>
    ...
    {tab==="timeline"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>From Operation Epic Fury (Feb 28) through the Islamabad MoU and the 35-day countdown to Aug 16.</div>
      </Hero>
    ...
    {tab==="gaps"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #ef4444"}}>
        <div style={{fontSize:11,color:"rgba(255,255,255,.4)",textTransform:"uppercase",letterSpacing:".08em",marginBottom:8}}>⚠️ Unresolved Gaps — 35 Days Remain</div>
    ...
    {tab==="hormuz"&&<div>
      <Hero t={t} color="#0e7490"><div style={{fontSize:11,fontWeight:800,letterSpacing:".12em",color:"#22d3ee",marginBottom:6}}>🚢 THE STRAIT OF HORMUZ</div><div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>Iran shut the strait — the artery for roughly a fifth of global oil — during the war, and its partial reopening is now the central bargaining chip in the post-war negotiations. Tehran insists only coastal states control Hormuz security; Washington demands full reopening; and every tanker transit doubles as a live test of the standoff.</div></Hero>
      <Grid2 t={t} items={[
        {icon:"🛢️",label:"Share of global oil transiting Hormuz",val:"~20%",sub:"Plus roughly a third of seaborne LNG",color:"#0e7490"},
        {icon:"💥",label:"Tankers struck by Iran",val:"3",sub:"Jul 6-7 — for using non-designated routes",color:"#dc2626"},
        {icon:"🎯",label:"US targets struck",val:"80+",sub:"Jul 7-8, two waves — incl. 60+ IRGC boats",color:"#f97316"},
        {icon:"⏳",label:"MoU deadline",val:"Aug 16",sub:"60-day Islamabad window closes",color:"#8b5cf6"},
      ]}/>
      <ST t={t} color="#0e7490">📋 Status Board</ST>
      <Card t={t}><div style={{padding:"11px 14px"}}><div style={{fontSize:12,color:t.sub,lineHeight:1.7}}>
        <div style={{marginBottom:6}}><span style={{color:t.text,fontWeight:700}}>Jul 7 crisis</span> — Iran struck three tankers (Qatari Al Rekayyat, Saudi Wedyan among them) reportedly for using non-designated routes; the US hit 80+ targets including 60+ IRGC boats and revoked the GL X oil license. Iran's response came Jul 8: IRGC claims 85 US military targets struck in Bahrain and Kuwait; the US launched a second strike wave (Sirik, Bushehr, Konarak, Chabahar, Kish) and Trump declared the MoU 'over.' Brent +6% to $78. Insurance and transit calculus reset — early July's partial reopening is moot.</div>
        <div style={{marginBottom:6}}><span style={{color:t.text,fontWeight:700}}>UK-French patrol offer rejected</span> — both offered naval forces for freedom of navigation; Iran's chief negotiator warned the 'crisis-makers will be held accountable' and asserted only coastal states control Hormuz security.</div>
        <div style={{marginBottom:6}}><span style={{color:t.text,fontWeight:700}}>NATO enters the frame</span> — the Ankara summit draft declaration calls on Iran to 'fully respect freedom of navigation' in the strait, the alliance's first collective Hormuz language; the Trump administration expects strait security to be discussed at the summit.</div>
        <div><span style={{color:t.text,fontWeight:700}}>Leverage logic — now tested</span> — Iran enforced its designated-route regime with missiles; Washington answered that any Iranian 'measure of control' is unacceptable, with strikes and the sanctions snap-back. Both sides insist negotiations continue ('our negotiators continue to work in good faith' — US official), but the strait is once again a live-fire zone.</div>
      </div></div></Card>
      <Note t={t} color="#0e7490">Transit counts and U-turn figures are tracking-data snapshots (MarineTraffic via CNN reporting), not audited totals — treat day-to-day numbers as directional. Cross-reference: Sanctions & Energy trackers on Today, and the Gaps tab for the Pickaxe Mountain/Natanz friction points.</Note>
    </div>}
  </div>;
}
...
function NuclearSection({t,initialTab}){
  ...
  const TABS=[{id:"vectors",label:"⚠️ Active Vectors"},{id:"arsenals",label:"🌐 Global Arsenals"},{id:"delivery",label:"🚀 Delivery Systems"},{id:"treaties",label:"📜 Treaties & Doctrine"}];
  ...
  const VECTORS=[
    ...
    {flag:"🇮🇷",name:"Iran — Nuclear Clock",status:"35 DAYS",color:"#8b5cf6",text:"Islamabad MoU 60-day window closes ~Aug 16. IAEA inspector access disputed. Enrichment red lines unresolved — Pezeshkian: 'we will never back down from the right to enrich uranium.'"},
...
function USMilSection({t,initialTab}){
  ...
  return <div>
    ...
    {tab==="rankings"&&<div>
      ...
      <Card t={t}><div style={{padding:"10px 14px"}}>
        {GLOBAL_MIL_RANKINGS.map((c,i)=><div key={i} style={{marginBottom:10}}>
          ...
          <div style={{height:6,background:t.isDark?"rgba(255,255,255,.08)":"rgba(0,0,0,.08)",borderRadius:3,overflow:"hidden"}}><div style={{height:"100%",width:`${Math.max(3,c.aircraft/RANK_MAX.aircraft*100)}%`,background:c.rank===1?"#eab308":"#5b8ec8",borderRadius:3,transformOrigin:"left",animation:`barGrow .6s cubic-bezier(.22,1,.36,1) ${i*0.04}s both`}}/></div>
        </div>)}
      </div></Card>
      ...
      <Card t={t}><div style={{padding:"10px 14px"}}>
        {GLOBAL_MIL_RANKINGS.map((c,i)=><div key={i} style={{marginBottom:10}}>
          ...
          <div style={{height:6,background:t.isDark?"rgba(255,255,255,.08)":"rgba(0,0,0,.08)",borderRadius:3,overflow:"hidden"}}><div style={{height:"100%",width:`${Math.max(3,c.navy/RANK_MAX.navy*100)}%`,background:c.rank===1?"#5b8ec8":"#22c55e",borderRadius:3,transformOrigin:"left",animation:`barGrow .6s cubic-bezier(.22,1,.36,1) ${i*0.04}s both`}}/></div>
        </div>)}
      </div></Card>
      ...
      <Card t={t}><div style={{padding:"10px 14px"}}>
        {GLOBAL_MIL_RANKINGS.map((c,i)=><div key={i} style={{marginBottom:10}}>
          ...
          <div style={{height:6,background:t.isDark?"rgba(255,255,255,.08)":"rgba(0,0,0,.08)",borderRadius:3,overflow:"hidden"}}><div style={{height:"100%",width:`${Math.max(3,c.tanks/RANK_MAX.tanks*100)}%`,background:c.rank===1?"#ef4444":"#f97316",borderRadius:3,transformOrigin:"left",animation:`barGrow .6s cubic-bezier(.22,1,.36,1) ${i*0.04}s both`}}/></div>
        </div>)}
    ...
    {tab==="minerals"&&<div>
      ...
      <Note t={t} color="#eab308">Sources: MOFCOM announcements via China Briefing/Clark Hill, CSIS, CFR (Feb 2026), USGS MCS 2026. Ties into: Sanctions Tracker (Today), Taiwan/SCS section (blockade scenarios), Defense Industry tab (explosives/propellant inputs). Watch: both suspensions lapse Nov 2026 — a built-in escalation timer.</Note>
    </div>}

    {tab==="nato"&&<div>
      <Hero t={t} color="#5b8ec8"><div style={{fontSize:11,fontWeight:800,letterSpacing:".12em",color:"#bcd3ec",marginBottom:6}}>🔗 ALLIANCE & ARMS-FLOW MAP</div><div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>Who arms whom — the transfer corridors that shape every theater on this dashboard. Western flows run through NATO/AUKUS frameworks and the €140B Ankara pledge; the counter-network runs Pyongyang→Moscow, Tehran→Moscow, and Beijing→everyone as dual-use supplier of last resort.</div></Hero>
    ...
    {tab==="dprk"&&<div>
      ...
      <Grid2 t={t} items={[
        ...
        {icon:"⚰️",label:"DPRK casualties (Kursk)",val:"4,000+",sub:"Killed/wounded, per US/ROK estimates",color:"#dc2626"},
      ]}/>
      ...
      <Card t={t}><div style={{padding:"11px 14px"}}><div style={{fontSize:12,color:t.sub,lineHeight:1.7}}>
        ...
        <div style={{marginBottom:6}}><span style={{color:t.text,fontWeight:700}}>Kursk casualties</span> — DPRK troops took heavy losses in Kursk's open terrain, unfamiliar with drone-saturated modern combat; estimates of over 4,000 killed/wounded make it by far North Korea's costliest military engagement in decades, yet Pyongyang has shown no sign of reducing its commitment.</div>
...
function CyberSection({t,initialTab}){
  ...
  return <div>
    <div style={{display:"flex",gap:6,flexWrap:"wrap",marginBottom:12}}>{TABS.map(tb=><button key={tb.id} className="pill-tab" onClick={()=>setTab(tb.id)} style={{flexShrink:0,padding:"6px 12px",borderRadius:20,border:`1px solid ${tab===tb.id?"#5b8ec8":t.border}`,background:tab===tb.id?"#5b8ec8":"none",color:tab===tb.id?"#fff":t.sub,fontSize:12,fontWeight:tab===tb.id?700:400,cursor:"pointer",fontFamily:FONT,whiteSpace:"nowrap"}}>{tb.label}</button>)}</div>
...
function VenezuelaSection({t,initialTab}){
  ...
  const TABS=[{id:"cuba",label:"🇨🇺 Cuba Blockade"},{id:"spear",label:"🚤 Southern Spear"},{id:"conflict",label:"🇻🇪 Venezuela"}];
...
const SECTION_TAB_LISTS={
  ukraine:[{id:"overview",label:"📊 Overview"},{id:"losses",label:"⚖️ Losses"},{id:"frontline",label:"🎯 Frontline"},{id:"diplomacy",label:"🗣️ Diplomacy"},{id:"nato",label:"🤝 NATO"},{id:"crimea",label:"🏴 Crimea"},{id:"blacksea",label:"🌊 Black Sea"},{id:"strikes",label:"💥 Strikes"},{id:"economy",label:"💸 RU Economy"},{id:"manpower",label:"👥 Manpower"},{id:"intel",label:"🔍 Intel"},{id:"airdef",label:"🛡️ Air Defense"},{id:"uaindustry",label:"🏭 UA Industry"},{id:"analysts",label:"📺 Analysts"},{id:"belarus",label:"🇧🇾 Belarus Axis"}],
  ...
  nuclear:[{id:"vectors",label:"⚠️ Active Vectors"},{id:"arsenals",label:"🌐 Global Arsenals"},{id:"delivery",label:"🚀 Delivery Systems"},{id:"treaties",label:"📜 Treaties & Doctrine"}],
  iran:[{id:"overview",label:"🇮🇷 Overview"},{id:"hormuz",label:"🚢 Hormuz"},{id:"timeline",label:"📅 Timeline"},{id:"gaps",label:"⚠️ Gaps"}],
  venezuela:[{id:"cuba",label:"🇨🇺 Cuba Blockade"},{id:"spear",label:"🚤 Southern Spear"},{id:"conflict",label:"🇻🇪 Venezuela"}],
  ...
  gaza:[{id:"conflict",label:"⚔️ Gaza"},{id:"humanitarian",label:"🆘 Humanitarian"},{id:"governance",label:"🌐 Governance"},{id:"lebanon",label:"🇱🇧 Lebanon Front"}],
  cyber:[{id:"overview",label:"📡 Overview"},{id:"cables",label:"⚓ Undersea Cables"},{id:"ew",label:"🛰️ Electronic Warfare"},{id:"cyber",label:"🕵️ Cyber Intrusions"},{id:"greyzone",label:"🌫️ Grey-Zone"}],
};
...
const SPLASH_PARTICLES=Array.from({length:26},(_,i)=>({left:(i*37.7)%100,size:1+(i%3),delay:(i*0.31)%4,dur:5+(i%4)*1.6,color:i%3===0?"#7d94b3":"#5b8ec8"}));
...
function SplashScreen({onDone}){
  ...
  return <div style={{position:"fixed",inset:0,zIndex:9999,display:"flex",alignItems:"center",justifyContent:"center",background:"radial-gradient(ellipse at center,#0a1526 0%,#050a14 70%)",animation:phase==="out"?"splashFadeOut .65s ease forwards":"none",overflow:"hidden"}}>
    ...
    <div style={{position:"relative",display:"flex",flexDirection:"column",alignItems:"center",gap:20}}>
      <div style={{position:"relative",width:"66vw",maxWidth:280,aspectRatio:"3/2",borderRadius:14,overflow:"hidden",boxShadow:"0 0 90px rgba(59,74,92,0.6),0 0 30px rgba(91,142,196,0.2)",animation:"flagWave 3s ease-in-out infinite"}}>
        <div style={{position:"absolute",top:0,left:0,right:0,height:"50%",background:"linear-gradient(180deg,#16202c,#111a24)",animation:"bandL .65s cubic-bezier(.22,1,.36,1) both"}}/>
        <div style={{position:"absolute",bottom:0,left:0,right:0,height:"50%",background:"linear-gradient(180deg,#0f1720,#0a1017)",animation:"bandR .65s cubic-bezier(.22,1,.36,1) .12s both"}}/>
        <div style={{position:"absolute",top:0,bottom:0,width:"46%",background:"linear-gradient(90deg,transparent,rgba(91,142,196,0.28),transparent)",animation:"sheen 1.1s ease-in-out 1.15s both"}}/>
        <div style={{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center"}}>
          <span style={{position:"absolute",width:70,height:70,borderRadius:"50%",border:"2px solid rgba(91,142,196,0.55)",animation:"glowRing 1.4s ease-out .75s both"}}/>
          <span style={{position:"absolute",width:70,height:70,borderRadius:"50%",border:"1px solid rgba(91,142,196,0.5)",animation:"glowRing 1.4s ease-out 1.05s both"}}/>
          <span style={{width:78,height:78,display:"flex",alignItems:"center",justifyContent:"center",animation:"tridentIn .8s cubic-bezier(.34,1.56,.64,1) .55s both, splashPulse 2.2s ease-in-out 1.4s infinite",filter:"drop-shadow(0 0 16px rgba(0,0,0,0.5)) drop-shadow(0 0 24px rgba(91,142,196,0.35))"}}><svg viewBox="0 0 100 100" width="78" height="78" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="wcdOcean" cx="38%" cy="34%" r="72%"><stop offset="0%" stopColor="#1c3a5e"/><stop offset="55%" stopColor="#12283f"/><stop offset="100%" stopColor="#0a1524"/></radialGradient><radialGradient id="wcdAtmo" cx="50%" cy="50%" r="50%"><stop offset="82%" stopColor="rgba(91,142,196,0)"/><stop offset="94%" stopColor="rgba(91,142,196,0.35)"/><stop offset="100%" stopColor="rgba(91,142,196,0)"/></radialGradient><clipPath id="wcdGlobeClip"><circle cx="50" cy="50" r="40"/></clipPath></defs><circle cx="50" cy="50" r="46" fill="url(#wcdAtmo)"/><circle cx="50" cy="50" r="40" fill="url(#wcdOcean)" stroke="rgba(91,142,196,0.55)" strokeWidth="0.8"/><g clipPath="url(#wcdGlobeClip)"><g style={{transformBox:"fill-box",transformOrigin:"center",animation:"globeSpin 24s linear infinite"}}><g fill="#3f7a52" fillOpacity="0.92"><path d="M18,34 q6,-8 15,-6 q8,2 6,9 q-3,7 -12,7 q-10,1 -13,-4 q-2,-4 4,-6 Z"/><path d="M30,52 q4,10 -2,20 q-3,6 -9,4 q-4,-6 -1,-15 q2,-9 12,-9 Z"/><path d="M52,30 q14,-5 22,3 q6,6 -2,11 q-10,5 -20,1 q-8,-4 -6,-10 q1,-4 6,-5 Z"/><path d="M60,52 q10,-2 12,8 q1,10 -8,16 q-7,4 -10,-4 q-3,-11 2,-17 q1,-2 4,-3 Z"/><path d="M80,40 q8,1 7,9 q-2,7 -9,6 q-6,-2 -5,-9 q1,-6 7,-6 Z"/></g><g fill="#3f7a52" fillOpacity="0.92" transform="translate(80,0)"><path d="M18,34 q6,-8 15,-6 q8,2 6,9 q-3,7 -12,7 q-10,1 -13,-4 q-2,-4 4,-6 Z"/><path d="M30,52 q4,10 -2,20 q-3,6 -9,4 q-4,-6 -1,-15 q2,-9 12,-9 Z"/><path d="M52,30 q14,-5 22,3 q6,6 -2,11 q-10,5 -20,1 q-8,-4 -6,-10 q1,-4 6,-5 Z"/><path d="M60,52 q10,-2 12,8 q1,10 -8,16 q-7,4 -10,-4 q-3,-11 2,-17 q1,-2 4,-3 Z"/><path d="M80,40 q8,1 7,9 q-2,7 -9,6 q-6,-2 -5,-9 q1,-6 7,-6 Z"/></g></g><g stroke="rgba(120,160,205,0.28)" strokeWidth="0.5" fill="none"><ellipse cx="50" cy="50" rx="40" ry="13"/><ellipse cx="50" cy="50" rx="40" ry="27"/><ellipse cx="50" cy="50" rx="13" ry="40"/><ellipse cx="50" cy="50" rx="27" ry="40"/><line x1="10" y1="50" x2="90" y2="50"/></g><circle cx="50" cy="50" r="40" fill="rgba(5,10,20,0.30)" transform="translate(9,9)"/></g><circle cx="50" cy="50" r="40" fill="none" stroke="rgba(91,142,196,0.4)" strokeWidth="0.8"/></svg></span>
        </div>
      </div>
      <DecryptText text={"WORLD CONFLICT DEBRIEF"} delay={1150} style={{fontSize:15,fontWeight:800,color:"#cddcf2",letterSpacing:".18em",textTransform:"uppercase",fontFamily:FONT,textShadow:"0 0 18px rgba(91,142,196,0.6)",minHeight:20,textAlign:"center"}}/>
      <DecryptText text={"OSINT · GLOBAL CONFLICT DESK"} delay={1650} style={{fontSize:10,fontWeight:700,color:"#5b8ec8",letterSpacing:".3em",fontFamily:FONT,opacity:.9,minHeight:14}}/>
      <div style={{width:"52vw",maxWidth:220,height:2,background:"rgba(91,142,196,0.15)",borderRadius:2,overflow:"hidden"}}>
        <div style={{height:"100%",background:"linear-gradient(90deg,#3a4a5c,#5b8ec8,#7d94b3)",animation:"loadBar 2.7s cubic-bezier(.4,0,.2,1) .2s both",boxShadow:"0 0 8px rgba(91,142,196,0.8)"}}/>
      </div>
    </div>
  </div>;
}
...
export default function App(){
  ...
  return <div style={{background:t.bg,minHeight:"100vh",maxWidth:t.isLandscape?900:480,margin:"0 auto",fontFamily:FONT,lineHeight:1.5,WebkitFontSmoothing:"antialiased",paddingBottom:34}}>
