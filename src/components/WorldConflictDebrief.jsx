...
const NEWS=[
  {id:"b_ukraine_political_crisis",conflictId:"ukraine",severity:"critical",icon:"🔴",headline:"Zelensky Dismisses Commander-in-Chief Syrskyi and Names Drapatyi, But Fedorov Standoff Drags Into a Second Week",conflict:"Ukraine",conflictColor:"#5b8ec8",publishedAt:"Jul 22, 2026",bullets:["HOW IT STARTED — Zelensky announced Jul 12 that Ukraine was 'changing its political strategy,' launching the war's fourth government reshuffle: PM Yulia Svyrydenko resigned Jul 15, replaced by ex-Naftogaz CEO Serhii Koretsky (Rada confirmed the new Cabinet Jul 16). The bigger shock was the dismissal of Defense Minister Mykhailo Fedorov after just six months — credited with cutting ministry corruption and persuading Elon Musk to deny Russia Starlink access — with SBU officer Yevhenii Khmara installed as acting defense minister. Analysts point to a feud between Fedorov and then-Commander-in-Chief Oleksandr Syrskyi as the real driver; Fedorov declined an advisor role, saying 'I don't need to be Minister of Defense just to be Minister of Defense'","THE COMMANDER FALLS — After the General Staff flatly denied Jul 20 reports that Syrskyi had been removed, Zelensky did exactly that on Jul 21, appointing Maj. Gen. Mykhailo Drapatyi (previously Joint Forces commander) as commander-in-chief to 'reset' the war effort. Syrskyi broke his usual silence with an op-ed apologizing if he'd offended Fedorov while defending his record: he says he established Ukraine's drone forces as a separate branch and couldn't 'switch a million-people army to drones in two months.' Russia responded by urgently adding Drapatyi to its wanted list","STILL UNRESOLVED — Fedorov has refused Zelensky's offer of a senior tech-sector government role (Financial Times), leaving the standoff open; a senior air force commander resigned in protest, as did Deputy Air Force Commander Pavlo Yelizarov earlier. Protests that began with 1,000+ in Kyiv's central square have run more than a week and spread to Lviv, Odesa and Dnipro, with demonstrators setting a Jul 24 deadline for Fedorov's reinstatement","CONTEXT — Martial law and mobilization were both extended to Oct 31, 2026 (the 20th such vote). The churn lands squarely on the dashboard's central open thread: Patriot-production licensing and air-defense reform now ride on an untested defense minister and a brand-new commander-in-chief. The UN human rights mission (Danielle Bell) reported 1,396 civilians killed and 7,978 wounded nationwide in H1 2026"],sources:["Kyiv Independent","RFE/RL","Ukrinform","Financial Times","RBC-Ukraine","Al Jazeera"],impact:"Ukraine's most serious wartime political crisis to date: two of the three people running the war effort replaced inside ten days, the reform-vs-conventional-command rift still unresolved, and a hard protest deadline on Jul 24 that the leadership has no obvious way to meet",impactColor:"#dc2626"},
  {id:"b_iran_war_jul22",conflictId:"iran",severity:"critical",icon:"🔴",headline:"11th Night of US Strikes as Trump Targets Fortified Nuclear Site; Houthis Close Bab el-Mandeb to Saudi Oil, Brent Tops $92",conflict:"Iran",conflictColor:"#8b5cf6",publishedAt:"Jul 22, 2026",bullets:["THE CAMPAIGN — CENTCOM struck Iranian military operations centers, maritime capabilities, aircraft hangars, drone storage and logistics infrastructure in an 11th consecutive night of attacks, with Iranian state media reporting explosions across seven provinces including an electrical installation near the Bushehr nuclear plant. Iranian authorities say 95 locations across 12 cities were hit in the first 10 days alone; Hegseth puts the war's cost to the US at $37.5B. This grew out of the Jul 14 naval blockade of Iran's entire coastline — 20+ warships in-theater, enforced first against the tanker M/T Belma, disabled by Hellfire fire near Kharg Island","US CASUALTIES — The Pentagon identified Sgt. Angel S. Rampersad, 28, of Ozone Park, N.Y. as the third service member killed in the Jul 17 Jordan strike, after she was initially listed missing; a separate death, Sgt. Michael Emmanuel Swinton, 30, of Fayetteville NC, came in a controlled drone-detonation at Erbil Air Base, Iraq. Cumulative US deaths in the Iran war now stand at 18. Trump posted that Iran will 'pay for that killing many times over,' and appeared to fault Jordan for letting missiles 'slip through' at the Muwafaq al-Salti base","IRAN'S RESPONSE — Iran struck the eastern Jordan air base again plus Bahrain's Sheikh Isa air base (a US Fifth Fleet logistics hub); Jordan intercepted six missiles Wednesday. Iran attacked another tanker in Hormuz, pushing Brent past $92/bbl, and Kuwait's desalination plant and power stations caught fire earlier in the week. Tehran says about 3,000 people in Iran, many civilians, have been killed across the war; DNA-identified remains of 32 victims of the Feb 28 strike on a girls' school — where Iran says 168 students and teachers died — were buried this week, with the US military still investigating that attack","NEW FRONT & NUCLEAR THREAT — The Houthis declared Bab el-Mandeb off limits to Saudi Arabia and warned international shipping away, putting ~2.5M barrels/day at risk; six ships turned course and Saudi-loaded tankers backed out. Trump said the US plans to hit a fortified underground site near a main enrichment facility — the Pickaxe Mountain complex, where satellite imagery since June has shown reconstruction alongside repairs at Parchin's Taleghan 2 — and Iran called any strike on nuclear sites a major escalation. Regional mediators have floated a 10-day ceasefire; Iranian Interior Minister Eskander Momeni went to Pakistan for talks, but Trump said Iran is 'getting decimated' and 'until they're ready to meet in a meaningful way, we have no interest'"],sources:["NPR","CNN","Al Jazeera","CNBC","Institute for Science and International Security"],impact:"The war is widening faster than it is being negotiated — a second chokepoint closed, a nuclear site openly threatened, and a named American death toll at 18, all while a ceasefire proposal sits on the table that neither side has picked up",impactColor:"#dc2626"},
...
const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,433,230",todayChange:"+1,330",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
  {id:2,category:"Tanks",total:"12,163",todayChange:"+2",color:"#f97316",icon:"🪖",description:"Main battle tanks"},
  {id:3,category:"Armoured Vehs",total:"24,982",todayChange:"+4",color:"#eab308",icon:"🚧",description:"APCs, IFVs, MRAPs"},
  {id:4,category:"Artillery",total:"46,492",todayChange:"+57",color:"#84cc16",icon:"💥",description:"Guns, howitzers, mortars"},
  {id:5,category:"MLRS",total:"1,958",todayChange:"+3",color:"#22c55e",icon:"🚀",description:"Multiple launch rockets"},
  {id:6,category:"Air Defence",total:"1,513",todayChange:"—",color:"#06b6d4",icon:"🛡️",description:"SAM & SHORAD systems"},
  {id:7,category:"UAVs",total:"421,900",todayChange:"+1,610",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
  ...
  {id:12,category:"Vehicles",total:"123,702",todayChange:"+355",color:"#a78bfa",icon:"🚛",description:"Trucks & logistics"},
  {id:13,category:"Ground Robots",total:"1,981",todayChange:"+11",color:"#f43f5e",icon:"🤖",description:"UGV platforms"},
  {id:14,category:"Special Equip",total:"4,450",todayChange:"+9",color:"#fb923c",icon:"🔧",description:"Engineering & EW"},
],gaza:[
...
const REPORT_NOW=new Date("2026-07-23T01:30:00Z");
  ...
  return <div>
    ...
    {tab==="timeline"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>From Operation Epic Fury (Feb 28) through the Islamabad MoU and the 24-day countdown to Aug 16.</div>
      </Hero>
    ...
    {tab==="gaps"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #ef4444"}}>
        <div style={{fontSize:11,color:"rgba(255,255,255,.4)",textTransform:"uppercase",letterSpacing:".08em",marginBottom:8}}>⚠️ Unresolved Gaps — 24 Days Remain</div>
...
function NuclearSection({t,initialTab}){
  ...
  const VECTORS=[
    ...
    {flag:"🇮🇷",name:"Iran — Nuclear Clock",status:"24 DAYS",color:"#8b5cf6",text:"Islamabad MoU 60-day window closes ~Aug 16. IAEA inspector access disputed. Enrichment red lines unresolved — Pezeshkian: 'we will never back down from the right to enrich uranium.'"},
