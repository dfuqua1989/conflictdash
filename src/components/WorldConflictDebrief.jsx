...
const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,421,810",todayChange:"+1,120",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
  {id:2,category:"Tanks",total:"12,131",todayChange:"+6",color:"#f97316",icon:"🪖",description:"Main battle tanks"},
  {id:3,category:"Armoured Vehs",total:"24,932",todayChange:"+1",color:"#eab308",icon:"🚧",description:"APCs, IFVs, MRAPs"},
  {id:4,category:"Artillery",total:"45,911",todayChange:"+46",color:"#84cc16",icon:"💥",description:"Guns, howitzers, mortars"},
  {id:5,category:"MLRS",total:"1,931",todayChange:"+2",color:"#22c55e",icon:"🚀",description:"Multiple launch rockets"},
  {id:6,category:"Air Defence",total:"1,491",todayChange:"+2",color:"#06b6d4",icon:"🛡️",description:"SAM & SHORAD systems"},
  {id:7,category:"UAVs",total:"407,201",todayChange:"+1,508",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
  ...
  {id:10,category:"Cruise Missiles",total:"4,899",todayChange:"+3",color:"#14b8a6",icon:"🎯",description:"Destroyed in flight"},
  {id:11,category:"Ships/Boats",total:"33",todayChange:"—",color:"#64748b",icon:"⛵",description:"Naval vessels"},
  {id:12,category:"Vehicles",total:"119,862",todayChange:"+330",color:"#a78bfa",icon:"🚛",description:"Trucks & logistics"},
  {id:13,category:"Ground Robots",total:"1,905",todayChange:"+11",color:"#f43f5e",icon:"🤖",description:"UGV platforms"},
  {id:14,category:"Special Equip",total:"4,416",todayChange:"+4",color:"#fb923c",icon:"🔧",description:"Engineering & EW"},
],gaza:[
...
const REPORT_NOW=new Date("2026-07-14T12:00:00Z");
...
function IranSection({t,initialTab}){
  ...
  return <div>
    ...
    {tab==="overview"&&<div>
      <ConflictOverviewCard conflict={conflict} t={t}/>
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        <div style={{fontSize:11,color:"rgba(255,255,255,.4)",textTransform:"uppercase",letterSpacing:".08em",marginBottom:10}}>🚨 Blockade in Effect — MoU Declared Dead by Tehran</div>
        <Grid2 t={t} items={[{val:"20:00 GMT",label:"Blockade effective Jul 14",sub:"All flags, entire Iranian coastline (JMIC)",color:"#dc2626"},{val:"\"No commitments\"",label:"Iran deputy FM on the MoU",sub:"Says US destroyed the interim deal",color:"#ef4444"},{val:"~Aug 16",label:"60-day clock (nominal)",sub:"Now overtaken by events on the ground",color:"#f97316"},{val:"Ground war?",label:"Trump won't rule it out",sub:"Threatens bridges, power plants 'next week'",color:"#dc2626"}]}/>
      </Hero>
    ...
    {tab==="timeline"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>From Operation Epic Fury (Feb 28) through the Islamabad MoU and the 33-day countdown to Aug 16.</div>
      </Hero>
    ...
    {tab==="gaps"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #ef4444"}}>
        <div style={{fontSize:11,color:"rgba(255,255,255,.4)",textTransform:"uppercase",letterSpacing:".08em",marginBottom:8}}>⚠️ Unresolved Gaps — 33 Days Remain</div>
    ...
    {tab==="hormuz"&&<div>
      <Hero t={t} color="#0e7490"><div style={{fontSize:11,fontWeight:800,letterSpacing:".12em",color:"#22d3ee",marginBottom:6}}>🚢 THE STRAIT OF HORMUZ</div><div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>The strait — the artery for roughly a fifth of global oil — is now under dueling regimes: Iran claims sole control and strikes 'non-compliant' vessels; the US has imposed a formal naval blockade of the entire Iranian coastline (effective 20:00 GMT Jul 14, all flags — neutral ships bound for non-Iranian ports may pass, humanitarian cargo subject to inspection). Every transit is now a live test of two competing blockades.</div></Hero>
      <Grid2 t={t} items={[
        {icon:"🛢️",label:"Share of global oil transiting Hormuz",val:"~20%",sub:"Plus roughly a third of seaborne LNG",color:"#0e7490"},
        {icon:"📉",label:"Daily strait crossings",val:"22 vs 147",sub:"Jul 9 vs the day before the war began (Kpler)",color:"#dc2626"},
...
function NuclearSection({t,initialTab}){
  ...
  const VECTORS=[
    ...
    {flag:"🇮🇷",name:"Iran — Nuclear Clock",status:"33 DAYS",color:"#8b5cf6",text:"Islamabad MoU 60-day window closes ~Aug 16. IAEA inspector access disputed. Enrichment red lines unresolved — Pezeshkian: 'we will never back down from the right to enrich uranium.'"},
