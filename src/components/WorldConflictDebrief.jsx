...
const CONFLICTS=[
  ...
  {id:"iran",name:"US-Iran War (2026)",region:"Middle East",status:"ACTIVE COMBAT",statusColor:"#dc2626",icon:"🇮🇷",deaths:"~6,000+ total",displaced:"Hundreds K",summary:"Operation Epic Fury Feb 28; Islamabad MoU signed Jun 17. The 60-day truce has effectively collapsed into open fighting: US struck ~140+ Iranian targets Jul 12-13 (first use of one-way attack sea drones); Iran retaliated across Jordan, Bahrain, Kuwait and Oman and again claims control of Hormuz. Satellite imagery separately shows Iran covertly rebuilding at Parchin and Pickaxe Mountain.",warDay:null},
...
const NEWS=[
  ...
  {id:"b_iran_gulf_strikes_jul13",conflictId:"iran",severity:"critical",icon:"🔴",headline:"US Strikes ~140 Targets in Iran, IRGC Retaliates Across Jordan, Bahrain, Kuwait and Oman — Ceasefire in Name Only",conflict:"Iran",conflictColor:"#8b5cf6",publishedAt:"Jul 13, 2026",bullets:["Late Jul 12: IRGC intercepted two tankers in the Strait of Hormuz for switching off transponders, calling them 'violating vessels'; CENTCOM responded by striking Iranian coastal military bases overnight, then followed with a larger wave hitting air-defense systems, coastal radar, missile/drone sites and small boats — using fighter aircraft, naval vessels, and for the first time, one-way attack sea drones","Iran's IRGC retaliated in multiple phases: missile/drone strikes set fuel and missile depots ablaze at Jordan's Prince Hassan Air Base, hit helicopter maintenance facilities and a P-8 surveillance aircraft hangar at Bahrain's Sheikh Isa base, and destroyed a fuel depot, a Patriot air-defense system and a radar facility at a US base in Kuwait; Oman's long-range and vessel-detection radars were also targeted","Missile alerts sounded in the UAE, Qatar, Kuwait, Oman and Bahrain; 3 people including a child were injured by shrapnel in Qatar; Jordan intercepted 4 incoming missiles; Iranian state media reported one army officer killed","The exchange lands almost exactly at the midway point of the Jun 17 MoU's 60-day window — Iran is again publicly claiming sole control of the Strait of Hormuz, which CENTCOM explicitly disputed: 'Iran does not control it'","This follows Jul 10's CNN/ISIS revelation that Iran was covertly rebuilding bombed nuclear sites at Parchin and Pickaxe Mountain even while the MoU was nominally in force"],sources:["Al Jazeera","CENTCOM","Press TV/IRGC statements"],impact:"This is no longer a dispute about whether talks will resume — it's a live shooting war across five countries. The 60-day MoU clock (~Aug 16) now looks less like a diplomatic deadline and more like a formality overtaken by events on the ground",impactColor:"#dc2626"},
...
const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,420,690",todayChange:"+1,600",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
  {id:2,category:"Tanks",total:"12,125",todayChange:"+5",color:"#f97316",icon:"🪖",description:"Main battle tanks"},
  {id:3,category:"Armoured Vehs",total:"24,931",todayChange:"+3",color:"#eab308",icon:"🚧",description:"APCs, IFVs, MRAPs"},
  {id:4,category:"Artillery",total:"45,865",todayChange:"+58",color:"#84cc16",icon:"💥",description:"Guns, howitzers, mortars"},
  {id:5,category:"MLRS",total:"1,929",todayChange:"+1",color:"#22c55e",icon:"🚀",description:"Multiple launch rockets"},
  {id:6,category:"Air Defence",total:"1,489",todayChange:"+4",color:"#06b6d4",icon:"🛡️",description:"SAM & SHORAD systems"},
  {id:7,category:"UAVs",total:"405,693",todayChange:"+1,734",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
  ...
  {id:10,category:"Cruise Missiles",total:"4,896",todayChange:"+7",color:"#14b8a6",icon:"🎯",description:"Destroyed in flight"},
  {id:11,category:"Ships/Boats",total:"33",todayChange:"—",color:"#64748b",icon:"⛵",description:"Naval vessels"},
  {id:12,category:"Vehicles",total:"119,532",todayChange:"+494",color:"#a78bfa",icon:"🚛",description:"Trucks & logistics"},
  {id:13,category:"Ground Robots",total:"1,883",todayChange:"+15",color:"#f43f5e",icon:"🤖",description:"UGV platforms"},
  {id:14,category:"Special Equip",total:"4,412",todayChange:"+5",color:"#fb923c",icon:"🔧",description:"Engineering & EW"},
],gaza:[
...
const REPORT_NOW=new Date("2026-07-13T12:00:00Z");
  ...
  return <div>
    ...
    {tab==="timeline"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>From Operation Epic Fury (Feb 28) through the Islamabad MoU and the 34-day countdown to Aug 16.</div>
      </Hero>
    ...
    {tab==="gaps"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #ef4444"}}>
        <div style={{fontSize:11,color:"rgba(255,255,255,.4)",textTransform:"uppercase",letterSpacing:".08em",marginBottom:8}}>⚠️ Unresolved Gaps — 34 Days Remain</div>
...
function NuclearSection({t,initialTab}){
  ...
  const VECTORS=[
    ...
    {flag:"🇮🇷",name:"Iran — Nuclear Clock",status:"34 DAYS",color:"#8b5cf6",text:"Islamabad MoU 60-day window closes ~Aug 16. IAEA inspector access disputed. Enrichment red lines unresolved — Pezeshkian: 'we will never back down from the right to enrich uranium.'"},
