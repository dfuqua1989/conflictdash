...
const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,444,810",todayChange:"+1,360",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
  {id:2,category:"Tanks",total:"12,230",todayChange:"+3",color:"#f97316",icon:"🪖",description:"Main battle tanks"},
  {id:3,category:"Armoured Vehs",total:"25,049",todayChange:"+5",color:"#eab308",icon:"🚧",description:"APCs, IFVs, MRAPs"},
  {id:4,category:"Artillery",total:"47,003",todayChange:"+41",color:"#84cc16",icon:"💥",description:"Guns, howitzers, mortars"},
  {id:5,category:"MLRS",total:"1,969",todayChange:"+1",color:"#22c55e",icon:"🚀",description:"Multiple launch rockets"},
  {id:6,category:"Air Defence",total:"1,522",todayChange:"+1",color:"#06b6d4",icon:"🛡️",description:"SAM & SHORAD systems"},
  {id:7,category:"UAVs",total:"434,140",todayChange:"+1,362",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
...
const EVENTS={ukraine:[{id:1,date:"Jan 6, 2026",label:"Coalition of Willing — Paris",note:"35 nations at Elysée Palace. UK + France pledge troops post-ceasefire.",color:"#22c55e",isUpcoming:false},{id:2,date:"Feb 17, 2026",label:"Geneva trilateral talks",note:"Military track: constructive. Political track: stuck.",color:"#f97316",isUpcoming:false},{id:3,date:"May 9, 2026",label:"Trump 3-day ceasefire",note:"Expired. Full-scale combat resumed immediately.",color:"#f97316",isUpcoming:false},{id:4,date:"Jun 7, 2026",label:"Putin refuses direct talks",note:"Declines Zelensky face-to-face proposal.",color:"#ef4444",isUpcoming:false},{id:5,date:"Jun 23, 2026",label:"Rail bridge to Crimea destroyed",note:"Last intact rail link from north severed.",color:"#ef4444",isUpcoming:false},{id:6,date:"Jun 25, 2026",label:"Belarus halts Shahed relay",note:"Partial compliance with Ukraine ultimatum.",color:"#22c55e",isUpcoming:false},{id:7,date:"Jun 27, 2026",label:"Putin-Lukashenko Valdai summit",note:"2-day secret talks at Putin's private residence. WSJ: Russia pressuring Belarus to open second front. No communiqué issued.",color:"#ef4444",isUpcoming:false},{id:8,date:"Jun 27, 2026",label:"Serbia's Vucic announces resignation",note:"Snap elections coming. Pro-Russia Balkan president destabilised. Serbia has warm ties with Moscow — election outcome uncertain.",color:"#f59e0b",isUpcoming:false},{id:10,date:"Jun 16-17, 2026",label:"Russia rejects Turkish ceasefire proposal",note:"Fidan proposed ceasefire in Moscow — Russia rejected, remained firm on Donbas demands. Turkey had hoped to bring both sides to NATO Ankara. Diplomatic track blocked.",color:"#ef4444",isUpcoming:false},{id:11,date:"Jun 28, 2026",label:"Putin United Russia congress — rejects diplomacy",note:"First public admission of fuel shortages. ISW: 'rejected diplomatic solutions.' United Russia formally claimed as Putin's party. Duma elections Sept 2026.",color:"#ef4444",isUpcoming:false},{id:9,date:"Jul 7, 2026",label:"NATO Ankara Summit",note:"Potential ceasefire deadline. Security guarantees on agenda. Slovakia refuses aid pledge. Turkey jet engine deal confirmed.",color:"#5b8ec8",isUpcoming:true}],iran:[
    ...
    {id:25,date:"Jul 29-30, 2026",label:"War reignites: Jordan base attack, Egypt struck, Saudi Arabia joins",note:"Iran struck a US base in Jordan (intercepted); CENTCOM answered with a \u2018heavy wave\u2019 of strikes on dozens of IRGC targets, killing a family of three on Qeshm island per Iranian media, and the US sanctioned 10 entities and 8 tankers. A drone hit a US-owned LNG tanker at Egypt\u2019s Damietta port \u2014 the first time Egyptian infrastructure has been struck in the war \u2014 while Saudi Arabia conducted its first acknowledged direct strikes alongside the US, against Iranian-backed militias in Iraq.",color:"#dc2626",isUpcoming:false},
    {id:26,date:"~Aug 16, 2026",label:"60-day MoU clock expires",note:"Window closes. Trump has said he could relaunch full military strikes if talks fail. If no deal, Iran could resume full enrichment and Hormuz re-closure.",color:"#ef4444",isUpcoming:true},
...
const BRIEFING={summaryShort:"Russia launched its largest combined strike in weeks overnight \u2014 74 missiles and 284 drones hit Kyiv, Kryvyi Rih and Lviv, killing 8-10 including 3 children from one family, with a missile crossing into Poland and prompting NATO jets to scramble. Russian losses reached 1,444,810 (+1,360) per the Jul 30 MoD report. Separately, the Iran war's five-night pause ended: the US launched a \u2018heavy wave\u2019 of strikes after Iran hit a US base in Jordan, and Egypt was struck for the first time, pulling in Saudi Arabia as a direct combatant too. Zelensky remains unable to resolve the Fedorov political crisis.",summary:"Ukraine: Russia's overnight Jul 29-30 attack was its largest combined strike since the mid-July interceptor shortage began \u2014 61 Kh-101/Kalibr cruise, 9 Iskander-M ballistic and 4 Zircon anti-ship missiles alongside 284 drones, of which Ukraine's air defense intercepted only 1 of 9 ballistic missiles. An Iskander-M strike killed 6 members of one family near Kryvyi Rih; Lviv had two high-rises, a school and two kindergartens damaged. A missile or debris crossed into Poland's Lublin region, leaving a crater and prompting Polish/NATO jets to scramble \u2014 the most serious NATO-airspace incident in months. Russian losses reached 1,444,810 (+1,360) per the Jul 30 MoD report. This follows Zelensky's Jul 28 White House meeting with Trump on Patriot licensing and Ukraine's deep strike on Russia's Ryazan refinery. Domestically, Fedorov \u2014 in a new interview \u2014 linked his dismissal to a procurement-reform push that drew backlash, and said his rift with former Commander-in-Chief Syrskyi was 'ideological, not personal'; the crisis remains unresolved with no new defense minister named. Iran: the five-night pause ended abruptly \u2014 Iran struck a US base in Jordan, and the US retaliated with a 'heavy wave' of strikes on dozens of IRGC targets, killing a family of three on Qeshm island per Iranian media. A drone hit a US-owned LNG tanker at Egypt's Damietta port, the first time Egyptian infrastructure has been struck in the war, while Saudi Arabia conducted joint strikes with the US in Iraq \u2014 its first acknowledged direct combat role. The Strait of Hormuz remains closed per Iran's IRGC. Elsewhere: Gaza's post-ceasefire violence continues (IDF struck a mosque in Gaza City this week; a Hezbollah drone hit an Israeli vehicle in south Lebanon in a truce violation); Taiwan Strait and Americas files remain active without major new developments today.",watch:"Whether the Poland missile incident triggers any NATO Article 4/5 consultation or remains a one-off; whether Egypt or Saudi Arabia sustain direct roles in the Iran war or this proves a single incident; and whether Ukraine's political crisis produces a confirmed new defense minister.",generatedAt:new Date().toISOString()};

const UKRAINE_BRIEFING={summaryShort:"Russia's overnight Jul 29-30 attack was its largest combined strike in weeks \u2014 74 missiles and 284 drones, with only 1 of 9 ballistic missiles intercepted \u2014 killing 8-10 people including 3 children from one family near Kryvyi Rih, and sending a missile across the border into Poland. Russian cumulative losses reached 1,444,810 (+1,360) as of the Jul 30 MoD report, an ~8:1 loss ratio in H1 2026 per CSIS even as Russia's ground offensive grinds on at Pokrovsk. Fedorov gave a new interview linking his dismissal to procurement reform and calling the Syrskyi rift 'ideological, not personal.' Full breakdown below.",summary:"Russia's overnight Jul 29-30 attack was the largest combined strike since the mid-July interceptor shortage began: 61 Kh-101/Kalibr cruise, 9 Iskander-M/S-400/KN-23 ballistic and 4 Zircon/Onyx anti-ship missiles alongside 284 drones. Ukraine's air defense downed 55 of 74 missiles but just 1 of 9 ballistic missiles \u2014 the ballistic-intercept rebound from Jul 25-26 did not hold. An Iskander-M strike killed 6 members of one family, including 3 children, near Kryvyi Rih; Lviv had two high-rises, a school and two kindergartens damaged; at least 8-10 died and 50+ were injured nationwide. A missile or debris, believed Russian, crossed into Poland's Lublin region, prompting Polish and NATO jets to scramble \u2014 the most serious NATO-airspace incident in months. Russia's attrition math remains historically bad for Moscow even so: CSIS's H1 2026 assessment puts the loss ratio at nearly 8:1, and cumulative losses reached 1,444,810 (+1,360) per the Jul 30 MoD report. The war isn't simply going well for Ukraine, though: Russia's offensive still holds Pokrovsk at genuine encirclement risk, and the Patriot/PAC-3 shortage \u2014 worsened by the Iran war draining US stocks \u2014 was starkly exposed by last night's near-total ballistic-intercept failure.",assessment:[{cat:"Attrition",text:"~8:1 RU:UA loss ratio in H1 2026 (CSIS). Cumulative Russian losses reached 1,444,810 as of the Jul 30 MoD report (+1,360 on the day) \u2014 tanks to 12,230, artillery to 47,003; Russian UAV losses passed 434,000. Ukraine's naval/deep-strike interdiction campaign remains a sustained second front, regularly reaching Moscow region and 1,000+km inside Russia."},{cat:"Territory",text:"Russian advance remains grinding \u2014 Pokrovsk is the single hottest sector on the front, alongside Huliaipole. Monthly gain estimates diverge sharply by source (DeepState vs. ISW), among the slowest rates of any war in the past century either way. Russia had a net territorial loss in Apr-May 2026, its first monthly net loss since Aug 2024."},{cat:"Deep Strikes",text:"Ukraine's deep-strike campaign continues reaching deep inside Russia \u2014 the Ryazan oil refinery (~5% of Russian refining capacity) and a classified Rosrezerv strategic fuel reserve in Udmurtia (1,300km deep) both hit this week, alongside a Rostov Oblast export terminal and Iranian-cargo vessels in the Caspian Sea. The cumulative effect remains a nationwide Russian fuel crisis severe enough to have forced a diesel export ban."},{cat:"Air Defense",text:"A stark reversal: after downing 5 of 7 ballistic missiles Jul 25-26 (71%, the best rate since the mid-July shortage), Ukraine intercepted just 1 of 9 ballistic missiles in the Jul 29-30 mass attack \u2014 confirming the earlier rebound was a one-off rather than a durable fix. Trump's Jul 28 meeting with Zelensky again touched on Patriot production licensing, though real domestic output remains months-to-years out; Poland continues co-producing and transferring PAC-3s."},{cat:"Diplomacy",text:"Zelensky's Jul 28 White House meeting with Trump \u2014 called 'good' by Zelensky \u2014 covered Patriot licenses and diplomacy. Putin is still reported to have dropped territorial-concession offers entirely, and the Kremlin continues to treat the Anchorage understandings as void; the Turkish ceasefire push remains rejected."},{cat:"Political",text:"Fedorov gave a new interview linking his dismissal to a procurement/tender reform push that drew internal backlash, and said his rift with former Commander-in-Chief Syrskyi (also since replaced, by Drapatyi) was 'ideological, not personal' \u2014 a conflict over vision rather than a personal feud. Fedorov continues rejecting Zelensky's alternative post; protests have run for close to three weeks with no new defense minister named."}],watch:"Whether the Poland missile incident escalates into any formal NATO consultation; whether last night's near-total ballistic-intercept failure was a one-off exposed by a maximum-effort attack or signals the Jul 25-26 rebound is not repeatable; and whether Pokrovsk holds.",generatedAt:new Date().toISOString()};

const IRAN_BRIEFING={summaryShort:"The war reignited Jul 29-30 after a five-night pause \u2014 Iran struck a US base in Jordan, and CENTCOM answered with a \u2018heavy wave\u2019 of strikes on dozens of IRGC targets. The war also expanded geographically for the first time: Egypt\u2019s Damietta port was hit by a drone, and Saudi Arabia conducted its first acknowledged direct strikes alongside the US, against Iranian-backed militias in Iraq. The core gaps \u2014 enrichment, missiles, Hormuz governance \u2014 remain unbridged with 17 days left on the nominal MoU clock.",summary:"After 13 consecutive nights of strikes drove Brent past $100 and cumulative US deaths to 18, the war unexpectedly went quiet: no US strikes on Iranian territory for five nights (Jul 25-29), the longest pause since the campaign resumed Jul 7. Trump said Iran had requested the pause \u2018because we\u2019ve been hitting them very hard\u2019 and that strikes would resume if talks failed; Iran\u2019s Foreign Ministry denied any direct negotiations were underway beyond ongoing Oman-mediated talks, and neither side used the word \u2018ceasefire.\u2019 The pause ended abruptly Jul 29-30: Iran struck US forces at a base in Jordan (intercepted), and CENTCOM responded with a \u2018heavy wave\u2019 hitting dozens of IRGC targets across southern and coastal Iran, including military command centers and drone facilities \u2014 Iranian state media reported a family of three killed on Qeshm island. The US also sanctioned 10 entities and 8 tankers. Most significantly, the war expanded geographically for the first time in this cycle: a drone struck a US-owned LNG storage tanker at Egypt\u2019s Damietta port \u2014 unclaimed, but unnamed Iranian sources reportedly hinted at Tehran\u2019s involvement \u2014 and Saudi Arabia conducted joint strikes with the US against Iranian-backed militias in Iraq, its first acknowledged direct combat role in the war. Iran\u2019s IRGC maintains the Strait of Hormuz stays closed as long as US \u2018interference\u2019 continues. None of the core negotiating gaps \u2014 uranium enrichment, the missile program, who governs Hormuz shipping, IAEA access to bombed and reportedly-being-rebuilt sites \u2014 have moved. The nominal 60-day Islamabad MoU window closes in 17 days.",assessment:[{cat:"Military",text:"The Jul 29-30 \u2018heavy wave\u2019 hit dozens of IRGC targets across southern/coastal Iran (Farashband among them) after Iran\u2019s attack on the Jordan base. This followed the longest pause of the war (5 nights) \u2014 Trump\u2019s framing was that Iran asked for space to negotiate, though Tehran disputes that characterization. Cumulative confirmed US deaths remain at 18 (unchanged since Jul 22), with no new fatalities reported through the pause or its end."},{cat:"Geographic Expansion",text:"Two genuinely new developments: a drone hit a US-owned LNG tanker at Egypt\u2019s Damietta port, the first time Egyptian infrastructure has been struck in the war \u2014 unclaimed, but Iranian sources reportedly hinted at involvement. Separately, Saudi Arabia conducted its first acknowledged direct strikes alongside the US, against Iranian-backed militias in Iraq. Both raise the number of states with an active combat role in the war."},{cat:"Diplomacy/MoU",text:"No confirmed direct US-Iran negotiations exist beyond ongoing Oman-mediated talks, which Iran describes as the only real channel. The Jul 24 dispute over a reported (and Iran-denied) Iraqi-brokered ceasefire proposal remains unresolved. Enrichment rights, the missile program, and Hormuz shipping governance are all still unbridged core gaps with 17 days left on the nominal MoU clock."},{cat:"Hormuz/Economy",text:"Iran\u2019s IRGC maintains the strait stays closed to normal traffic as long as US \u2018interference\u2019 continues. Brent crude has been volatile \u2014 spiking past $100 during the 13-night strike run, pulling back during the pause, then rising again on the Jul 29-30 re-escalation. Daily Hormuz crossings remain far below the pre-war ~130/day average."},{cat:"Iran Domestic",text:"No confirmed public appearance by successor Supreme Leader Mojtaba Khamenei since his father\u2019s Jul 9-10 burial \u2014 now several weeks with no image, video or voice recording, a genuinely unusual gap for a head of state. Satellite imagery has separately shown apparent reconstruction activity at the Taleghan 2 facility inside Parchin and vehicle traffic at the Pickaxe Mountain site, which Trump has explicitly threatened to strike \u2018very heavily.\u2019"}],watch:"Whether the Egypt and Saudi Arabia developments represent one-off incidents or a durable geographic expansion; whether Trump follows through on striking Pickaxe Mountain, the site Tehran calls a red line; and whether the Oman-mediated channel produces anything resembling real negotiations before the Aug 16 MoU deadline.",generatedAt:new Date().toISOString()};
...
const REPORT_NOW=new Date("2026-07-30T20:30:00Z");
  ...
  return <div>
    ...
    {tab==="overview"&&<div>
      ...
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <Grid2 t={t} items={[{val:"18+ killed",label:"US troops (war to date)",sub:"Toll frozen since Jul 22; no new US deaths confirmed since",color:"#dc2626"},{val:"1st time",label:"Egypt struck",sub:"Damietta port drone strike, Jul 29",color:"#dc2626"},{val:"1st time",label:"Saudi Arabia joins directly",sub:"Joint strikes w/ US on militias in Iraq",color:"#f97316"},{val:"17 days",label:"MoU clock (nominal)",sub:"Overtaken by events on the ground",color:"#8b5cf6"}]}/>
      </Hero>
      <ST t={t}>📡 Key Intelligence</ST>
      <Card t={t}>{[{icon:"📜",label:"Islamabad Memorandum",text:"Signed Jun 17. Pakistan brokered; Qatar, Saudi Arabia, Turkey, Egypt facilitated. 60-day window covers nuclear program, Hormuz shipping, sanctions, missiles, Lebanon."},{icon:"🚢",label:"Hormuz: live-fire zone again",text:"Iran struck three tankers Jul 6-7 (Marshall Islands-flagged Al Rekayyat, Saudi Wedyan, Liberian Cyprus Prosperity) for using non-designated routes. US answered with 80+ targets Jul 7 and a second round Jul 8 (Sirik, Bushehr, Konarak, Chabahar, Kish). IRGC claims strikes on 85 US military sites in Bahrain and Kuwait."},{icon:"🇾🇪",label:"Houthis join the conflict",text:"The Houthis announced a maritime embargo Jul 20 in solidarity with Iran, adding a further armed actor with a track record of Red Sea shipping attacks — a real risk of the war spreading to a second maritime chokepoint."},{icon:"☢️",label:"Nuclear: IAEA inspectors",text:"MoU allows IAEA inspectors back into Iran. But Iran and US in dispute over whether bombed sites must be opened before or after sanctions relief."},{icon:"⚠️",label:"MoU state of play",text:"After a 5-night pause (Jul 25-29) that Trump attributed to Iranian request for 'space' to talk — which Iran denied constituted real negotiations — the war reignited Jul 29-30 with an Iranian attack on a US base in Jordan and a US 'heavy wave' of retaliatory strikes. The war has also expanded geographically for the first time: Egypt's Damietta port was struck, and Saudi Arabia conducted its first acknowledged direct strikes alongside the US. Enrichment, missiles and Hormuz governance remain unbridged — 17 days to Aug 16."}].map((item,i,a)=><div key={i} style={{display:"flex",gap:10,padding:"11px 14px",borderBottom:i<a.length-1?`.5px solid ${t.sep}`:0}}><span style={{fontSize:20,flexShrink:0}}>{item.icon}</span><div><div style={{fontSize:13,fontWeight:700,color:t.text,marginBottom:3}}>{item.label}</div><div style={{fontSize:12,color:t.sub,lineHeight:1.55}}>{item.text}</div></div></div>)}
      </Card>
    ...
    {tab==="timeline"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>From Operation Epic Fury (Feb 28) through the Islamabad MoU and the 17-day countdown to Aug 16.</div>
      </Hero>
