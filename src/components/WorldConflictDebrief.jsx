...
const CONFLICTS=[
  {id:"ukraine",name:"Ukraine War",region:"Eastern Europe",status:"Active",statusColor:"#ef4444",icon:"🇺🇦",deaths:"~500K–700K killed",displaced:"11.8M total",get summary(){return `War Day ${getWarDay()}. 1.438M+ Russian casualties. Putin publicly admitted fuel shortages at United Russia congress Jun 28 — first time. Rejected all diplomatic solutions. Russia launched 142 drones + 2 Zircon + 6 Iskander overnight. NATO Ankara concluded: $80B/yr pledged, Patriot co-production greenlit.`;},get warDay(){return getWarDay();}},
  {id:"gaza",name:"Israel & the Levant",region:"Middle East",status:"Multi-Front",statusColor:"#f59e0b",icon:"🇵🇸",deaths:"73,326 killed total",displaced:"1.9M displaced",summary:"Ceasefire since Oct 10, 2025. 1,200 killed since ceasefire. Quiet annexation accelerating. 80% of buildings damaged.",warDay:null},
...
const NEWS=[
  ...
  {id:"b_senate_defense_bill_jul14",confidence:"Confirmed",conflictId:"ukraine",severity:"major",icon:"🟠",headline:"Senate Democrats Block $1 Trillion Defense Bill in Protest Over the Iran War",conflict:"Ukraine",conflictColor:"#5b8ec8",publishedAt:"Jul 14, 2026",bullets:["Senate Democrats blocked procedural passage of the National Defense Authorization Act by 50-46, short of the 60 votes needed, citing the renewed Iran war and the lack of Congressional authorization for the latest round of strikes. The bill would authorize much of a $1.15T military budget including a troop pay raise; Majority Leader Thune voted no procedurally, preserving his right to bring it back up","Beyond Iran, some Democrats also objected to provisions deepening US military and intelligence cooperation with Israel — Sen. Van Hollen argued the bill would order the executive branch to share more intelligence regardless of Israeli government conduct. Congress has now voted more than 10 times on war-powers resolutions seeking to halt hostilities, none successfully","The move lands one day after the death of Sen. Lindsey Graham, one of the chamber's most reliable votes for defense and Ukraine-related spending, further complicating the bill's path","Given this dashboard's tracking of US legislative capacity for Ukraine aid and Russia sanctions, a stalled defense bill is a relevant leading indicator — appropriations fights over Iran can just as easily delay Ukraine-linked funding riders"],sources:["AP"],impact:"A concrete sign that the Iran war is now spilling into domestic US legislative gridlock, with second-order risk to unrelated defense and Ukraine funding items that typically ride on the same bill",impactColor:"#f97316"},
...
const LOSSES={ukraine:[
  {id:1,category:"Personnel",total:"1,438,990",todayChange:"+1,440",color:"#ef4444",icon:"☠️",description:"Killed & wounded (est.)"},
  {id:2,category:"Tanks",total:"12,217",todayChange:"+9",color:"#f97316",icon:"🪖",description:"Main battle tanks"},
  {id:3,category:"Armoured Vehs",total:"25,019",todayChange:"+8",color:"#eab308",icon:"🚧",description:"APCs, IFVs, MRAPs"},
  {id:4,category:"Artillery",total:"46,794",todayChange:"+70",color:"#84cc16",icon:"💥",description:"Guns, howitzers, mortars"},
  {id:5,category:"MLRS",total:"1,969",todayChange:"+1",color:"#22c55e",icon:"🚀",description:"Multiple launch rockets"},
  {id:6,category:"Air Defence",total:"1,518",todayChange:"—",color:"#06b6d4",icon:"🛡️",description:"SAM & SHORAD systems"},
  {id:7,category:"UAVs",total:"428,286",todayChange:"+1,450",color:"#5b8ec8",icon:"🛸",description:"Operational UAVs"},
  ...
  {id:10,category:"Cruise Missiles",total:"4,944",todayChange:"+1",color:"#14b8a6",icon:"🎯",description:"Destroyed in flight"},
  {id:11,category:"Ships/Boats",total:"34",todayChange:"—",color:"#64748b",icon:"⛵",description:"Naval vessels"},
  {id:12,category:"Vehicles",total:"125,811",todayChange:"+453",color:"#a78bfa",icon:"🚛",description:"Trucks & logistics"},
  {id:13,category:"Ground Robots",total:"2,031",todayChange:"+8",color:"#f43f5e",icon:"🤖",description:"UGV platforms"},
  {id:14,category:"Special Equip",total:"4,465",todayChange:"+3",color:"#fb923c",icon:"🔧",description:"Engineering & EW"},
],gaza:[
...
const REPORT_NOW=new Date("2026-07-26T20:30:00Z");
  ...
  return <div>
    ...
    {tab==="timeline"&&<div>
      <Hero t={t} style={{borderLeft:"4px solid #8b5cf6"}}>
        ...
        <div style={{fontSize:12,color:"rgba(255,255,255,.65)",lineHeight:1.6}}>From Operation Epic Fury (Feb 28) through the Islamabad MoU and the 21-day countdown to Aug 16.</div>
      </Hero>
