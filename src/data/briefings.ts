...
export const BRIEFINGS: Briefing[] = [
  {
    date: "2026-08-22",
    title: "Trump announced a ‘crushing economic operation’ against Iran — the toughest sanctions…",
    lede: "Trump announced a ‘crushing economic operation’ against Iran — the toughest sanctions package yet, to be detailed Monday, with Washington pressing China to join. Iran’s Foreign Ministry called it a ‘declaration of war’ on all nations, framing it as an attempt to exert extraterritorial sovereignty over UN member states. Tehran will let Iraqi oil tankers through Hormuz — a selective easing, not a reopening; traffic sits near 20% of pre-war. Russian losses reached 1,475,270 (+1,240) as of Aug 22, and Kyiv mourned the 17+ killed in Thursday’s barrage.",
    body: "The Iran confrontation is now being fought primarily with economic instruments, and both sides escalated their framing of it. Trump announced a ‘crushing economic operation,’ with the toughest sanctions package of the war due to be detailed Monday and US officials pressing China — Iran’s largest oil customer — to support it. Iran’s Foreign Ministry answered with a deliberately universalising claim: the sanctions are a ‘declaration of war’ not just on Iran but on all nations, ‘an attempt by the United States to exert extraterritorial sovereignty over all independent UN member states.’ That is an argument aimed at third countries rather than at Washington, and its traction with Beijing and Delhi is the thing worth watching. A close ally of Khamenei separately said Trump’s rhetoric reflects desperation and vowed Iran ‘will not submit.’ Practically, one small thing moved: Iranian state media said Tehran will allow Iraqi oil tankers to transit the strait — a targeted carve-out for a neighbour rather than a reopening, with overall traffic still near 20% of the pre-war average per CNN analysis. US gas prices are running nearly a dollar above last year, and AAA expects the highest August on record. On Ukraine, the General Staff’s Aug 22 report puts cumulative Russian losses at 1,475,270 (+1,240), and Kyiv observed a day of mourning for the at least 17 killed in Thursday’s mass barrage — the same attack that struck a Romanian gas project and a Moldovan border crossing.",
    watch: "Whether China and other large buyers give any ground on the sanctions package detailed Monday — the test of whether Iran’s ‘all nations’ framing lands; whether the Iraqi-tanker carve-out widens into a genuine partial reopening or stays a one-off; and whether Thursday’s spillover into Romania and Moldova draws any NATO consultation now that several days have passed.",
    theaters: ["Ukraine","Iran","Strait of Hormuz","China"],
  },
  {
    date: "2026-08-21",
    title: "US Threatens Unprecedented Economic Isolation of Iran as Kyiv Mourns Barrage Dead",
    lede: "The US has pivoted from military escalation to economic strangulation on Iran — new Hezbollah sanctions plus a threat of ‘economic isolation like the world has never seen,’ with Treasury saying the Hormuz blockade will keep anything from moving in or out of Iranian ports. Iran called the threat unlawful; the IRGC warned it could field more ‘destructive’ weapons if the war restarts. In Gaza, at least 10 were killed in strikes two days after US negotiators asked Israel to draw down. Russian losses reached 1,474,030 (+1,390) as of Aug 21, and Kyiv is holding a day of mourning for the 17+ killed in Thursday’s barrage.",
    body: "The Iran confrontation changed instrument rather than intensity this cycle. Having publicly stepped back from diplomacy — no talks scheduled, no attempt to revive the lapsed MoU — Washington escalated economically instead: new sanctions on Hezbollah, and a threatened campaign that Treasury Secretary Bessent described as ‘economic isolation, like the world has never seen before,’ explicitly tying it to the Hormuz blockade keeping anything from moving in or out of Iranian ports. Iran’s Foreign Ministry condemned the ‘unlawful’ threat and warned that those who order or implement the levies ‘are liable to prosecution and punishment,’ while the IRGC warned it could deploy more ‘destructive’ weapons if the war restarts. VP Vance called economic pressure the administration’s ‘most effective tool’ but conceded it is a ‘delicate dance.’ In Gaza, the gap between diplomacy and conditions on the ground widened: at least 10 people were killed in two Israeli strikes on Aug 19, including one on a cafe at the Gaza port, just two days after US negotiators reportedly asked Israel to reduce attacks during Kushner’s marathon meeting with Netanyahu. That meeting did produce one concrete mechanism — agreement that a US general should oversee Hamas’ demilitarization — but the sequencing dispute remains unresolved. On Ukraine, Kyiv observes a day of mourning today for the at least 17 killed in Thursday’s mass barrage, and the General Staff’s Aug 21 report puts cumulative Russian losses at 1,474,030 (+1,390).",
    watch: "Whether the threatened ‘economic isolation’ campaign materializes as specific measures or stays rhetorical, and whether Iran follows through on its threat to prosecute those implementing it; whether the US-general-oversees-demilitarization mechanism gains Israeli and Hamas buy-in or joins the list of stalled proposals; and whether Israeli strikes in Gaza slow now that Washington has explicitly asked for a drawdown.",
    theaters: ["Ukraine","Iran","Strait of Hormuz","Israel","Lebanon"],
  },
  {
    date: "2026-08-18",
